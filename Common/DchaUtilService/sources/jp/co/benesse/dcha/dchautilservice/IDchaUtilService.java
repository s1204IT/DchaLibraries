...
public interface IDchaUtilService extends IInterface {
    ...
    int[] getOriginalLcdSize() throws RemoteException;
    ...
    void initializeDevice() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IDchaUtilService {
        ...
        static final int TRANSACTION_getOriginalLcdSize = 16;
        ...
        static final int TRANSACTION_initializeDevice = 18;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case TRANSACTION_copyFile:
                    ...
                    return true;
                case TRANSACTION_copyDirectory:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_existsFile:
                    ...
                    return true;
                case TRANSACTION_getOriginalLcdSize:
                    data.enforceInterface(DESCRIPTOR);
                    int[] _result12 = getOriginalLcdSize();
                    reply.writeNoException();
        ...
        private static class Proxy implements IDchaUtilService {
            ...
            @Override
            public int[] getOriginalLcdSize() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_getOriginalLcdSize, _data, _reply, 0);
                    _reply.readException();
                    int[] _result = _reply.createIntArray();
                    return _result;
                } finally {
