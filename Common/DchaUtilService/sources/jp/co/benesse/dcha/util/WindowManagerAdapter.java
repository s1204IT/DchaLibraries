...
public class WindowManagerAdapter {
    ...
    private static final void getInitialDisplaySize(Context context, Point outSize) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ClassLoader loader = ClassLoader.getSystemClassLoader();
        Object serviceManager = ReflectionUtils.invokeDeclaredMethod(loader.loadClass("android.os.ServiceManager"), null, "getService", new Class[]{String.class}, new Object[]{"window"});
        Object iwindowManager = ReflectionUtils.invokeDeclaredMethod(loader.loadClass("android.view.IWindowManager$Stub"), null, "asInterface", new Class[]{IBinder.class}, new Object[]{serviceManager});
        WindowManager wm = (WindowManager) context.getSystemService("window");
        Display display = wm.getDefaultDisplay();
        ReflectionUtils.invokeDeclaredMethod(loader.loadClass("android.view.IWindowManager"), iwindowManager, "getInitialDisplaySize", new Class[]{Integer.TYPE, Point.class}, new Object[]{Integer.valueOf(display.getDisplayId()), outSize});
    }
}
