...
public class FastStringBuffer {
    ...
    public final void reset() {
        ...
        this.m_innerFSB = null;
        this.m_array = (char[][]) Array.newInstance((Class<?>) Character.TYPE, 16, 0);
        this.m_array[0] = new char[this.m_chunkSize];
    }
            ...
            while (strlen > 0) {
                ...
                if (strlen > 0) {
                    ...
                    if (chunk == null) {
                        ...
                        int i3 = this.m_lastChunk;
                        char[] chunk2 = new char[this.m_chunkSize];
                        cArr3[i3] = chunk2;
                    }
    ...
    public String getString(int start, int length) {
        ...
        return (startColumn + length >= this.m_chunkMask || this.m_innerFSB != null) ? getString(new StringBuffer(length), startChunk, startColumn, length).toString() : getOneChunkString(startChunk, startColumn, length);
    }
    ...
    public char charAt(int pos) {
        ...
        return (startChunk != 0 || this.m_innerFSB == null) ? this.m_array[startChunk][this.m_chunkMask & pos] : this.m_innerFSB.charAt(this.m_chunkMask & pos);
    }
    ...
    public int sendNormalizedSAXcharacters(ContentHandler ch, int start, int length) throws SAXException {
        ...
        if (stopChunk == 0 && this.m_innerFSB != null) {
            int stateForNextChunk2 = this.m_innerFSB.sendNormalizedSAXcharacters(ch, startColumn, stopColumn - startColumn);
            return stateForNextChunk2;
        }
