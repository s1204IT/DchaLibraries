        ...
        if (target.equals("xml-stylesheet")) {
            ...
            while (tokenizer.hasMoreTokens()) {
                ...
                if (!tokenizer.hasMoreTokens() || (!token.equals(" ") && !token.equals("\t") && !token.equals("="))) {
                    ...
                    } else if (name.equals(org.apache.xalan.templates.Constants.ATTRNAME_HREF)) {
                        token = tokenizer.nextToken();
                        while (tokenizer.hasMoreTokens() && (token.equals(" ") || token.equals("\t") || token.equals("="))) {
                            token = tokenizer.nextToken();
                        }
            ...
            if (type != null) {
                if ((type.equals("text/xsl") || type.equals("text/xml") || type.equals("application/xml+xslt")) && href != null) {
                    if (this.m_media == null || (media != null && media.equals(this.m_media))) {
