...
public abstract class SerializerBase implements SerializationHandler, SerializerConstants {
    ...
    private String getProp(String name, boolean defaultVal) {
        ...
        if (defaultVal) {
            String val = (String) this.m_OutputPropsDefault.get(name);
            return val;
        }
        String val2 = (String) this.m_OutputProps.get(name);
        return val2;
    }
    ...
    void setProp(String name, String val, boolean defaultVal) {
        ...
        if (Constants.ATTRNAME_OUTPUT_CDATA_SECTION_ELEMENTS.equals(name) && val != null) {
            initCdataElems(val);
