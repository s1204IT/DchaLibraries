...
public abstract class ToStream extends SerializerBase {
    ...
    protected boolean escapingNotNeeded(char ch) {
        ...
        boolean ret = this.m_encodingInfo.isInEncoding(ch);
        return ret;
    }
    ...
    int accumDefaultEntity(Writer writer, char ch, int i, char[] chars, int len, boolean fromTextNode, boolean escLF) throws IOException {
        ...
        if (!escLF && '\n' == ch) {
            ...
            if ((!(fromTextNode && this.m_charInfo.shouldMapTextChar(ch)) && (fromTextNode || !this.m_charInfo.shouldMapAttrChar(ch))) || (outputStringForChar = this.m_charInfo.getOutputStringForChar(ch)) == null) {
                return i;
            }
