...
public class SAX2DTM2 extends SAX2DTM {
    ...
    public final class ChildrenIterator extends DTMDefaultBaseIterators.InternalAxisIteratorBase {
        ...
        public DTMAxisIterator setStartNode(int node) {
            ...
            if (this._isRestartable) {
                ...
                this._currentNode = node != -1 ? SAX2DTM2.this._firstch2(SAX2DTM2.this.makeNodeIdentity(node)) : -1;
    ...
    public final class TypedChildrenIterator extends DTMDefaultBaseIterators.InternalAxisIteratorBase {
        ...
        public DTMAxisIterator setStartNode(int node) {
            ...
            if (this._isRestartable) {
                this._startNode = node;
                this._currentNode = node != -1 ? SAX2DTM2.this._firstch2(SAX2DTM2.this.makeNodeIdentity(this._startNode)) : -1;
                return resetPosition();
            }
            return this;
        }
        ...
        public int getNodeByPosition(int position) {
            ...
            if (nodeType != 1) {
                while (node != -1) {
                    if (SAX2DTM2.this._exptype2(node) == nodeType && (pos = pos + 1) == position) {
            ...
            while (node != -1) {
                if (SAX2DTM2.this._exptype2(node) >= 14 && (pos = pos + 1) == position) {
                    return SAX2DTM2.this.makeNodeHandle(node);
                }
                node = SAX2DTM2.this._nextsib2(node);
            }
    ...
    public class FollowingIterator extends DTMDefaultBaseIterators.InternalAxisIteratorBase {
        ...
        public DTMAxisIterator setStartNode(int node) {
            ...
            if (this._isRestartable) {
                ...
                int node2 = SAX2DTM2.this.makeNodeIdentity(node);
                int type = SAX2DTM2.this._type2(node2);
                if ((2 == type || 13 == type) && -1 != (first = SAX2DTM2.this._firstch2((node2 = SAX2DTM2.this._parent2(node2))))) {
                    this._currentNode = SAX2DTM2.this.makeNodeHandle(first);
                    return resetPosition();
                }
                do {
                    first2 = SAX2DTM2.this._nextsib2(node2);
                    if (-1 == first2) {
                        node2 = SAX2DTM2.this._parent2(node2);
                    }
                    if (-1 != first2) {
                ...
                if (nodeType >= 14) {
                    while (nodeID != -1) {
                        if (SAX2DTM2.this._exptype2(nodeID) == nodeType) {
                            ...
                            int i = this.m_size;
                            this.m_size = i + 1;
                            iArr[i] = SAX2DTM2.this.makeNodeHandle(nodeID);
                        }
                        nodeID = SAX2DTM2.this._parent2(nodeID);
                    }
                } else {
                    while (nodeID != -1) {
                        ...
                        if ((eType < 14 && eType == nodeType) || (eType >= 14 && SAX2DTM2.this.m_extendedTypes[eType].getNodeType() == nodeType)) {
                            ...
                            int i2 = this.m_size;
                            this.m_size = i2 + 1;
                            iArr2[i2] = SAX2DTM2.this.makeNodeHandle(nodeID);
                        }
                        nodeID = SAX2DTM2.this._parent2(nodeID);
                    }
                }
    ...
    public final int _exptype2(int identity) {
        return identity < this.m_blocksize ? this.m_exptype_map0[identity] : this.m_exptype_map[identity >>> this.m_SHIFT][this.m_MASK & identity];
    }

    public final int _nextsib2(int identity) {
        return identity < this.m_blocksize ? this.m_nextsib_map0[identity] : this.m_nextsib_map[identity >>> this.m_SHIFT][this.m_MASK & identity];
    }

    public final int _firstch2(int identity) {
        return identity < this.m_blocksize ? this.m_firstch_map0[identity] : this.m_firstch_map[identity >>> this.m_SHIFT][this.m_MASK & identity];
    }

    public final int _parent2(int identity) {
        return identity < this.m_blocksize ? this.m_parent_map0[identity] : this.m_parent_map[identity >>> this.m_SHIFT][this.m_MASK & identity];
    }
    ...
    public int getIdForNamespace(String uri) {
        ...
        if (index < 0) {
            ...
            int index2 = this.m_valueIndex;
            this.m_valueIndex = index2 + 1;
            return index2;
        }
        return index;
    }
    ...
    public String getNodeName(int nodeHandle) {
        ...
        if (extType.getNamespace().length() == 0) {
            ...
            if (type == 7) {
                int dataIndex = _dataOrQName(nodeID);
                String localName2 = this.m_valuesOrPrefixes.indexToString(this.m_data.elementAt(-dataIndex));
                return localName2;
            }
            if (localName.length() == 0) {
                String localName3 = getFixedNames(type);
                return localName3;
            }
            return localName;
        }
        int qnameIndex = this.m_dataOrQName.elementAt(nodeID);
        if (qnameIndex == 0) {
            String localName4 = extType.getLocalName();
            return localName4;
        }
        if (qnameIndex < 0) {
            qnameIndex = this.m_data.elementAt(-qnameIndex);
        }
        String localName5 = this.m_valuesOrPrefixes.indexToString(qnameIndex);
        return localName5;
    }
