...
public class DTMNodeProxy implements Node, Document, Text, Element, Attr, ProcessingInstruction, Comment, DocumentFragment {
    ...
    static class DTMNodeProxyImplementation implements DOMImplementation {
        ...
        public boolean hasFeature(String feature, String version) {
            return ("CORE".equals(feature.toUpperCase()) || "XML".equals(feature.toUpperCase())) && (SerializerConstants.XMLVERSION10.equals(version) || "2.0".equals(version));
        }
    ...
    public boolean isEqualNode(Node arg) {
        ...
        return getNodeValue() == null ? arg.getNodeValue() == null : getNodeValue().equals(arg.getNodeValue());
    }
