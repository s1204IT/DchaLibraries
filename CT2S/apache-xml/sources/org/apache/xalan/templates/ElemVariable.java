...
public class ElemVariable extends ElemTemplateElement {
    ...
    public void compose(StylesheetRoot sroot) throws TransformerException {
        XPath newSelect;
        if (this.m_selectPattern == null && sroot.getOptimizer() && (newSelect = rewriteChildToExpression(this)) != null) {
    ...
    public boolean isPsuedoVar() {
        ...
        return ns != null && ns.equals("http://xml.apache.org/xalan/psuedovar") && this.m_qname.getLocalName().startsWith("#");
    }
