    ...
    public boolean equals(Object obj) {
        ...
        if (Proxy.isProxyClass(obj.getClass())) {
            ...
            if (handler instanceof AnnotationFactory) {
                ...
                int i$ = 0;
                while (i$ < len$) {
                    AnnotationMember el1 = arr$[i$];
                    AnnotationMember[] arr$2 = other.elements;
                    for (AnnotationMember el2 : arr$2) {
                        if (el1.equals(el2)) {
                            break;
                        }
                    }
        ...
        AnnotationMember[] arr$3 = this.elements;
        for (AnnotationMember el : arr$3) {
            if (el.tag == '!') {
                return false;
            }
            try {
