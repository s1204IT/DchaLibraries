...
class Logical {
        ...
        if (iLonger < shorter.numberLength) {
            ...
            if (digit == 0) {
                do {
                    ...
                    digit = (longer.digits[i] | shorter.digits[i]) ^ (-1);
                } while (digit == 0);
                if (digit == 0) {
                    while (i < longer.numberLength && (digit = longer.digits[i] ^ (-1)) == 0) {
                        i++;
                    }
                    if (digit == 0) {
        ...
        if (iNeg < positive.numberLength) {
            ...
            if (iPos > iNeg) {
                ...
                if (digit == 0) {
                    ...
                    i++;
                    while (i < limit2) {
                        digit = (negative.digits[i] | positive.digits[i]) ^ (-1);
                        if (digit != 0) {
                            break;
                        }
                        i++;
                    ...
                    if (digit == 0) {
                        while (i < positive.numberLength && (digit = positive.digits[i] ^ (-1)) == 0) {
                            i++;
                        }
                        while (i < negative.numberLength && (digit = negative.digits[i] ^ (-1)) == 0) {
                            i++;
                        }
                        if (digit == 0) {
    ...
    static BigInteger andNotNegative(BigInteger val, BigInteger that) {
        ...
        int i2 = i + 1;
        while (i2 < limit2) {
            resDigits[i2] = (val.digits[i2] ^ (-1)) & that.digits[i2];
            i2++;
        }
    ...
    static BigInteger xorDiffSigns(BigInteger positive, BigInteger negative) {
        ...
        if (iNeg < iPos) {
            ...
            if (digit == 0) {
                ...
                i2++;
                while (i2 < limit3) {
                    digit = positive.digits[i2] ^ (negative.digits[i2] ^ (-1));
                    if (digit != 0) {
                        break;
                    }
                    i2++;
                ...
                if (digit == 0) {
                    while (i2 < positive.numberLength && (digit = positive.digits[i2] ^ (-1)) == 0) {
                        i2++;
                    }
                    while (i2 < negative.numberLength && (digit = negative.digits[i2] ^ (-1)) == 0) {
                        i2++;
                    }
                    if (digit == 0) {
                        int resLength2 = resLength + 1;
