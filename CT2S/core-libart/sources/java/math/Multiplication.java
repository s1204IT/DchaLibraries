...
class Multiplication {
    ...
    static final int[] fivePows = {1, 5, 25, Opcodes.OP_NEG_LONG, 625, 3125, 15625, 78125, 390625, 1953125, 9765625, 48828125, 244140625, 1220703125};
    ...
    static BigInteger powerOf10(long exp) {
        ...
        try {
            if (exp <= 2147483647L) {
                BigInteger res = bigFivePows[1].pow(intExp).shiftLeft(intExp);
                return res;
            }
