...
public class PrintWriter extends Writer {
    ...
    public PrintWriter(File file, String csn) throws UnsupportedEncodingException, FileNotFoundException {
        this((Writer) new OutputStreamWriter(new BufferedOutputStream(new FileOutputStream(file)), csn), false);
    }

    public PrintWriter(String fileName) throws FileNotFoundException {
        this((Writer) new OutputStreamWriter(new BufferedOutputStream(new FileOutputStream(fileName))), false);
    }

    public PrintWriter(String fileName, String csn) throws UnsupportedEncodingException, FileNotFoundException {
        this((Writer) new OutputStreamWriter(new BufferedOutputStream(new FileOutputStream(fileName)), csn), false);
    }
