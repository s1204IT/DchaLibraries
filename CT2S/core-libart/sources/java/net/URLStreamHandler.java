...
public abstract class URLStreamHandler {
    ...
    protected void parseURL(URL url, String spec, int start, int end) {
        ...
        setURL(url, url.getProtocol(), host, port, authority, userInfo, UrlUtils.authoritySafePath(authority, path), query, ref);
    }
    ...
    private static String relativePath(String base, String path) {
        ...
        if (base != null) {
            String combined = base.substring(0, base.lastIndexOf(47) + 1) + path;
