...
public class EllipticCurve {
    ...
    public EllipticCurve(ECField field, BigInteger a, BigInteger b, byte[] seed) {
        ...
        if (this.field instanceof ECFieldF2m) {
    ...
    public int hashCode() {
        if (this.hash == 0) {
            int hash0 = this.field.hashCode() + 341;
            int hash02 = (((hash0 * 31) + this.a.hashCode()) * 31) + this.b.hashCode();
            if (this.seed != null) {
                for (int i = 0; i < this.seed.length; i++) {
                    hash02 = (hash02 * 31) + this.seed[i];
                }
            } else {
                hash02 *= 31;
            }
