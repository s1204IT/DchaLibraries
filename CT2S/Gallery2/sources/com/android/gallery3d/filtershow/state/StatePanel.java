...
public class StatePanel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = (LinearLayout) inflater.inflate(R.layout.filtershow_state_panel_new, (ViewGroup) null);
        View panel = this.mMainView.findViewById(R.id.listStates);
        this.track = (StatePanelTrack) panel;
