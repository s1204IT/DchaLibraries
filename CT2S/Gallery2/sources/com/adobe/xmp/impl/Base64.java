...
public class Base64 {
    ...
    public static final byte[] encode(byte[] src, int lineFeed) {
        ...
        while (sidx + 3 <= src.length) {
            int sidx2 = sidx + 1;
            int bits24 = (src[sidx] & 255) << 16;
            int sidx3 = sidx2 + 1;
            int bits242 = bits24 | ((src[sidx2] & 255) << 8);
            int sidx4 = sidx3 + 1;
            int bits243 = bits242 | ((src[sidx3] & 255) << 0);
        ...
        if (src.length - sidx == 2) {
            int bits244 = ((src[sidx] & 255) << 16) | ((src[sidx + 1] & 255) << 8);
