...
public class MD5Digest extends GeneralDigest {
    ...
    protected void processBlock() {
        ...
        int c5 = rotateLeft(((F(d5, a5, b4) + c4) + this.X[S23]) - 1502002290, 17) + d5;
        int b5 = rotateLeft(F(c5, d5, a5) + b4 + this.X[S43] + 1236535329, 22) + c5;
        int a6 = rotateLeft(((G(b5, c5, d5) + a5) + this.X[1]) - 165796510, 5) + b5;
        int d6 = rotateLeft(((G(a6, b5, c5) + d5) + this.X[6]) - 1069501632, 9) + a6;
        int c6 = rotateLeft(G(d6, a6, b5) + c5 + this.X[11] + 643717713, S23) + d6;
        ...
        int c7 = rotateLeft(((G(d7, a7, b6) + c6) + this.X[S43]) - 660478335, S23) + d7;
        int b7 = rotateLeft(((G(c7, d7, a7) + b6) + this.X[4]) - 405537848, 20) + c7;
        int a8 = rotateLeft(G(b7, c7, d7) + a7 + this.X[9] + 568446438, 5) + b7;
        int d8 = rotateLeft(((G(a8, b7, c7) + d7) + this.X[S23]) - 1019803690, 9) + a8;
        int c8 = rotateLeft(((G(d8, a8, b7) + c7) + this.X[3]) - 187363961, S23) + d8;
        ...
        int c9 = rotateLeft(G(d9, a9, b8) + c8 + this.X[7] + 1735328473, S23) + d9;
        ...
        int b10 = rotateLeft(((H(c10, d10, a10) + b9) + this.X[S23]) - 35309556, 23) + c10;
        ...
        int c13 = rotateLeft(H(d13, a13, b12) + c12 + this.X[S43] + 530742520, 16) + d13;
        ...
        int c14 = rotateLeft(((K(d14, a14, b13) + c13) + this.X[S23]) - 1416354905, S43) + d14;
        ...
        int c15 = rotateLeft(((K(d15, a15, b14) + c14) + this.X[10]) - 1051523, S43) + d15;
        ...
        int d16 = rotateLeft(((K(a16, b15, c15) + d15) + this.X[S43]) - 30611744, 10) + a16;
        int c16 = rotateLeft(((K(d16, a16, b15) + c15) + this.X[6]) - 1560198380, S43) + d16;
        ...
        int c17 = rotateLeft(K(d17, a17, b16) + c16 + this.X[2] + 718787259, S43) + d17;
