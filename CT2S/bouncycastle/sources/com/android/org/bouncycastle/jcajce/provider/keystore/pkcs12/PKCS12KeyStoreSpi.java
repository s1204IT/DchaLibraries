...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    protected byte[] cryptData(boolean forEncryption, AlgorithmIdentifier algId, char[] password, boolean wrongPKCS12Zero, byte[] data) throws IOException {
        ...
        if (algorithm.equals(PKCSObjectIdentifiers.id_PBES2)) {
            try {
                return createCipher(2, password, algId).doFinal(data);
            } catch (Exception e2) {
    ...
    private Cipher createCipher(int mode, char[] password, AlgorithmIdentifier algId) throws InvalidKeySpecException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        SecretKey key;
                        ...
                        for (int j2 = 0; j2 != seq2.size(); j2++) {
                            ...
                            if (b2.getBagId().equals(certBag)) {
                                ...
                                while (e5.hasMoreElements()) {
                                    ASN1Sequence sq3 = (ASN1Sequence) e5.nextElement();
                                    ASN1ObjectIdentifier aOid3 = (ASN1ObjectIdentifier) sq3.getObjectAt(0);
                                    ASN1Set attrSet3 = (ASN1Set) sq3.getObjectAt(1);
                                    ASN1Primitive attr3 = null;
                                    if (attrSet3.size() > 0) {
                                        attr3 = (ASN1Primitive) attrSet3.getObjectAt(0);
                ...
                try {
                    ...
                    if (b3.getBagAttributes() != null) {
                        ...
                        while (e6.hasMoreElements()) {
                            ASN1Sequence sq4 = (ASN1Sequence) e6.nextElement();
                            ASN1ObjectIdentifier oid = (ASN1ObjectIdentifier) sq4.getObjectAt(0);
                            ASN1Primitive attr4 = (ASN1Primitive) ((ASN1Set) sq4.getObjectAt(1)).getObjectAt(0);
    ...
    private void doStore(OutputStream stream, char[] password, boolean useDEREncoding) throws IOException {
        ...
        try {
            ...
            AlgorithmIdentifier algId = new AlgorithmIdentifier(id_SHA1, (ASN1Encodable) DERNull.INSTANCE);
