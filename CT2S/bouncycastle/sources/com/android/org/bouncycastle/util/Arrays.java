...
public final class Arrays {
    ...
    public static byte[] concatenate(byte[] a, byte[] b, byte[] c) {
        ...
        if (b == null) {
            byte[] rv2 = concatenate(a, c);
            return rv2;
        }
        byte[] rv3 = concatenate(a, b);
        return rv3;
    }
    ...
    public static byte[] concatenate(byte[] a, byte[] b, byte[] c, byte[] d) {
        ...
        if (d == null) {
            byte[] rv2 = concatenate(a, b, c);
            return rv2;
        }
        if (c == null) {
            byte[] rv3 = concatenate(a, b, d);
            return rv3;
        }
        if (b == null) {
            byte[] rv4 = concatenate(a, c, d);
            return rv4;
        }
        byte[] rv5 = concatenate(b, c, d);
        return rv5;
    }
