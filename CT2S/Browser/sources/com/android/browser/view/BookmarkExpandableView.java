...
public class BookmarkExpandableView extends ExpandableListView implements BreadCrumbView.Controller {
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        this.mContextMenuInfo = new BookmarkContextMenuInfo(childPosition.intValue(), groupPosition.intValue());
        if (getParent() != null) {
    ...
    class BookmarkAccountAdapter extends BaseExpandableListAdapter {
        ...
        public void clear() {
            ...
            for (int i = 0; i < this.mChildren.size(); i++) {
                BrowserBookmarksAdapter b = this.mChildren.get(i);
                if (b != null) {
                    b.clearThread();
                }
            }
