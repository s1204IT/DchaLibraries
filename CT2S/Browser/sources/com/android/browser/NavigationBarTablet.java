...
public class NavigationBarTablet extends NavigationBarBase implements UrlInputView.StateListener {
    ...
    protected void onFinishInflate() {
        ...
        this.mVoiceButton = findViewById(R.id.voice);
    ...
    void updateNavigationState(Tab tab) {
        if (tab != null) {
            this.mBackButton.setImageResource(tab.canGoBack() ? R.drawable.ic_back_holo_dark : R.drawable.ic_back_disabled_holo_dark);
            this.mForwardButton.setImageResource(tab.canGoForward() ? R.drawable.ic_forward_holo_dark : R.drawable.ic_forward_disabled_holo_dark);
        }
        updateUrlIcon();
    }
