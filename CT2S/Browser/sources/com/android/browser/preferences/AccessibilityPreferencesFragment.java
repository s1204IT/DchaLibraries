...
public class AccessibilityPreferencesFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Preference e4 = findPreference("inverted_contrast");
        e4.setOnPreferenceChangeListener(this);
        updateInvertedContrastSummary(e4, (int) (settings.getInvertedContrast() * 100.0f));
    }
    ...
    void updateInvertedContrastSummary(Preference pref, int contrast) {
        pref.setSummary(this.mFormat.format(((double) contrast) / 100.0d));
    }
    ...
    public boolean onPreferenceChange(Preference pref, Object objValue) {
        ...
        if ("inverted_contrast".equals(pref.getKey())) {
            updateInvertedContrastSummary(pref, (((Integer) objValue).intValue() + 10) * 10);
        }
        return true;
    }
}
