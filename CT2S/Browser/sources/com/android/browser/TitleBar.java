...
public class TitleBar extends RelativeLayout {
    ...
    private void setFixedTitleBar() {
        boolean isFixed = ((this.mUseQuickControls || this.mContext.getResources().getBoolean(R.bool.hide_title)) ? false : true) | this.mAccessibilityManager.isEnabled();
        ViewGroup parent = (ViewGroup) getParent();
        if (this.mIsFixedTitleBar != isFixed || parent == null) {
            this.mIsFixedTitleBar = isFixed;
    ...
    public View focusSearch(View focused, int dir) {
        ...
        return (130 == dir && hasFocus() && web != null && web.hasFocusable() && web.getParent() != null) ? web : super.focusSearch(focused, dir);
    }
