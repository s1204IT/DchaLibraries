...
public class UserDictionarySettings extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(android.R.layout.js_prompt, container, false);
    }
    ...
    private static class MyAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        public MyAdapter(Context context, int layout, Cursor c, String[] from, int[] to, UserDictionarySettings settings) {
            ...
            if (c != null) {
                String alphabet = context.getString(android.R.string.indeterminate_progress_background);
