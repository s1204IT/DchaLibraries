...
public class WifiSettingsForSetupWizardXL extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view == this.mSkipOrNextButton) {
    ...
    private void onBackButtonPressed() {
        if (this.mScreenState == 2 || this.mScreenState == 3) {
            ...
            for (WifiConfiguration config : configs) {
                Log.d("SetupWizard", String.format("forgeting Wi-Fi network \"%s\" (id: %d)", config.SSID, Integer.valueOf(config.networkId)));
                this.mWifiManager.forget(config.networkId, new WifiManager.ActionListener() {
