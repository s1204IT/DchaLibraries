...
public class WifiSetupActivity extends WifiPickerActivity implements ButtonBarHandler, SetupWizardNavBar.NavigationBarListener {
    ...
    private boolean isWifiConnected() {
        ...
        boolean wifiConnected = connectivity != null && connectivity.getNetworkInfo(1).isConnected();
    ...
    public void finishOrNext(int resultCode) {
        Log.d("WifiSetupActivity", "finishOrNext resultCode=" + resultCode + " isUsingWizardManager=" + SetupWizardUtils.isUsingWizardManager(this));
    ...
    public static class WifiSkipDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity()).setMessage(messageRes).setCancelable(false).setPositiveButton(R.string.wifi_skip_anyway, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int id) {
                    WifiSetupActivity activity = (WifiSetupActivity) WifiSkipDialog.this.getActivity();
                    activity.finishOrNext(1);
                }
