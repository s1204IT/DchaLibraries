...
class InjectedSetting {
    ...
    public boolean equals(Object o) {
        ...
        return this.packageName.equals(that.packageName) && this.className.equals(that.className) && this.title.equals(that.title) && this.iconId == that.iconId && this.mUserHandle.equals(that.mUserHandle) && this.settingsActivity.equals(that.settingsActivity);
    }
