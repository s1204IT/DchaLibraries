...
final class PanProfile implements LocalBluetoothProfile {
    ...
    PanProfile(Context context) {
        ...
        adapter.getProfileProxy(context, new PanServiceListener(), 5);
    }
    ...
    public boolean isPreferred(BluetoothDevice device) {
        return getConnectionStatus(device) == 2;
    }
    ...
    public int getNameResource(BluetoothDevice device) {
        return isLocalRoleNap(device) ? R.string.bluetooth_profile_pan_nap : R.string.bluetooth_profile_pan;
    }
