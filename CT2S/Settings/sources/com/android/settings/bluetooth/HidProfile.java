...
final class HidProfile implements LocalBluetoothProfile {
    ...
    public int getConnectionStatus(BluetoothDevice device) {
        ...
        return (deviceList.isEmpty() || !deviceList.get(0).equals(device)) ? 0 : this.mService.getConnectionState(device);
    }
    ...
    public int getDrawableResource(BluetoothClass btClass) {
        return btClass == null ? R.drawable.ic_lockscreen_ime : getHidClassDrawable(btClass);
    }
