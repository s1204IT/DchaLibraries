    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.mTriggerPref = new SettingPref(i, "turn_on_automatically", "low_power_trigger_level", 0, getResources().getIntArray(R.array.battery_saver_trigger_values)) {
            ...
            protected String getCaption(Resources res, int value) {
                return (value <= 0 || value >= 100) ? res.getString(R.string.battery_saver_turn_on_automatically_never) : res.getString(R.string.battery_saver_turn_on_automatically_pct, Utils.formatPercentage(value));
            }
        };
