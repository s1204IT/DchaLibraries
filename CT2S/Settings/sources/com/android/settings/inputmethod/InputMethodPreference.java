...
class InputMethodPreference extends SwitchPreference implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    void updatePreferenceViews() {
        ...
        setEnabled(!(isAlwaysChecked && isImeEnabler()) && this.mIsAllowedByOrganization);
    ...
    private String getSummaryString() {
        ...
        for (InputMethodSubtype subtype : subtypes) {
            CharSequence label = subtype.getDisplayName(context, this.mImi.getPackageName(), this.mImi.getServiceInfo().applicationInfo);
