...
public class StorageItemPreference extends Preference {
    ...
    public StorageItemPreference(Context context, CharSequence title, int colorRes, int userHandle) {
        ...
        if (colorRes != 0) {
            ...
            int width = res.getDimensionPixelSize(R.dimen.device_memory_usage_button_width);
            int height = res.getDimensionPixelSize(R.dimen.device_memory_usage_button_height);
