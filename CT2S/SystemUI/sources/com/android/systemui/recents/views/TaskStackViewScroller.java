...
public class TaskStackViewScroller {
    ...
    public boolean setStackScrollToInitialState() {
        ...
        return Float.compare(prevStackScrollP, this.mStackScrollP) != 0;
    }
    ...
    void animateScroll(float curScroll, float newScroll, final Runnable postRunnable) {
        ...
        this.mScrollAnimator = ObjectAnimator.ofFloat(this, "stackScroll", curScroll, newScroll);
    ...
    int progressToScrollRange(float p) {
        return (int) (this.mLayoutAlgorithm.mStackVisibleRect.height() * p);
    }

    float scrollRangeToProgress(int s) {
        return s / this.mLayoutAlgorithm.mStackVisibleRect.height();
    }
