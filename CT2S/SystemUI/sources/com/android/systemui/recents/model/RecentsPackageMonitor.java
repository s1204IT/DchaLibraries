...
public class RecentsPackageMonitor extends PackageMonitor {
    ...
    public void onPackageRemoved(String packageName, int uid) {
        if (this.mCb != null) {
            int eventUserId = getChangingUserId();
            this.mCb.onPackagesChanged(this, packageName, eventUserId);
        }
    }
    ...
    public HashSet<ComponentName> computeComponentsRemoved(List<Task.TaskKey> taskKeys, String packageName, int userId) {
