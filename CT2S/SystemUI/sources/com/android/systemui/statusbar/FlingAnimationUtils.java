...
public class FlingAnimationUtils {
    ...
    public FlingAnimationUtils(Context ctx, float maxLengthSeconds) {
        ...
        this.mFastOutSlowIn = AnimationUtils.loadInterpolator(ctx, R.interpolator.fast_out_slow_in);
        this.mFastOutLinearIn = AnimationUtils.loadInterpolator(ctx, R.interpolator.fast_out_linear_in);
