...
public final class HdmiControlService extends SystemService {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            enabled = HdmiControlService.this.readBooleanSetting(option, true);
            switch (option) {
    ...
    private void initPortInfo() {
        ...
        if (cecPortInfo != null) {
            ...
            HdmiPortInfo[] arr$2 = cecPortInfo;
            for (HdmiPortInfo info3 : arr$2) {
    ...
    private final class BinderService extends IHdmiControlService.Stub {
        ...
        public List<HdmiDeviceInfo> getInputDevices() {
            ...
            HdmiCecLocalDeviceTv tv = HdmiControlService.this.tv();
            synchronized (HdmiControlService.this.mLock) {
                List<HdmiDeviceInfo> cecDevices = tv == null ? Collections.emptyList() : tv.getSafeExternalInputsLocked();
        ...
        public List<HdmiDeviceInfo> getDeviceList() {
            List<HdmiDeviceInfo> listEmptyList;
            HdmiControlService.this.enforceAccessPermission();
            HdmiCecLocalDeviceTv tv = HdmiControlService.this.tv();
            synchronized (HdmiControlService.this.mLock) {
                listEmptyList = tv == null ? Collections.emptyList() : tv.getSafeCecDevicesLocked();
            }
