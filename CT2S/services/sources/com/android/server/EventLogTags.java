...
public class EventLogTags {
    ...
    public static void writeNotificationExpansion(String key, int userAction, int expanded) {
        EventLog.writeEvent(NOTIFICATION_EXPANSION, key, Integer.valueOf(userAction), Integer.valueOf(expanded));
    }
    ...
    public static void writeNotificationActionClicked(String key, int actionIndex) {
        EventLog.writeEvent(NOTIFICATION_ACTION_CLICKED, key, Integer.valueOf(actionIndex));
    }

    public static void writeNotificationCanceled(String key, int reason) {
        EventLog.writeEvent(NOTIFICATION_CANCELED, key, Integer.valueOf(reason));
    }
    ...
    public static void writeWmStackCreated(int stackid, int relativeboxid, int position, int weight) {
        EventLog.writeEvent(WM_STACK_CREATED, Integer.valueOf(stackid), Integer.valueOf(relativeboxid), Integer.valueOf(position), Integer.valueOf(weight));
    }
