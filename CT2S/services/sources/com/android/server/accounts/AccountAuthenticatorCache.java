...
class AccountAuthenticatorCache extends RegisteredServicesCache<AuthenticatorDescription> implements IAccountAuthenticatorCache {
    ...
    @Override
    public RegisteredServicesCache.ServiceInfo getServiceInfo(AuthenticatorDescription x0, int x1) {
    ...
    public AuthenticatorDescription m0parseServiceAttributes(Resources res, String packageName, AttributeSet attrs) {
    ...
    private static class MySerializer implements XmlSerializerAndParser<AuthenticatorDescription> {
        ...
        public AuthenticatorDescription m1createFromXml(XmlPullParser parser) throws XmlPullParserException, IOException {
