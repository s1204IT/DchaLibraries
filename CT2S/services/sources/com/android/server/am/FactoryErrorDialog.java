...
final class FactoryErrorDialog extends BaseErrorDialog {
    ...
    public FactoryErrorDialog(Context context, CharSequence msg) {
        ...
        setCancelable(false);
        setTitle(context.getText(R.string.ext_media_unsupported_notification_message));
        setMessage(msg);
        setButton(-1, context.getText(R.string.face_acquired_dark_glasses_detected), this.mHandler.obtainMessage(0));
