...
public final class SystemServer {
    ...
    private void startOtherServices() throws Throwable {
        ...
        ?? r23;
        ILocationManager.Stub locationManagerService;
        ...
        if (zEquals) {
            ...
            try {
                ...
                final AudioService audioService22 = audioService;
                this.mActivityManagerService.systemReady(new Runnable() {
                    @Override
                    public void run() {
                        Slog.i(SystemServer.TAG, "Making services ready");
        ...
        if (this.mFactoryTestMode == 1) {
            ...
            if (!z2 && !"0".equals(SystemProperties.get("system_init.startaudioservice"))) {
                try {
                    ...
                    AudioService audioService3 = new AudioService(context);
                    try {
                        ServiceManager.addService("audio", audioService3);
            ...
            if (!z6) {
                try {
                    ...
                    IAssetAtlas.Stub assetAtlasService = new AssetAtlasService(context);
                    try {
        ...
        final AudioService audioService222 = audioService;
        this.mActivityManagerService.systemReady(new Runnable() {
            @Override
            public void run() {
                Slog.i(SystemServer.TAG, "Making services ready");
                ...
                try {
                    if (audioService222 != null) {
                        audioService222.systemReady();
                    }
                } catch (Throwable e12) {
                    SystemServer.this.reportWtf("Notifying AudioService running", e12);
                }
