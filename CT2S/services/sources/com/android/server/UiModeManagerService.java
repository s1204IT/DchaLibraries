...
final class UiModeManagerService extends SystemService {
    ...
    public void onStart() {
        ...
        this.mDefaultUiModeType = context.getResources().getInteger(R.integer.config_burnInProtectionMinHorizontalOffset);
        this.mCarModeKeepsScreenOn = context.getResources().getInteger(R.integer.config_burnInProtectionMaxRadius) == 1;
        this.mDeskModeKeepsScreenOn = context.getResources().getInteger(R.integer.config_brightness_ramp_rate_slow) == 1;
        ...
        this.mNightMode = Settings.Secure.getInt(context.getContentResolver(), "ui_night_mode", 0);
    ...
    void updateLocked(int enableFlags, int disableFlags) {
        ...
        boolean keepScreenOn = this.mCharging && ((this.mCarModeEnabled && this.mCarModeKeepsScreenOn && (this.mCarModeEnableFlags & 2) == 0) || (this.mCurUiMode == 2 && this.mDeskModeKeepsScreenOn));
    ...
    private void adjustStatusBarCarModeLocked() {
        ...
        if (this.mNotificationManager != null) {
            if (this.mCarModeEnabled) {
                ...
                n.icon = R.drawable.input_method_fullscreen_background_holo;
                n.defaults = 4;
                n.flags = 2;
                n.when = 0L;
                n.color = context.getResources().getColor(R.color.system_accent3_600);
                n.setLatestEventInfo(context, context.getString(R.string.kg_failed_attempts_almost_at_login), context.getString(R.string.kg_failed_attempts_almost_at_wipe), PendingIntent.getActivityAsUser(context, 0, carModeOffIntent, 0, null, UserHandle.CURRENT));
                this.mNotificationManager.notifyAsUser(null, R.string.kg_failed_attempts_almost_at_login, n, UserHandle.ALL);
                return;
            }
            this.mNotificationManager.cancelAsUser(null, R.string.kg_failed_attempts_almost_at_login, UserHandle.ALL);
        }
    }
