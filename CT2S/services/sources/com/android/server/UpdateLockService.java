...
public class UpdateLockService extends IUpdateLock.Stub {
    ...
    void sendLockChangedBroadcast(boolean state) {
        ...
        try {
            Intent intent = new Intent("android.os.UpdateLock.UPDATE_LOCK_CHANGED").putExtra("nowisconvenient", state).putExtra("timestamp", System.currentTimeMillis()).addFlags(67108864);
