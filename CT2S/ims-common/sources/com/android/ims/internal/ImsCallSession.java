...
public class ImsCallSession {
    ...
    private class IImsCallSessionListenerProxy extends IImsCallSessionListener.Stub {
        ...
        public void callSessionMergeStarted(IImsCallSession session, IImsCallSession newSession, ImsCallProfile profile) {
            if (ImsCallSession.this.mListener != null) {
                ImsCallSession.this.mListener.callSessionMergeStarted(ImsCallSession.this, new ImsCallSession(newSession), profile);
            }
        }

        public void callSessionMergeComplete(IImsCallSession session) {
            if (ImsCallSession.this.mListener != null) {
                ImsCallSession.this.mListener.callSessionMergeComplete(ImsCallSession.this);
            }
        }
