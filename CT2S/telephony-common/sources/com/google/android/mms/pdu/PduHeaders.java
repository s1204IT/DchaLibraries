...
public class PduHeaders {
    ...
    public static final int SUB_ID = 192;
        ...
        switch (field) {
            ...
            case 153:
                if (value > 194 && value < 224) {
                    value = 192;
                } else if ((value > 227 && value <= 255) || value < 128 || ((value > 128 && value < 192) || value > 255)) {
                    value = 224;
                }
                break;
            case 155:
            ...
            case STORE_STATUS:
                if (value > 193 && value < 224) {
                    value = 192;
                } else if ((value > 228 && value <= 255) || value < 128 || ((value > 128 && value < 192) || value > 255)) {
                    value = 224;
                }
                break;
