...
public class EventLogTags {
    ...
    public static void writePdpSetupFail(int cause, int cid, int networkType) {
        EventLog.writeEvent(PDP_SETUP_FAIL, Integer.valueOf(cause), Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeCallDrop(int cause, int cid, int networkType) {
        EventLog.writeEvent(CALL_DROP, Integer.valueOf(cause), Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeDataNetworkRegistrationFail(int opNumeric, int cid) {
        EventLog.writeEvent(DATA_NETWORK_REGISTRATION_FAIL, Integer.valueOf(opNumeric), Integer.valueOf(cid));
    }

    public static void writeDataNetworkStatusOnRadioOff(String dcState, int enable) {
        EventLog.writeEvent(DATA_NETWORK_STATUS_ON_RADIO_OFF, dcState, Integer.valueOf(enable));
    }

    public static void writePdpNetworkDrop(int cid, int networkType) {
        EventLog.writeEvent(PDP_NETWORK_DROP, Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeCdmaDataSetupFailed(int cause, int cid, int networkType) {
        EventLog.writeEvent(CDMA_DATA_SETUP_FAILED, Integer.valueOf(cause), Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeCdmaDataDrop(int cid, int networkType) {
        EventLog.writeEvent(CDMA_DATA_DROP, Integer.valueOf(cid), Integer.valueOf(networkType));
    }

    public static void writeGsmRatSwitched(int cid, int networkFrom, int networkTo) {
        EventLog.writeEvent(GSM_RAT_SWITCHED, Integer.valueOf(cid), Integer.valueOf(networkFrom), Integer.valueOf(networkTo));
    }

    public static void writeGsmDataStateChange(String oldstate, String newstate) {
        EventLog.writeEvent(GSM_DATA_STATE_CHANGE, oldstate, newstate);
    }

    public static void writeGsmServiceStateChange(int oldstate, int oldgprsstate, int newstate, int newgprsstate) {
        EventLog.writeEvent(GSM_SERVICE_STATE_CHANGE, Integer.valueOf(oldstate), Integer.valueOf(oldgprsstate), Integer.valueOf(newstate), Integer.valueOf(newgprsstate));
    }

    public static void writeCdmaDataStateChange(String oldstate, String newstate) {
        EventLog.writeEvent(CDMA_DATA_STATE_CHANGE, oldstate, newstate);
    }

    public static void writeCdmaServiceStateChange(int oldstate, int olddatastate, int newstate, int newdatastate) {
        EventLog.writeEvent(CDMA_SERVICE_STATE_CHANGE, Integer.valueOf(oldstate), Integer.valueOf(olddatastate), Integer.valueOf(newstate), Integer.valueOf(newdatastate));
    }
    ...
    public static void writeGsmRatSwitchedNew(int cid, int networkFrom, int networkTo) {
        EventLog.writeEvent(GSM_RAT_SWITCHED_NEW, Integer.valueOf(cid), Integer.valueOf(networkFrom), Integer.valueOf(networkTo));
    }
