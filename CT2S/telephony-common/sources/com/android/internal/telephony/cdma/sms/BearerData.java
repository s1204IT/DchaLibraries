...
public final class BearerData {
    ...
    private static byte[] encodeDtmfSmsAddress(String address) {
        int val;
        String address2 = CdmaSmsAddress.filterNumericSugar(address);
        int digits = address2.length();
    ...
    public static byte[] encode(BearerData bData) {
        ...
        try {
            ...
            Rlog.e(LOG_TAG, "BearerData encode failed: " + ex3);
            return null;
        }
    }
    ...
    private static void decodeUserDataPayload(UserData userData, boolean hasUserDataHeader) throws CodingException {
        ...
        switch (userData.msgEncoding) {
            case 0:
                boolean decodingtypeUTF8 = Resources.getSystem().getBoolean(R.^attr-private.foregroundInsidePadding);
