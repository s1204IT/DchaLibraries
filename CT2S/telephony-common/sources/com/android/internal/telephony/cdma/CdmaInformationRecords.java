...
public final class CdmaInformationRecords {
    ...
    public static class CdmaNumberInfoRec {
        ...
        public String toString() {
            return "CdmaNumberInfoRec: { id: " + CdmaInformationRecords.idToString(this.id) + ", number: " + this.number + ", numberType: " + ((int) this.numberType) + ", numberPlan: " + ((int) this.numberPlan) + ", pi: " + ((int) this.pi) + ", si: " + ((int) this.si) + " }";
        }
    }
