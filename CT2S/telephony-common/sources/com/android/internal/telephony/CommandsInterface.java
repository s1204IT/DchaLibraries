...
public interface CommandsInterface {
    ...
    void activateCLIP(boolean z, Message message);

    void activateCNAP(boolean z, Message message);

    void activateCOLP(boolean z, Message message);

    void activateCOLR(boolean z, Message message);
    ...
    void dialVT(String str, int i, Message message);
    ...
    void getCPPhonebookStatus(Message message);
    ...
    void getSIMLockInfo(Message message);
    ...
    void hangupVTConnection(int i, Message message);
    ...
    void queryCNAP(Message message);
    ...
    void setNetworkSelectionModeManualExt(String str, int i, Message message);

    void setOnCallRing(Handler handler, int i, Object obj);

    void setOnCatCallSetUp(Handler handler, int i, Object obj);

    void setOnCatCallSetUpResult(Handler handler, int i, Object obj);

    void setOnCatCallSetUpStatus(Handler handler, int i, Object obj);
    ...
    void setOnCatSendSmResult(Handler handler, int i, Object obj);

    void setOnCatSendSmStatus(Handler handler, int i, Object obj);

    void setOnCatSendUssdResult(Handler handler, int i, Object obj);
    ...
    void unSetOnCatCallSetUpResult(Handler handler);

    void unSetOnCatCallSetUpStatus(Handler handler);
    ...
    void unSetOnCatSendSmResult(Handler handler);

    void unSetOnCatSendSmStatus(Handler handler);

    void unSetOnCatSendUssdResult(Handler handler);
