...
public final class SmsBroadcastConfigInfo {
    ...
    public String toString() {
        return "SmsBroadcastConfigInfo: Id [" + this.mFromServiceId + UsimPhoneBookManager.PAUSE + this.mToServiceId + "] Code [" + this.mFromCodeScheme + UsimPhoneBookManager.PAUSE + this.mToCodeScheme + "] " + (this.mSelected ? "ENABLED" : "DISABLED");
    }
}
