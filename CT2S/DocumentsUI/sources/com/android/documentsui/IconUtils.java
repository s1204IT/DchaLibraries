...
public class IconUtils {
    ...
    static {
        ...
        add("application/vnd.oasis.opendocument.text", R.drawable.ic_doc_text);
        add("application/vnd.oasis.opendocument.text-master", R.drawable.ic_doc_text);
        add("application/vnd.oasis.opendocument.text-template", R.drawable.ic_doc_text);
        add("application/vnd.oasis.opendocument.text-web", R.drawable.ic_doc_text);
        add("application/vnd.stardivision.writer", R.drawable.ic_doc_text);
        add("application/vnd.stardivision.writer-global", R.drawable.ic_doc_text);
        add("application/vnd.sun.xml.writer", R.drawable.ic_doc_text);
        add("application/vnd.sun.xml.writer.global", R.drawable.ic_doc_text);
        add("application/vnd.sun.xml.writer.template", R.drawable.ic_doc_text);
        add("application/x-abiword", R.drawable.ic_doc_text);
        add("application/x-kword", R.drawable.ic_doc_text);
    ...
    public static Drawable loadMimeIcon(Context context, String mimeType, String authority, String docId, int mode) {
        if ("vnd.android.document/directory".equals(mimeType)) {
            if ("com.android.providers.media.documents".equals(authority) && docId.startsWith("album")) {
    ...
    public static Drawable applyTintColor(Context context, int drawableId, int tintColorId) {
        Drawable icon = context.getDrawable(drawableId);
        icon.mutate();
