...
public class AmPmCirclesView extends View {
    ...
    public void initialize(Context context, int amOrPm) {
        ...
        this.mUnselectedColor = res.getColor(R.color.white);
        this.mSelectedColor = res.getColor(R.color.blue);
    ...
    void setTheme(Context context, boolean themeDark) {
        Resources res = context.getResources();
        if (themeDark) {
            this.mUnselectedColor = res.getColor(R.color.dark_gray);
            this.mSelectedColor = res.getColor(R.color.red);
            this.mAmPmTextColor = res.getColor(R.color.white);
