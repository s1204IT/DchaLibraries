...
public class UserManager {
    ...
    public List<UserHandle> getUserProfiles() {
        ...
        new ArrayList();
        try {
            List<UserInfo> users = this.mService.getProfiles(UserHandle.myUserId(), true);
    ...
    public boolean isUserSwitcherEnabled() {
        ...
        boolean guestEnabled = Settings.Global.getInt(this.mContext.getContentResolver(), Settings.Global.GUEST_USER_ENABLED, 0) == 1;
