...
public class KeyCharacterMap implements Parcelable {
    ...
    static {
        ...
        addDeadKey(45, 72, R.styleable.Theme_preferenceFragmentListStyle);
        addDeadKey(45, 73, 407);
        addDeadKey(45, 76, ImsReasonInfo.CODE_SIP_REDIRECTED);
        addDeadKey(45, 79, 216);
        addDeadKey(45, 84, 358);
        addDeadKey(45, 100, R.styleable.Theme_errorMessageAboveBackground);
        addDeadKey(45, 103, 485);
        addDeadKey(45, 104, R.styleable.Theme_preferenceFragmentPaddingSide);
