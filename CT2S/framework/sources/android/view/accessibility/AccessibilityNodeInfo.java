...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    private void init(AccessibilityNodeInfo other) {
        ...
        if (otherChildNodeIds != null && otherChildNodeIds.size() > 0) {
            if (this.mChildNodeIds == null) {
                this.mChildNodeIds = otherChildNodeIds.m20clone();
            } else {
    ...
    public int hashCode() {
        int result = getAccessibilityViewId(this.mSourceNodeId) + 31;
    ...
    private AccessibilityNodeInfo getNodeForAccessibilityId(long accessibilityId) {
        ...
        AccessibilityInteractionClient client = AccessibilityInteractionClient.getInstance();
        return client.findAccessibilityNodeInfoByAccessibilityId(this.mConnectionId, this.mWindowId, accessibilityId, false, 7);
    }
