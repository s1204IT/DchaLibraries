...
public class NinePatch {
    ...
    void drawSoftware(Canvas canvas, RectF location, Paint paint) {
        nativeDraw(canvas.getNativeCanvasWrapper(), location, this.mBitmap.ni(), this.mNativeChunk, paint != null ? paint.mNativePaint : 0L, canvas.mDensity, this.mBitmap.mDensity);
    }
