...
public abstract class CarrierMessagingService extends Service {
    ...
    private class ICarrierMessagingWrapper extends ICarrierMessagingService.Stub {
        ...
        @Override
        public void sendTextSms(String text, int subId, String destAddress, final ICarrierMessagingCallback callback) {
            CarrierMessagingService.this.onSendTextSms(text, subId, destAddress, new ResultCallback<SendSmsResult>() {
                @Override
        ...
        @Override
        public void sendDataSms(byte[] data, int subId, String destAddress, int destPort, final ICarrierMessagingCallback callback) {
            CarrierMessagingService.this.onSendDataSms(data, subId, destAddress, destPort, new ResultCallback<SendSmsResult>() {
                @Override
                public void onReceiveResult(SendSmsResult result) throws RemoteException {
                    callback.onSendSmsComplete(result.getSendStatus(), result.getMessageRef());
                }
        ...
        @Override
        public void sendMultipartTextSms(List<String> parts, int subId, String destAddress, final ICarrierMessagingCallback callback) {
            CarrierMessagingService.this.onSendMultipartTextSms(parts, subId, destAddress, new ResultCallback<SendMultipartSmsResult>() {
                @Override
