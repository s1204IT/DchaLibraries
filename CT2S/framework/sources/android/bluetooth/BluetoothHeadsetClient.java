...
public final class BluetoothHeadsetClient implements BluetoothProfile {
    ...
    public static final String EXTRA_AG_FEATURE_INBAND_RING = "android.bluetooth.headsetclient.extra.EXTRA_AG_FEATURE_INBAND_RING";
    ...
    public BluetoothHeadsetClientCall getCall(BluetoothDevice device, int state) {
        Log.i(TAG, "getCall() -  state " + state);
        if (this.mService != null && isEnabled()) {
            try {
                return this.mService.getCall(device, state);
            } catch (RemoteException e) {
                Log.e(TAG, e.toString());
            }
        } else {
