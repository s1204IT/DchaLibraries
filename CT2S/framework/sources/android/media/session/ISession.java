        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg08 = PendingIntent.CREATOR.createFromParcel(data);
                    } else {
                        _arg08 = null;
                    }
                    setMediaButtonReceiver(_arg08);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg07 = PendingIntent.CREATOR.createFromParcel(data);
                    } else {
                        _arg07 = null;
                    }
                    setLaunchPendingIntent(_arg07);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg06 = MediaMetadata.CREATOR.createFromParcel(data);
                    } else {
                        _arg06 = null;
                    }
                    setMetadata(_arg06);
                ...
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = ParceledListSlice.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                    setQueue(_arg04);
