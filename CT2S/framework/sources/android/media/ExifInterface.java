...
public class ExifInterface {
    ...
    private static final HashSet<String> sTagSetForCompatibility = new HashSet<>(Arrays.asList(TAG_APERTURE, TAG_DIGITAL_ZOOM_RATIO, TAG_EXPOSURE_TIME, TAG_SUBJECT_DISTANCE, TAG_GPS_TIMESTAMP));
    private static final Charset ASCII = Charset.forName(StringPart.DEFAULT_CHARSET);
    ...
    static {
        ...
        int i3 = 2;
        int i4 = 3;
        IFD_TIFF_TAGS = new ExifTag[]{new ExifTag(TAG_IMAGE_WIDTH, 256, i4, i), new ExifTag(TAG_IMAGE_LENGTH, 257, i4, i), new ExifTag(TAG_BITS_PER_SAMPLE, 258, i4), new ExifTag(TAG_COMPRESSION, 259, i4), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, i4), new ExifTag(TAG_IMAGE_DESCRIPTION, R.styleable.Theme_textUnderlineColor, i3), new ExifTag(TAG_MAKE, R.styleable.Theme_textUnderlineThickness, i3), new ExifTag(TAG_MODEL, 272, i3), new ExifTag(TAG_STRIP_OFFSETS, R.styleable.Theme_errorMessageAboveBackground, i4, i), new ExifTag(TAG_ORIENTATION, R.styleable.Theme_searchResultListItemHeight, i4), new ExifTag(TAG_SAMPLES_PER_PIXEL, R.styleable.Theme_windowActionBarFullscreenDecorLayout, i4), new ExifTag(TAG_ROWS_PER_STRIP, R.styleable.Theme_alertDialogButtonGroupStyle, i4, i), new ExifTag(TAG_STRIP_BYTE_COUNTS, R.styleable.Theme_alertDialogCenterButtons, i4, i), new ExifTag(TAG_X_RESOLUTION, R.styleable.Theme_panelMenuListTheme, i2), new ExifTag(TAG_Y_RESOLUTION, R.styleable.Theme_gestureOverlayViewStyle, i2), new ExifTag(TAG_PLANAR_CONFIGURATION, R.styleable.Theme_quickContactBadgeOverlay, i4), new ExifTag(TAG_RESOLUTION_UNIT, R.styleable.Theme_seekBarPreferenceStyle, i4), new ExifTag(TAG_TRANSFER_FUNCTION, R.styleable.Theme_searchDialogTheme, i4), new ExifTag(TAG_SOFTWARE, R.styleable.Theme_findOnPageNextDrawable, i3), new ExifTag(TAG_DATETIME, R.styleable.Theme_findOnPagePreviousDrawable, i3), new ExifTag(TAG_ARTIST, 315, i3), new ExifTag(TAG_WHITE_POINT, 318, i2), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, i2), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, i), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, 514, i), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, i2), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, i4), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, i4), new ExifTag(TAG_REFERENCE_BLACK_WHITE, BluetoothClass.Device.PHONE_ISDN, i2), new ExifTag(TAG_COPYRIGHT, 33432, i3), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, i), new ExifTag(TAG_GPS_INFO_IFD_POINTER, GLES30.GL_DRAW_BUFFER0, i)};
        IFD_EXIF_TAGS = new ExifTag[]{new ExifTag(TAG_EXPOSURE_TIME, 33434, i2), new ExifTag(TAG_APERTURE, 33437, i2), new ExifTag(TAG_EXPOSURE_PROGRAM, 34850, i4), new ExifTag(TAG_SPECTRAL_SENSITIVITY, GLES30.GL_MAX_DRAW_BUFFERS, i3), new ExifTag(TAG_ISO, GLES30.GL_DRAW_BUFFER2, i4), new ExifTag(TAG_OECF, GLES30.GL_DRAW_BUFFER3, 7), new ExifTag(TAG_EXIF_VERSION, 36864, i3), new ExifTag(TAG_DATETIME_ORIGINAL, 36867, i3), new ExifTag(TAG_DATETIME_DIGITIZED, 36868, i3), new ExifTag(TAG_COMPONENTS_CONFIGURATION, 37121, 7), new ExifTag(TAG_COMPRESSED_BITS_PER_PIXEL, GLES31Ext.GL_TEXTURE_2D_MULTISAMPLE_ARRAY_OES, i2), new ExifTag(TAG_SHUTTER_SPEED_VALUE, 37377, 10), new ExifTag(TAG_APERTURE_VALUE, 37378, i2), new ExifTag(TAG_BRIGHTNESS_VALUE, 37379, 10), new ExifTag(TAG_EXPOSURE_BIAS_VALUE, 37380, 10), new ExifTag(TAG_MAX_APERTURE_VALUE, 37381, i2), new ExifTag(TAG_SUBJECT_DISTANCE, 37382, i2), new ExifTag(TAG_METERING_MODE, 37383, i4), new ExifTag(TAG_LIGHT_SOURCE, 37384, i4), new ExifTag(TAG_FLASH, 37385, i4), new ExifTag(TAG_FOCAL_LENGTH, 37386, i2), new ExifTag(TAG_SUBJECT_AREA, 37396, i4), new ExifTag(TAG_MAKER_NOTE, 37500, 7), new ExifTag(TAG_USER_COMMENT, 37510, 7), new ExifTag(TAG_SUBSEC_TIME, 37520, i3), new ExifTag(TAG_SUBSEC_TIME_ORIG, 37521, i3), new ExifTag(TAG_SUBSEC_TIME_DIG, 37522, i3), new ExifTag(TAG_FLASHPIX_VERSION, 40960, 7), new ExifTag(TAG_COLOR_SPACE, 40961, i4), new ExifTag(TAG_PIXEL_X_DIMENSION, 40962, i4, i), new ExifTag(TAG_PIXEL_Y_DIMENSION, 40963, i4, i), new ExifTag(TAG_RELATED_SOUND_FILE, 40964, i3), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, 40965, i), new ExifTag(TAG_FLASH_ENERGY, 41483, i2), new ExifTag(TAG_SPATIAL_FREQUENCY_RESPONSE, 41484, 7), new ExifTag(TAG_FOCAL_PLANE_X_RESOLUTION, 41486, i2), new ExifTag(TAG_FOCAL_PLANE_Y_RESOLUTION, 41487, i2), new ExifTag(TAG_FOCAL_PLANE_RESOLUTION_UNIT, 41488, i4), new ExifTag(TAG_SUBJECT_LOCATION, 41492, i4), new ExifTag(TAG_EXPOSURE_INDEX, 41493, i2), new ExifTag(TAG_SENSING_METHOD, 41495, i4), new ExifTag(TAG_FILE_SOURCE, 41728, 7), new ExifTag(TAG_SCENE_TYPE, 41729, 7), new ExifTag(TAG_CFA_PATTERN, 41730, 7), new ExifTag(TAG_CUSTOM_RENDERED, 41985, i4), new ExifTag(TAG_EXPOSURE_MODE, 41986, i4), new ExifTag(TAG_WHITE_BALANCE, 41987, i4), new ExifTag(TAG_DIGITAL_ZOOM_RATIO, 41988, i2), new ExifTag(TAG_FOCAL_LENGTH_IN_35MM_FILM, 41989, i4), new ExifTag(TAG_SCENE_CAPTURE_TYPE, 41990, i4), new ExifTag(TAG_GAIN_CONTROL, 41991, i4), new ExifTag(TAG_CONTRAST, 41992, i4), new ExifTag(TAG_SATURATION, 41993, i4), new ExifTag(TAG_SHARPNESS, 41994, i4), new ExifTag(TAG_DEVICE_SETTING_DESCRIPTION, 41995, 7), new ExifTag(TAG_SUBJECT_DISTANCE_RANGE, 41996, i4), new ExifTag(TAG_IMAGE_UNIQUE_ID, 42016, i3)};
        IFD_GPS_TAGS = new ExifTag[]{new ExifTag(TAG_GPS_VERSION_ID, 0, 1), new ExifTag(TAG_GPS_LATITUDE_REF, 1, i3), new ExifTag(TAG_GPS_LATITUDE, i3, i2), new ExifTag(TAG_GPS_LONGITUDE_REF, i4, i3), new ExifTag(TAG_GPS_LONGITUDE, i, i2), new ExifTag(TAG_GPS_ALTITUDE_REF, i2, 1), new ExifTag(TAG_GPS_ALTITUDE, 6, i2), new ExifTag(TAG_GPS_TIMESTAMP, 7, i2), new ExifTag(TAG_GPS_SATELLITES, 8, i3), new ExifTag(TAG_GPS_STATUS, 9, i3), new ExifTag(TAG_GPS_MEASURE_MODE, 10, i3), new ExifTag(TAG_GPS_DOP, 11, i2), new ExifTag(TAG_GPS_SPEED_REF, 12, i3), new ExifTag(TAG_GPS_SPEED, 13, i2), new ExifTag(TAG_GPS_TRACK_REF, 14, i3), new ExifTag(TAG_GPS_TRACK, 15, i2), new ExifTag(TAG_GPS_IMG_DIRECTION_REF, 16, i3), new ExifTag(TAG_GPS_IMG_DIRECTION, 17, i2), new ExifTag(TAG_GPS_MAP_DATUM, 18, i3), new ExifTag(TAG_GPS_DEST_LATITUDE_REF, 19, i3), new ExifTag(TAG_GPS_DEST_LATITUDE, 20, i2), new ExifTag(TAG_GPS_DEST_LONGITUDE_REF, 21, i3), new ExifTag(TAG_GPS_DEST_LONGITUDE, 22, i2), new ExifTag(TAG_GPS_DEST_BEARING_REF, 23, i3), new ExifTag(TAG_GPS_DEST_BEARING, 24, i2), new ExifTag(TAG_GPS_DEST_DISTANCE_REF, 25, i3), new ExifTag(TAG_GPS_DEST_DISTANCE, 26, i2), new ExifTag(TAG_GPS_PROCESSING_METHOD, 27, 7), new ExifTag(TAG_GPS_AREA_INFORMATION, 28, 7), new ExifTag(TAG_GPS_DATESTAMP, 29, i3), new ExifTag(TAG_GPS_DIFFERENTIAL, 30, i4)};
        IFD_INTEROPERABILITY_TAGS = new ExifTag[]{new ExifTag(TAG_INTEROPERABILITY_INDEX, 1, i3)};
        IFD_THUMBNAIL_TAGS = new ExifTag[]{new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, i4, i), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, i4, i), new ExifTag(TAG_BITS_PER_SAMPLE, 258, i4), new ExifTag(TAG_COMPRESSION, 259, i4), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, i4), new ExifTag(TAG_IMAGE_DESCRIPTION, R.styleable.Theme_textUnderlineColor, i3), new ExifTag(TAG_MAKE, R.styleable.Theme_textUnderlineThickness, i3), new ExifTag(TAG_MODEL, 272, i3), new ExifTag(TAG_STRIP_OFFSETS, i4, i), new ExifTag(TAG_ORIENTATION, R.styleable.Theme_searchResultListItemHeight, i4), new ExifTag(TAG_SAMPLES_PER_PIXEL, R.styleable.Theme_windowActionBarFullscreenDecorLayout, i4), new ExifTag(TAG_ROWS_PER_STRIP, R.styleable.Theme_alertDialogButtonGroupStyle, i4, i), new ExifTag(TAG_STRIP_BYTE_COUNTS, R.styleable.Theme_alertDialogCenterButtons, i4, i), new ExifTag(TAG_X_RESOLUTION, R.styleable.Theme_panelMenuListTheme, i2), new ExifTag(TAG_Y_RESOLUTION, R.styleable.Theme_gestureOverlayViewStyle, i2), new ExifTag(TAG_PLANAR_CONFIGURATION, R.styleable.Theme_quickContactBadgeOverlay, i4), new ExifTag(TAG_RESOLUTION_UNIT, R.styleable.Theme_seekBarPreferenceStyle, i4), new ExifTag(TAG_TRANSFER_FUNCTION, R.styleable.Theme_searchDialogTheme, i4), new ExifTag(TAG_SOFTWARE, R.styleable.Theme_findOnPageNextDrawable, i3), new ExifTag(TAG_DATETIME, R.styleable.Theme_findOnPagePreviousDrawable, i3), new ExifTag(TAG_ARTIST, 315, i3), new ExifTag(TAG_WHITE_POINT, 318, i2), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, i2), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, i), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, 514, i), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, i2), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, i4), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, i4), new ExifTag(TAG_REFERENCE_BLACK_WHITE, BluetoothClass.Device.PHONE_ISDN, i2), new ExifTag(TAG_COPYRIGHT, 33432, i3), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, i), new ExifTag(TAG_GPS_INFO_IFD_POINTER, GLES30.GL_DRAW_BUFFER0, i)};
        EXIF_TAGS = new ExifTag[][]{IFD_TIFF_TAGS, IFD_EXIF_TAGS, IFD_GPS_TAGS, IFD_INTEROPERABILITY_TAGS, IFD_THUMBNAIL_TAGS};
        IFD_POINTER_TAGS = new ExifTag[]{new ExifTag(TAG_EXIF_IFD_POINTER, 34665, i), new ExifTag(TAG_GPS_INFO_IFD_POINTER, GLES30.GL_DRAW_BUFFER0, i), new ExifTag(TAG_INTEROPERABILITY_IFD_POINTER, 40965, i)};
        JPEG_INTERCHANGE_FORMAT_TAG = new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, i);
            ...
            if ((i != 4 || this.mHasThumbnail) && (obj = sExifTagMapsForWriting[i].get(tag)) != null) {
                if (value == null) {
                    ...
                    if (exifTag.primaryFormat == guess.first.intValue() || exifTag.primaryFormat == guess.second.intValue()) {
                        ...
                        Log.w(TAG, "Given tag (" + tag + ") value didn't match with one of expected formats: " + IFD_FORMAT_NAMES[exifTag.primaryFormat] + (exifTag.secondaryFormat == -1 ? ProxyInfo.LOCAL_EXCL_LIST : ", " + IFD_FORMAT_NAMES[exifTag.secondaryFormat]) + " (guess: " + IFD_FORMAT_NAMES[guess.first.intValue()] + (guess.second.intValue() == -1 ? ProxyInfo.LOCAL_EXCL_LIST : ", " + IFD_FORMAT_NAMES[guess.second.intValue()]) + ")");
                    }
                    switch (dataFormat) {
                        case 1:
                        ...
                        case 5:
                            ...
                            for (int j3 = 0; j3 < values3.length; j3++) {
                                ...
                                rationalArray[j3] = new Rational(Long.parseLong(numbers[0]), Long.parseLong(numbers[1]));
                            }
                        ...
                        case 10:
                            ...
                            for (int j5 = 0; j5 < values5.length; j5++) {
                                ...
                                rationalArray2[j5] = new Rational(Long.parseLong(numbers2[0]), Long.parseLong(numbers2[1]));
                            }
    ...
    private void loadAttributes() throws Throwable {
        InputStream in;
        for (int i = 0; i < EXIF_TAGS.length; i++) {
    ...
    public byte[] getThumbnail() throws Throwable {
        FileInputStream in;
                    ...
                    case -31:
                        if (length >= 6) {
                            ...
                            if (Arrays.equals(identifier, IDENTIFIER_EXIF_APP1)) {
                                ...
                                readExifSegment(bytes, bytesRead4);
                                bytesRead4 += length;
                                length = 0;
                            }
                        }
    ...
    private int writeExifSegment(ByteOrderAwarenessDataOutputStream dataOutputStream, int exifOffsetFromBeginning) throws IOException {
        ...
        for (int hint = 0; hint < EXIF_TAGS.length; hint++) {
            Object[] arr$2 = this.mAttributes[hint].entrySet().toArray();
            for (Object obj : arr$2) {
        ...
        for (int i = 0; i < EXIF_TAGS.length; i++) {
            int sum = 0;
            Iterator i$ = this.mAttributes[i].entrySet().iterator();
            while (i$.hasNext()) {
                ExifAttribute exifAttribute = (ExifAttribute) ((Map.Entry) i$.next()).getValue();
        ...
        for (int hint3 = 0; hint3 < EXIF_TAGS.length; hint3++) {
            if (!this.mAttributes[hint3].isEmpty()) {
                ...
                Iterator i$2 = this.mAttributes[hint3].entrySet().iterator();
                while (i$2.hasNext()) {
                    ExifAttribute attribute2 = (ExifAttribute) ((Map.Entry) i$2.next()).getValue();
    ...
    private static Pair<Integer, Integer> guessDataFormat(String entryValue) {
        ...
        if (entryValue.contains(",")) {
            ...
            if (dataFormat3.first.intValue() != 2) {
                for (int i = 1; i < entryValues.length; i++) {
                    Pair<Integer, Integer> guessDataFormat = guessDataFormat(entryValues[i]);
                    int first = -1;
                    int second = -1;
                    if (guessDataFormat.first == dataFormat3.first || guessDataFormat.second == dataFormat3.first) {
                        first = dataFormat3.first.intValue();
                    }
                    if (dataFormat3.second.intValue() != -1 && (guessDataFormat.first == dataFormat3.second || guessDataFormat.second == dataFormat3.second)) {
                        second = dataFormat3.second.intValue();
                    }
                    if (first == -1 && second == -1) {
    ...
    private static class ByteOrderAwarenessDataInputStream extends ByteArrayInputStream {
        ...
        public long readUnsignedInt() throws IOException {
            return ((long) readInt()) & ExpandableListView.PACKED_POSITION_VALUE_NULL;
        }
