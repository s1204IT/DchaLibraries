...
public abstract class MediaMetadataEditor {
    ...
    public synchronized MediaMetadataEditor putObject(int key, Object value) throws IllegalArgumentException {
        MediaMetadataEditor mediaMetadataEditorPutBitmap;
        if (this.mApplied) {
            Log.e(TAG, "Can't edit a previously applied MediaMetadataEditor");
            mediaMetadataEditorPutBitmap = this;
        } else {
            switch (METADATA_KEYS_TYPE.get(key, -1)) {
                case 0:
                    if (value instanceof Long) {
                        mediaMetadataEditorPutBitmap = putLong(key, ((Long) value).longValue());
                    } else {
                ...
                case 1:
                    if (value == null || (value instanceof String)) {
                        mediaMetadataEditorPutBitmap = putString(key, (String) value);
                    } else {
                ...
                case 2:
                    if (value == null || (value instanceof Bitmap)) {
                        mediaMetadataEditorPutBitmap = putBitmap(key, (Bitmap) value);
                    } else {
        ...
        return mediaMetadataEditorPutBitmap;
    }
