...
public class Equalizer extends AudioEffect {
    ...
    public Equalizer(int priority, int audioSession) throws RuntimeException {
        ...
        if (this.mNumPresets != 0) {
            ...
            for (int i = 0; i < this.mNumPresets; i++) {
                ...
                try {
                    this.mPresetNames[i] = new String(value, 0, length, FilePart.DEFAULT_CHARSET);
    ...
    public String getPresetName(short preset) {
        return (preset < 0 || preset >= this.mNumPresets) ? ProxyInfo.LOCAL_EXCL_LIST : this.mPresetNames[preset];
    }
