...
public class AudioSystem {
    ...
    public static final int DEVICE_IN_FMRADIO = -2146959360;
    ...
    public static final int DEVICE_OUT_FM_HEADPHONE = 8388608;
    public static final String DEVICE_OUT_FM_HEADPHONE_NAME = "fm_headphone_device";
    public static final String DEVICE_OUT_FM_NAME = "fm_transmitter";
    public static final int DEVICE_OUT_FM_SPEAKER = 23068672;
    public static final String DEVICE_OUT_FM_SPEAKER_NAME = "fm_speaker_device";
    ...
    public static String getOutputDeviceName(int device) {
        switch (device) {
            ...
            case 8388608:
                return DEVICE_OUT_FM_HEADPHONE_NAME;
