    ...
    public Animator createAnimator(final ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (parentMatches(startParent, endParent)) {
                ...
                if (!this.mResizeClip) {
                    ...
                    if (numChanges == 2) {
                        if (startWidth == endWidth && startHeight == endHeight) {
                            ...
                            anim = ObjectAnimator.ofObject(view, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath);
                        } else {
                        ...
                        anim = ObjectAnimator.ofObject(view, (Property<View, V>) TOP_LEFT_ONLY_PROPERTY, (TypeConverter) null, topLeftPath3);
                    } else {
                        Path bottomRight = getPathMotion().getPath(startRight, startBottom, endRight, endBottom);
                        anim = ObjectAnimator.ofObject(view, (Property<View, V>) BOTTOM_RIGHT_ONLY_PROPERTY, (TypeConverter) null, bottomRight);
                    }
                } else {
                    ...
                    if (startLeft != endLeft || startTop != endTop) {
                        ...
                        positionAnimator = ObjectAnimator.ofObject(view, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath4);
                    }
                    if (startClip == null) {
            ...
            if (startX != endX || startY != endY) {
                ...
                Path topLeftPath5 = getPathMotion().getPath(startX - this.tempLocation[0], startY - this.tempLocation[1], endX - this.tempLocation[0], endY - this.tempLocation[1]);
