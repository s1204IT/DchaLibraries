...
public final class Settings {
    ...
    private static class NameValueCache {
        ...
        public String getStringForUser(ContentResolver cr, String name, int userHandle) {
            ...
            if (this.mCallGetCommand != null) {
                Bundle args = null;
                if (isSelf) {
                    b = cp.call(cr.getPackageName(), this.mCallGetCommand, name, args);
                    if (b != null) {
                    }
                } else {
                    try {
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            VOLUME_SETTINGS = new String[]{VOLUME_VOICE, VOLUME_SYSTEM, VOLUME_RING, VOLUME_MUSIC, VOLUME_ALARM, VOLUME_NOTIFICATION, VOLUME_BLUETOOTH_SCO, VOLUME_SYSTEM_ENFORCED, VOLUME_DTMF, VOLUME_TTS, VOLUME_FM};
    ...
    public static final class Secure extends NameValueTable {
        ...
        public static final String USER_SETUP_DEVICE_OWNER = "user_setup_device_owner";
        ...
        public static final boolean setLocationProviderEnabledForUser(ContentResolver cr, String provider, boolean enabled, int userId) {
            ...
            synchronized (Settings.mLocationSettingsLock) {
                if (enabled) {
                    ...
                    provider2 = NativeLibraryHelper.CLEAR_ABI_OVERRIDE + provider;
                }
    ...
    public static final class Global extends NameValueTable {
        ...
        public static final String ENABLE_SIM1 = "enable_sim1";
        public static final String ENABLE_SIM2 = "enable_sim2";
        ...
        public static String zenModeToString(int mode) {
            return mode == 1 ? "ZEN_MODE_IMPORTANT_INTERRUPTIONS" : mode == 2 ? "ZEN_MODE_NO_INTERRUPTIONS" : "ZEN_MODE_OFF";
        }
