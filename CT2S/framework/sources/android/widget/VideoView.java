...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl, SubtitleController.Anchor {
    ...
    public VideoView(Context context) {
        ...
        this.mSizeChangedListener = new MediaPlayer.OnVideoSizeChangedListener() {
            ...
            public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
                VideoView.this.updateVideoSize(mp);
    ...
    public VideoView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        Log.i(this.TAG, "PowerHint: will send video boost requst");
        PowerHintManager phm = new PowerHintManager();
        double phmId = phm.obtainDurablePowerHintTimer();
        phm.sendDurablePowerHint(PowerHintManager.HINT_VIDEO_START, phmId, 2000, "enable");
        Log.i(this.TAG, "PowerHint: finished sending video start boost");
        initVideoView();
    }
    ...
    private void updateVideoSize(MediaPlayer mp) {
    ...
    public void restoreInstanceState(Bundle savedInstance) {
        if (savedInstance != null) {
            this.mVideoWidth = savedInstance.getInt(KEY_VIDEO_WIDTH, 0);
            this.mVideoHeight = savedInstance.getInt(KEY_VIDEO_HEIGHT, 0);
        }
    }

    public void onSaveInstanceState(Bundle outState) {
        outState.putInt(KEY_VIDEO_WIDTH, this.mVideoWidth);
        outState.putInt(KEY_VIDEO_HEIGHT, this.mVideoHeight);
    }
}
