...
public class PreciseCallState implements Parcelable {
    ...
    public int hashCode() {
        int result = this.mRingingCallState + 31;
        return (((((((result * 31) + this.mForegroundCallState) * 31) + this.mBackgroundCallState) * 31) + this.mDisconnectCause) * 31) + this.mPreciseDisconnectCause;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            return (this.mRingingCallState == other.mRingingCallState || this.mForegroundCallState == other.mForegroundCallState || this.mBackgroundCallState == other.mBackgroundCallState || this.mDisconnectCause == other.mDisconnectCause || this.mPreciseDisconnectCause == other.mPreciseDisconnectCause) ? false : true;
        }
        return false;
    }
