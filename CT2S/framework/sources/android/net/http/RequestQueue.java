...
public class RequestQueue implements RequestFeeder {
    ...
    class ActivePool implements ConnectionManager {
        ...
        static int access$408(ActivePool x0) {
    ...
    private synchronized void setProxyConfig() {
        ...
        if ((info != null && info.getType() == 1) || (host = Proxy.getHost(this.mContext)) == null) {
            this.mProxyHost = null;
        } else {
    ...
    synchronized void dump() {
        ...
        if (!this.mPending.isEmpty()) {
            ...
            while (iter.hasNext()) {
                ...
                int count2 = count + 1;
                StringBuilder line = new StringBuilder(TtmlUtils.TAG_P + count + " " + hostName + " ");
    ...
    public synchronized Request getRequest() {
        Request ret;
        ret = this.mPending.isEmpty() ? null : removeFirst(this.mPending);
        return ret;
    }
