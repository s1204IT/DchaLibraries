...
public class WifiInfo implements Parcelable {
    ...
    public void updatePacketRates(WifiLinkLayerStats stats) {
        if (stats != null) {
            ...
            this.txBadRate = (this.txBadRate * 0.5d) + ((txbad - this.txBad) * 0.5d);
            this.txSuccessRate = (this.txSuccessRate * 0.5d) + ((txgood - this.txSuccess) * 0.5d);
            this.rxSuccessRate = (this.rxSuccessRate * 0.5d) + ((rxgood - this.rxSuccess) * 0.5d);
            this.txRetriesRate = (this.txRetriesRate * 0.5d) + ((txretries - this.txRetries) * 0.5d);
            this.txBad = txbad;
    ...
    public void updatePacketRates(long txPackets, long rxPackets) {
        ...
        this.txBadRate = 0.0d;
        this.txRetriesRate = 0.0d;
        this.txSuccessRate = (this.txSuccessRate * 0.5d) + ((txPackets - this.txSuccess) * 0.5d);
        this.rxSuccessRate = (this.rxSuccessRate * 0.5d) + ((rxPackets - this.rxSuccess) * 0.5d);
    ...
    public String toString() {
        ...
        sb.append("SSID: ").append(this.mWifiSsid == null ? WifiSsid.NONE : this.mWifiSsid).append(", BSSID: ").append(this.mBSSID == null ? "<none>" : this.mBSSID).append(", MAC: ").append(this.mMacAddress == null ? "<none>" : this.mMacAddress).append(", Supplicant state: ").append(this.mSupplicantState != null ? this.mSupplicantState : "<none>").append(", RSSI: ").append(this.mRssi).append(", Link speed: ").append(this.mLinkSpeed).append(LINK_SPEED_UNITS).append(", Frequency: ").append(this.mFrequency).append(FREQUENCY_UNITS).append(", Net ID: ").append(this.mNetworkId).append(", Metered hint: ").append(this.mMeteredHint).append(", score: ").append(Integer.toString(this.score));
        return sb.toString();
    }
