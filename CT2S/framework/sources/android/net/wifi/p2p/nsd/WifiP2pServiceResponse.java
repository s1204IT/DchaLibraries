...
public class WifiP2pServiceResponse implements Parcelable {
    ...
    public int hashCode() {
        int result = this.mServiceType + 527;
        return (((((((result * 31) + this.mStatus) * 31) + this.mTransId) * 31) + (this.mDevice.deviceAddress == null ? 0 : this.mDevice.deviceAddress.hashCode())) * 31) + (this.mData != null ? this.mData.hashCode() : 0);
    }
