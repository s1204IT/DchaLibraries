...
public class PropertyValuesHolder implements Cloneable {
            ...
            try {
                ...
                for (int i = 0; i < keyframeCount; i++) {
                    ...
                    if (!kf.hasValue() || kf.valueWasSetOnStart()) {
                        if (obj == null) {
                            Object testValue = convertBack(this.mProperty.get(target));
                            obj = testValue;
                        }
                        kf.setValue(obj);
    ...
    public PropertyValuesHolder mo6clone() {
        try {
            ...
            newPVH.mKeyframes = this.mKeyframes.mo2clone();
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        public IntPropertyValuesHolder mo6clone() {
            IntPropertyValuesHolder newPVH = (IntPropertyValuesHolder) super.mo6clone();
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        public FloatPropertyValuesHolder mo6clone() {
            FloatPropertyValuesHolder newPVH = (FloatPropertyValuesHolder) super.mo6clone();
