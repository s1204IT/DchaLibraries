...
public class DevicePolicyManager {
    ...
    public boolean setDeviceOwner(String packageName) throws IllegalStateException, IllegalArgumentException {
        return setDeviceOwner(packageName, null);
    }

    public boolean setDeviceOwner(String packageName, String ownerName) throws IllegalStateException, IllegalArgumentException {
        if (this.mService != null) {
            try {
