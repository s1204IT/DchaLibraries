                    ...
                    if (newState < 2) {
                        ...
                        if (f.mView != null && f.mContainer != null) {
                            ...
                            if (this.mCurState > 0 && !this.mDestroyed) {
                                anim2 = loadAnimator(f, transit, false, transitionStyle);
                            }
                            if (anim2 != null) {
                                final ViewGroup container2 = f.mContainer;
                                final View view = f.mView;
                                container2.startViewTransition(view);
                                f.mAnimatingAway = anim2;
                                f.mStateAfterAnimating = newState;
                                anim2.addListener(new AnimatorListenerAdapter() {
                                    @Override
                                    public void onAnimationEnd(Animator anim3) {
                                        container2.endViewTransition(view);
                                        if (f.mAnimatingAway != null) {
                                            f.mAnimatingAway = null;
                ...
                case 1:
                    if (newState < 1) {
                        if (this.mDestroyed && f.mAnimatingAway != null) {
                            Animator anim3 = f.mAnimatingAway;
                            f.mAnimatingAway = null;
                            anim3.cancel();
                        }
                        if (f.mAnimatingAway != null) {
