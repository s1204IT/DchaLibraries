...
public class CaptureCollector {
    ...
    public boolean queueRequest(RequestHolder holder, LegacyRequest legacy, long timeout, TimeUnit unit, boolean isBurstCapture) throws InterruptedException {
        ...
        try {
            ...
            if (h.needsJpeg) {
                while (this.mInFlight > 0 && !isBurstCapture) {
                    if (nanos <= 0) {
                        return false;
                    }
    ...
    public void failNextPreview() {
        ...
        try {
            ...
            if (h1 == null) {
                ...
                h = (h2 != null && h1.compareTo(h2) > 0) ? h2 : h1;
            }
            if (h != null) {
