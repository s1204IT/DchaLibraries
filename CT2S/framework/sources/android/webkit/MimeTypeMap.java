...
public class MimeTypeMap {
    ...
    String remapGenericMimeType(String mimeType, String url, String contentDisposition) {
        if ("text/plain".equals(mimeType) || FilePart.DEFAULT_CONTENT_TYPE.equals(mimeType)) {
        ...
        if (!"text/vnd.wap.wml".equals(mimeType) && "application/vnd.wap.xhtml+xml".equals(mimeType)) {
