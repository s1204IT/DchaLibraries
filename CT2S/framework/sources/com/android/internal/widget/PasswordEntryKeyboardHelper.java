...
public class PasswordEntryKeyboardHelper implements KeyboardView.OnKeyboardActionListener {
    ...
    private void createKeyboardsWithSpecificSize(int width, int height) {
        ...
        this.mQwertyKeyboard = new PasswordEntryKeyboard(this.mContext, this.mLayouts[1], R.id.mode_normal, width, height);
        this.mQwertyKeyboard.enableShiftLock();
        this.mQwertyKeyboardShifted = new PasswordEntryKeyboard(this.mContext, this.mLayouts[2], R.id.mode_normal, width, height);
