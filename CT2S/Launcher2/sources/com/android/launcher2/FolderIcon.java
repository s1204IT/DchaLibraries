...
public class FolderIcon extends LinearLayout implements FolderInfo.FolderListener {
    ...
    public static class FolderRingAnimator {
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            this.mOuterRingDrawable = res.getDrawable(R.drawable.portal_ring_outer_holo);
            this.mInnerRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_holo);
    ...
    private PreviewItemDrawingParams computePreviewItemDrawingParams(int index, PreviewItemDrawingParams params) {
        ...
        float transY = this.mAvailableSpaceInPreview - ((offset + scaledSize) + scaleOffsetCorrection);
    ...
    private void animateFirstItem(Drawable d, int duration, final boolean reverse, final Runnable onCompleteRunnable) {
        ...
        final float transY0 = (this.mAvailableSpaceInPreview - d.getIntrinsicHeight()) / 2;
