...
public class AsYouTypeFormatter {
    ...
    private String appendNationalNumber(String nationalNumber) {
        ...
        return (!this.shouldAddSpaceAfterNationalPrefix || prefixBeforeNationalNumberLength <= 0 || this.prefixBeforeNationalNumber.charAt(prefixBeforeNationalNumberLength + (-1)) == ' ') ? ((Object) this.prefixBeforeNationalNumber) + nationalNumber : new String(this.prefixBeforeNationalNumber) + SEPARATOR_BEFORE_NATIONAL_NUMBER + nationalNumber;
    }
