...
public class HTMLSchema extends Schema implements HTMLModels {
    public HTMLSchema() {
        ...
        parent(ClientCookie.COMMENT_ATTR, "body");
        parent("dd", "dl");
        parent("del", "body");
        parent("dfn", "body");
        parent("dir", "body");
        ...
        attribute("form", "enctype", "CDATA", URLEncodedUtils.CONTENT_TYPE);
        ...
        attribute(ClientCookie.COMMENT_ATTR, ParameterNames.ID, "ID", null);
        ...
        entity("Eacgr", 904);
        entity("eacgr", 941);
        entity("Eacute", HttpStatus.SC_CREATED);
        entity("eacute", 233);
        entity("easter", 10862);
        entity("Ecaron", 282);
        entity("ecaron", 283);
        ...
        entity("ETH", 208);
        entity("eth", 240);
        entity("Euml", HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION);
        entity("euml", 235);
        entity("euro", 8364);
        entity("excl", 33);
        entity("exist", 8707);
        ...
        entity("Iacgr", 906);
        entity("iacgr", 943);
        entity("Iacute", HttpStatus.SC_RESET_CONTENT);
        entity("iacute", 237);
        entity("ic", 8291);
        entity("Icirc", HttpStatus.SC_PARTIAL_CONTENT);
        entity("icirc", 238);
        entity("Icy", 1048);
        entity("icy", 1080);
        entity("idiagr", 912);
        entity("Idigr", 938);
        entity("idigr", 970);
        entity("Idot", HttpStatus.SC_NOT_MODIFIED);
        entity("IEcy", 1045);
        entity("iecy", 1077);
        entity("iexcl", 161);
        entity("iff", 8660);
        ...
        entity("Igr", 921);
        entity("igr", 953);
        entity("Igrave", HttpStatus.SC_NO_CONTENT);
        entity("igrave", 236);
        entity("ii", 8520);
        entity("iiiint", 10764);
        entity("iiint", 8749);
        ...
        entity("iiota", 8489);
        entity("IJlig", 306);
        entity("ijlig", HttpStatus.SC_TEMPORARY_REDIRECT);
        entity("Im", 8465);
        entity("Imacr", 298);
        entity("imacr", 299);
        entity("image", 8465);
        ...
        entity("iocy", 1105);
        entity("Iogon", 302);
        entity("iogon", HttpStatus.SC_SEE_OTHER);
        entity("Iopf", 120128);
        entity("iopf", 120154);
        entity("Iota", 921);
        entity("iota", 953);
        ...
        entity("Iukcy", 1030);
        entity("iukcy", 1110);
        entity("Iuml", HttpStatus.SC_MULTI_STATUS);
        entity("iuml", 239);
        entity("Jcirc", 308);
        entity("jcirc", 309);
        entity("Jcy", 1049);
