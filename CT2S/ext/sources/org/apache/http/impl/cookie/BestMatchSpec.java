...
public class BestMatchSpec implements CookieSpec {
    ...
    public boolean match(Cookie cookie, CookieOrigin origin) {
        ...
        return cookie.getVersion() > 0 ? getStrict().match(cookie, origin) : getCompat().match(cookie, origin);
    }
    ...
    public List<Header> formatCookies(List<Cookie> cookies) {
        ...
        return version > 0 ? getStrict().formatCookies(cookies) : getCompat().formatCookies(cookies);
    }
