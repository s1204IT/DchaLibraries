...
public abstract class LogFactory {
    ...
    protected static Object createFactory(String factoryClass, ClassLoader classLoader) {
        ...
        try {
            ...
            if (clsLoadClass != null && !LogFactory.class.isAssignableFrom(clsLoadClass)) {
    ...
    private static Enumeration getResources(final ClassLoader loader, final String name) {
        PrivilegedAction action = new PrivilegedAction() {
            ...
            public Object run() {
                ...
                try {
                    if (loader != null) {
                        systemResources = loader.getResources(name);
                    } else {
                        systemResources = ClassLoader.getSystemResources(name);
                    }
                } catch (IOException e) {
    ...
    public static String objectId(Object o) {
        return o == null ? "null" : o.getClass().getName() + Separators.AT + System.identityHashCode(o);
    }
}
