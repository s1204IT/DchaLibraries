...
public class GoogleSearch extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (("android.intent.action.WEB_SEARCH".equals(action) || "android.intent.action.SEARCH".equals(action)) && BenesseExtension.getDchaState() == 0) {
    ...
    private Intent createLaunchUriIntentFromSearchIntent(Intent intent) {
        ...
        if (appSearchData != null) {
            source = appSearchData.getString("source");
        }
