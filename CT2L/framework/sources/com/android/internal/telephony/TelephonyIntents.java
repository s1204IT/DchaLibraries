...
public class TelephonyIntents {
    ...
    public static final String ACTION_CP_PHONEBOOK_INITED = "android.intent.action.CP_PHONEBOOK_INITED";
    ...
    public static final String ACTION_SIM_HOT_PLUGGED = "android.intent.action.SIM_HOT_PLUGGED";
    ...
    public static final String ACTION_SYNC_APN = "android.intent.action.SIM_SYNC_APN";
