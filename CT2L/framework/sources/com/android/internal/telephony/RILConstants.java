...
public interface RILConstants {
    ...
    public static final int NETWORK_MODE_LTE_GSM = 15;
    public static final int NETWORK_MODE_LTE_GSM_GSM_PREF = 13;
    public static final int NETWORK_MODE_LTE_GSM_LTE_PREF = 14;
    public static final int NETWORK_MODE_LTE_GSM_WCDMA = 9;
    public static final int NETWORK_MODE_LTE_GSM_WCDMA_GSM_PREF = 19;
    public static final int NETWORK_MODE_LTE_GSM_WCDMA_LTE_PREF = 21;
    public static final int NETWORK_MODE_LTE_GSM_WCDMA_WCDMA_PREF = 20;
    public static final int NETWORK_MODE_LTE_ONLY = 11;
    public static final int NETWORK_MODE_LTE_WCDMA = 12;
    public static final int NETWORK_MODE_LTE_WCDMA_LTE_PREF = 17;
    public static final int NETWORK_MODE_LTE_WCDMA_WCDMA_PREF = 16;
    ...
    public static final int RIL_OEM_ERROR_BASE = 80;
    ...
    public static final int RIL_REQUEST_GET_CNAP = 506;
    public static final int RIL_REQUEST_GET_CP_PHONEBOOK_STATUS = 512;
    ...
    public static final int RIL_REQUEST_HANGUP_VT = 501;
    ...
    public static final int RIL_REQUEST_LOCK_INFO = 510;
    ...
    public static final int RIL_REQUEST_QUERY_COLP = 503;
    public static final int RIL_REQUEST_QUERY_COLR = 508;
    ...
    public static final int RIL_REQUEST_SET_CLIP = 504;
    public static final int RIL_REQUEST_SET_CLIR = 32;
    public static final int RIL_REQUEST_SET_CNAP = 507;
    public static final int RIL_REQUEST_SET_COLP = 505;
    public static final int RIL_REQUEST_SET_COLR = 509;
    ...
    public static final int RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_EXT = 502;
    ...
    public static final int RIL_REQUEST_SIM_GET_ATR = 511;
    ...
    public static final int RIL_UNSOL_CP_PHONEBOOK_INITED = 1505;
    ...
    public static final int RIL_UNSOL_SIM_HOT_PLUG_EVENT = 1507;
    ...
    public static final int RIL_UNSOL_VZW_PCO_ACTION = 1506;
