...
public final class RotationPolicy {
    ...
    private static final int NATURAL_ROTATION = SystemProperties.getInt("ro.wm.default_rotation", 0);
    ...
    public static void setRotationLock(Context context, boolean enabled) {
        ...
        int rotation = areAllRotationsAllowed(context) ? -1 : NATURAL_ROTATION;
