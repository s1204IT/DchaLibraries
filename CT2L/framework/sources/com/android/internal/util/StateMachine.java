...
public class StateMachine {
    ...
    public static class LogRec {
        ...
        public String toString() {
            ...
            sb.append(" what=");
            String what = this.mSm != null ? this.mSm.getWhatToString(this.mWhat) : ProxyInfo.LOCAL_EXCL_LIST;
    ...
    private static class SmHandler extends Handler {
        ...
        private final StateInfo addState(State state, State parent) {
            if (this.mDbg) {
                this.mSm.log("addStateInternal: E state=" + state.getName() + ",parent=" + (parent == null ? ProxyInfo.LOCAL_EXCL_LIST : parent.getName()));
            }
