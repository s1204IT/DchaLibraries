...
public class GpsMeasurement implements Parcelable {
    ...
    public void setState(short value) {
        switch (value) {
            ...
            case 7:
            default:
                Log.d(TAG, "Sanitizing invalid 'sync state': " + ((int) value));
                this.mState = (short) 0;
                break;
        }
    }
    ...
    public void setAccumulatedDeltaRangeState(short value) {
        switch (value) {
            ...
            case 3:
            default:
                Log.d(TAG, "Sanitizing invalid 'Accumulated Delta Range state': " + ((int) value));
    ...
    public void setLossOfLock(byte value) {
        switch (value) {
            ...
            case 2:
                ...
                break;
            default:
                Log.d(TAG, "Sanitizing invalid 'loss of lock': " + ((int) value));
    ...
    public void setMultipathIndicator(byte value) {
        switch (value) {
            ...
            case 2:
                ...
                break;
            default:
                Log.d(TAG, "Sanitizing invalid 'muti-path indicator': " + ((int) value));
