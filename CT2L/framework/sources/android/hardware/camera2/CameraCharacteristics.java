...
public final class CameraCharacteristics extends CameraMetadata<Key<?>> {
    ...
    @PublicKey
    public static final Key<int[]> CONTROL_AVAILABLE_ISO_MODES = new Key<>("android.control.availableIsoModes", int[].class);
    ...
    @PublicKey
    public static final Key<Integer> CONTROL_MAX_CONTRAST = new Key<>("android.control.maxContrast", Integer.TYPE);

    @PublicKey
    public static final Key<Integer> CONTROL_MIN_CONTRAST = new Key<>("android.control.minContrast", Integer.TYPE);

    @PublicKey
    public static final Key<Integer> CONTROL_MAX_SATURATION = new Key<>("android.control.maxSaturation", Integer.TYPE);

    @PublicKey
    public static final Key<Integer> CONTROL_MIN_SATURATION = new Key<>("android.control.minSaturation", Integer.TYPE);

    @PublicKey
    public static final Key<Integer> CONTROL_MAX_BRIGHTNESS = new Key<>("android.control.maxBrightness", Integer.TYPE);

    @PublicKey
    public static final Key<Integer> CONTROL_MIN_BRIGHTNESS = new Key<>("android.control.minBrightness", Integer.TYPE);

    @PublicKey
    public static final Key<Integer> CONTROL_MAX_SHARPNESS = new Key<>("android.control.maxSharpness", Integer.TYPE);

    @PublicKey
    public static final Key<Integer> CONTROL_MIN_SHARPNESS = new Key<>("android.control.minSharpness", Integer.TYPE);
    ...
    public List<Key<?>> getKeys() {
        ...
        this.mKeys = Collections.unmodifiableList(getKeysStatic(getClass(), getKeyClass(), this, filterTags));
        return this.mKeys;
    }
    ...
    private <TKey> List<TKey> getAvailableKeyList(Class<?> metadataClass, Class<TKey> keyClass, int[] filterTags) {
        ...
        List<TKey> staticKeyList = getKeysStatic(metadataClass, keyClass, null, filterTags);
