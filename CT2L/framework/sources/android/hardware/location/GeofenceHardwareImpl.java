...
public final class GeofenceHardwareImpl {
    ...
    private void updateFusedHardwareAvailability() {
        ...
        try {
            fusedSupported = this.mFusedService != null ? this.mFusedService.isSupported() : false;
        } catch (RemoteException e) {
    ...
    class Reaper implements IBinder.DeathRecipient {
        ...
        public boolean equals(Object obj) {
            ...
            return binderEquals(rhs.mCallback, this.mCallback) && binderEquals(rhs.mMonitorCallback, this.mMonitorCallback) && rhs.mMonitoringType == this.mMonitoringType;
        }
