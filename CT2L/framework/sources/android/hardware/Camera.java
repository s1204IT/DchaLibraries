...
public class Camera {
    ...
    private static final int CAMERA_MSG_ISP_INFO_FOR_CT = 32768;
    ...
    private static final int CAMERA_MSG_SCENE_UPDATE = 4096;
    ...
    private IspInfoListener mIspInfoListener;
    ...
    private SceneDetectionListener mSceneListener;
    ...
    public static class Face {
        public int LeftEyeCloseRatio;
        public int RightEyeCloseRatio;
        public Rect rect;
        public int score;
    ...
    public static class IspInfo {
        public int b_gain;
        public int dvs_cropH;
        public int dvs_cropW;
        public int dvs_cropX;
        public int dvs_cropY;
    ...
    public interface IspInfoListener {
        void onIspInfo(IspInfo ispInfo, Camera camera);
    }
    ...
    public interface SceneDetectionListener {
        void onSceneDetection(String str, Camera camera);
    }
    ...
    private final native int _getRegister(int i);

    private final native int _setRegister(int i, int i2);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2048:
                    ...
                    return;
                case 4096:
                    if (Camera.this.mSceneListener != null) {
                        Camera.this.mSceneListener.onSceneDetection((String) msg.obj, this.mCamera);
                        return;
                    }
                    return;
                case 32768:
                    if (Camera.this.mIspInfoListener != null) {
                        Camera.this.mIspInfoListener.onIspInfo((IspInfo) msg.obj, this.mCamera);
                        return;
                    }
                    return;
                default:
    ...
    public final int setRegister(int address, int value) {
        return _setRegister(address, value);
    }

    public final int getRegister(int address) {
        return _getRegister(address);
    }
    ...
    public final void setSceneDetectionListener(SceneDetectionListener listener) {
        this.mSceneListener = listener;
    }

    public final void setIspInfoListener(IspInfoListener listener) {
        this.mIspInfoListener = listener;
    }
    ...
    public class Parameters {
        ...
        public static final String BEST_SHOT_INDEX = "best-index";
        public static final String BURST_CAPTURE_MODE_FAST = "fast-burst";
        public static final String BURST_CAPTURE_MODE_INFINITE = "infinite-burst";
        public static final String BURST_CAPTURE_MODE_OFF = "off-burst";
        public static final String EFFECT_AQUA = "aqua";
        public static final String EFFECT_BLACKBOARD = "blackboard";
        public static final String EFFECT_FRAME = "frame";
        public static final String EFFECT_GLOW = "glow";
        public static final String EFFECT_MONO = "mono";
        public static final String EFFECT_NEGATIVE = "negative";
        public static final String EFFECT_NONE = "none";
        public static final String EFFECT_OLDMOVIE = "oldmovie";
        public static final String EFFECT_PENCILSKETCH = "pencilsketch";
        public static final String EFFECT_POSTERIZE = "posterize";
        public static final String EFFECT_SEPIA = "sepia";
        public static final String EFFECT_SOLARIZE = "solarize";
        public static final String EFFECT_SUNSHINE = "sunshine";
        public static final String EFFECT_TOONSHADING = "toonshading";
        public static final String EFFECT_TWIST = "twist";
        public static final String EFFECT_VIVID = "vivid";
        public static final String EFFECT_WHITEBOARD = "whiteboard";
        public static final String EXPOSURE_MODE_MANUAL = "exposure-mode-manual";
        ...
        public static final String ISO_MODE_100 = "100";
        public static final String ISO_MODE_1600 = "1600";
        public static final String ISO_MODE_200 = "200";
        public static final String ISO_MODE_3200 = "3200";
        public static final String ISO_MODE_400 = "400";
        public static final String ISO_MODE_50 = "50";
        public static final String ISO_MODE_800 = "800";
        public static final String ISO_MODE_AUTO = "auto";
        private static final String KEY_ANTIBANDING = "antibanding";
        private static final String KEY_AUTO_EXPOSURE_LOCK = "auto-exposure-lock";
        private static final String KEY_AUTO_EXPOSURE_LOCK_SUPPORTED = "auto-exposure-lock-supported";
        private static final String KEY_AUTO_WHITEBALANCE_LOCK = "auto-whitebalance-lock";
        private static final String KEY_AUTO_WHITEBALANCE_LOCK_SUPPORTED = "auto-whitebalance-lock-supported";
        public static final String KEY_A_GAIN = "a-gain";
        private static final String KEY_BLINK_DETECTION_SUPPORTED = "blink-detection-supported";
        private static final String KEY_BRIGHTNESS = "light_key";
        private static final String KEY_BURST_CAPTURE_MODE = "burst-capture-mode";
        private static final String KEY_BURST_CAPTURE_MODE_SUPPORTED = "burst-capture-mode-supported";
        private static final String KEY_BURST_CAPTURE_NUM = "burst-capture-number";
        private static final String KEY_B_GAIN = "b-gain";
        private static final String KEY_CONTRAST = "contrast";
        private static final String KEY_DNS_TIMES = "dns-times";
        public static final String KEY_D_GAIN = "d-gain";
        private static final String KEY_EFFECT = "effect";
        private static final String KEY_EFFECT_PARAM = "effect-param";
        private static final String KEY_EXPOSURE_COMPENSATION = "exposure-compensation";
        private static final String KEY_EXPOSURE_COMPENSATION_STEP = "exposure-compensation-step";
        public static final String KEY_EXPOSURE_MODE = "exposure-mode";
        public static final String KEY_FACE_BEAUTIFY = "face-beautify";
        private static final String KEY_FACE_BEAUTIFY_SUPPORTED = "face-beautify-supported";
        private static final String KEY_FLASH_MODE = "flash-mode";
        private static final String KEY_FOCAL_LENGTH = "focal-length";
        private static final String KEY_FOCUS_AREAS = "focus-areas";
        private static final String KEY_FOCUS_DISTANCES = "focus-distances";
        private static final String KEY_FOCUS_MODE = "focus-mode";
        private static final String KEY_FOCUS_POSITION = "focus-position";
        private static final String KEY_GB_GAIN = "gb-gain";
        private static final String KEY_GPS_ALTITUDE = "gps-altitude";
        private static final String KEY_GPS_LATITUDE = "gps-latitude";
        private static final String KEY_GPS_LONGITUDE = "gps-longitude";
        private static final String KEY_GPS_PROCESSING_METHOD = "gps-processing-method";
        private static final String KEY_GPS_TIMESTAMP = "gps-timestamp";
        private static final String KEY_GR_GAIN = "gr-gain";
        private static final String KEY_HDR_MODE = "hdr-mode";
        private static final String KEY_HDR_MODE_SUPPORTED = "hdr-mode-supported";
        private static final String KEY_HORIZONTAL_VIEW_ANGLE = "horizontal-view-angle";
        private static final String KEY_ISO_MODE = "iso-mode";
        private static final String KEY_ISO_MODE_SUPPORTED = "iso-mode-supported";
        public static final String KEY_ISP_GAIN = "isp-gain";
        private static final String KEY_JPEG_QUALITY = "jpeg-quality";
        private static final String KEY_JPEG_THUMBNAIL_HEIGHT = "jpeg-thumbnail-height";
        private static final String KEY_JPEG_THUMBNAIL_QUALITY = "jpeg-thumbnail-quality";
        private static final String KEY_JPEG_THUMBNAIL_SIZE = "jpeg-thumbnail-size";
        private static final String KEY_JPEG_THUMBNAIL_WIDTH = "jpeg-thumbnail-width";
        private static final String KEY_MAX_BRIGHTNESS = "max-brightness";
        private static final String KEY_MAX_BURST_CAPTURE_NUM = "max-burst-capture-number";
        ...
        private static final String KEY_MAX_SHUTTER_SPEED = "max-shutter-speed";
        private static final String KEY_MAX_ZOOM = "max-zoom";
        private static final String KEY_METERING_AREAS = "metering-areas";
        private static final String KEY_MIN_BRIGHTNESS = "min-brightness";
        private static final String KEY_MIN_CONTRAST = "min-contrast";
        private static final String KEY_MIN_EXPOSURE_COMPENSATION = "min-exposure-compensation";
        private static final String KEY_MIN_SATURATION = "min-saturation";
        private static final String KEY_MIN_SHARPNESS = "min-sharpness";
        private static final String KEY_MIN_SHUTTER_SPEED = "min-shutter-speed";
        ...
        private static final String KEY_R_GAIN = "r-gain";
        ...
        private static final String KEY_SMILE_DETECTION_SUPPORTED = "smile-detection-supported";
        private static final String KEY_SMOOTH_ZOOM_SUPPORTED = "smooth-zoom-supported";
        private static final String KEY_UV_DNS = "uv-dns";
        private static final String KEY_VERTICAL_VIEW_ANGLE = "vertical-view-angle";
        private static final String KEY_VIDEO_SCENE_MODE = "video-scene-mode";
        private static final String KEY_VIDEO_SIZE = "video-size";
        private static final String KEY_VIDEO_SNAPSHOT_SUPPORTED = "video-snapshot-supported";
        private static final String KEY_VIDEO_STABILIZATION = "video-stabilization";
        private static final String KEY_VIDEO_STABILIZATION_SUPPORTED = "video-stabilization-supported";
        private static final String KEY_VIDEO_TNR = "video-tnr";
        private static final String KEY_VIDEO_TNR_SUPPORTED = "video-tnr-supported";
        private static final String KEY_WHITE_BALANCE = "whitebalance";
        private static final String KEY_Y_DNS = "y-dns";
        ...
        private static final String PIXEL_FORMAT_YUV420P_I420 = "yuv420p-i420";
        private static final String PIXEL_FORMAT_YUV420SP = "yuv420sp";
        private static final String PIXEL_FORMAT_YUV422I = "yuv422i-yuyv";
        private static final String PIXEL_FORMAT_YUV422I_UYVY = "yuv422i-uyvy";
        ...
        public static final String SCENE_MODE_BESTSHOT = "best-shot";
        public static final String SCENE_MODE_CANDLELIGHT = "candlelight";
        public static final String SCENE_MODE_DETECT = "scene-detect";
        ...
        public static final String SCENE_MODE_SMILE = "smile";
        public static final String SCENE_MODE_SNOW = "snow";
        public static final String SCENE_MODE_SPORTS = "sports";
        public static final String SCENE_MODE_STEADYPHOTO = "steadyphoto";
        public static final String SCENE_MODE_SUNSET = "sunset";
        public static final String SCENE_MODE_TEST = "scene-test";
        ...
        public int getBestIndex() {
            return getInt(BEST_SHOT_INDEX, -1);
        }
        ...
        private String cameraFormatForPixelFormat(int pixel_format) {
            switch (pixel_format) {
                ...
                case 19:
                    return PIXEL_FORMAT_YUV420P_I420;
                case 20:
                    return PIXEL_FORMAT_YUV422I;
                case 22:
                    return PIXEL_FORMAT_YUV422I_UYVY;
                case 256:
        ...
        private int pixelFormatForCameraFormat(String format) {
            ...
            if (format.equals(PIXEL_FORMAT_YUV422I_UYVY)) {
                return 22;
            }
            return format.equals(PIXEL_FORMAT_YUV420P_I420) ? 19 : 0;
        }
        ...
        public void setColorEffectParam(String value1, String value2) {
            set(KEY_EFFECT, value1);
            set(KEY_EFFECT_PARAM, value2);
        }

        public String getColorEffectParam() {
            return get(KEY_EFFECT_PARAM);
        }
        ...
        public String getVideoSceneMode() {
            return get(KEY_VIDEO_SCENE_MODE);
        }

        public void setVideoSceneMode(String value) {
            set(KEY_VIDEO_SCENE_MODE, value);
        }

        public List<String> getSupportedVideoSceneModes() {
            String str = get("video-scene-mode-values");
            return split(str);
        }
        ...
        public boolean isSmileDetectionSupported() {
            String str = get(KEY_SMILE_DETECTION_SUPPORTED);
            return TRUE.equals(str);
        }

        public boolean isBlinkDetectionSupported() {
            String str = get(KEY_BLINK_DETECTION_SUPPORTED);
            return TRUE.equals(str);
        }

        public boolean isFaceBeautifySupported() {
            String str = get(KEY_FACE_BEAUTIFY_SUPPORTED);
            return TRUE.equals(str);
        }

        public void setFaceBeautify(boolean faceBeautify) {
            set(KEY_FACE_BEAUTIFY, faceBeautify ? TRUE : FALSE);
        }
        ...
        public void setVideoTNR(boolean toggle) {
            set(KEY_VIDEO_TNR, toggle ? TRUE : FALSE);
        }

        public boolean isVideoTNRSupported() {
            String str = get(KEY_VIDEO_TNR_SUPPORTED);
            return TRUE.equals(str);
        }
        ...
        public void setIsoMode(String value) {
            set(KEY_ISO_MODE, value);
        }

        public List<String> getSupportedIsoModes() {
            String str = get("iso-mode-values");
            return split(str);
        }

        public String getBurstCaptureMode() {
            return get(KEY_BURST_CAPTURE_MODE);
        }

        public void setBurstCaptureMode(String value) {
            set(KEY_BURST_CAPTURE_MODE, value);
        }

        public List<String> getSupportedBurstCaptureModes() {
            String str = get("burst-capture-mode-values");
            return split(str);
        }
        ...
        public int getBurstCaptureNum() {
            return getInt(KEY_BURST_CAPTURE_NUM, 1);
        }

        public int getMaxBurstCaptureNum() {
            return getInt(KEY_MAX_BURST_CAPTURE_NUM, 1);
        }

        public void setMaxBurstCaptureNum(int value) {
            set(KEY_MAX_BURST_CAPTURE_NUM, value);
        }

        public String getHDRMode() {
            return get(KEY_HDR_MODE);
        }

        public void setHDRMode(String value) {
            set(KEY_HDR_MODE, value);
        }

        public List<String> getSupportedHDRModes() {
            String str = get("hdr-mode-values");
            return split(str);
        }
        ...
        public int getMinBrightness() {
            return getInt(KEY_MIN_BRIGHTNESS, 0);
        }
        ...
        public int getMinSharpness() {
            return getInt(KEY_MIN_SHARPNESS, 0);
        }
        ...
        public int getMinContrast() {
            return getInt(KEY_MIN_CONTRAST, 0);
        }
        ...
        public int getMinSaturation() {
            return getInt(KEY_MIN_SATURATION, 0);
        }

        public void setShutterSpeed(double value) {
            set(KEY_SHUTTER_SPEED, value);
        }

        public double getShutterSpeed() {
            return Double.parseDouble(get(KEY_SHUTTER_SPEED));
        }

        public void setExposureMode(int value) {
            set(KEY_EXPOSURE_MODE, value);
        }

        public void setFocusPosition(int value) {
            set(KEY_FOCUS_POSITION, value);
        }

        public void setAGain(double value) {
            set(KEY_A_GAIN, value);
        }

        public void setDGain(double value) {
            set(KEY_D_GAIN, value);
        }

        public void setIspGain(double value) {
            set(KEY_ISP_GAIN, value);
        }

        public void setBGain(double value) {
            set(KEY_B_GAIN, value);
        }

        public void setGbGain(double value) {
            set(KEY_GB_GAIN, value);
        }

        public void setGrGain(double value) {
            set(KEY_GR_GAIN, value);
        }

        public void setRGain(double value) {
            set(KEY_R_GAIN, value);
        }

        public void setYDns(boolean enable) {
            set(KEY_Y_DNS, enable ? TRUE : FALSE);
        }

        public void setUVDns(boolean enable) {
            set(KEY_UV_DNS, enable ? TRUE : FALSE);
        }

        public void setDnsTimes(int value) {
            set(KEY_DNS_TIMES, value);
        }

        public void setBurstCaptureNum(int value) {
            set(KEY_BURST_CAPTURE_NUM, value);
        }
