...
public class FindActionModeCallback implements ActionMode.Callback, TextWatcher, View.OnClickListener, WebView.FindListener {
    ...
    private void findNext(boolean next) throws BlockGuard.BlockGuardPolicyException {
    ...
    @Override
    public void onClick(View v) throws BlockGuard.BlockGuardPolicyException {
        findNext(true);
    }
    ...
    @Override
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) throws BlockGuard.BlockGuardPolicyException {
        if (this.mWebView == null) {
    ...
    @Override
    public void onTextChanged(CharSequence s, int start, int before, int count) throws BlockGuard.BlockGuardPolicyException {
        findAll();
    }
