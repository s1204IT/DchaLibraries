...
public class DdmHandleThread extends ChunkHandler {
    ...
    private Chunk handleTHST(Chunk request) {
        ...
        return status != null ? new Chunk(CHUNK_THST, status, 0, status.length) : createFailChunk(1, "Can't build THST chunk");
    }
    ...
    private Chunk handleSTKL(Chunk request) {
        ...
        return trace == null ? createFailChunk(1, "Stack trace unavailable") : createStackChunk(trace, threadId);
    }
