...
public class SslCertificate {
    ...
    private static String formatDate(Date date) {
        return date == null ? ProxyInfo.LOCAL_EXCL_LIST : new SimpleDateFormat(ISO_8601_DATE_FORMAT).format(date);
    }
    ...
    private String formatCertificateDate(Context context, Date certificateDate) {
        return certificateDate == null ? ProxyInfo.LOCAL_EXCL_LIST : DateFormat.getDateFormat(context).format(certificateDate);
    }
}
