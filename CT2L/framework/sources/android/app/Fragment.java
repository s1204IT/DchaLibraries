...
public class Fragment implements ComponentCallbacks2, View.OnCreateContextMenuListener {
    ...
    public void onInflate(Activity activity, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        this.mEnterTransition = loadTransition(activity, a, this.mEnterTransition, null, 4);
        this.mReturnTransition = loadTransition(activity, a, this.mReturnTransition, USE_DEFAULT_TRANSITION, 6);
        this.mExitTransition = loadTransition(activity, a, this.mExitTransition, null, 3);
        this.mReenterTransition = loadTransition(activity, a, this.mReenterTransition, USE_DEFAULT_TRANSITION, 8);
        this.mSharedElementEnterTransition = loadTransition(activity, a, this.mSharedElementEnterTransition, null, 5);
