...
public class TtsEngines {
    ...
    static {
        ...
        String[] arr$ = Locale.getISOLanguages();
        ...
        String[] arr$2 = Locale.getISOCountries();
        for (String country : arr$2) {
            try {
    ...
    public static String[] toOldLocaleStringFormat(Locale locale) {
        String[] ret = {ProxyInfo.LOCAL_EXCL_LIST, ProxyInfo.LOCAL_EXCL_LIST, ProxyInfo.LOCAL_EXCL_LIST};
        try {
    ...
    public synchronized void updateLocalePrefForEngine(String engineName, Locale newLocale) {
        ...
        String newPrefList = updateValueInCommaSeparatedList(prefList, engineName, newLocale != null ? newLocale.toString() : ProxyInfo.LOCAL_EXCL_LIST);
