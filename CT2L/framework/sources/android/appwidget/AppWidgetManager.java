...
public class AppWidgetManager {
    ...
    public List<AppWidgetProviderInfo> getInstalledProvidersForProfile(UserHandle profile) {
        return this.mService == null ? Collections.emptyList() : getInstalledProvidersForProfile(1, profile);
    }
    ...
    public List<AppWidgetProviderInfo> getInstalledProviders(int categoryFilter) {
        return this.mService == null ? Collections.emptyList() : getInstalledProvidersForProfile(categoryFilter, null);
    }
    ...
    public boolean bindAppWidgetIdIfAllowed(int appWidgetId, ComponentName provider) {
        ...
        return bindAppWidgetIdIfAllowed(appWidgetId, UserHandle.myUserId(), provider, (Bundle) null);
    }
