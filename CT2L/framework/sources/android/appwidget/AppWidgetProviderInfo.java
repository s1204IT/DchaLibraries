...
public class AppWidgetProviderInfo implements Parcelable {
    ...
    public AppWidgetProviderInfo m13clone() {
        AppWidgetProviderInfo that = new AppWidgetProviderInfo();
        that.provider = this.provider == null ? null : this.provider.m14clone();
        ...
        that.configure = this.configure == null ? null : this.configure.m14clone();
