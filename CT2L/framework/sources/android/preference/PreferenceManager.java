...
public class PreferenceManager {
    ...
    public PreferenceScreen inflateFromResource(Context context, int resId, PreferenceScreen rootPreferences) {
        setNoCommit(true);
        PreferenceInflater inflater = new PreferenceInflater(context, this);
        PreferenceScreen rootPreferences2 = (PreferenceScreen) inflater.inflate(resId, rootPreferences, true);
    ...
    void dispatchActivityDestroy() {
        ...
        synchronized (this) {
            if (this.mActivityDestroyListeners != null) {
                List<OnActivityDestroyListener> list2 = new ArrayList<>(this.mActivityDestroyListeners);
                list = list2;
            }
        }
        if (list != null) {
