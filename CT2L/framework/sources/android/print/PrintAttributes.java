...
public final class PrintAttributes implements Parcelable {
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + (this.mMinMargins == null ? 0 : this.mMinMargins.hashCode())) * 31) + (this.mMediaSize == null ? 0 : this.mMediaSize.hashCode())) * 31) + (this.mResolution != null ? this.mResolution.hashCode() : 0);
    }
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize NA_JUNIOR_LEGAL = new MediaSize("NA_JUNIOR_LEGAL", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_na_junior_legal, 8000, BluetoothInputDevice.INPUT_DISCONNECT_FAILED_NOT_CONNECTED);
        ...
        public static final MediaSize NA_INDEX_3X5 = new MediaSize("NA_INDEX_3X5", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_na_index_3x5, 3000, BluetoothInputDevice.INPUT_DISCONNECT_FAILED_NOT_CONNECTED);
        ...
        public static final MediaSize NA_INDEX_5X8 = new MediaSize("NA_INDEX_5X8", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_na_index_5x8, BluetoothInputDevice.INPUT_DISCONNECT_FAILED_NOT_CONNECTED, 8000);
        ...
        public static final MediaSize JPN_CHOU2 = new MediaSize("JPN_CHOU2", ZenModeConfig.SYSTEM_AUTHORITY, R.string.mediasize_japanese_chou2, 4374, 5748);
