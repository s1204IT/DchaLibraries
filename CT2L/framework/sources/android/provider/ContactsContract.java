            ...
            if (c != null) {
                try {
                    if (c.moveToFirst()) {
                        ...
                        lookupUri = getLookupUri(contactId, lookupKey);
                    }
                } finally {
                    c.close();
                }
            ...
            if (lookupUri != null && (c = resolver.query(lookupUri, new String[]{"_id"}, null, null, null)) != null) {
                try {
                    if (c.moveToFirst()) {
                        ...
                        uriWithAppendedId = ContentUris.withAppendedId(CONTENT_URI, contactId);
                    }
                } finally {
                    c.close();
                }
            ...
            public static final class Builder {
                ...
                public Uri build() {
                    ...
                    for (int i = 0; i < count; i++) {
                        builder.appendQueryParameter("query", this.mKinds.get(i) + ":" + this.mValues.get(i));
                    }
