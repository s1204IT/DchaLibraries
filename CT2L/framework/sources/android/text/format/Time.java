        ...
        if (len >= 19) {
            ...
            if (len > tzIndex) {
                ...
                if (offset != 0) {
                    ...
                    minute += (n8 + getChar(s, tzIndex + 5, 1)) * offset;
                }
            }
            this.hour = hour;
            this.minute = minute;
    ...
    private static class TimeCalculator {
        ...
        public static int compare(TimeCalculator aObject, TimeCalculator bObject) {
            ...
            if (aObject.timezone.equals(bObject.timezone)) {
                int diff2 = aObject.wallTime.getYear() - bObject.wallTime.getYear();
                if (diff2 == 0) {
                    int diff3 = aObject.wallTime.getMonth() - bObject.wallTime.getMonth();
                    if (diff3 == 0) {
                        int diff4 = aObject.wallTime.getMonthDay() - bObject.wallTime.getMonthDay();
                        if (diff4 == 0) {
                            int diff5 = aObject.wallTime.getHour() - bObject.wallTime.getHour();
                            if (diff5 == 0) {
                                int diff6 = aObject.wallTime.getMinute() - bObject.wallTime.getMinute();
                                if (diff6 == 0) {
                                    int diff7 = aObject.wallTime.getSecond() - bObject.wallTime.getSecond();
                                    if (diff7 == 0) {
                                        return 0;
                                    }
                                    return diff7;
