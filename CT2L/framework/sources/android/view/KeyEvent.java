...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    static int access$076(KeyEvent x0, int x1) {
        int i = x0.mFlags | x1;
        x0.mFlags = i;
        return i;
    }
    ...
    public static class DispatcherState {
        ...
        public void handleUpEvent(KeyEvent event) {
            ...
            if (index >= 0) {
                KeyEvent.access$076(event, R.styleable.Theme_actionModePopupWindowStyle);
    ...
    public static int keyCodeFromString(String symbolicName) {
        int keyCode;
        if (!symbolicName.startsWith(LABEL_PREFIX) || (keyCode = nativeKeyCodeFromString((symbolicName = symbolicName.substring(LABEL_PREFIX.length())))) <= 0) {
            try {
