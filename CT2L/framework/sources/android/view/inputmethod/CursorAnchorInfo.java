...
public final class CursorAnchorInfo implements Parcelable {
    ...
    public int hashCode() {
        ...
        int hash = floatHash > 0.0f ? (int) floatHash : (int) (-floatHash);
        return (((((((((hash * 31) + this.mInsertionMarkerFlags) * 31) + this.mSelectionStart + this.mSelectionEnd + this.mComposingTextStart) * 31) + Objects.hashCode(this.mComposingText)) * 31) + Objects.hashCode(this.mCharacterBoundsArray)) * 31) + Objects.hashCode(this.mMatrix);
    }
    ...
    private CursorAnchorInfo(Builder builder) {
        SparseRectFArray sparseRectFArrayBuild;
        ...
        if (builder.mCharacterBoundsArrayBuilder != null) {
            sparseRectFArrayBuild = builder.mCharacterBoundsArrayBuilder.build();
        } else {
            sparseRectFArrayBuild = null;
        }
        this.mCharacterBoundsArray = sparseRectFArrayBuild;
