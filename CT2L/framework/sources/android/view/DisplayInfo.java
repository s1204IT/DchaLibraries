...
public final class DisplayInfo implements Parcelable {
    ...
    public int getNaturalWidth() {
        return (mHwrotation == 0 || mHwrotation == 180) ? (this.rotation == 0 || this.rotation == 2) ? this.logicalWidth : this.logicalHeight : (this.rotation == 0 || this.rotation == 2) ? this.logicalHeight : this.logicalWidth;
    }

    public int getNaturalHeight() {
        return (mHwrotation == 0 || mHwrotation == 180) ? (this.rotation == 0 || this.rotation == 2) ? this.logicalHeight : this.logicalWidth : (this.rotation == 0 || this.rotation == 2) ? this.logicalWidth : this.logicalHeight;
    }
