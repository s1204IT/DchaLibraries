...
public class AnimationSet extends Animation {
    ...
    @Override
    protected AnimationSet mo27clone() throws CloneNotSupportedException {
        AnimationSet animation = (AnimationSet) super.mo27clone();
        ...
        for (int i = 0; i < count; i++) {
            animation.mAnimations.add(animations.get(i).mo27clone());
        }
        return animation;
    }
