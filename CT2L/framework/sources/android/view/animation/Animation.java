...
public abstract class Animation implements Cloneable {
    ...
    @Override
    protected Animation mo27clone() throws CloneNotSupportedException {
    ...
    public void restrictDuration(long durationMillis) {
        ...
        if (this.mDuration <= 0) {
            this.mDuration = 0L;
            this.mRepeatCount = 0;
        } else if (this.mRepeatCount < 0 || this.mRepeatCount > durationMillis || ((long) this.mRepeatCount) * dur > durationMillis) {
