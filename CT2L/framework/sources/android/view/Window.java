...
public abstract class Window {
    ...
    public boolean shouldCloseOnTouch(Context context, MotionEvent event) {
        return this.mCloseOnTouchOutside && event.getAction() == 0 && isOutOfBounds(context, event) && peekDecorView() != null;
    }
    ...
    public boolean requestFeature(int featureId) {
        ...
        this.mFeatures |= flag;
        this.mLocalFeatures = (this.mContainer != null ? (this.mContainer.mFeatures ^ (-1)) & flag : flag) | this.mLocalFeatures;
