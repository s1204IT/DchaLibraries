...
public class StatusBarNotification implements Parcelable {
    ...
    public StatusBarNotification m17clone() {
        return new StatusBarNotification(this.pkg, this.opPkg, this.id, this.tag, this.uid, this.initialPid, this.score, this.notification.m8clone(), this.user, this.postTime);
    }
