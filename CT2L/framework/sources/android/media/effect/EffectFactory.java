...
public class EffectFactory {
    ...
    private static final String[] EFFECT_PACKAGES = {"android.media.effect.effects.", ProxyInfo.LOCAL_EXCL_LIST};
    ...
    private static Class getEffectClassByName(String className) {
        ...
        for (String packageName : arr$) {
            try {
                clsLoadClass = contextClassLoader.loadClass(packageName + className);
