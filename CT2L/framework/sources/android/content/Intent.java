...
public class Intent implements Parcelable, Cloneable {
    ...
    public static final String ACTION_SIM_ENABLE_CHANGED = "android.intent.action.SIM_ENABLE_CHANGED";
            ...
            if (data != null) {
                if (data.startsWith("intent:")) {
                    ...
                    if (data.charAt(12) == '/' && data.charAt(13) == '/') {
                        ...
                        if (end < 0) {
                            intent2.mPackage = data.substring(14);
                            if (!explicitAction) {
                            ...
                            intent2.mPackage = data.substring(14, end);
    ...
    public String resolveTypeIfNeeded(ContentResolver resolver) {
        return this.mComponent != null ? this.mType : resolveType(resolver);
    }
        ...
        if (this.mExtras != null) {
            for (String key : this.mExtras.keySet()) {
                ...
                if (value instanceof String) {
                    ...
                    entryType = value instanceof Boolean ? 'B' : value instanceof Byte ? 'b' : value instanceof Character ? 'c' : value instanceof Double ? DateFormat.DATE : value instanceof Float ? 'f' : value instanceof Integer ? 'i' : value instanceof Long ? 'l' : value instanceof Short ? 's' : (char) 0;
                }
                if (entryType != 0) {
