        ...
        try {
            try {
                ...
                if (v == null) {
                    ...
                    android.content.pm.ServiceInfo serviceInfo2 = service.serviceInfo;
                    ApplicationInfo applicationInfo = serviceInfo2.applicationInfo;
                    int uid = applicationInfo.uid;
                    serviceInfo = new ServiceInfo<>(v, componentName, uid);
                    if (parser != null) {
                        parser.close();
                    }
                }
                    ...
                    do {
                        if (eventType2 == 2) {
                            if (parser.getDepth() == 2) {
                                ...
                                if (Notification.CATEGORY_SERVICE.equals(tagName2)) {
