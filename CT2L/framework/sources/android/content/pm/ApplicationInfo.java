...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    public Drawable loadDefaultIcon(PackageManager pm) {
        return ((this.flags & 262144) == 0 || !isPackageUnavailable(pm)) ? pm.getDefaultActivityIcon() : Resources.getSystem().getDrawable(R.drawable.sym_app_on_sd_unavailable_icon);
    }
