...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int layoutResId = a.getResourceId(1, R.layout.search_view);
    ...
    private boolean onSuggestionsKey(View v, int keyCode, KeyEvent event) {
        ...
        if ((keyCode == 19 && this.mSearchSrcTextView.getListSelection() == 0) || (actionKey = this.mSearchable.findActionKey(keyCode)) == null) {
            return false;
        }
        if ((actionKey.getSuggestActionMsg() == null && actionKey.getSuggestActionMsgColumn() == null) || (position = this.mSearchSrcTextView.getListSelection()) == -1) {
            return false;
        }
    ...
    public void onActionViewCollapsed() {
        setQuery(ProxyInfo.LOCAL_EXCL_LIST, false);
        clearFocus();
        updateViewsVisibility(true);
