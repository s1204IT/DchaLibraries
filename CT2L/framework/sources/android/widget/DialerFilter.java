...
public class DialerFilter extends RelativeLayout {
    ...
    public CharSequence getLetters() {
        return this.mLetters.getVisibility() == 0 ? this.mLetters.getText() : ProxyInfo.LOCAL_EXCL_LIST;
    }

    public CharSequence getDigits() {
        return this.mDigits.getVisibility() == 0 ? this.mDigits.getText() : ProxyInfo.LOCAL_EXCL_LIST;
    }
