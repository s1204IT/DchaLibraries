...
public class LinearLayout extends ViewGroup {
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(((-16777216) & childState) | widthSizeAndState, resolveSizeAndState(Math.max(maxHeight + this.mPaddingTop + this.mPaddingBottom, getSuggestedMinimumHeight()), heightMeasureSpec, childState << 16));
        if (matchHeight) {
