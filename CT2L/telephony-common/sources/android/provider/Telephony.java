...
public final class Telephony {
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static Uri addMessageToUri(ContentResolver resolver, Uri uri, String address, String body, String subject, Long date, boolean read, boolean deliveryReport) {
            return addMessageToUri(SubscriptionManager.getDefaultSmsSubId(), resolver, uri, address, body, subject, date, read, deliveryReport, -1L);
        }
        ...
        public static Uri addMessageToUri(int subId, ContentResolver resolver, Uri uri, String address, String body, String subject, Long date, boolean read, boolean deliveryReport, long threadId) {
            ...
            if (deliveryReport) {
                values.put(TextBasedSmsColumns.STATUS, (Integer) 32);
            }
            if (threadId != -1) {
    ...
    public static final class CellBroadcasts implements BaseColumns {
        ...
        public static final String[] QUERY_COLUMNS = {"_id", GEOGRAPHICAL_SCOPE, PLMN, LAC, "cid", SERIAL_NUMBER, SERVICE_CATEGORY, LANGUAGE_CODE, "body", "date", "read", MESSAGE_FORMAT, MESSAGE_PRIORITY, ETWS_WARNING_TYPE, CMAS_MESSAGE_CLASS, CMAS_CATEGORY, CMAS_RESPONSE_TYPE, CMAS_SEVERITY, CMAS_URGENCY, CMAS_CERTAINTY};
