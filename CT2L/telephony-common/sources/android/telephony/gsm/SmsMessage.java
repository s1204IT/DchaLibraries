...
public class SmsMessage {
    ...
    public static int getTPLayerLengthForPDU(String pdu) {
        int activePhone = TelephonyManager.getDefault().getCurrentPhoneType();
        return 2 == activePhone ? com.android.internal.telephony.cdma.SmsMessage.getTPLayerLengthForPDU(pdu) : com.android.internal.telephony.gsm.SmsMessage.getTPLayerLengthForPDU(pdu);
    }
    ...
    private static final SmsMessageBase getSmsFacility() {
        int activePhone = TelephonyManager.getDefault().getCurrentPhoneType();
        return 2 == activePhone ? new com.android.internal.telephony.cdma.SmsMessage() : new com.android.internal.telephony.gsm.SmsMessage();
    }
}
