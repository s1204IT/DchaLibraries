...
public interface Phone {
    ...
    public static final int NT_MODE_LTE_GSM = 15;
    public static final int NT_MODE_LTE_GSM_GSM_PREF = 13;
    public static final int NT_MODE_LTE_GSM_LTE_PREF = 14;
    public static final int NT_MODE_LTE_GSM_WCDMA = 9;
    public static final int NT_MODE_LTE_GSM_WCDMA_GSM_PREF = 19;
    public static final int NT_MODE_LTE_GSM_WCDMA_LTE_PREF = 21;
    public static final int NT_MODE_LTE_GSM_WCDMA_WCDMA_PREF = 20;
    public static final int NT_MODE_LTE_ONLY = 11;
    public static final int NT_MODE_LTE_WCDMA = 12;
    public static final int NT_MODE_LTE_WCDMA_LTE_PREF = 17;
    public static final int NT_MODE_LTE_WCDMA_WCDMA_PREF = 16;
    ...
    public static final String REASON_RESUMED_BY_OTHER_PHONE = "resumedByOtherPhone";
    ...
    public static final String REASON_SUSPENED_BY_OTHER_PHONE = "suspendedByOtherPhone";
    ...
    Connection dialVT(String str) throws CallStateException;

    void disableDataCall();
    ...
    IccCardApplicationStatus.AppType getCurrentUiccAppType();
