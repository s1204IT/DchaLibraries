...
public final class PduCache extends AbstractCache<Uri, PduCacheEntry> {
    ...
    public synchronized PduCacheEntry purge(Uri uri) {
        PduCacheEntry pduCacheEntryPurgeSingleEntry;
        int match = URI_MATCHER.match(uri);
        switch (match) {
            case 0:
            case 10:
                purgeAll();
                pduCacheEntryPurgeSingleEntry = null;
                break;
            case 1:
                pduCacheEntryPurgeSingleEntry = purgeSingleEntry(uri);
                break;
            case 2:
            case 4:
            case 6:
            ...
            case 9:
                ...
                pduCacheEntryPurgeSingleEntry = purgeSingleEntry(Uri.withAppendedPath(Telephony.Mms.CONTENT_URI, msgId));
                break;
            case 11:
        ...
        return pduCacheEntryPurgeSingleEntry;
    }
