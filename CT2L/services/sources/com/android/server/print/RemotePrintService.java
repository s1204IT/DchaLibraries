...
final class RemotePrintService implements IBinder.DeathRecipient {
    ...
    public void dump(PrintWriter pw, String prefix) {
        ...
        pw.append((CharSequence) prefix).append("  ").append("isDiscoveringPrinters=").append((CharSequence) String.valueOf(this.mDiscoveryPriorityList != null ? true : DEBUG)).println();
