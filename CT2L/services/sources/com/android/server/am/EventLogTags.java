...
public class EventLogTags {
    ...
    public static void writeAmOnPausedCalled(int user, String componentName) {
        EventLog.writeEvent(AM_ON_PAUSED_CALLED, Integer.valueOf(user), componentName);
    }

    public static void writeAmOnResumeCalled(int user, String componentName) {
        EventLog.writeEvent(AM_ON_RESUME_CALLED, Integer.valueOf(user), componentName);
    }
    ...
    public static void writeAmFocusedActivity(int user, String componentName) {
        EventLog.writeEvent(AM_FOCUSED_ACTIVITY, Integer.valueOf(user), componentName);
    }

    public static void writeAmHomeStackMoved(int user, int toFront, int topStackId, int focusedStackId, String reason) {
        EventLog.writeEvent(AM_HOME_STACK_MOVED, Integer.valueOf(user), Integer.valueOf(toFront), Integer.valueOf(topStackId), Integer.valueOf(focusedStackId), reason);
    }
}
