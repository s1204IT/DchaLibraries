...
final class AccessibilityController {
    ...
    private static final class DisplayMagnifier {
        ...
        private final class MagnifiedViewport {
            ...
            public MagnifiedViewport() {
                ...
                this.mBorderWidth = TypedValue.applyDimension(1, 5.0f, DisplayMagnifier.this.mContext.getResources().getDisplayMetrics());
    ...
    private static final class WindowsForAccessibilityObserver {
                    ...
                    for (int i = visibleWindowCount - 1; i >= 0; i--) {
                        ...
                        if ((flags & 16) == 0) {
                            ...
                            if (!unaccountedSpace.quickReject(boundsInScreen)) {
                                ...
                                if (unaccountedSpace.isEmpty() || (flags & 40) == 0) {
                                    break;
                                }
                            } else {
                                continue;
        ...
        private static boolean isReportedWindowType(int windowType) {
            if (windowType == 2029 || windowType == 2013 || windowType == 2021 || windowType == 2026 || windowType == 2016 || windowType == 2022 || windowType == 2018 || windowType == 2025 || windowType == 2027 || windowType == 1004 || windowType == 2015 || windowType == 2030) {
                return DEBUG;
            }
            return true;
        }
