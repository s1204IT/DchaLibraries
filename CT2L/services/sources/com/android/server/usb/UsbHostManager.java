...
public class UsbHostManager {
    ...
    public UsbHostManager(Context context) {
        ...
        this.mHostBlacklist = context.getResources().getStringArray(R.array.config_autoKeyboardBacklightDecreaseLuxThreshold);
    ...
    private void addUsbInterface(int id, String name, int altSetting, int Class, int subClass, int protocol) {
        ...
        if (this.mNewInterface.getInterfaceClass() == 14) {
            ...
            SystemProperties.set("camera.disable_zsl_mode", "1");
            Slog.i(TAG, "UVC Added");
        }
    }
        ...
        synchronized (this.mLock) {
            ...
            if (device != null) {
                ...
                while (true) {
                    ...
                    if (0 != 0 || interfaces.getInterfaceClass() != 14) {
                        intf++;
                    } else {
                        SystemProperties.set("front_camera_version", "1");
                        SystemProperties.set("camera.disable_zsl_mode", "");
                        Slog.i(TAG, "UVC Removed");
                        break;
                    }
                }
