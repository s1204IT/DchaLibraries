...
public class NetworkStatsRecorder {
    ...
    public NetworkStats.Entry getTotalSinceBootLocked(NetworkTemplate template) {
        return this.mSinceBoot.getSummary(template, Long.MIN_VALUE, JobStatus.NO_LATEST_RUNTIME).getTotal((NetworkStats.Entry) null);
    }
        ...
        if (snapshot != null) {
            ...
            for (int i = 0; i < delta.size(); i++) {
                ...
                if (ident == null) {
                    ...
                    if ((entry.tag == 0 ? DUMP_BEFORE_DELETE : false) != this.mOnlyTags) {
