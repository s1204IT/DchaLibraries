...
public class LocationFudger {
    ...
    public LocationFudger(Context context, Handler handler) {
        ...
        this.mContext.getContentResolver().registerContentObserver(Settings.Secure.getUriFor(COARSE_ACCURACY_CONFIG_NAME), D, this.mSettingsObserver);
    ...
    private Location createCoarseLocked(Location fine) {
        ...
        double lon5 = wrapLongitude(Math.round(lon4 / lonGranularity) * lonGranularity);
