...
public class SystemConfig {
        ...
        try {
            ...
            while (true) {
                ...
                if ("group".equals(name) && !onlyFeatures) {
                    ...
                    } else if (allowed && isAvailableFeatures(fname)) {
    ...
    boolean isAvailableFeatures(String fname) {
        if (Build.DEVICE.equals("TAB-A03-BR2")) {
            if ("android.hardware.location".equals(fname) || "android.hardware.location.gps".equals(fname) || "android.hardware.sensor.compass".equals(fname) || "android.hardware.sensor.gyroscope".equals(fname) || "android.hardware.sensor.light".equals(fname)) {
                return false;
            }
        } else if (Build.DEVICE.equals("TAB-A03-BR2B") && ("android.hardware.location".equals(fname) || "android.hardware.location.gps".equals(fname) || "android.hardware.sensor.light".equals(fname))) {
            return false;
        }
        return true;
    }
