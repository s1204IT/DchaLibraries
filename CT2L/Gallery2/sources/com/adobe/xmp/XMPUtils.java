...
public class XMPUtils {
    public static boolean convertToBoolean(String value) throws XMPException {
        ...
        try {
            ...
            return "true".equals(value2) || "t".equals(value2) || "on".equals(value2) || "yes".equals(value2);
        }
    }
        ...
        if (rawValue != null) {
            try {
                if (rawValue.length() != 0) {
                    return rawValue.startsWith("0x") ? Integer.parseInt(rawValue.substring(2), 16) : Integer.parseInt(rawValue);
                }
            } catch (NumberFormatException e) {
    ...
    public static long convertToLong(String rawValue) throws XMPException {
        if (rawValue != null) {
            try {
                if (rawValue.length() != 0) {
                    return rawValue.startsWith("0x") ? Long.parseLong(rawValue.substring(2), 16) : Long.parseLong(rawValue);
                }
            } catch (NumberFormatException e) {
