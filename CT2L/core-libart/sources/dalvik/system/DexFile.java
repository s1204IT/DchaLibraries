...
public final class DexFile {
    ...
    public static native byte isDexOptNeededInternal(String str, String str2, String str3, boolean z) throws IOException;
    ...
    private static Class defineClass(String name, ClassLoader loader, long cookie, List<Throwable> suppressed) {
        try {
            Class result = defineClassNative(name, loader, cookie);
            return result;
