...
class Grego {
    ...
    private static final int[] DAYS_BEFORE = {0, 31, 59, 90, Opcodes.OP_INVOKE_INTERFACE_RANGE, Opcodes.OP_XOR_INT, Opcodes.OP_AND_INT_2ADDR, Opcodes.OP_REM_INT_LIT16, Opcodes.OP_IGET_WIDE_QUICK, 273, HttpURLConnection.HTTP_NOT_MODIFIED, 334, 0, 31, 60, 91, 121, Opcodes.OP_SHL_INT, Opcodes.OP_OR_INT_2ADDR, Opcodes.OP_AND_INT_LIT16, Opcodes.OP_IGET_OBJECT_QUICK, 274, HttpURLConnection.HTTP_USE_PROXY, 335};
