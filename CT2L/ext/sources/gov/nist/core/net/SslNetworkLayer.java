...
public class SslNetworkLayer implements NetworkLayer {
    ...
    public SslNetworkLayer(String trustStoreFile, String keyStoreFile, char[] keyStorePassword, String keyStoreType) throws GeneralSecurityException, IOException {
    ...
    public Socket createSocket(InetAddress address, int port, InetAddress myAddress) throws IOException {
        return myAddress != null ? new Socket(address, port, myAddress, 0) : new Socket(address, port);
    }
