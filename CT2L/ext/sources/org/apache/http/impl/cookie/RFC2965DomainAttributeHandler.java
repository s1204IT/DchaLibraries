...
public class RFC2965DomainAttributeHandler implements CookieAttributeHandler {
    ...
    public void parse(SetCookie cookie, String domain) throws MalformedCookieException {
        ...
        if (!domain2.startsWith(Separators.DOT)) {
            domain2 = '.' + domain2;
        }
    ...
    public void validate(Cookie cookie, CookieOrigin origin) throws MalformedCookieException {
        ...
        if ((cookie instanceof ClientCookie) && ((ClientCookie) cookie).containsAttribute("domain")) {
            if (!cookieDomain.startsWith(Separators.DOT)) {
        ...
        if (!cookie.getDomain().equals(host)) {
            throw new MalformedCookieException("Illegal domain attribute: \"" + cookie.getDomain() + "\".Domain of origin: \"" + host + Separators.DOUBLE_QUOTE);
        }
    }
