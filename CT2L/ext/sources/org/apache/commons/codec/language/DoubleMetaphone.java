...
public class DoubleMetaphone implements StringEncoder {
    ...
    private int handleG(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
        ...
        if ((contains(value, index + 1, 2, "ER") || charAt(value, index + 1) == 'Y') && !contains(value, 0, 6, "DANGER", "RANGER", "MANGER") && !contains(value, index - 1, 1, TokenNames.E, TokenNames.I) && !contains(value, index - 1, 3, "RGY", "OGY")) {
            result.append('K', 'J');
            return index + 2;
        }
        if (contains(value, index + 1, 1, TokenNames.E, TokenNames.I, "Y") || contains(value, index - 1, 4, "AGGI", "OGGI")) {
    ...
    private int handleS(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
        ...
        if ((index == 0 && contains(value, index + 1, 1, TokenNames.M, "N", TokenNames.L, "W")) || contains(value, index + 1, 1, "Z")) {
            result.append('S', 'X');
        ...
        return contains(value, index + 1, 1, TokenNames.S, "Z") ? index + 2 : index + 1;
    }
    ...
    private int handleT(String value, DoubleMetaphoneResult result, int index) {
        ...
        result.append('T');
        return contains(value, index + 1, 1, TokenNames.T, "D") ? index + 2 : index + 1;
    }
    ...
    private int handleX(String value, DoubleMetaphoneResult result, int index) {
        ...
        return contains(value, index + 1, 1, TokenNames.C, TokenNames.X) ? index + 2 : index + 1;
    }
    ...
    private boolean conditionL0(String value, int index) {
        ...
        return (contains(value, index + (-1), 2, "AS", "OS") || contains(value, value.length() + (-1), 1, "A", TokenNames.O)) && contains(value, index + (-1), 4, "ALLE");
    }
