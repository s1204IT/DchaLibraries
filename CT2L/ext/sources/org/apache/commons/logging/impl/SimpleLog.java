...
public class SimpleLog implements Log, Serializable {
    ...
    private static String getStringProperty(String name) {
        ...
        String prop2 = simpleLogProps.getProperty(name);
        return prop2;
    }
    ...
    public SimpleLog(String name) {
        ...
        int i = String.valueOf(name).lastIndexOf(Separators.DOT);
        while (lvl == null && i > -1) {
            name = name.substring(0, i);
            lvl = getStringProperty("org.apache.commons.logging.simplelog.log." + name);
            i = String.valueOf(name).lastIndexOf(Separators.DOT);
        }
        ...
        if (ParameterNames.INFO.equalsIgnoreCase(lvl)) {
            setLevel(3);
            return;
        }
    ...
    protected void log(int type, Object message, Throwable t) {
        ...
        if (t != null) {
            ...
            StringWriter sw = new StringWriter(HTMLModels.M_HEAD);
