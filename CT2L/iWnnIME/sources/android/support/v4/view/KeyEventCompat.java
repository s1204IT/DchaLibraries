...
public class KeyEventCompat {
    ...
    static class BaseKeyEventVersionImpl implements KeyEventVersionImpl {
        ...
        public int normalizeMetaState(int metaState) {
            ...
            return metaState & IWnnServiceConnector.PSEUDO_TYPE_HAN_YOMI2DATE_MMDD;
        }

        @Override
        public boolean metaStateHasModifiers(int metaState, int modifiers) {
            return metaStateFilterDirectionalModifiers(metaStateFilterDirectionalModifiers(normalizeMetaState(metaState) & IWnnServiceConnector.PSEUDO_TYPE_HAN_YOMI2DATE_MMDD, modifiers, 1, 64, 128), modifiers, 2, 16, 32) == modifiers;
        }

        @Override
        public boolean metaStateHasNoModifiers(int metaState) {
            return (normalizeMetaState(metaState) & IWnnServiceConnector.PSEUDO_TYPE_HAN_YOMI2DATE_MMDD) == 0;
        }
