    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8 && (lp2 = (LayoutParams) child.getLayoutParams()) != null && lp2.isDecor) {
                ...
                int vgrav = lp2.gravity & IWnnImeBase.ENGINE_MODE_OPT_TYPE_50KEY;
        ...
        switch (action & 255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    velocityTracker.computeCurrentVelocity(IWnnSymbolEngine.MAX_ITEM_IN_PAGE, this.mMaximumVelocity);
