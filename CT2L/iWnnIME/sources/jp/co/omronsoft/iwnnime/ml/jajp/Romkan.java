...
public class Romkan implements LetterConverter {
    ...
    private static final HashMap<String, String> romkanTable = new HashMap<String, String>() {
        {
            ...
            put("ltu", "っ");
            put("xtu", "っ");
            put(LoggingEvents.EXTRA_CALLING_APP_NAME, "っ");
            put("tsu", "つ");
            put("tu", "つ");
            put("tsa", "つぁ");
            put("tsi", "つぃ");
            ...
            put("-", "ー");
            put(".", "。");
            put(iWnnEngine.DECO_OPERATION_SEPARATOR, "、");
            put("?", "？");
            put("/", "・");
            put("@", "＠");
            put("#", "＃");
    ...
    public boolean convert(ComposingText text) {
        ...
        while (start < 4) {
            ...
            String match = romkanTable.get(iWnnEngine.getEngine().toLowerCase(key.toString()));
            if (match != null) {
                if (upper) {
                    match = iWnnEngine.getEngine().toUpperCase(match);
                }
                if (match.length() == 1) {
