...
public class MultiChoicePreference extends DialogPreference {
    ...
    public MultiChoicePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, new int[]{R.attr.entries, R.attr.entryValues}, 0, 0);
            ...
            if (sharedPref != null) {
                ...
                builder.setMultiChoiceItems(this.mEntries, this.mChecked, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        MultiChoicePreference.this.onMultiChoiceItemsClick(dialog, which, isChecked);
                    }
                });
            }
        }
    ...
    public void setChecked(int which, boolean isChecked) {
