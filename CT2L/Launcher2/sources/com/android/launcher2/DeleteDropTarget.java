...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    public void onDragStart(DragSource source, Object info, int dragAction) {
        ...
        if (isAllAppsApplication(source, info)) {
            ...
            if (userManager.hasUserRestriction("no_control_apps") || userManager.hasUserRestriction("no_uninstall_apps")) {
                isVisible = false;
            }
        }
        if (isUninstall) {
    ...
    private static class FlingAlongVectorAnimatorUpdateListener implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            if (!this.mHasOffsetForScale) {
                ...
                this.mFrom.left = (int) (r7.left + xOffset);
                this.mFrom.top = (int) (r7.top + yOffset);
            }
            this.mFrom.left = (int) (r7.left + ((this.mVelocity.x * (curTime - this.mPrevTime)) / 1000.0f));
            this.mFrom.top = (int) (r7.top + ((this.mVelocity.y * (curTime - this.mPrevTime)) / 1000.0f));
