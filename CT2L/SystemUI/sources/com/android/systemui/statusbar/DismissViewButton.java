...
public class DismissViewButton extends Button {
    ...
    public DismissViewButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mAnimatedDismissDrawable = (AnimatedVectorDrawable) getContext().getResources().getDrawable(R.drawable.dismiss_all_shape_animation).mutate();
        ...
        this.mStaticDismissDrawable = getContext().getResources().getDrawable(R.drawable.dismiss_all_shape);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.translate(dx, (getHeight() / 2.0f) + (drawableHeight / 2.0f));
    ...
    protected boolean verifyDrawable(Drawable who) {
        return super.verifyDrawable(who) || who == this.mAnimatedDismissDrawable || who == this.mStaticDismissDrawable;
    }
