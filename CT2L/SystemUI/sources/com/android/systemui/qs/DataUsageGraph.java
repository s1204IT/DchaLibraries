...
public class DataUsageGraph extends View {
    ...
    public DataUsageGraph(Context context, AttributeSet attrs) {
        ...
        this.mTrackColor = res.getColor(R.color.data_usage_graph_track);
        this.mUsageColor = res.getColor(R.color.system_accent_color);
        this.mOverlimitColor = res.getColor(R.color.system_warning_color);
        this.mWarningColor = res.getColor(R.color.data_usage_graph_warning);
