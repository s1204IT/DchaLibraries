...
public class TaskViewThumbnail extends View {
    ...
    public TaskViewThumbnail(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mThumbnailAlphaUpdateListener = new ValueAnimator.AnimatorUpdateListener() {
            @Override
    ...
    void setThumbnail(Bitmap bm) {
        if (bm != null) {
            ...
            this.mBitmapRect.set(0.0f, 0.0f, bm.getWidth(), bm.getHeight());
            updateThumbnailScale();
        } else {
    ...
    void updateClipToTaskBar(View taskBar) {
        ...
        int top = (int) Math.max(0.0f, (taskBar.getTranslationY() + taskBar.getMeasuredHeight()) - 1.0f);
        this.mClipRect.set(0, top, getMeasuredWidth(), getMeasuredHeight());
    ...
    void startFadeAnimation(float finalAlpha, int delay, int duration, final Runnable postAnimRunnable) {
        ...
        this.mThumbnailAlphaAnimator = ValueAnimator.ofFloat(this.mThumbnailAlpha, finalAlpha);
        this.mThumbnailAlphaAnimator.setStartDelay(delay);
        this.mThumbnailAlphaAnimator.setDuration(duration);
