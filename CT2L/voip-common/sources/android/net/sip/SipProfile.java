...
public class SipProfile implements Parcelable, Serializable, Cloneable {
    ...
    public static class Builder {
        ...
        public Builder(String uriString) throws ParseException {
            ...
            try {
                ...
                SipURI sipURICreateURI = this.mAddressFactory.createURI(fix(uriString));
        ...
        public SipProfile build() {
            ...
            try {
                if (TextUtils.isEmpty(this.mProxyAddress)) {
                    ...
                    SipURI uri = this.mAddressFactory.createURI(fix(this.mProxyAddress));
    ...
    public String getUriString() {
        return !TextUtils.isEmpty(this.mProxyAddress) ? "sip:" + getUserName() + "@" + this.mDomain : getUri().toString();
    }
