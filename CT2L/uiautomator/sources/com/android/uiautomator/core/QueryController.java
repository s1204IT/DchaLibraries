...
class QueryController {
    ...
    protected AccessibilityNodeInfo findAccessibilityNodeInfo(UiSelector selector, boolean isCounting) {
        AccessibilityNodeInfo accessibilityNodeInfoTranslateCompoundSelector;
        this.mUiAutomatorBridge.waitForIdle();
        initializeNewSearch();
        if (DEBUG) {
        ...
        synchronized (this.mLock) {
            ...
            if (rootNode == null) {
                ...
                accessibilityNodeInfoTranslateCompoundSelector = null;
            } else {
                UiSelector uiSelector = new UiSelector(selector);
                accessibilityNodeInfoTranslateCompoundSelector = translateCompoundSelector(uiSelector, rootNode, isCounting);
            }
        }
        return accessibilityNodeInfoTranslateCompoundSelector;
    }
