...
public class UiSelector {
    ...
    boolean isLeaf() {
        return this.mSelectorAttributes.indexOfKey(SELECTOR_CHILD) < 0 && this.mSelectorAttributes.indexOfKey(SELECTOR_PARENT) < 0;
    }

    boolean hasChildSelector() {
        return this.mSelectorAttributes.indexOfKey(SELECTOR_CHILD) >= 0;
    }

    boolean hasPatternSelector() {
        return this.mSelectorAttributes.indexOfKey(SELECTOR_PATTERN) >= 0;
    }

    boolean hasContainerSelector() {
        return this.mSelectorAttributes.indexOfKey(SELECTOR_CONTAINER) >= 0;
    }

    boolean hasParentSelector() {
        return this.mSelectorAttributes.indexOfKey(SELECTOR_PARENT) >= 0;
    }
    ...
    private UiSelector getLastSubSelector() {
        ...
        return parent.getLastSubSelector() == null ? parent : parent.getLastSubSelector();
    }
