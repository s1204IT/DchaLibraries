...
public class DayOfMonthDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int textHeight = this.mTextBounds.bottom - this.mTextBounds.top;
        Rect bounds = getBounds();
        canvas.drawText(this.mDayOfMonth, bounds.right / 2, ((bounds.bottom + textHeight) + 1.0f) / 2.0f, this.mPaint);
    }
    ...
    public void setDayOfMonth(int day) {
        this.mDayOfMonth = Integer.toString(day);
        invalidateSelf();
    }
}
