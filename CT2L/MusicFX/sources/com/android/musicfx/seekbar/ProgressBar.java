...
public class ProgressBar extends View {
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyle, int styleRes) {
        ...
        initProgressBar();
        TypedArray a = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.ProgressBar, defStyle, styleRes);
        ...
        this.mAnimationResolution = a.getInteger(14, 200);
        a.recycle();
    }
