...
public class WifiP2pSettings extends SettingsPreferenceFragment implements WifiP2pManager.PeerListListener, WifiP2pManager.PersistentGroupInfoListener {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.net.wifi.p2p.CONNECTION_STATE_CHANGE".equals(action)) {
                if (WifiP2pSettings.this.mWifiP2pManager != null) {
                    ...
                    if (!networkInfo.isConnected() && !WifiP2pSettings.this.mLastGroupFormed) {
    ...
    public Dialog onCreateDialog(int id) {
        ...
        if (id == 1) {
            ...
            return new AlertDialog.Builder(getActivity()).setTitle(R.string.wifi_p2p_disconnect_title).setMessage(msg).setPositiveButton(getActivity().getString(R.string.dlg_ok), this.mDisconnectListener).setNegativeButton(getActivity().getString(R.string.dlg_cancel), (DialogInterface.OnClickListener) null).create();
        }
        if (id == 2) {
