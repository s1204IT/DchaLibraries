...
public class FileItemInfoLayout extends RelativeLayout implements Checkable {
    private static final int sLengthExternalStorageDirPrefix = new Environment.UserEnvironment(UserHandle.myUserId()).getExternalStorageDirectory().getAbsolutePath().length() + 1;
