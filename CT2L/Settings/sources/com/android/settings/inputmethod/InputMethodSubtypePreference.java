...
class InputMethodSubtypePreference extends SwitchWithNoTextPreference {
    ...
    InputMethodSubtypePreference(Context context, InputMethodSubtype subtype, InputMethodInfo imi) {
        ...
        CharSequence subtypeLabel = subtype.getDisplayName(context, imi.getPackageName(), imi.getServiceInfo().applicationInfo);
        ...
        if (TextUtils.isEmpty(subtypeLocaleString)) {
            ...
            this.mIsSystemLanguage = this.mIsSystemLocale || InputMethodUtils.getLanguageFromLocaleString(subtypeLocaleString).equals(systemLocale.getLanguage());
        }
    }
