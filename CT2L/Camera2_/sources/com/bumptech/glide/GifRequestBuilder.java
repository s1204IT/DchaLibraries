...
public class GifRequestBuilder<ModelType, TranscodeType> extends GenericRequestBuilder<ModelType, InputStream, GifData, TranscodeType> {
    private Glide glide;

    GifRequestBuilder(Context context, ModelType model, LoadProvider<ModelType, InputStream, GifData, TranscodeType> loadProvider, Class<TranscodeType> transcodeClass, Glide glide, RequestTracker requestTracker) {
        super(context, model, loadProvider, transcodeClass, glide, requestTracker);
        this.glide = glide;
    }

    @Override
    public GifRequestBuilder<ModelType, TranscodeType> thumbnail(GenericRequestBuilder<ModelType, InputStream, GifData, TranscodeType> genericRequestBuilder) {
        super.thumbnail((GenericRequestBuilder) genericRequestBuilder);
        return this;
    }

    public GifRequestBuilder<ModelType, TranscodeType> thumbnail(GifRequestBuilder<ModelType, TranscodeType> thumbnailRequest) {
    ...
    @Override
    public GifRequestBuilder<ModelType, TranscodeType> decoder(ResourceDecoder<InputStream, GifData> resourceDecoder) {
        super.decoder((ResourceDecoder) resourceDecoder);
        return this;
    }

    @Override
    public GifRequestBuilder<ModelType, TranscodeType> cacheDecoder(ResourceDecoder<InputStream, GifData> resourceDecoder) {
        super.cacheDecoder((ResourceDecoder) resourceDecoder);
        return this;
    }

    @Override
    public GifRequestBuilder<ModelType, TranscodeType> encoder(ResourceEncoder<GifData> resourceEncoder) {
    ...
    public GifRequestBuilder<ModelType, TranscodeType> fitCenter() {
        return transformBitmap(new FitCenter(this.glide.getBitmapPool()));
    }

    public GifRequestBuilder<ModelType, TranscodeType> centerCrop() {
        return transformBitmap(new CenterCrop(this.glide.getBitmapPool()));
    }

    public GifRequestBuilder<ModelType, TranscodeType> transformBitmap(Transformation<Bitmap> bitmapTransformation) {
        return transform((Transformation<GifData>) new GifDataTransformation(bitmapTransformation));
    }
    ...
    @Override
    public GifRequestBuilder<ModelType, TranscodeType> transcoder(ResourceTranscoder<GifData, TranscodeType> resourceTranscoder) {
    ...
    @Override
    public GifRequestBuilder<ModelType, TranscodeType> listener(RequestListener<ModelType, TranscodeType> requestListener) {
    ...
    @Override
    public GifRequestBuilder<ModelType, TranscodeType> sourceEncoder(Encoder<InputStream> encoder) {
