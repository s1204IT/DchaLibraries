...
class CameraActions {
    ...
    public static final int GET_REGISTER = 802;
    ...
    public static final int SET_ISP_INFO_LISTENER = 901;
    ...
    public static final int SET_REGISTER = 801;
    public static final int SET_SCENE_DETECTION_LISTENER = 701;
    ...
    public static final int UPDATE_CAPABILITIES = 902;
