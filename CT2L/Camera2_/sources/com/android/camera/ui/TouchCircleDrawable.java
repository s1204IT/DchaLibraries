...
public class TouchCircleDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (w != -1 && h != -1 && this.mCenter != null) {
            ...
            canvas.drawCircle(this.mCenter.x, this.mCenter.y, this.mColorRadius, this.mColorPaint);
    ...
    public void animate() {
        ...
        ValueAnimator colorAnimator = ValueAnimator.ofInt(0, Math.min(this.mW / 2, this.mH / 2));
