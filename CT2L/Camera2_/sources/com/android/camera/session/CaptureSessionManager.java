...
public interface CaptureSessionManager {
    ...
    void saveImage(byte[] bArr, String str, long j, Location location, int i, int i2, int i3, ExifInterface exifInterface, MediaSaver.OnMediaSavedListener onMediaSavedListener);
}
