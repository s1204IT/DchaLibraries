...
public class XPathParser {
    ...
    private final boolean lookahead(String s, int n) {
        ...
        boolean isToken = lookahead.equals(s);
        return isToken;
    }
    ...
    private final String getTokenRelative(int i) {
        ...
        if (relative > 0 && relative < this.m_ops.getTokenQueueSize()) {
            String tok = (String) this.m_ops.m_tokenQueue.elementAt(relative);
            return tok;
        }
        return null;
    }
    ...
    protected boolean PrimaryExpr() throws TransformerException {
        ...
        if (lookahead('(', 1) || (lookahead(':', 1) && lookahead('(', 3))) {
            boolean matchFound = FunctionCall();
            return matchFound;
        }
        return false;
    }
