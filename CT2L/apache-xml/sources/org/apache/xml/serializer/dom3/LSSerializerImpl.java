...
public final class LSSerializerImpl implements DOMConfiguration, LSSerializer {
    ...
    public void setParameter(String name, Object value) throws DOMException {
        if (value instanceof Boolean) {
            ...
            String msg4 = Utils.messages.createMessage("FEATURE_NOT_FOUND", new Object[]{name});
            throw new DOMException((short) 8, msg4);
        }
        if (name.equalsIgnoreCase(DOMConstants.DOM_ERROR_HANDLER)) {
            if (value == null || (value instanceof DOMErrorHandler)) {
                ...
                String msg5 = Utils.messages.createMessage(MsgKey.ER_TYPE_MISMATCH_ERR, new Object[]{name});
        ...
        if (name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_LOCATION) || name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_TYPE)) {
            if (value != null) {
                if (!(value instanceof String)) {
                    String msg6 = Utils.messages.createMessage(MsgKey.ER_TYPE_MISMATCH_ERR, new Object[]{name});
