...
public final class Messages {
    ...
    public final String createMessage(String msgKey, Object[] args) {
        ...
        return this.m_resourceBundle != null ? createMsg(this.m_resourceBundle, msgKey, args) : "Could not load the resource bundles: " + this.m_resourceBundleName;
    }
    ...
    private final String createMsg(ListResourceBundle fResourceBundle, String msgKey, Object[] args) {
        ...
        if (msg == null) {
            ...
            try {
                ...
                String str = "The message key '" + msgKey + "' is not in the message class '" + this.m_resourceBundleName + "'";
            }
        } else if (args != null) {
            try {
                int n = args.length;
