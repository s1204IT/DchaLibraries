...
public class ObjectPool implements Serializable {
    ...
    public synchronized Object getInstanceIfFree() {
        return !this.freeStack.isEmpty() ? this.freeStack.remove(this.freeStack.size() - 1) : null;
    }
