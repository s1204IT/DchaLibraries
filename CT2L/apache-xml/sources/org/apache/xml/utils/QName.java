...
public class QName implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (getLocalName().equals(qname.getLocalName())) {
            ...
            } else if (thisnamespace.equals(thatnamespace)) {
                return true;
            }
        }
        return false;
    ...
    public static boolean isXMLNSDecl(String attRawName) {
        return attRawName.startsWith("xmlns") && (attRawName.equals("xmlns") || attRawName.startsWith(org.apache.xalan.templates.Constants.ATTRNAME_XMLNS));
    }
