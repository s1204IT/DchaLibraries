...
public class QuickResponseUtils {
    public static void maybeMigrateLegacyQuickResponses(Context context) {
        ...
        if (sharedPreferences.contains("canned_response_pref_1")) {
            Log.d("QuickResponseUtils", "maybeMigrateLegacyQuickResponses() - Telecom QuickResponses exist", new Object[0]);
            return;
        }
        String string = resources.getString(R.string.respond_via_sms_canned_response_1);
        String string2 = resources.getString(R.string.respond_via_sms_canned_response_2);
        String string3 = resources.getString(R.string.respond_via_sms_canned_response_3);
        String string4 = resources.getString(R.string.respond_via_sms_canned_response_4);
        ...
        try {
            ...
            Log.e("QuickResponseUtils", (Throwable) e, "maybeMigrateLegacyQuickResponses() - Can't find Telephony package.", new Object[0]);
        ...
        if (contextCreatePackageContext != null) {
            ...
            string = sharedPreferences2.getString("canned_response_pref_1", string);
            string2 = sharedPreferences2.getString("canned_response_pref_2", string2);
            string3 = sharedPreferences2.getString("canned_response_pref_3", string3);
            string4 = sharedPreferences2.getString("canned_response_pref_4", string4);
        }
