...
public class PageDialogsHandler {
    ...
    private AlertDialog.Builder createSslCertificateDialog(SslCertificate sslCertificate, SslError sslError) {
        ...
        if (sslError == null) {
            ((TextView) ((LinearLayout) layoutInflaterFrom.inflate(2130968624, linearLayout)).findViewById(2131558517)).setText(android.R.string.mediasize_iso_b2);
            i = 2130837548;
        } else {
        ...
        return new AlertDialog.Builder(this.mContext).setTitle(android.R.string.mediasize_iso_b10).setIcon(i).setView(viewInflateCertificateView);
    }
