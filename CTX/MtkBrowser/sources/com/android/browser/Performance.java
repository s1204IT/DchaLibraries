...
public class Performance {
    ...
    static boolean checkShouldReleaseTabs(int i, ArrayList<Integer> arrayList, boolean z, String str, CopyOnWriteArrayList<Integer> copyOnWriteArrayList, boolean z2) {
        ...
        synchronized (mLock) {
            ...
            if (Math.max(memInfoReader.getFreeSize(), memInfoReader.getCachedSize()) >= mVisibleAppThreshold) {
                ...
                if (str3 == null || !str3.equals("1") ? totalPss <= 0.4000000059604645d || i <= 5 || !z : totalPss <= 0.30000001192092896d || i <= 3 || !z) {
                }
            }
        }
        return z3;
    ...
    static void printSysMemInfo(ActivityManager.MemoryInfo memoryInfo, String str) {
        if (memoryInfo != null) {
            ...
            sb.append("{\r\n");
            sb.append(str);
            sb.append("    \"System Memory Usage (MB)\": {\r\n");
            sb.append(str);
            sb.append(String.format("                total=: %.2f,\r\n", Double.valueOf((j / 1024.0d) / 1024.0d)));
            sb.append(str);
            sb.append(String.format("                threshold=: %.2f,\r\n", Double.valueOf((j2 / 1024.0d) / 1024.0d)));
            sb.append(str);
            sb.append(String.format("                availMem=: %.2f,\r\n", Double.valueOf((j3 / 1024.0d) / 1024.0d)));
            sb.append(str);
            sb.append(String.format("                hiddenAppThreshold=: %.2f,\r\n", Double.valueOf((j4 / 1024.0d) / 1024.0d)));
            sb.append(str);
            sb.append(String.format("                secondaryServerThreshold=: %.2f,\r\n", Double.valueOf((j5 / 1024.0d) / 1024.0d)));
            sb.append(str);
            sb.append(String.format("                visibleAppThreshold=: %.2f,\r\n", Double.valueOf((j6 / 1024.0d) / 1024.0d)));
            sb.append(str);
            sb.append(String.format("                foregroundAppThreshold=: %.2f,\r\n", Double.valueOf((j7 / 1024.0d) / 1024.0d)));
