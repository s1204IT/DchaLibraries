...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = 8388613 | (this.mButtonGravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = 8388611 | (this.mButtonGravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            if (!layoutTitle || this.mTitleTextView.getMeasuredWidth() <= 0) {
                ...
                width = width2;
                int width3 = this.mGravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
                ...
                if (isRtl) {
                    ...
                    if (layoutSubtitle) {
                        ...
                        int subtitleRight2 = this.mSubtitleTextView.getMeasuredWidth() + subtitleLeft2;
                    ...
                    if (titleHasWidth) {
                        left3 = Math.max(titleLeft2, subtitleLeft2);
                    }
                }
            }
        } else {
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (vgrav == 16 || vgrav == 48 || vgrav == 80) {
            return vgrav;
        }
        return this.mGravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (expandedActionParent != Toolbar.this) {
                ...
                lp.gravity = 8388611 | (Toolbar.this.mButtonGravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay);
                lp.mViewType = 2;
