...
public class StatusBarSignalPolicy implements NetworkController.SignalCallback, SecurityController.SecurityControllerCallback, TunerService.Tunable, ISystemUIStatusBarExt.StatusBarCallback {
    ...
    public StatusBarSignalPolicy(Context context, StatusBarIconController statusBarIconController) {
        ...
        this.mSlotAirplane = this.mContext.getString(R.string.mediasize_iso_b3);
        this.mSlotMobile = this.mContext.getString(R.string.mediasize_iso_c7);
        this.mSlotWifi = this.mContext.getString(R.string.mediasize_japanese_jis_b5);
        this.mSlotEthernet = this.mContext.getString(R.string.mediasize_iso_c10);
        this.mSlotVpn = this.mContext.getString(R.string.mediasize_japanese_jis_b4);
