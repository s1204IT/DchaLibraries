...
public class PhoneStatusBarPolicy implements CommandQueue.Callbacks, BluetoothController.Callback, DataSaverController.Listener, DeviceProvisionedController.DeviceProvisionedListener, KeyguardMonitor.Callback, LocationController.LocationChangeCallback, RotationLockController.RotationLockControllerCallback, ZenModeController.Callback {
    ...
    public PhoneStatusBarPolicy(Context context, StatusBarIconController statusBarIconController) {
        ...
        this.mSlotCast = context.getString(R.string.mediasize_iso_b7);
        this.mSlotHotspot = context.getString(R.string.mediasize_iso_c3);
        this.mSlotBluetooth = context.getString(R.string.mediasize_iso_b6);
        this.mSlotTty = context.getString(R.string.mediasize_japanese_jis_b2);
        this.mSlotZen = context.getString(R.string.mediasize_japanese_jis_b6);
        this.mSlotVolume = context.getString(R.string.mediasize_japanese_jis_b3);
        this.mSlotAlarmClock = context.getString(R.string.mediasize_iso_b4);
        this.mSlotManagedProfile = context.getString(R.string.mediasize_iso_c6);
        this.mSlotRotate = context.getString(R.string.mediasize_japanese_chou4);
        this.mSlotHeadset = context.getString(R.string.mediasize_iso_c2);
        this.mSlotDataSaver = context.getString(R.string.mediasize_iso_c1);
        this.mSlotLocation = context.getString(R.string.mediasize_iso_c5);
