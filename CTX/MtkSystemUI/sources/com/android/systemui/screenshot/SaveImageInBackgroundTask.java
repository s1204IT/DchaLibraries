...
class SaveImageInBackgroundTask extends AsyncTask<Void, Void, Void> {
    ...
    public Void doInBackground(Void... voidArr) {
        ...
        try {
            ...
            intent.addFlags(1);
            this.mNotificationBuilder.addAction(new Notification.Action.Builder(R.drawable.ic_screenshot_share, resources.getString(android.R.string.lockscreen_transport_stop_description), PendingIntent.getBroadcast(context, 0, new Intent(context, (Class<?>) GlobalScreenshot.ScreenshotActionReceiver.class).putExtra("android:screenshot_sharing_intent", intent), 268435456)).build());
            Intent intent2 = new Intent("android.intent.action.EDIT");
            intent2.setType("image/png");
            intent2.setData(uriInsert);
            intent2.addFlags(1);
            intent2.addFlags(2);
            this.mNotificationBuilder.addAction(new Notification.Action.Builder(R.drawable.ic_screenshot_edit, resources.getString(android.R.string.lockscreen_glogin_instructions), PendingIntent.getBroadcast(context, 1, new Intent(context, (Class<?>) GlobalScreenshot.ScreenshotActionReceiver.class).putExtra("android:screenshot_sharing_intent", intent2), 268435456)).build());
