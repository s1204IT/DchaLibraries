...
public abstract class PreferenceFragment extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args != null) {
            string = getArguments().getString(ARG_PREFERENCE_ROOT);
        } else {
            string = null;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = this.mStyledContext.obtainStyledAttributes(null, R$styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, R$attr.preferenceFragmentStyle, R.attr.preferenceFragmentStyle), 0);
    ...
    private class DividerDecoration extends RecyclerView.ItemDecoration {
        ...
        DividerDecoration(PreferenceFragment this$0, DividerDecoration dividerDecoration) {
            this();
        }
