...
public class ListPopupWindow implements ShowableListMenu {
    ...
    private final PopupTouchInterceptor mTouchInterceptor = new PopupTouchInterceptor(this, 0 == true ? 1 : 0);
    private final PopupScrollListener mScrollListener = new PopupScrollListener(this, 0 == true ? 1 : 0);
    private final ListSelectorHider mHideSelector = new ListSelectorHider(this, 0 == true ? 1 : 0);
    ...
    public void setAdapter(@Nullable ListAdapter adapter) {
        PopupDataSetObserver popupDataSetObserver = null;
        if (this.mObserver == null) {
            this.mObserver = new PopupDataSetObserver(this, popupDataSetObserver);
    ...
    private class PopupDataSetObserver extends DataSetObserver {
        PopupDataSetObserver(ListPopupWindow this$0, PopupDataSetObserver popupDataSetObserver) {
            this();
        }
    ...
    private class ListSelectorHider implements Runnable {
        ListSelectorHider(ListPopupWindow this$0, ListSelectorHider listSelectorHider) {
            this();
        }
    ...
    private class ResizePopupRunnable implements Runnable {
        ResizePopupRunnable(ListPopupWindow this$0, ResizePopupRunnable resizePopupRunnable) {
            this();
        }
    ...
    private class PopupTouchInterceptor implements View.OnTouchListener {
        PopupTouchInterceptor(ListPopupWindow this$0, PopupTouchInterceptor popupTouchInterceptor) {
            this();
        }
    ...
    private class PopupScrollListener implements AbsListView.OnScrollListener {
        PopupScrollListener(ListPopupWindow this$0, PopupScrollListener popupScrollListener) {
            this();
        }
