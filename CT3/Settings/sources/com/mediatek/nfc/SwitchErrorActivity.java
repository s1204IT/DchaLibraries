...
public class SwitchErrorActivity extends AlertActivity {
    ...
    private void showErrorDialog(String errorMode) {
        ...
        p.mTitle = getString(com.android.settings.R.string.card_emulation_switch_error_title);
        p.mMessage = getString(com.android.settings.R.string.card_emulation_switch_error_message, new Object[]{errorMode});
    ...
    private void showNotSupportDialog(String simDescription) {
        ...
        p.mIconId = R.drawable.ic_dialog_alert;
        p.mTitle = getString(com.android.settings.R.string.card_emulation_switch_error_title);
        p.mMessage = getString(com.android.settings.R.string.card_emulation_sim_not_supported_message, new Object[]{simDescription});
        p.mPositiveButtonText = getString(R.string.ok);
        setupAlert();
    }
    ...
    private void showTwoSimNotSupportDialog() {
        ...
        p.mIconId = R.drawable.ic_dialog_alert;
        p.mTitle = getString(com.android.settings.R.string.card_emulation_switch_error_title);
        p.mMessage = getString(com.android.settings.R.string.card_emulation_two_sim_not_supported_message);
        p.mPositiveButtonText = getString(R.string.ok);
        setupAlert();
    }
}
