    ...
    void refreshUi(boolean dataChanged) {
        ...
        synchronized (this.mState.mLock) {
            ...
            if (this.mCurShowCached) {
                ...
                medRam = (long) (this.mState.mBackgroundProcessMemory + ((this.mState.mBackgroundProcessSwapMemory * 1.0f) / zramCompressRatio));
            } else {
                lowRam = (long) (this.mMemInfoReader.getFreeSize() + this.mMemInfoReader.getCachedSize() + this.mState.mBackgroundProcessMemory + extraAvailableSize + ((this.mState.mBackgroundProcessSwapMemory * 1.0f) / zramCompressRatio));
