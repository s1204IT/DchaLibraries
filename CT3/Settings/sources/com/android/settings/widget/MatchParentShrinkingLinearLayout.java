...
public class MatchParentShrinkingLinearLayout extends ViewGroup {
    ...
    @ViewDebug.ExportedProperty(category = "measurement", flagMapping = {@ViewDebug.FlagToString(equals = -1, mask = -1, name = "NONE"), @ViewDebug.FlagToString(equals = DefaultWfcSettingsExt.RESUME, mask = DefaultWfcSettingsExt.RESUME, name = "NONE"), @ViewDebug.FlagToString(equals = 48, mask = 48, name = "TOP"), @ViewDebug.FlagToString(equals = 80, mask = 80, name = "BOTTOM"), @ViewDebug.FlagToString(equals = DefaultWfcSettingsExt.DESTROY, mask = DefaultWfcSettingsExt.DESTROY, name = "LEFT"), @ViewDebug.FlagToString(equals = 5, mask = 5, name = "RIGHT"), @ViewDebug.FlagToString(equals = 8388611, mask = 8388611, name = "START"), @ViewDebug.FlagToString(equals = 8388613, mask = 8388613, name = "END"), @ViewDebug.FlagToString(equals = 16, mask = 16, name = "CENTER_VERTICAL"), @ViewDebug.FlagToString(equals = 112, mask = 112, name = "FILL_VERTICAL"), @ViewDebug.FlagToString(equals = DefaultWfcSettingsExt.PAUSE, mask = DefaultWfcSettingsExt.PAUSE, name = "CENTER_HORIZONTAL"), @ViewDebug.FlagToString(equals = 7, mask = 7, name = "FILL_HORIZONTAL"), @ViewDebug.FlagToString(equals = 17, mask = 17, name = "CENTER"), @ViewDebug.FlagToString(equals = 119, mask = 119, name = "FILL"), @ViewDebug.FlagToString(equals = 8388608, mask = 8388608, name = "RELATIVE")}, formatToHexString = true)
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
            ...
            for (int i3 = 0; i3 < count; i3++) {
                ...
                if (child3.getVisibility() != 8) {
                    ...
                    boolean matchWidthLocally2 = widthMode != 1073741824 && lp3.width == -1;
