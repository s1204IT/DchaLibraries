...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
    ...
    private static final StateTracker sBluetoothState = new BluetoothStateTracker(0 == true ? 1 : 0);
    private static final StateTracker sLocationState = new LocationStateTracker(0 == true ? 1 : 0);
    private static final StateTracker sSyncState = new SyncStateTracker(0 == true ? 1 : 0);
    ...
    private static final class BluetoothStateTracker extends StateTracker {
        BluetoothStateTracker(BluetoothStateTracker bluetoothStateTracker) {
            this();
        }
    ...
    private static final class LocationStateTracker extends StateTracker {
        ...
        LocationStateTracker(LocationStateTracker locationStateTracker) {
            this();
        }
    ...
    private static final class SyncStateTracker extends StateTracker {
        SyncStateTracker(SyncStateTracker syncStateTracker) {
            this();
        }
    ...
    private void toggleBrightness(Context context) {
        ...
        try {
            ...
            if (context.getResources().getBoolean(android.R.^attr-private.calendarViewMode)) {
