...
public abstract class ExploreByTouchHelper extends View.AccessibilityDelegate {
    ...
    public AccessibilityNodeProvider getAccessibilityNodeProvider(View host) {
        ExploreByTouchNodeProvider exploreByTouchNodeProvider = null;
        if (this.mNodeProvider == null) {
            this.mNodeProvider = new ExploreByTouchNodeProvider(this, exploreByTouchNodeProvider);
        }
    ...
    private class ExploreByTouchNodeProvider extends AccessibilityNodeProvider {
        ExploreByTouchNodeProvider(ExploreByTouchHelper this$0, ExploreByTouchNodeProvider exploreByTouchNodeProvider) {
            this();
        }
