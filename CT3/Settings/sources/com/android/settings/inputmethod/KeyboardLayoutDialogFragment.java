...
public class KeyboardLayoutDialogFragment extends DialogFragment implements InputManager.InputDeviceListener, LoaderManager.LoaderCallbacks<Keyboards> {
    ...
    private void updateSwitchHintVisibility() {
        ...
        View customPanel = dialog.findViewById(android.R.id.flagRequestAccessibilityButton);
    ...
    private static final class KeyboardLayoutAdapter extends ArrayAdapter<KeyboardLayout> {
        ...
        public KeyboardLayoutAdapter(Context context) {
            super(context, android.R.layout.notification_template_material_big_text);
            this.mCheckedItem = -1;
        ...
        private View inflateTwoLine(View convertView, ViewGroup parent, String label, String collection, boolean checked) {
            View view = convertView;
            if (convertView == null || !isTwoLine(convertView)) {
                view = this.mInflater.inflate(android.R.layout.notification_template_material_big_text, parent, false);
                setTwoLine(view, true);
            }
            TextView headline = (TextView) view.findViewById(android.R.id.text1);
            TextView subText = (TextView) view.findViewById(android.R.id.text2);
            RadioButton radioButton = (RadioButton) view.findViewById(android.R.id.input_method_nav_center_group);
            headline.setText(label);
