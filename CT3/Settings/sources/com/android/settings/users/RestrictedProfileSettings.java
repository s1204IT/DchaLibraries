...
public class RestrictedProfileSettings extends AppRestrictionsFragment implements EditUserInfoController.OnContentChangedCallback {
    ...
    public void onResume() {
        ...
        if (info == null) {
            ...
            ((ImageView) this.mHeaderView.findViewById(android.R.id.icon)).setImageDrawable(com.android.settingslib.Utils.getUserIcon(getActivity(), this.mUserManager, info));
        }
    }
    ...
    public Dialog onCreateDialog(int dialogId) {
        ...
        if (dialogId == 2) {
            Dialog dlg = UserDialogs.createRemoveDialog(getActivity(), this.mUser.getIdentifier(), new DialogInterface.OnClickListener() {
                @Override
