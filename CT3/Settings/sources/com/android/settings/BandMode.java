...
public class BandMode extends Activity {
    ...
    public void displayBandSelectionResult(Throwable ex) {
        ...
        this.mProgressPanel = new AlertDialog.Builder(this).setMessage(ex != null ? status + getString(R.string.band_mode_failed) : status + getString(R.string.band_mode_succeeded)).setPositiveButton(android.R.string.ok, (DialogInterface.OnClickListener) null).show();
    }
