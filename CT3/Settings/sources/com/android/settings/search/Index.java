...
public class Index {
    ...
    private String getDataKeywords(Context context, AttributeSet attrs) {
        return getData(context, attrs, com.android.settings.R.styleable.Preference, 28);
    }
    ...
    private class UpdateIndexTask extends AsyncTask<UpdateData, Integer, Void> {
        UpdateIndexTask(Index this$0, UpdateIndexTask updateIndexTask) {
            this();
        }
        ...
        public Void doInBackground(UpdateData... params) {
            try {
                ...
                boolean fullIndex = params[0].fullIndex;
        ...
        private boolean processDataToUpdate(SQLiteDatabase database, String localeStr, List<SearchIndexableData> dataToUpdate, Map<String, List<String>> nonIndexableKeys, boolean forceUpdate) {
            ...
            for (int n = 0; n < count; n++) {
                ...
                try {
                    ...
                    StringBuilder sbAppend = new StringBuilder().append("Cannot index: ");
                    if (str != null) {
                        str = ((SearchIndexableData) str).className;
                    }
                    Log.e("Index", sbAppend.append((Object) str).append(" for locale: ").append(localeStr).toString(), e);
                }
            }
    ...
    private class SaveSearchQueryTask extends AsyncTask<String, Void, Long> {
        SaveSearchQueryTask(Index this$0, SaveSearchQueryTask saveSearchQueryTask) {
            this();
        }
