...
public class RestrictedSwitchPreference extends SwitchPreference {
    ...
    public RestrictedSwitchPreference(Context context, AttributeSet attrs) {
        this(context, attrs, TypedArrayUtils.getAttr(context, android.support.v7.preference.R$attr.switchPreferenceStyle, R.attr.switchPreferenceStyle));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        View switchWidget = holder.findViewById(R.id.switch_widget);
