...
public class AppWidgetProviderInfo implements Parcelable {
    ...
    public AppWidgetProviderInfo m317clone() {
        AppWidgetProviderInfo that = new AppWidgetProviderInfo();
        that.provider = this.provider == null ? null : this.provider.m435clone();
        ...
        that.configure = this.configure == null ? null : this.configure.m435clone();
        that.label = this.label != null ? this.label.substring(0) : null;
        that.icon = this.icon;
