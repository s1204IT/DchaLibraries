        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    onReadyForSpeech(bundleCreateFromParcel4);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    onBeginningOfSpeech();
                ...
                case 7:
                    ...
                    onResults(bundleCreateFromParcel3);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onPartialResults(bundleCreateFromParcel2);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onEvent(_arg04, bundleCreateFromParcel);
                    return true;
