...
public class CommonClock {
    ...
    private class TimelineChangedListener extends Binder {
        ...
        TimelineChangedListener(CommonClock this$0, TimelineChangedListener timelineChangedListener) {
            this();
        }
    ...
    private void registerTimelineChangeListener() throws RemoteException {
        boolean success;
        TimelineChangedListener timelineChangedListener = null;
        if (this.mCallbackTgt != null) {
            return;
        }
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        this.mCallbackTgt = new TimelineChangedListener(this, timelineChangedListener);
        try {
