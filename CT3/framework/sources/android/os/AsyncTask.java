...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final int[] f22androidosAsyncTask$StatusSwitchesValues = null;
    ...
    private final WorkerRunnable<Params, Result> mWorker = new WorkerRunnable<Params, Result>() {
        ...
        public Result call() throws Exception {
            ...
            Object objDoInBackground = AsyncTask.this.doInBackground(this.mParams);
            Binder.flushPendingCommands();
            return (Result) AsyncTask.this.postResult(objDoInBackground);
        }
    };
    ...
    private static int[] m1753getandroidosAsyncTask$StatusSwitchesValues() {
        if (f22androidosAsyncTask$StatusSwitchesValues != null) {
            return f22androidosAsyncTask$StatusSwitchesValues;
        }
        ...
        f22androidosAsyncTask$StatusSwitchesValues = iArr;
        return iArr;
    }
    ...
    public final AsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (m1753getandroidosAsyncTask$StatusSwitchesValues()[this.mStatus.ordinal()]) {
                case 1:
