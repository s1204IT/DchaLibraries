...
public final class StorageVolume implements Parcelable {
    ...
    StorageVolume(Parcel in, StorageVolume storageVolume) {
        this(in);
    }
    ...
    public int getFatVolumeId() {
        ...
        try {
            return (int) Long.parseLong(this.mFsUuid.replace(ContactsContract.Aas.ENCODE_SYMBOL, ProxyInfo.LOCAL_EXCL_LIST), 16);
