...
public class UserManager {
    ...
    public static boolean supportsMultipleUsers() {
        if (getMaxSupportedUsers() > 1) {
            return SystemProperties.getBoolean("fw.show_multiuserui", Resources.getSystem().getBoolean(17956980));
        }
        return false;
    }
    ...
    public static int getMaxSupportedUsers() {
        ...
        return SystemProperties.getInt("fw.max_users", Resources.getSystem().getInteger(17694855));
    }

    public boolean isUserSwitcherEnabled() {
        List<UserInfo> users;
        if (!supportsMultipleUsers() || (users = getUsers(true)) == null) {
            return false;
        }
