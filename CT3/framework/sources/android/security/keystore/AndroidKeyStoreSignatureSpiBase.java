...
abstract class AndroidKeyStoreSignatureSpiBase extends SignatureSpi implements KeyStoreCryptoOperation {
    ...
    protected final void engineInitSign(PrivateKey privateKey, SecureRandom random) throws InvalidKeyException {
        ...
        try {
            ...
            this.mSigning = true;
            initKey(privateKey);
            ((SignatureSpi) this).appRandom = random;
    ...
    protected final void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        try {
            ...
            this.mSigning = false;
            initKey(publicKey);
            ((SignatureSpi) this).appRandom = null;
            ensureKeystoreOperationInitialized();
            success = true;
        } finally {
            if (!success) {
    ...
    protected final byte[] engineSign() throws SignatureException {
        ...
        try {
            ensureKeystoreOperationInitialized();
            byte[] additionalEntropy = KeyStoreCryptoOperationUtils.getRandomBytesToMixIntoKeystoreRng(((SignatureSpi) this).appRandom, getAdditionalEntropyAmountForSign());
