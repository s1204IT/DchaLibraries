...
public abstract class KeyProperties {
    ...
    public static abstract class Purpose {
        ...
        public static int allFromKeymaster(Collection<Integer> purposes) {
            int result = 0;
            Iterator keymasterPurpose$iterator = purposes.iterator();
            while (keymasterPurpose$iterator.hasNext()) {
                int keymasterPurpose = ((Integer) keymasterPurpose$iterator.next()).intValue();
    ...
    public static abstract class BlockMode {
        ...
        public static String[] allFromKeymaster(Collection<Integer> blockModes) {
            ...
            int offset = 0;
            Iterator blockMode$iterator = blockModes.iterator();
            while (blockMode$iterator.hasNext()) {
                int blockMode = ((Integer) blockMode$iterator.next()).intValue();
    ...
    public static abstract class Digest {
        ...
        public static String[] allFromKeymaster(Collection<Integer> digests) {
            ...
            int offset = 0;
            Iterator digest$iterator = digests.iterator();
            while (digest$iterator.hasNext()) {
                int digest = ((Integer) digest$iterator.next()).intValue();
