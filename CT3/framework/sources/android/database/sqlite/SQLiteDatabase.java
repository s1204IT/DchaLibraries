...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    private static final boolean DEBUG_DETAIL_TRACE;
    ...
    static {
        f7assertionsDisabled = !SQLiteDatabase.class.desiredAssertionStatus();
        DEBUG_DETAIL_TRACE = Log.isLoggable("SQLiteDatabaseTrace", 2);
    ...
    public List<Pair<String, String>> getAttachedDbs() {
        ...
        synchronized (this.mLock) {
            ...
            if (!this.mHasAttachedDbsLocked) {
                attachedDbs.add(new Pair<>(Camera.Parameters.SENSOR_DEV_MAIN, this.mConfigurationLocked.path));
                return attachedDbs;
            }
            acquireReference();
            Cursor c = null;
    ...
    public boolean isDatabaseIntegrityOk() throws Throwable {
        ...
        try {
            try {
                ...
                List<Pair<String, String>> attachedDbs2 = new ArrayList<>();
                try {
                    attachedDbs2.add(new Pair<>(Camera.Parameters.SENSOR_DEV_MAIN, getPath()));
