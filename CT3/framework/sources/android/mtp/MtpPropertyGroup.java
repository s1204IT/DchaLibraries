...
class MtpPropertyGroup {
    ...
    private String queryString(int id, String column) {
        Cursor c = null;
        try {
            c = this.mProvider.query(this.mUri, new String[]{"_id", column}, ID_WHERE, new String[]{Integer.toString(id)}, null, null);
    ...
    private String queryAudio(int id, String column) {
        Cursor c = null;
        try {
            c = this.mProvider.query(MediaStore.Audio.Media.getContentUri(this.mVolumeName), new String[]{"_id", column}, ID_WHERE, new String[]{Integer.toString(id)}, null, null);
            if (c == null || !c.moveToNext()) {
                if (c != null) {
                    c.close();
                }
    ...
    MtpPropertyList getPropertyList(int handle, int format, int depth) {
        ...
        if (format == 0) {
            if (handle == -1) {
                ...
                strArr = new String[]{Integer.toString(handle)};
            ...
            strArr = new String[]{Integer.toString(handle), Integer.toString(format)};
            where = depth == 1 ? PARENT_FORMAT_WHERE : ID_FORMAT_WHERE;
        }
        Cursor c = null;
        if (depth > 0 || handle == -1) {
            c = this.mProvider.query(this.mUri, this.mColumns, where, strArr, null, null);
            if (c == null) {
