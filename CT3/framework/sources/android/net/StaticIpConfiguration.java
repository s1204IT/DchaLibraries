...
public class StaticIpConfiguration implements Parcelable {
    ...
    public boolean equals(Object obj) {
        StaticIpConfiguration other;
        if (this == obj) {
            return true;
        }
        if ((obj instanceof StaticIpConfiguration) && (other = (StaticIpConfiguration) obj) != null && Objects.equals(this.ipAddress, other.ipAddress) && Objects.equals(this.gateway, other.gateway) && this.dnsServers.equals(other.dnsServers)) {
