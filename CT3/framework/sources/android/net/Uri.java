...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    public static final Uri EMPTY = new HierarchicalUri(null, Part.NULL, PathPart.EMPTY, Part.NULL, Part.NULL, 0 == true ? 1 : 0);
    ...
    public String toSafeString() {
        ...
        if (scheme != null) {
            if (scheme.equalsIgnoreCase(PhoneAccount.SCHEME_TEL) || scheme.equalsIgnoreCase("sip") || scheme.equalsIgnoreCase("sms") || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto")) {
    ...
    public static Uri fromFile(File file) {
        HierarchicalUri hierarchicalUri = null;
        if (file == null) {
            throw new NullPointerException("file");
        }
        PathPart path = PathPart.fromDecoded(file.getAbsolutePath());
        return new HierarchicalUri("file", Part.EMPTY, path, Part.NULL, Part.NULL, hierarchicalUri);
    }
    ...
    private static class StringUri extends AbstractHierarchicalUri {
        ...
        StringUri(String uriString, StringUri stringUri) {
            this(uriString);
        }
    ...
    public static Uri fromParts(String scheme, String ssp, String fragment) {
        ...
        return new OpaqueUri(scheme, Part.fromDecoded(ssp), Part.fromDecoded(fragment), opaqueUri);
    }
    ...
    private static class OpaqueUri extends Uri {
        ...
        OpaqueUri(String scheme, Part ssp, Part fragment, OpaqueUri opaqueUri) {
    ...
    private static class HierarchicalUri extends AbstractHierarchicalUri {
        ...
        HierarchicalUri(String scheme, Part authority, PathPart path, Part query, Part fragment, HierarchicalUri hierarchicalUri) {
    ...
    public static final class Builder {
        ...
        public Uri build() {
            ...
            if (this.opaquePart != null) {
                ...
                return new OpaqueUri(this.scheme, this.opaquePart, this.fragment, opaqueUri);
            }
            ...
            return new HierarchicalUri(this.scheme, this.authority, pathPartMakeAbsolute, this.query, this.fragment, objArr == true ? 1 : 0);
        }
    ...
    public boolean getBooleanQueryParameter(String key, boolean defaultValue) {
        ...
        return ("false".equals(flag2) || WifiEnterpriseConfig.ENGINE_DISABLE.equals(flag2)) ? false : true;
    }
    ...
    private static boolean isAllowed(char c, String allow) {
        ...
        if ((c < '0' || c > '9') && "_-!.~'()*".indexOf(c) == -1) {
            return (allow == null || allow.indexOf(c) == -1) ? false : true;
        }
        return true;
    }
    ...
    static class Part extends AbstractPart {
        ...
        Part(String encoded, String decoded, Part part) {
