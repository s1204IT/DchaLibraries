...
public final class ValidationProbeEvent extends IpConnectivityEvent implements Parcelable {
    ...
    ValidationProbeEvent(Parcel in, ValidationProbeEvent validationProbeEvent) {
        this(in);
    }
    ...
    public String toString() {
        return String.format("ValidationProbeEvent(%d, %s:%d, %dms)", Integer.valueOf(this.netId), getProbeName(this.probeType), Integer.valueOf(this.returnCode), Long.valueOf(this.durationMs));
    }
