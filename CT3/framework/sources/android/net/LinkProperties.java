...
public final class LinkProperties implements Parcelable {
    ...
    public enum ProvisioningChange {
        ...
        public static ProvisioningChange[] valuesCustom() {
            return values();
        }
    }
    ...
    public LinkProperties(LinkProperties source) {
        ...
        this.mHttpProxy = source.getHttpProxy() != null ? new ProxyInfo(source.getHttpProxy()) : null;
    ...
    private boolean hasIPv4AddressOnInterface(String iface) {
        ...
        return this.mStackedLinks.get(iface).hasIPv4Address();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (isIdenticalInterfaceName(target) && isIdenticalAddresses(target) && isIdenticalDnses(target) && isIdenticalRoutes(target) && isIdenticalHttpProxy(target) && isIdenticalStackedLinks(target) && isIdenticalMtu(target)) {
            return isIdenticalTcpBufferSizes(target);
        }
        return false;
    }
