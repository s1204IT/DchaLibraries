...
public class ProxyInfo implements Parcelable {
    public static final Parcelable.Creator<ProxyInfo> CREATOR = new Parcelable.Creator<ProxyInfo>() {
        ...
        public ProxyInfo createFromParcel(Parcel in) {
            ...
            ProxyInfo proxyProperties = new ProxyInfo(host, port, exclList, parsedExclList, null);
    ...
    ProxyInfo(String host, int port, String exclList, String[] parsedExclList, ProxyInfo proxyInfo) {
