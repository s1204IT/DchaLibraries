...
public final class RouteInfo implements Parcelable {
    ...
    public RouteInfo(LinkAddress destination, InetAddress gateway, String iface) {
        this(destination != null ? new IpPrefix(destination.getAddress(), destination.getPrefixLength()) : null, gateway, iface);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Objects.equals(this.mDestination, target.getDestination()) && Objects.equals(this.mGateway, target.getGateway()) && Objects.equals(this.mInterface, target.getInterface())) {
            return this.mType == target.getType();
        }
        return false;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        byte[] gatewayBytes = this.mGateway != null ? this.mGateway.getAddress() : null;
