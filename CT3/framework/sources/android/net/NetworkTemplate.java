...
public class NetworkTemplate implements Parcelable {
    ...
    NetworkTemplate(Parcel in, NetworkTemplate networkTemplate) {
        this(in);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mMatchRule == other.mMatchRule && Objects.equals(this.mSubscriberId, other.mSubscriberId)) {
            return Objects.equals(this.mNetworkId, other.mNetworkId);
        }
        return false;
    }
    ...
    private boolean matchesMobile(NetworkIdentity ident) {
        ...
        if ((sForceAllNetworkTypes || (ident.mType == 0 && ident.mMetered)) && !ArrayUtils.isEmpty(this.mMatchSubscriberIds)) {
            return ArrayUtils.contains(this.mMatchSubscriberIds, ident.mSubscriberId);
        }
        return false;
    }
    ...
    public static NetworkTemplate getNetworkTemplateFromBackup(DataInputStream in) throws BackupUtils.BadVersionException, IOException {
