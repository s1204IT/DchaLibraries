...
public class TlvBufferUtils {
    ...
    public static class TlvElement {
        ...
        TlvElement(int type, int length, byte[] refArray, int offset, TlvElement tlvElement) {
        ...
        public Iterator<TlvElement> iterator() {
            return new Iterator<TlvElement>() {
                ...
                public TlvElement next() {
                    ...
                    TlvElement tlv = new TlvElement(sPeekShort, sPeekShort2, TlvIterable.this.mArray, this.mOffset, null);
