...
public interface INetworkManagementEventObserver extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkManagementEventObserver {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            LinkAddress linkAddressCreateFromParcel;
            LinkAddress linkAddressCreateFromParcel2;
            switch (code) {
                case 1:
                ...
                case 5:
                    ...
                    if (data.readInt() != 0) {
                        linkAddressCreateFromParcel2 = LinkAddress.CREATOR.createFromParcel(data);
                    } else {
                        linkAddressCreateFromParcel2 = null;
                    }
                    addressUpdated(_arg05, linkAddressCreateFromParcel2);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    if (data.readInt() != 0) {
                        linkAddressCreateFromParcel = LinkAddress.CREATOR.createFromParcel(data);
                    } else {
                        linkAddressCreateFromParcel = null;
                    }
                    addressRemoved(_arg06, linkAddressCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 8:
                    ...
                    interfaceClassDataActivityChanged(_arg08, _arg14, _arg2);
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    interfaceDnsServerInfo(_arg09, _arg15, _arg22);
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    routeUpdated(routeInfoCreateFromParcel2);
                    reply.writeNoException();
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    routeRemoved(routeInfoCreateFromParcel);
                    reply.writeNoException();
                    return true;
