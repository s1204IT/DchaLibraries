...
public class SslCertificate {
    ...
    public View inflateCertificateView(Context context) {
        ...
        View certificateView = factory.inflate(17367271, (ViewGroup) null);
        DName issuedTo = getIssuedTo();
        if (issuedTo != null) {
            ((TextView) certificateView.findViewById(16909324)).setText(issuedTo.getCName());
            ((TextView) certificateView.findViewById(16909326)).setText(issuedTo.getOName());
            ((TextView) certificateView.findViewById(16909328)).setText(issuedTo.getUName());
        }
        ((TextView) certificateView.findViewById(16909330)).setText(getSerialNumber(this.mX509Certificate));
        DName issuedBy = getIssuedBy();
        if (issuedBy != null) {
            ((TextView) certificateView.findViewById(16909332)).setText(issuedBy.getCName());
            ((TextView) certificateView.findViewById(16909334)).setText(issuedBy.getOName());
            ((TextView) certificateView.findViewById(16909336)).setText(issuedBy.getUName());
        }
        String issuedOn = formatCertificateDate(context, getValidNotBeforeDate());
        ((TextView) certificateView.findViewById(16909339)).setText(issuedOn);
        String expiresOn = formatCertificateDate(context, getValidNotAfterDate());
        ((TextView) certificateView.findViewById(16909341)).setText(expiresOn);
        ((TextView) certificateView.findViewById(16909344)).setText(getDigest(this.mX509Certificate, "SHA256"));
        ((TextView) certificateView.findViewById(16909346)).setText(getDigest(this.mX509Certificate, "SHA1"));
