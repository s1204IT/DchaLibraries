        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        ipConfigurationCreateFromParcel = IpConfiguration.CREATOR.createFromParcel(data);
                    } else {
                        ipConfigurationCreateFromParcel = null;
                    }
                    setConfiguration(ipConfigurationCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    IEthernetServiceListener _arg02 = IEthernetServiceListener.Stub.asInterface(data.readStrongBinder());
        ...
        private static class Proxy implements IEthernetManager {
            ...
            public IpConfiguration getConfiguration() throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        ipConfigurationCreateFromParcel = IpConfiguration.CREATOR.createFromParcel(_reply);
                    } else {
                        ipConfigurationCreateFromParcel = null;
                    }
