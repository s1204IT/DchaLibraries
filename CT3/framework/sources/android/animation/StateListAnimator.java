...
public class StateListAnimator implements Cloneable {
    ...
    public StateListAnimator m85clone() {
        try {
            ...
            for (int i = 0; i < tupleSize; i++) {
                ...
                Animator animatorClone = tuple.mAnimator.m35clone();
    ...
    public static class Tuple {
        ...
        Tuple(int[] specs, Animator animator, Tuple tuple) {
            this(specs, animator);
        }
    ...
    private static class StateListAnimatorConstantState extends ConstantState<StateListAnimator> {
        ...
        public StateListAnimator newInstance() {
            StateListAnimator clone = this.mAnimator.m85clone();
