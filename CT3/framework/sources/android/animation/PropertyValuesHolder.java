...
public class PropertyValuesHolder implements Cloneable {
    ...
    PropertyValuesHolder(String propertyName, PropertyValuesHolder propertyValuesHolder) {
        this(propertyName);
    }
    ...
    public void getPropertyValues(PropertyValues values) {
        ...
        if ((this.mKeyframes instanceof PathKeyframes.FloatKeyframesBase) || (this.mKeyframes instanceof PathKeyframes.IntKeyframesBase)) {
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override
        public IntPropertyValuesHolder m81clone() {
            IntPropertyValuesHolder newPVH = (IntPropertyValuesHolder) super.m81clone();
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override
        public FloatPropertyValuesHolder m81clone() {
            FloatPropertyValuesHolder newPVH = (FloatPropertyValuesHolder) super.m81clone();
