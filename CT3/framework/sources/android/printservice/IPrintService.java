        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    requestCancelPrintJob(printJobInfoCreateFromParcel2);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onPrintJobQueued(printJobInfoCreateFromParcel);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    List<PrinterId> _arg02 = data.createTypedArrayList(PrinterId.CREATOR);
                    startPrinterDiscovery(_arg02);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    List<PrinterId> _arg03 = data.createTypedArrayList(PrinterId.CREATOR);
                    validatePrinters(_arg03);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    startPrinterStateTracking(printerIdCreateFromParcel3);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    requestCustomPrinterIcon(printerIdCreateFromParcel2);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    stopPrinterStateTracking(printerIdCreateFromParcel);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
