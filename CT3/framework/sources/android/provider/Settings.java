...
public final class Settings {
    ...
    private static final boolean DEBUG_LOGV = Build.TYPE.equals("eng");
    ...
    private static class NameValueCache {
        ...
        public String getStringForUser(ContentResolver cr, String name, int userHandle) throws Throwable {
            Bundle args;
            Bundle args2;
                ...
                synchronized (this) {
                    if (this.mGenerationTracker != null) {
                        if (this.mGenerationTracker.isGenerationChanged()) {
                            ...
                            if (Settings.DEBUG_LOGV) {
                                Log.d(Settings.TAG, " from settings cache , name = " + name + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + ", value = " + this.mValues.get(name));
                            }
                    ...
                    if (isSelf) {
                        try {
                            if (this.mGenerationTracker == null) {
                                ...
                                args2 = args == null ? new Bundle() : args;
                                try {
                            ...
                            Bundle b = cp.call(cr.getPackageName(), this.mCallGetCommand, name, args2);
                            if (b != null) {
                                String value = b.getString("value");
                                if (isSelf) {
                                    synchronized (this) {
                                        if (needsGenerationTracker) {
                                            MemoryIntArray array = b.getParcelable(Settings.CALL_METHOD_TRACK_GENERATION_KEY);
                                            ...
                                            if (array != null && index >= 0) {
                                                ...
                                                this.mGenerationTracker = new GenerationTracker(array, index, generation, new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        NameValueCache.this.m1915android_provider_Settings$NameValueCache_lambda$1();
                                                    }
                                                });
                                            }
                                        }
            ...
            try {
                try {
                    Cursor c = cp.query(cr.getPackageName(), this.mUri, SELECT_VALUE, NAME_EQ_PLACEHOLDER, new String[]{name}, null, null);
                    if (c == null) {
        ...
        void m1915android_provider_Settings$NameValueCache_lambda$1() {
            synchronized (this) {
    ...
    public static final class System extends NameValueTable {
        ...
        public static final Uri DEFAULT_SIP_CALL_URI;
        public static final Uri DEFAULT_VIDEO_CALL_URI;
        ...
        public static final String SCREEN_CAPTURE_ON = "screen_capture_on";
        ...
        private static final NameValueCache sNameValueCache = new NameValueCache(CONTENT_URI, Settings.CALL_METHOD_GET_SYSTEM, Settings.CALL_METHOD_PUT_SYSTEM);
        ...
        static {
            ...
            MOVED_TO_GLOBAL.add(Global.ACM_ENABLED);
            MOVED_TO_GLOBAL.add("msim_mode_setting");
            sBooleanValidator = new DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE});
            ...
            SCREEN_AUTO_BRIGHTNESS_ADJ_VALIDATOR = new InclusiveFloatRangeValidator(-1.0f, 1.0f);
        ...
        public static String getString(ContentResolver resolver, String name) {
            if (name != null && name.startsWith("bc:")) {
                return BenesseExtension.getString(name);
            }
    ...
    public static final class Secure extends NameValueTable {
        ...
        private static final NameValueCache sNameValueCache = new NameValueCache(CONTENT_URI, Settings.CALL_METHOD_GET_SECURE, Settings.CALL_METHOD_PUT_SECURE);
        ...
        public static final boolean setLocationProviderEnabledForUser(ContentResolver cr, String provider, boolean enabled, int userId) {
            ...
            synchronized (Settings.mLocationSettingsLock) {
                if (enabled) {
                    ...
                    provider2 = ContactsContract.Aas.ENCODE_SYMBOL + provider;
                }
                zPutStringForUser = putStringForUser(cr, "location_providers_allowed", provider2, userId);
            }
            return zPutStringForUser;
        }

        private static final boolean saveLocationModeForUser(ContentResolver cr, int userId) {
            int mode = getLocationModeForUser(cr, userId);
            return putIntForUser(cr, LOCATION_PREVIOUS_MODE, mode, userId);
        }
    ...
    public static final class Bookmarks implements BaseColumns {
        ...
        public static CharSequence getTitle(Context context, Cursor cursor) {
            ...
            try {
                ...
                return info != null ? info.loadLabel(packageManager) : ProxyInfo.LOCAL_EXCL_LIST;
