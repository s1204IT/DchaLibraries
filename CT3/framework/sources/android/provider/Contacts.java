    ...
    public static final class ContactMethods implements BaseColumns, ContactMethodsColumns, PeopleColumns {
        ...
        public static final CharSequence getDisplayLabel(Context context, int kind, int type, CharSequence label) {
            switch (kind) {
                case 1:
                    if (type != 0) {
                        CharSequence[] labels = context.getResources().getTextArray(R.array.emailAddressTypes);
                        try {
                            CharSequence display = labels[type - 1];
                            return display;
                        } catch (ArrayIndexOutOfBoundsException e) {
                ...
                case 2:
                    if (type != 0) {
                        CharSequence[] labels2 = context.getResources().getTextArray(R.array.postalAddressTypes);
                        try {
                    ...
                    return label;
                default:
                    CharSequence display5 = context.getString(R.string.untitled);
                    return display5;
            }
        }
