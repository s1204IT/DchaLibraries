...
public final class CalendarContract {
            ...
            public Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                ...
                while (subCursor2.moveToNext()) {
                    try {
                        ...
                        reminderValues.put("method", Integer.valueOf(subCursor2.getInt(1)));
                ...
                subCursor2.close();
                if (this.mResolver != null) {
                    subCursor2 = this.mResolver.query(ExtendedProperties.CONTENT_URI, EXTENDED_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                } else {
                    subCursor2 = this.mProvider.query(ExtendedProperties.CONTENT_URI, EXTENDED_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                }
                while (subCursor2.moveToNext()) {
                    try {
    ...
    public static final class CalendarAlerts implements BaseColumns, CalendarAlertsColumns, EventsColumns, CalendarColumns {
        ...
        public static void scheduleAlarm(Context context, AlarmManager manager, long alarmTime) throws Throwable {
            if (manager == null) {
