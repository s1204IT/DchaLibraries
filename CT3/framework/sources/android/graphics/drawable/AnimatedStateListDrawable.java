...
public class AnimatedStateListDrawable extends StateListDrawable {
    ...
    AnimatedStateListDrawable(AnimatedStateListState state, Resources res, AnimatedStateListDrawable animatedStateListDrawable) {
        this(state, res);
    }
    ...
    protected boolean onStateChange(int[] stateSet) {
        ...
        if (targetIndex == getCurrentIndex()) {
            ...
            changed = !selectTransition(targetIndex) ? selectDrawable(targetIndex) : true;
        }
    ...
    private int parseTransition(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, BlockGuard.BlockGuardPolicyException, IOException {
        int type;
    ...
    static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        public Drawable newDrawable() {
            return new AnimatedStateListDrawable(this, null, 0 == true ? 1 : 0);
        }
