...
public class ShapeDrawable extends Drawable {
    ...
    ShapeDrawable(ShapeState state, Resources res, ShapeDrawable shapeDrawable) {
        this(state, res);
    }
    ...
    public Drawable mutate() {
        if (!this.mMutated && super.mutate() == this) {
            ...
            try {
                this.mShapeState.mShape = this.mShapeState.mShape.m708clone();
                this.mMutated = true;
    ...
    static final class ShapeState extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            return new ShapeDrawable(this, null, 0 == true ? 1 : 0);
        }
