...
public final class Bitmap implements Parcelable {
    ...
    private static final int[] f10androidgraphicsBitmap$ConfigSwitchesValues = null;
    ...
    private static int[] m594getandroidgraphicsBitmap$ConfigSwitchesValues() {
        if (f10androidgraphicsBitmap$ConfigSwitchesValues != null) {
            return f10androidgraphicsBitmap$ConfigSwitchesValues;
        }
        ...
        f10androidgraphicsBitmap$ConfigSwitchesValues = iArr;
        return iArr;
    }
    ...
    Bitmap(long nativeBitmap, byte[] buffer, int width, int height, int density, boolean isMutable, boolean requestPremultiplied, byte[] ninePatchChunk, NinePatch.InsetStruct ninePatchInsets) {
        ...
        long nativeSize = buffer == null ? 32 + ((long) getByteCount()) : 32L;
    ...
    public static Bitmap createBitmap(Bitmap source, int x, int y, int width, int height, Matrix m, boolean filter) {
        ...
        if (config != null) {
            switch (m594getandroidgraphicsBitmap$ConfigSwitchesValues()[config.ordinal()]) {
                case 1:
    ...
    public boolean compress(CompressFormat format, int quality, OutputStream stream) {
        ...
        Trace.traceBegin(32768L, "Bitmap.compress");
