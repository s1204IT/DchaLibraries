...
public interface IBluetoothManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothManager {
        ...
        static final int TRANSACTION_isBleAppPresent = 16;
        static final int TRANSACTION_isBleScanAlwaysAvailable = 14;
        ...
        static final int TRANSACTION_updateBleAppCount = 15;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 10:
                    ...
                    boolean _result7 = bindBluetoothProfileService(_arg06, _arg1);
                    reply.writeNoException();
                ...
                case 11:
                    ...
                    unbindBluetoothProfileService(_arg07, _arg12);
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    String _result8 = getAddress();
                    reply.writeNoException();
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result10 = isBleScanAlwaysAvailable();
                    reply.writeNoException();
                ...
                case 15:
                    ...
                    int _result11 = updateBleAppCount(_arg08, _arg13);
                    reply.writeNoException();
                    reply.writeInt(_result11);
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result12 = isBleAppPresent();
                    reply.writeNoException();
