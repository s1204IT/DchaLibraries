...
public final class AdvertiseSettings implements Parcelable {
    ...
    AdvertiseSettings(int advertiseMode, int advertiseTxPowerLevel, boolean advertiseConnectable, int advertiseTimeout, AdvertiseSettings advertiseSettings) {
        this(advertiseMode, advertiseTxPowerLevel, advertiseConnectable, advertiseTimeout);
    }

    AdvertiseSettings(Parcel in, AdvertiseSettings advertiseSettings) {
        this(in);
    }
