...
public final class BluetoothAvrcpPlayerSettings implements Parcelable {
    ...
    BluetoothAvrcpPlayerSettings(Parcel in, BluetoothAvrcpPlayerSettings bluetoothAvrcpPlayerSettings) {
        this(in);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        Iterator k$iterator = this.mSettingsValue.keySet().iterator();
        while (k$iterator.hasNext()) {
            int k = ((Integer) k$iterator.next()).intValue();
            out.writeInt(k);
