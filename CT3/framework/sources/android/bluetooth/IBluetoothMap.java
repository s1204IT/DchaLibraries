        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    boolean _result3 = connect(bluetoothDeviceCreateFromParcel6);
                    reply.writeNoException();
                ...
                case 4:
                    ...
                    boolean _result4 = disconnect(bluetoothDeviceCreateFromParcel5);
                    reply.writeNoException();
                ...
                case 5:
                    ...
                    boolean _result5 = isConnected(bluetoothDeviceCreateFromParcel4);
                    reply.writeNoException();
                ...
                case 7:
                    ...
                    List<BluetoothDevice> _result7 = getDevicesMatchingConnectionStates(_arg0);
                    reply.writeNoException();
                ...
                case 8:
                    ...
                    int _result8 = getConnectionState(bluetoothDeviceCreateFromParcel3);
                    reply.writeNoException();
                ...
                case 9:
                    ...
                    boolean _result9 = setPriority(bluetoothDeviceCreateFromParcel2, _arg1);
                    reply.writeNoException();
                ...
                case 10:
                    ...
                    int _result10 = getPriority(bluetoothDeviceCreateFromParcel);
                    reply.writeNoException();
        ...
        private static class Proxy implements IBluetoothMap {
            ...
            public BluetoothDevice getClient() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        bluetoothDeviceCreateFromParcel = BluetoothDevice.CREATOR.createFromParcel(_reply);
                    } else {
                        bluetoothDeviceCreateFromParcel = null;
                    }
