    ...
    public static abstract class Stub extends Binder implements IBluetoothA2dpSink {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    boolean _result = connect(bluetoothDeviceCreateFromParcel7);
                ...
                case 2:
                    ...
                    boolean _result2 = disconnect(bluetoothDeviceCreateFromParcel6);
                    reply.writeNoException();
                ...
                case 5:
                    ...
                    int _result5 = getConnectionState(bluetoothDeviceCreateFromParcel5);
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    BluetoothAudioConfig _result6 = getAudioConfig(bluetoothDeviceCreateFromParcel4);
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 7:
                    ...
                    boolean _result7 = setPriority(bluetoothDeviceCreateFromParcel3, _arg1);
                    reply.writeNoException();
                ...
                case 8:
                    ...
                    int _result8 = getPriority(bluetoothDeviceCreateFromParcel2);
                    reply.writeNoException();
                ...
                case 9:
                    ...
                    boolean _result9 = isA2dpPlaying(bluetoothDeviceCreateFromParcel);
                    reply.writeNoException();
        ...
        private static class Proxy implements IBluetoothA2dpSink {
            ...
            public BluetoothAudioConfig getAudioConfig(BluetoothDevice device) throws RemoteException {
                BluetoothAudioConfig bluetoothAudioConfigCreateFromParcel;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        bluetoothAudioConfigCreateFromParcel = BluetoothAudioConfig.CREATOR.createFromParcel(_reply);
                    } else {
                        bluetoothAudioConfigCreateFromParcel = null;
                    }
                    return bluetoothAudioConfigCreateFromParcel;
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
