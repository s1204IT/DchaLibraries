        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        clipDataCreateFromParcel = ClipData.CREATOR.createFromParcel(data);
                    } else {
                        clipDataCreateFromParcel = null;
                    }
                    String _arg1 = data.readString();
                    setPrimaryClip(clipDataCreateFromParcel, _arg1);
                    reply.writeNoException();
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg0 = data.readString();
                    ClipData _result = getPrimaryClip(_arg0);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                ...
                case 3:
                    ...
                    ClipDescription _result2 = getPrimaryClipDescription(_arg02);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                ...
                case 4:
                    ...
                    boolean _result3 = hasPrimaryClip(_arg03);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    IOnPrimaryClipChangedListener _arg04 = IOnPrimaryClipChangedListener.Stub.asInterface(data.readStrongBinder());
                    String _arg12 = data.readString();
                    addPrimaryClipChangedListener(_arg04, _arg12);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    IOnPrimaryClipChangedListener _arg05 = IOnPrimaryClipChangedListener.Stub.asInterface(data.readStrongBinder());
                    removePrimaryClipChangedListener(_arg05);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg06 = data.readString();
                    boolean _result4 = hasClipboardText(_arg06);
                    reply.writeNoException();
        ...
        private static class Proxy implements IClipboard {
            ...
            public ClipData getPrimaryClip(String pkg) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        clipDataCreateFromParcel = ClipData.CREATOR.createFromParcel(_reply);
                    } else {
                        clipDataCreateFromParcel = null;
                    }
            ...
            public ClipDescription getPrimaryClipDescription(String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        clipDescriptionCreateFromParcel = ClipDescription.CREATOR.createFromParcel(_reply);
                    } else {
