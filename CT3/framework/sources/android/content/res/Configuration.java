...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    Configuration(Parcel source, Configuration configuration) {
        this(source);
    }
    ...
    public void setTo(Configuration o) {
        ...
        this.mcc = o.mcc;
        this.mnc = o.mnc;
        this.locale = o.locale != null ? (Locale) o.locale.clone() : null;
        o.fixUpLocaleList();
    ...
    public int compareTo(Configuration that) {
        ...
        int n15 = this.screenLayout - that.screenLayout;
        if (n15 != 0) {
            return n15;
        }
        int n16 = this.uiMode - that.uiMode;
        if (n16 != 0) {
            return n16;
        }
        int n17 = this.screenWidthDp - that.screenWidthDp;
        if (n17 != 0) {
            return n17;
        }
        int n18 = this.screenHeightDp - that.screenHeightDp;
        if (n18 != 0) {
            return n18;
        }
        int n19 = this.smallestScreenWidthDp - that.smallestScreenWidthDp;
        return n19 != 0 ? n19 : this.densityDpi - that.densityDpi;
    }
    ...
    public static String resourceQualifierString(Configuration config) {
        ...
        switch (config.screenLayout & 15) {
            case 1:
                ...
                break;
            case 2:
                parts.add(Camera.Parameters.CAPTURE_MODE_NORMAL);
                break;
            case 3:
                parts.add("large");
                break;
        ...
        return TextUtils.join(ContactsContract.Aas.ENCODE_SYMBOL, parts);
    }
