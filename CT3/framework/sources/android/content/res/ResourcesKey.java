...
public final class ResourcesKey {
    ...
    public ResourcesKey(String resDir, String[] splitResDirs, String[] overlayDirs, String[] libDirs, int displayId, Configuration overrideConfig, CompatibilityInfo compatInfo) {
        ...
        this.mOverrideConfiguration = overrideConfig == null ? Configuration.EMPTY : overrideConfig;
        this.mCompatInfo = compatInfo == null ? CompatibilityInfo.DEFAULT_COMPATIBILITY_INFO : compatInfo;
        int hash = Objects.hashCode(this.mResDir) + 527;
    ...
    public boolean isPathReferenced(String path) {
        if ((this.mResDir != null && this.mResDir.startsWith(path)) || anyStartsWith(this.mSplitResDirs, path) || anyStartsWith(this.mOverlayDirs, path)) {
            return true;
        }
        return anyStartsWith(this.mLibDirs, path);
    }
