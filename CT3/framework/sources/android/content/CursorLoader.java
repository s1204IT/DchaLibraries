...
public class CursorLoader extends AsyncTaskLoader<Cursor> {
    ...
    public Cursor loadInBackground() {
        ...
        Cursor cursor = null;
        try {
            if (getContext() != null && getContext().getContentResolver() != null && (cursor = getContext().getContentResolver().query(this.mUri, this.mProjection, this.mSelection, this.mSelectionArgs, this.mSortOrder, this.mCancellationSignal)) != null) {
                try {
                    cursor.getCount();
