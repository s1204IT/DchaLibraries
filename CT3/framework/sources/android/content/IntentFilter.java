...
public class IntentFilter implements Parcelable {
    ...
    public static final Parcelable.Creator<IntentFilter> CREATOR = new Parcelable.Creator<IntentFilter>() {
        ...
        public IntentFilter createFromParcel(Parcel source) {
            return new IntentFilter(source, (IntentFilter) null);
        }
    ...
    IntentFilter(Parcel source, IntentFilter intentFilter) {
        this(source);
    }
    ...
    public final boolean hasExactDataType(String type) {
        if (this.mDataTypes != null) {
            return this.mDataTypes.contains(type);
        }
        return false;
    }
    ...
    public final boolean hasDataScheme(String scheme) {
        if (this.mDataSchemes != null) {
            return this.mDataSchemes.contains(scheme);
        }
        return false;
    }
    ...
    public final int matchData(String type, String scheme, Uri data) {
        ...
        } else if (scheme != null && !ProxyInfo.LOCAL_EXCL_LIST.equals(scheme) && !"content".equals(scheme) && !"file".equals(scheme)) {
            return -2;
        }
        if (types != null) {
    ...
    private final boolean findMimeType(String type) {
        ...
        if (this.mHasPartialTypes && t.contains(NetworkCapabilities.MATCH_ALL_REQUESTS_NETWORK_SPECIFIER)) {
            return true;
        }
        int slashpos = type.indexOf(47);
        if (slashpos > 0) {
