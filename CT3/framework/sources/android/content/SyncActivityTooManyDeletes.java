...
public class SyncActivityTooManyDeletes extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence[] options = {getResources().getText(17040529), getResources().getText(17040530), getResources().getText(17040531)};
        ListAdapter adapter = new ArrayAdapter(this, R.layout.simple_list_item_1, R.id.text1, options);
        ListView listView = new ListView(this);
        listView.setAdapter(adapter);
        listView.setItemsCanFocus(true);
        listView.setOnItemClickListener(this);
        TextView textView = new TextView(this);
        CharSequence tooManyDeletesDescFormat = getResources().getText(17040528);
