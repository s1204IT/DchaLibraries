...
public final class EphemeralApplicationInfo implements Parcelable {
    public static final Parcelable.Creator<EphemeralApplicationInfo> CREATOR = new Parcelable.Creator<EphemeralApplicationInfo>() {
        @Override
    ...
    EphemeralApplicationInfo(Parcel parcel, EphemeralApplicationInfo ephemeralApplicationInfo) {
        this(parcel);
    }
