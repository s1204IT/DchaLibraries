...
public interface IPackageInstaller extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPackageInstaller {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            PackageInstaller.SessionParams sessionParamsCreateFromParcel;
            switch (code) {
                case 1:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        sessionParamsCreateFromParcel = PackageInstaller.SessionParams.CREATOR.createFromParcel(data);
                    } else {
                        sessionParamsCreateFromParcel = null;
                    }
                    String _arg1 = data.readString();
                    int _arg2 = data.readInt();
                    int _result = createSession(sessionParamsCreateFromParcel, _arg1, _arg2);
                ...
                case 2:
                    ...
                    updateSessionAppIcon(_arg0, bitmapCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    updateSessionAppLabel(_arg02, _arg12);
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg03 = data.readInt();
                    abandonSession(_arg03);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg04 = data.readInt();
                    IPackageInstallerSession _result2 = openSession(_arg04);
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    PackageInstaller.SessionInfo _result3 = getSessionInfo(_arg05);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 7:
                    ...
                    ParceledListSlice _result4 = getAllSessions(_arg06);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 8:
                    ...
                    ParceledListSlice _result5 = getMySessions(_arg07, _arg13);
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 11:
                    ...
                    uninstall(_arg010, _arg15, _arg22, intentSenderCreateFromParcel, _arg4);
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setPermissionsResult(_arg011, _arg16);
                    reply.writeNoException();
                    return true;
        ...
        private static class Proxy implements IPackageInstaller {
            ...
            public PackageInstaller.SessionInfo getSessionInfo(int sessionId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        sessionInfoCreateFromParcel = PackageInstaller.SessionInfo.CREATOR.createFromParcel(_reply);
                    } else {
