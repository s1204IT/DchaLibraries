...
public class ActivityInfo extends ComponentInfo implements Parcelable {
    ...
    ActivityInfo(Parcel source, ActivityInfo activityInfo) {
        this(source);
    }
    ...
    boolean isFixedOrientation() {
        return this.screenOrientation == 0 || this.screenOrientation == 1 || this.screenOrientation == 6 || this.screenOrientation == 7 || this.screenOrientation == 8 || this.screenOrientation == 9 || this.screenOrientation == 11 || this.screenOrientation == 12 || this.screenOrientation == 14;
    }
