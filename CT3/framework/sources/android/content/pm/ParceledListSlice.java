...
public class ParceledListSlice<T extends Parcelable> implements Parcelable {
    ...
    ParceledListSlice(Parcel p, ClassLoader loader, ParceledListSlice parceledListSlice) {
        this(p, loader);
    }
    ...
    private ParceledListSlice(Parcel parcel, ClassLoader classLoader) {
        ...
        Parcelable.Creator<?> parcelableCreator = parcel.readParcelableCreator(classLoader);
        Class<?> cls = null;
        int i2 = 0;
