...
public final class ShortcutInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<ShortcutInfo> CREATOR = new Parcelable.Creator<ShortcutInfo>() {
        ...
        public ShortcutInfo createFromParcel(Parcel source) {
            return new ShortcutInfo(source, (ShortcutInfo) null);
        }
    ...
    ShortcutInfo(Builder b, ShortcutInfo shortcutInfo) {
        this(b);
    }

    ShortcutInfo(Parcel source, ShortcutInfo shortcutInfo) {
        this(source);
    }
    ...
    public static class Builder {
        ...
        public Builder setText(String text) {
            this.mText = (String) Preconditions.checkStringNotEmpty(text, ContactsContract.StreamItemsColumns.TEXT);
            return this;
        }
    ...
    public ShortcutInfo(int userId, String id, String packageName, ComponentName activityComponent, Icon icon, String title, String text, Set<String> categories, Intent intent, PersistableBundle intentPersistableExtras, int weight, PersistableBundle extras, long lastChangedTimestamp, int flags, int iconResId, String bitmapPath) {
        ...
        this.mTitle = title;
        this.mText = text;
        this.mCategories = clone(categories);
        this.mIntent = intent;
