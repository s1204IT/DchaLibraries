...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    ApplicationInfo(Parcel source, ApplicationInfo applicationInfo) {
        this(source);
    }
    ...
    public ApplicationInfo(ApplicationInfo orig) {
        ...
        String str2 = orig.credentialProtectedDataDir;
        this.credentialProtectedDataDir = str2;
        this.credentialEncryptedDataDir = str2;
        this.uid = orig.uid;
    ...
    private ApplicationInfo(Parcel source) {
        ...
        this.deviceProtectedDataDir = string;
        this.deviceEncryptedDataDir = string;
        String string2 = source.readString();
        this.credentialProtectedDataDir = string2;
        this.credentialEncryptedDataDir = string2;
    ...
    public void initForUser(int userId) {
        ...
        String absolutePath2 = Environment.getDataUserCePackageDirectory(this.volumeUuid, userId, this.packageName).getAbsolutePath();
        this.credentialProtectedDataDir = absolutePath2;
        this.credentialEncryptedDataDir = absolutePath2;
    ...
    public Drawable loadDefaultIcon(PackageManager pm) {
        if ((this.flags & 262144) != 0 && isPackageUnavailable(pm)) {
            return Resources.getSystem().getDrawable(17303334);
        }
