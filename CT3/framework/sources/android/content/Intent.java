...
public class Intent implements Parcelable, Cloneable {
                        ...
                        if (end < 0) {
                            ...
                            if (end + 1 < data.length()) {
                                ...
                                if (newEnd2 >= 0) {
                                    ...
                                    if (newEnd2 < data.length() && (newEnd = data.indexOf(47, newEnd2 + 1)) >= 0) {
                                        authority = data.substring(newEnd2 + 1, newEnd);
                                        end = newEnd;
                                    }
                                } else {
                                                                        ...
                                                                        if (!opt.equals("--efa")) {
                                                                            if (!opt.equals("--efal")) {
                                                                                if (!opt.equals("--esa")) {
                                                                                    ...
                                                                                    intent2.putExtra(key3, value3.split("(?<!\\\\),"));
                                                                                    hasIntentInfo = true;
                                                                                }
                                                                            } else {
                                                                                String key4 = cmd.getNextArgRequired();
                                                                                String value4 = cmd.getNextArgRequired();
                                                                                String[] strings2 = value4.split(",");
                                                                                ArrayList<Float> list2 = new ArrayList<>(strings2.length);
                                                                                for (String str3 : strings2) {
                                                                                    list2.add(Float.valueOf(str3));
                                                                                }
                                                                                intent2.putExtra(key4, list2);
                                                                                hasIntentInfo = true;
                                                                            }
                                                                        } else {
                                                                            String key5 = cmd.getNextArgRequired();
                                                                            String value5 = cmd.getNextArgRequired();
                                                                            String[] strings3 = value5.split(",");
                                                                            float[] list3 = new float[strings3.length];
                                                                            for (int i = 0; i < strings3.length; i++) {
                                                                                list3[i] = Float.valueOf(strings3[i]).floatValue();
                                                                            }
                                                                            intent2.putExtra(key5, list3);
                                                                            hasIntentInfo = true;
                                                                        }
                                                                    } else {
                                                                        String key6 = cmd.getNextArgRequired();
                                                                        String value6 = cmd.getNextArgRequired();
                                                                        intent2.putExtra(key6, Float.valueOf(value6));
                                                                        hasIntentInfo = true;
                                                                    }
                                                                } else {
                                                                    String key7 = cmd.getNextArgRequired();
                                                                    String value7 = cmd.getNextArgRequired();
                                                                    String[] strings4 = value7.split(",");
                                                                    ArrayList<Long> list4 = new ArrayList<>(strings4.length);
                                                                    for (String str4 : strings4) {
                                                                        list4.add(Long.valueOf(str4));
                                                                    }
                                                                    intent2.putExtra(key7, list4);
                                                                    hasIntentInfo = true;
                                                                }
                                                            } else {
                                                                String key8 = cmd.getNextArgRequired();
                                                                String value8 = cmd.getNextArgRequired();
                                                                String[] strings5 = value8.split(",");
                                                                long[] list5 = new long[strings5.length];
                                                                for (int i2 = 0; i2 < strings5.length; i2++) {
                                                                    list5[i2] = Long.valueOf(strings5[i2]).longValue();
                                                                }
                                                                intent2.putExtra(key8, list5);
                                                                hasIntentInfo = true;
                                                            }
                                                        } else {
                                                            String key9 = cmd.getNextArgRequired();
                                                            String value9 = cmd.getNextArgRequired();
                                                            intent2.putExtra(key9, Long.valueOf(value9));
                                                        }
                                                    } else {
                                                        String key10 = cmd.getNextArgRequired();
                                                        String value10 = cmd.getNextArgRequired();
                                                        String[] strings6 = value10.split(",");
                                                        ArrayList<Integer> list6 = new ArrayList<>(strings6.length);
                                                        for (String str5 : strings6) {
                                                            list6.add(Integer.decode(str5));
                                                        }
                                                        intent2.putExtra(key10, list6);
                                                    }
                                                } else {
                                                    String key11 = cmd.getNextArgRequired();
                                                    String value11 = cmd.getNextArgRequired();
                                                    String[] strings7 = value11.split(",");
                                                    int[] list7 = new int[strings7.length];
                                                    for (int i3 = 0; i3 < strings7.length; i3++) {
                                                        list7[i3] = Integer.decode(strings7[i3]).intValue();
                                                    }
                                                    intent2.putExtra(key11, list7);
                                                }
                                            } else {
                                                String key12 = cmd.getNextArgRequired();
                                                String value12 = cmd.getNextArgRequired();
                                                ComponentName cn2 = ComponentName.unflattenFromString(value12);
                                                if (cn2 == null) {
                                                    throw new IllegalArgumentException("Bad component name: " + value12);
                                                }
                                                intent2.putExtra(key12, cn2);
                                            }
                                        } else {
                                            String key13 = cmd.getNextArgRequired();
                                            String value13 = cmd.getNextArgRequired();
                                            intent2.putExtra(key13, Uri.parse(value13));
                                        }
                                    } else {
                                        String key14 = cmd.getNextArgRequired();
                                        String value14 = cmd.getNextArgRequired();
                                        intent2.putExtra(key14, Integer.decode(value14));
                                    }
                                } else {
                                    String key15 = cmd.getNextArgRequired();
                                    intent2.putExtra(key15, (String) null);
                                }
                            } else {
                                String key16 = cmd.getNextArgRequired();
                                String value15 = cmd.getNextArgRequired();
                                intent2.putExtra(key16, value15);
                            }
                        } else {
    ...
    public boolean hasCategory(String category) {
        if (this.mCategories != null) {
            return this.mCategories.contains(category);
        }
        return false;
    }
    ...
    public boolean filterEquals(Intent other) {
        return other != null && Objects.equals(this.mAction, other.mAction) && Objects.equals(this.mData, other.mData) && Objects.equals(this.mType, other.mType) && Objects.equals(this.mPackage, other.mPackage) && Objects.equals(this.mComponent, other.mComponent) && Objects.equals(this.mCategories, other.mCategories);
    }
    ...
    public void toShortString(StringBuilder b, boolean secure, boolean comp, boolean extras, boolean clip) {
        ...
        if (this.mClipData != null) {
            ...
            if (clip) {
                ...
                boolean first2 = this.mClipData.getDescription() == null || !this.mClipData.getDescription().toShortStringTypesOnly(b);
    ...
    private void toUriInner(StringBuilder uri, String scheme, String defAction, String defPackage, int flags) {
        ...
        for (String key : this.mExtras.keySet()) {
            ...
            if (value instanceof String) {
                ...
                entryType = value instanceof Short ? SearchManager.MENU_KEY : (char) 0;
            }
            if (entryType != 0) {
    ...
    public static Intent restoreFromXml(XmlPullParser in) throws XmlPullParserException, IOException {
        Intent intent = new Intent();
    ...
    public void fixUris(int contentUserHint) {
        ...
        if ((!MediaStore.ACTION_IMAGE_CAPTURE.equals(action) && !MediaStore.ACTION_IMAGE_CAPTURE_SECURE.equals(action) && !MediaStore.ACTION_VIDEO_CAPTURE.equals(action)) || (output = (Uri) getParcelableExtra(MediaStore.EXTRA_OUTPUT)) == null) {
            return;
        }
