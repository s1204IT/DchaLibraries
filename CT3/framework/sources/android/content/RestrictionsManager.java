...
public class RestrictionsManager {
    ...
    private RestrictionEntry loadRestrictionElement(Context appContext, XmlResourceParser xml) throws XmlPullParserException, IOException {
    ...
    private RestrictionEntry loadRestriction(Context appContext, TypedArray a, XmlResourceParser xml) throws XmlPullParserException, BlockGuard.BlockGuardPolicyException, IOException {
    ...
    private static Bundle addRestrictionToBundle(Bundle bundle, RestrictionEntry entry) {
        switch (entry.getType()) {
            ...
            case 5:
                ...
                return bundle;
            case 7:
                Bundle childBundle = convertRestrictionsToBundle(Arrays.asList(entry.getRestrictions()));
