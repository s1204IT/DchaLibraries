...
public class NanoAppInstanceInfo {
    ...
    NanoAppInstanceInfo(Parcel in, NanoAppInstanceInfo nanoAppInstanceInfo) {
        this(in);
    }
    ...
    public String toString() {
        ...
        return (((retVal + ", Id : 0x" + Long.toHexString(this.mAppId)) + ", Version : " + this.mAppVersion) + ", Name : " + this.mName) + ", Publisher : " + this.mPublisher;
    }
}
