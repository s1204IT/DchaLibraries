...
public interface IActivityRecognitionHardwareSink extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IActivityRecognitionHardwareSink {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ActivityChangedEvent activityChangedEventCreateFromParcel;
            switch (code) {
                case 1:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        activityChangedEventCreateFromParcel = ActivityChangedEvent.CREATOR.createFromParcel(data);
                    } else {
                        activityChangedEventCreateFromParcel = null;
                    }
                    onActivityChanged(activityChangedEventCreateFromParcel);
