...
public class HdmiTimerRecordSources {
    ...
    public static TimerRecordSource ofExternalPlug(TimerInfo timerInfo, HdmiRecordSources.ExternalPlugData externalPlugData) {
        ...
        return new TimerRecordSource(timerInfo, new ExternalSourceDecorator(externalPlugData, 4, null), 0 == true ? 1 : 0);
    }
    ...
    public static TimerRecordSource ofExternalPhysicalAddress(TimerInfo timerInfo, HdmiRecordSources.ExternalPhysicalAddress externalPhysicalAddress) {
        ...
        return new TimerRecordSource(timerInfo, new ExternalSourceDecorator(externalPhysicalAddress, 5, null), 0 == true ? 1 : 0);
    }
    ...
    public static final class Time extends TimeUnit {
        Time(int hour, int minute, Time time) {
            this(hour, minute);
        }
    ...
    public static final class Duration extends TimeUnit {
        Duration(int hour, int minute, Duration duration) {
            this(hour, minute);
        }
    ...
    public static final class TimerInfo {
        ...
        TimerInfo(int dayOfMonth, int monthOfYear, Time startTime, Duration duration, int recordingSequence, TimerInfo timerInfo) {
    ...
    private static class ExternalSourceDecorator extends HdmiRecordSources.RecordSource {
        ...
        ExternalSourceDecorator(HdmiRecordSources.RecordSource recordSource, int externalSourceSpecifier, ExternalSourceDecorator externalSourceDecorator) {
