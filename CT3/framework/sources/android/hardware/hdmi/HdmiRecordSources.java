...
public final class HdmiRecordSources {
    ...
    private static final class ChannelIdentifier {
        ...
        ChannelIdentifier(int format, int majorNumber, int minorNumer, ChannelIdentifier channelIdentifier) {
    ...
    public static DigitalServiceSource ofDigitalChannelId(int broadcastSystem, DigitalChannelData data) {
        DigitalServiceSource digitalServiceSource = null;
        if (data == null) {
        ...
        switch (broadcastSystem) {
            ...
            case 26:
            case 27:
                return new DigitalServiceSource(1, broadcastSystem, data, digitalServiceSource);
            case 3:
            case 4:
            case 5:
            case 6:
    ...
    public static DigitalServiceSource ofArib(int aribType, AribData data) {
        ...
        switch (aribType) {
            ...
            case 9:
            case 10:
                return new DigitalServiceSource(0, aribType, data, digitalServiceSource);
            default:
    ...
    public static DigitalServiceSource ofAtsc(int atscType, AtscData data) {
        ...
        switch (atscType) {
            ...
            case 17:
            case 18:
                return new DigitalServiceSource(0, atscType, data, digitalServiceSource);
            default:
    ...
    public static DigitalServiceSource ofDvb(int dvbType, DvbData data) {
        ...
        switch (dvbType) {
            ...
            case 26:
            case 27:
                return new DigitalServiceSource(0, dvbType, data, digitalServiceSource);
            default:
    ...
    public static final class DigitalServiceSource extends RecordSource {
        ...
        DigitalServiceSource(int identificatinoMethod, int broadcastSystem, DigitalServiceIdentification identification, DigitalServiceSource digitalServiceSource) {
    ...
    public static final class AnalogueServiceSource extends RecordSource {
        ...
        AnalogueServiceSource(int broadcastType, int frequency, int broadcastSystem, AnalogueServiceSource analogueServiceSource) {
    ...
    public static final class ExternalPlugData extends RecordSource {
        ...
        ExternalPlugData(int plugNumber, ExternalPlugData externalPlugData) {
            this(plugNumber);
        }
    ...
    public static final class ExternalPhysicalAddress extends RecordSource {
        ...
        ExternalPhysicalAddress(int physicalAddress, ExternalPhysicalAddress externalPhysicalAddress) {
