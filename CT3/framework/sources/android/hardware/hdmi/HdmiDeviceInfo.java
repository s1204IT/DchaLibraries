...
public class HdmiDeviceInfo implements Parcelable {
    ...
    public String toString() {
        ...
        switch (this.mHdmiDeviceType) {
            ...
            case 1:
                s.append("MHL: ");
                s.append("device_id: ").append(String.format("0x%04X", Integer.valueOf(this.mDeviceId))).append(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER);
                s.append("adopter_id: ").append(String.format("0x%04X", Integer.valueOf(this.mAdopterId))).append(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER);
                break;
            case 2:
                s.append("Hardware: ");
                break;
    ...
    public boolean equals(Object obj) {
        return (obj instanceof HdmiDeviceInfo) && this.mHdmiDeviceType == obj.mHdmiDeviceType && this.mPhysicalAddress == obj.mPhysicalAddress && this.mPortId == obj.mPortId && this.mLogicalAddress == obj.mLogicalAddress && this.mDeviceType == obj.mDeviceType && this.mVendorId == obj.mVendorId && this.mDevicePowerStatus == obj.mDevicePowerStatus && this.mDisplayName.equals(obj.mDisplayName) && this.mDeviceId == obj.mDeviceId && this.mAdopterId == obj.mAdopterId;
    }
}
