...
public final class DngCreator implements AutoCloseable {
    ...
    public DngCreator(CameraCharacteristics characteristics, CaptureResult metadata) {
        ...
        String formattedCaptureTime = sDateTimeStampFormat.format(Long.valueOf(timestamp != null ? (timestamp.longValue() / 1000000) + bootTimeMillis : captureTime));
