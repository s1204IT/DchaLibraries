...
public final class OutputConfiguration implements Parcelable {
    public static final Parcelable.Creator<OutputConfiguration> CREATOR = new Parcelable.Creator<OutputConfiguration>() {
        ...
        public OutputConfiguration createFromParcel(Parcel source) {
            try {
                OutputConfiguration outputConfiguration = new OutputConfiguration(source, (OutputConfiguration) null);
    ...
    OutputConfiguration(Parcel source, OutputConfiguration outputConfiguration) {
        this(source);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mRotation == other.mRotation && this.mSurface == other.mSurface && this.mConfiguredGenerationId == other.mConfiguredGenerationId && this.mConfiguredSize.equals(other.mConfiguredSize) && this.mConfiguredFormat == other.mConfiguredFormat && this.mConfiguredDataspace == other.mConfiguredDataspace) {
            return this.mSurfaceGroupId == other.mSurfaceGroupId;
        }
        return false;
    }
