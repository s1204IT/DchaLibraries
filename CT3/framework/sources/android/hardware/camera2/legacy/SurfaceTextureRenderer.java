...
public class SurfaceTextureRenderer {
    ...
    private class EGLSurfaceHolder {
        ...
        EGLSurfaceHolder(SurfaceTextureRenderer this$0, EGLSurfaceHolder eGLSurfaceHolder) {
            this();
        }
    ...
    private void configureEGLContext() {
        ...
        int[] attribList = {EGL14.EGL_RED_SIZE, 8, EGL14.EGL_GREEN_SIZE, 8, EGL14.EGL_BLUE_SIZE, 8, EGL14.EGL_RENDERABLE_TYPE, 4, EGL_RECORDABLE_ANDROID, 1, EGL14.EGL_SURFACE_TYPE, 5, EGL14.EGL_NONE};
        ...
        int[] attrib_list = {12440, 2, EGL14.EGL_NONE};
    ...
    private void releaseEGLContext() throws Throwable {
        if (this.mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
    ...
    private void dumpGlTiming() throws Throwable {
    ...
    public void configureSurfaces(Collection<Pair<Surface, Size>> surfaces) throws Throwable {
        releaseEGLContext();
        if (surfaces == null || surfaces.size() == 0) {
    ...
    public void cleanupEGLContext() throws Throwable {
        releaseEGLContext();
    }
