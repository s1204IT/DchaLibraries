...
public class RequestHolder {
    ...
    RequestHolder(int requestId, int subsequenceId, CaptureRequest request, boolean repeating, long frameNumber, int numJpegTargets, int numPreviewTargets, Collection jpegSurfaceIds, RequestHolder requestHolder) {
