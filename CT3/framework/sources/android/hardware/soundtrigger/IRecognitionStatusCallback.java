...
public interface IRecognitionStatusCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRecognitionStatusCallback {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            SoundTrigger.GenericRecognitionEvent genericRecognitionEventCreateFromParcel;
            SoundTrigger.KeyphraseRecognitionEvent keyphraseRecognitionEventCreateFromParcel;
            switch (code) {
                case 1:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        keyphraseRecognitionEventCreateFromParcel = SoundTrigger.KeyphraseRecognitionEvent.CREATOR.createFromParcel(data);
                    } else {
                        keyphraseRecognitionEventCreateFromParcel = null;
                    }
                    onKeyphraseDetected(keyphraseRecognitionEventCreateFromParcel);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        genericRecognitionEventCreateFromParcel = SoundTrigger.GenericRecognitionEvent.CREATOR.createFromParcel(data);
                    } else {
                        genericRecognitionEventCreateFromParcel = null;
                    }
                    onGenericSoundTriggerDetected(genericRecognitionEventCreateFromParcel);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
