...
public interface IInputManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputManager {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            InputDeviceIdentifier inputDeviceIdentifierCreateFromParcel;
            InputMethodInfo inputMethodInfo;
            InputMethodSubtype inputMethodSubtype;
            InputDeviceIdentifier inputDeviceIdentifierCreateFromParcel2;
            InputMethodInfo inputMethodInfo2;
            InputMethodSubtype inputMethodSubtype2;
            InputDeviceIdentifier inputDeviceIdentifierCreateFromParcel3;
            InputDeviceIdentifier inputDeviceIdentifierCreateFromParcel4;
            InputDeviceIdentifier inputDeviceIdentifierCreateFromParcel5;
            InputDeviceIdentifier inputDeviceIdentifierCreateFromParcel6;
            InputDeviceIdentifier inputDeviceIdentifierCreateFromParcel7;
            InputDeviceIdentifier inputDeviceIdentifierCreateFromParcel8;
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    boolean _result3 = hasKeys(_arg02, _arg1, _arg2, zArr);
                    reply.writeNoException();
                ...
                case 5:
                    ...
                    boolean _result4 = injectInputEvent(inputEvent, _arg12);
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    TouchCalibration _result5 = getTouchCalibrationForInputDevice(_arg04, _arg13);
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 7:
                    ...
                    if (data.readInt() != 0) {
                        touchCalibrationCreateFromParcel = TouchCalibration.CREATOR.createFromParcel(data);
                    } else {
                        touchCalibrationCreateFromParcel = null;
                    }
                    setTouchCalibrationForInputDevice(_arg05, _arg14, touchCalibrationCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputDeviceIdentifierCreateFromParcel8 = InputDeviceIdentifier.CREATOR.createFromParcel(data);
                    } else {
                        inputDeviceIdentifierCreateFromParcel8 = null;
                    }
                    KeyboardLayout[] _result7 = getKeyboardLayoutsForInputDevice(inputDeviceIdentifierCreateFromParcel8);
                    reply.writeNoException();
                ...
                case 10:
                    ...
                    KeyboardLayout _result8 = getKeyboardLayout(_arg06);
                    reply.writeNoException();
                    if (_result8 != null) {
                        reply.writeInt(1);
                ...
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputDeviceIdentifierCreateFromParcel7 = InputDeviceIdentifier.CREATOR.createFromParcel(data);
                    } else {
                        inputDeviceIdentifierCreateFromParcel7 = null;
                    }
                    String _result9 = getCurrentKeyboardLayoutForInputDevice(inputDeviceIdentifierCreateFromParcel7);
                    reply.writeNoException();
                ...
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputDeviceIdentifierCreateFromParcel6 = InputDeviceIdentifier.CREATOR.createFromParcel(data);
                    } else {
                        inputDeviceIdentifierCreateFromParcel6 = null;
                    }
                    String _arg15 = data.readString();
                    setCurrentKeyboardLayoutForInputDevice(inputDeviceIdentifierCreateFromParcel6, _arg15);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputDeviceIdentifierCreateFromParcel5 = InputDeviceIdentifier.CREATOR.createFromParcel(data);
                    } else {
                        inputDeviceIdentifierCreateFromParcel5 = null;
                    }
                    String[] _result10 = getEnabledKeyboardLayoutsForInputDevice(inputDeviceIdentifierCreateFromParcel5);
                    reply.writeNoException();
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputDeviceIdentifierCreateFromParcel4 = InputDeviceIdentifier.CREATOR.createFromParcel(data);
                    } else {
                        inputDeviceIdentifierCreateFromParcel4 = null;
                    }
                    String _arg16 = data.readString();
                    addKeyboardLayoutForInputDevice(inputDeviceIdentifierCreateFromParcel4, _arg16);
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputDeviceIdentifierCreateFromParcel3 = InputDeviceIdentifier.CREATOR.createFromParcel(data);
                    } else {
                        inputDeviceIdentifierCreateFromParcel3 = null;
                    }
                    String _arg17 = data.readString();
                    removeKeyboardLayoutForInputDevice(inputDeviceIdentifierCreateFromParcel3, _arg17);
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputDeviceIdentifierCreateFromParcel2 = InputDeviceIdentifier.CREATOR.createFromParcel(data);
                    } else {
                        inputDeviceIdentifierCreateFromParcel2 = null;
                    }
                    if (data.readInt() != 0) {
                        inputMethodInfo2 = (InputMethodInfo) InputMethodInfo.CREATOR.createFromParcel(data);
                    } else {
                        inputMethodInfo2 = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    KeyboardLayout _result11 = getKeyboardLayoutForInputDevice(inputDeviceIdentifierCreateFromParcel2, inputMethodInfo2, inputMethodSubtype2);
                    reply.writeNoException();
                    if (_result11 != null) {
                        reply.writeInt(1);
                ...
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputDeviceIdentifierCreateFromParcel = InputDeviceIdentifier.CREATOR.createFromParcel(data);
                    } else {
                        inputDeviceIdentifierCreateFromParcel = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    setKeyboardLayoutForInputDevice(inputDeviceIdentifierCreateFromParcel, inputMethodInfo, inputMethodSubtype, _arg3);
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    IInputDevicesChangedListener _arg07 = IInputDevicesChangedListener.Stub.asInterface(data.readStrongBinder());
                    registerInputDevicesChangedListener(_arg07);
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    ITabletModeChangedListener _arg08 = ITabletModeChangedListener.Stub.asInterface(data.readStrongBinder());
                    registerTabletModeChangedListener(_arg08);
                    reply.writeNoException();
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    vibrate(_arg09, _arg18, _arg22, _arg32);
                    reply.writeNoException();
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    cancelVibrate(_arg010, _arg19);
                    reply.writeNoException();
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg011 = data.readInt();
                    setPointerIconType(_arg011);
                    reply.writeNoException();
                    return true;
                case 24:
                    data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements IInputManager {
            ...
            public TouchCalibration getTouchCalibrationForInputDevice(String inputDeviceDescriptor, int rotation) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        touchCalibrationCreateFromParcel = TouchCalibration.CREATOR.createFromParcel(_reply);
                    } else {
                        touchCalibrationCreateFromParcel = null;
                    }
            ...
            public KeyboardLayout getKeyboardLayout(String keyboardLayoutDescriptor) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        keyboardLayoutCreateFromParcel = KeyboardLayout.CREATOR.createFromParcel(_reply);
                    } else {
