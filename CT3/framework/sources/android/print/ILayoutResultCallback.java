...
public interface ILayoutResultCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILayoutResultCallback {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            PrintDocumentInfo printDocumentInfoCreateFromParcel;
            switch (code) {
                case 1:
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        printDocumentInfoCreateFromParcel = PrintDocumentInfo.CREATOR.createFromParcel(data);
                    } else {
                        printDocumentInfoCreateFromParcel = null;
                    }
                    boolean _arg12 = data.readInt() != 0;
                    int _arg2 = data.readInt();
                    onLayoutFinished(printDocumentInfoCreateFromParcel, _arg12, _arg2);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onLayoutFailed(charSequence, _arg13);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg02 = data.readInt();
                    onLayoutCanceled(_arg02);
                    return true;
