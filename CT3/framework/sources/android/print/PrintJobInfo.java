...
public final class PrintJobInfo implements Parcelable {
    ...
    private PrintJobInfo(Parcel parcel) {
        ...
        Preconditions.checkArgument(this.mAdvancedOptions.containsKey(null) ? false : true);
    }
    ...
    public boolean hasAdvancedOption(String key) {
        if (this.mAdvancedOptions != null) {
            return this.mAdvancedOptions.containsKey(key);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        builder.append(", documentInfo: ").append(this.mDocumentInfo != null ? this.mDocumentInfo.toString() : null);
        builder.append(", cancelling: ").append(this.mCanceling);
        builder.append(", pages: ").append(this.mPageRanges != null ? Arrays.toString(this.mPageRanges) : null);
        builder.append(", hasAdvancedOptions: ").append(this.mAdvancedOptions != null);
        builder.append(", progress: ").append(this.mProgress);
        builder.append(", status: ").append(this.mStatus != null ? this.mStatus.toString() : null);
        builder.append(", statusRes: ").append(this.mStatusRes);
        builder.append(", statusResAppPackageName: ").append(this.mStatusResAppPackageName != null ? this.mStatusResAppPackageName.toString() : null);
        builder.append("}");
