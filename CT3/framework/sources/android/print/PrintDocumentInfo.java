...
public final class PrintDocumentInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<PrintDocumentInfo> CREATOR = new Parcelable.Creator<PrintDocumentInfo>() {
        ...
        public PrintDocumentInfo createFromParcel(Parcel parcel) {
            return new PrintDocumentInfo(parcel, (PrintDocumentInfo) null);
        }
    ...
    PrintDocumentInfo(PrintDocumentInfo printDocumentInfo, PrintDocumentInfo printDocumentInfo2) {
        this();
    }

    PrintDocumentInfo(PrintDocumentInfo prototype, PrintDocumentInfo printDocumentInfo, PrintDocumentInfo printDocumentInfo2) {
        this(prototype);
    }
    ...
    public int hashCode() {
        int result = (this.mName != null ? this.mName.hashCode() : 0) + 31;
    ...
    public static final class Builder {
        ...
        public Builder(String name) {
            ...
            this.mPrototype = new PrintDocumentInfo(printDocumentInfo, printDocumentInfo);
        ...
        public PrintDocumentInfo build() {
            ...
            return new PrintDocumentInfo(this.mPrototype, printDocumentInfo, printDocumentInfo);
        }
    }
}
