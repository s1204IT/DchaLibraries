            ...
            public void handleMessage(Message message) {
                switch (message.what) {
                    case 1:
                        ...
                        break;
                    case 2:
                        PrintServicesChangeListenerWrapper wrapper2 = (PrintServicesChangeListenerWrapper) message.obj;
                        PrintServicesChangeListener listener2 = wrapper2.getListener();
                        if (listener2 != null) {
                            listener2.onPrintServicesChanged();
                        }
                        break;
                    case 3:
                        PrintServiceRecommendationsChangeListenerWrapper wrapper3 = (PrintServiceRecommendationsChangeListenerWrapper) message.obj;
                        PrintServiceRecommendationsChangeListener listener3 = wrapper3.getListener();
                        if (listener3 != null) {
            ...
            public void onWriteFinished(PageRange[] pages) {
                ...
                try {
                    ...
                    try {
                        ...
                        Log.e(PrintManager.LOG_TAG, "PrintDocumentAdapter is destroyed or under destroy");
                        this.mCallback = null;
                    }
                } finally {
                    destroy();
