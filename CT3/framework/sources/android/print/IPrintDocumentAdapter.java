        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    if (data.readInt() != 0) {
                        printAttributesCreateFromParcel2 = PrintAttributes.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    layout(printAttributesCreateFromParcel, printAttributesCreateFromParcel2, _arg2, bundleCreateFromParcel, _arg4);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    write(_arg02, parcelFileDescriptorCreateFromParcel, _arg22, _arg3);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    finish();
