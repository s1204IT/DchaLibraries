...
public class FrameFormat {
    ...
    public MutableFrameFormat mutableCopy() {
        ...
        result.mMetaData = this.mMetaData != null ? (KeyValueMap) this.mMetaData.clone() : null;
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof FrameFormat) && obj.mBaseType == this.mBaseType && obj.mTarget == this.mTarget && obj.mBytesPerSample == this.mBytesPerSample && Arrays.equals(obj.mDimensions, this.mDimensions)) {
            return obj.mMetaData.equals(this.mMetaData);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        String classString = this.mObjectClass == null ? ProxyInfo.LOCAL_EXCL_LIST : " class(" + this.mObjectClass.getSimpleName() + ") ";
