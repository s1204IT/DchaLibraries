...
public class AsyncRunner extends GraphRunner {
    ...
    private class RunnerResult {
        ...
        RunnerResult(AsyncRunner this$0, RunnerResult runnerResult) {
            this();
        }
    ...
    private class AsyncRunnerTask extends AsyncTask<SyncRunner, Void, RunnerResult> {
        ...
        AsyncRunnerTask(AsyncRunner this$0, AsyncRunnerTask asyncRunnerTask) {
            this();
        }
        ...
        protected void onPostExecute(RunnerResult result) {
            ...
            if (result == null) {
                result = new RunnerResult(AsyncRunner.this, runnerResult);
                result.status = 5;
            }
