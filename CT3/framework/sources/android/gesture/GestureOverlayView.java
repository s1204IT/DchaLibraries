...
public class GestureOverlayView extends FrameLayout {
    ...
    private void touchUp(MotionEvent event, boolean cancel) {
        ...
        if (this.mCurrentGesture != null) {
            ...
            if (!cancel) {
                ...
                clear(this.mHandleGestureActions ? this.mFadeEnabled : false, this.mHandleGestureActions ? this.mIsGesturing : false, false);
            } else {
                cancelGesture(event);
            }
        } else {
    ...
    private class FadeOutRunnable implements Runnable {
        ...
        FadeOutRunnable(GestureOverlayView this$0, FadeOutRunnable fadeOutRunnable) {
            this();
        }
