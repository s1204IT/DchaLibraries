...
public class DevicePolicyManager {
    ...
    private DevicePolicyManager(Context context, boolean parentInstance) {
        this(context, IDevicePolicyManager.Stub.asInterface(ServiceManager.getService(Context.DEVICE_POLICY_SERVICE)), parentInstance);
    }
    ...
    public void setPasswordQuality(ComponentName admin, int quality) {
        if (quality != 0 || this.mService == null) {
            return;
        }
        try {
    ...
    public boolean installKeyPair(ComponentName admin, PrivateKey privKey, Certificate[] certs, String alias, boolean requestAccess) {
        ...
        try {
            ...
            return this.mService.installKeyPair(admin, pkcs8Key, pemCert, pemChain, alias, requestAccess);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
    ...
    public void setAlwaysOnVpnPackage(ComponentName admin, String vpnPackage) throws UnsupportedOperationException, PackageManager.NameNotFoundException {
        setAlwaysOnVpnPackage(admin, vpnPackage, true);
    }

    public void setAlwaysOnVpnPackage(ComponentName admin, String vpnPackage, boolean lockdownEnabled) throws UnsupportedOperationException, PackageManager.NameNotFoundException {
    ...
    public boolean setDeviceOwner(ComponentName who, String ownerName, int userId) throws IllegalStateException, IllegalArgumentException {
        if (this.mService != null) {
            try {
