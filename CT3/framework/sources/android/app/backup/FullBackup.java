...
public class FullBackup {
    ...
    public static class BackupScheme {
        ...
        public synchronized Map<String, Set<String>> maybeParseAndGetCanonicalIncludePaths() throws XmlPullParserException, IOException {
        ...
        public synchronized ArraySet<String> maybeParseAndGetCanonicalExcludePaths() throws XmlPullParserException, IOException {
        ...
        public void parseBackupSchemeFromXmlLocked(XmlPullParser parser, Set<String> excludes, Map<String, Set<String>> includes) throws XmlPullParserException, IOException {
        ...
        private Set<String> parseCurrentTagForDomain(XmlPullParser parser, Set<String> excludes, Map<String, Set<String>> includes, String domain) throws XmlPullParserException {
            if ("include".equals(parser.getName())) {
                ...
                if (includeSet == null) {
                    Set<String> includeSet2 = new ArraySet<>();
