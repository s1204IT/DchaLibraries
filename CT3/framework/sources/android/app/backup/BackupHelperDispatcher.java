...
public class BackupHelperDispatcher {
    ...
    public void performRestore(BackupDataInput input, int appVersionCode, ParcelFileDescriptor newState) throws IOException {
        ...
        Iterator helper$iterator = this.mHelpers.values().iterator();
        while (helper$iterator.hasNext()) {
            ((BackupHelper) helper$iterator.next()).writeNewStateDescription(newState);
        }
    }
}
