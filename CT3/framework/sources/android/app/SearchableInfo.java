...
public final class SearchableInfo implements Parcelable {
    ...
    public static class ActionKeyInfo implements Parcelable {
        ...
        ActionKeyInfo(Parcel in, ActionKeyInfo actionKeyInfo) {
            this(in);
        }
            ...
            if (tagType == 2) {
                try {
                    if (xml.getName().equals("searchable")) {
                        ...
                        if (attr2 != null) {
                            try {
                                result2.addActionKey(new ActionKeyInfo(activityContext, attr2));
    ...
    SearchableInfo(Parcel in) {
        ActionKeyInfo actionKeyInfo = null;
        ...
        for (int count = in.readInt(); count > 0; count--) {
            addActionKey(new ActionKeyInfo(in, actionKeyInfo));
        }
