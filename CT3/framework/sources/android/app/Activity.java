...
public class Activity extends ContextThemeWrapper implements LayoutInflater.Factory2, Window.Callback, KeyEvent.Callback, View.OnCreateContextMenuListener, ComponentCallbacks2, Window.OnWindowDismissedCallback, Window.WindowControllerCallback {
    ...
    private void restoreManagedDialogs(Bundle savedInstanceState) {
        ...
        for (int i : ids) {
            ...
            if (dialogState != null) {
                ManagedDialog md = new ManagedDialog(managedDialog);
    ...
    public boolean isVoiceInteractionRoot() {
        try {
            if (this.mVoiceInteractor != null) {
                return ActivityManagerNative.getDefault().isRootVoiceInteraction(this.mToken);
            }
            return false;
    ...
    public void onBackPressed() {
        if ((this.mActionBar != null && this.mActionBar.collapseActionView()) || this.mFragments.getFragmentManager().popBackStackImmediate()) {
            return;
        }
    ...
    public boolean onKeyShortcut(int keyCode, KeyEvent event) {
        ...
        if (actionBar != null) {
            return actionBar.onKeyShortcut(keyCode, event);
        }
        return false;
    }
    ...
    public final boolean showDialog(int id, Bundle args) {
        ...
        if (md == null) {
            md = new ManagedDialog(managedDialog);
    ...
    private void startIntentSenderForResultInner(IntentSender intent, String who, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, Bundle options) throws IntentSender.SendIntentException {
        ...
        if (fillInIntent != null) {
            try {
                ...
                result = ActivityManagerNative.getDefault().startActivityIntentSender(this.mMainThread.getApplicationThread(), intent, fillInIntent, resolvedType, this.mToken, who, requestCode, flagsMask, flagsValues, options);
                if (result != -6) {
    ...
    public void startActivityForResult(String who, Intent intent, int requestCode, Bundle options) {
        ...
        Instrumentation.ActivityResult ar = this.mInstrumentation.execStartActivity(this, this.mMainThread.getApplicationThread(), this.mToken, who, intent, requestCode, options);
        if (ar != null) {
    ...
    public final void setSecondaryProgress(int secondaryProgress) {
        getWindow().setFeatureInt(2, secondaryProgress + HealthKeys.BASE_PID);
    }
    ...
    final void performPause() throws SuperNotCalledException {
        this.mDoReportFullyDrawn = false;
    ...
    void dispatchActivityResult(String who, int requestCode, int resultCode, Intent data) {
        ...
        if (who.startsWith(REQUEST_PERMISSIONS_WHO_PREFIX)) {
