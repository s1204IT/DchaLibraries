...
class ApplicationThreadProxy implements IApplicationThread {
    ...
    @Override
    public void dumpMemInfo(FileDescriptor fd, Debug.MemoryInfo mem, boolean checkin, boolean dumpInfo, boolean dumpDalvik, boolean dumpSummaryOnly, boolean dumpUnreachable, String[] args) throws RemoteException {
        Parcel data = Parcel.obtain();
