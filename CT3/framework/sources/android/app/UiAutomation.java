                ...
                synchronized (this.mLock) {
                    ...
                    while (!isConnectedLocked()) {
                        try {
                            ...
                            long remainingTimeMillis = CONNECT_TIMEOUT_MILLIS - elapsedTimeMillis;
        ...
        public IAccessibilityServiceClientImpl(Looper looper) {
            super(null, looper, new AccessibilityService.Callbacks() {
                ...
                public void init(int connectionId, IBinder windowToken) {
                    synchronized (val$this$0.mLock) {
                        val$this$0.mConnectionId = connectionId;
                        val$this$0.mLock.notifyAll();
                    }
                }
                ...
                public void onAccessibilityEvent(AccessibilityEvent event) {
                    synchronized (val$this$0.mLock) {
                        val$this$0.mLastEventTimeMillis = event.getEventTime();
                        if (val$this$0.mWaitingForEventDelivery) {
                            val$this$0.mEventQueue.add(AccessibilityEvent.obtain(event));
                        }
                        val$this$0.mLock.notifyAll();
                    }
                    OnAccessibilityEventListener listener = val$this$0.mOnAccessibilityEventListener;
                    if (listener == null) {
                        return;
                    }
