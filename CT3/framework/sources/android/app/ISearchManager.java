        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    SearchableInfo _result = getSearchableInfo(componentNameCreateFromParcel);
                ...
                case 6:
                    ...
                    launchAssist(bundleCreateFromParcel2);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    boolean _result6 = launchLegacyAssist(_arg0, _arg1, bundleCreateFromParcel);
                    reply.writeNoException();
        ...
        private static class Proxy implements ISearchManager {
            ...
            public SearchableInfo getSearchableInfo(ComponentName launchActivity) throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        searchableInfoCreateFromParcel = SearchableInfo.CREATOR.createFromParcel(_reply);
                    } else {
