...
public class ActivityView extends ViewGroup {
    ...
    public ActivityView(Context context, AttributeSet attributeSet, int i) {
        ...
        boolean z = false;
        this.mExecutor = new SerialExecutor(null);
        ...
        try {
            ...
            this.mTextureView = new TextureView(baseContext);
            this.mTextureView.setSurfaceTextureListener(new ActivityViewSurfaceTextureListener(this, z ? 1 : 0));
    ...
    private boolean injectInputEvent(InputEvent event) {
        if (this.mActivityContainer != null) {
            return this.mActivityContainer.injectEvent(event);
        }
        return false;
    }
    ...
    private class ActivityViewSurfaceTextureListener implements TextureView.SurfaceTextureListener {
        ActivityViewSurfaceTextureListener(ActivityView this$0, ActivityViewSurfaceTextureListener activityViewSurfaceTextureListener) {
            this();
        }
    ...
    private static class ActivityContainerCallback extends IActivityContainerCallback.Stub {
        ...
        public void onAllActivitiesComplete(IBinder container) {
            ...
            activityView.post(new Runnable() {
                @Override
                public void run() {
                    ActivityViewCallback callback2 = (ActivityViewCallback) callbackRef.get();
                    if (callback2 == null) {
                        return;
                    }
                    callback2.onAllActivitiesComplete(activityView);
                }
            });
        }
    }
