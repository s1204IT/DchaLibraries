        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    boolean _result = injectInputEvent(inputEvent, _arg12);
                    reply.writeNoException();
                ...
                case 4:
                    ...
                    boolean _result2 = setRotation(_arg02);
                    reply.writeNoException();
                ...
                case 5:
                    ...
                    Bitmap _result3 = takeScreenshot(_arg03, _arg13);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 6:
                    ...
                    boolean _result4 = clearWindowContentFrameStats(_arg04);
                    reply.writeNoException();
                ...
                case 7:
                    ...
                    WindowContentFrameStats _result5 = getWindowContentFrameStats(_arg05);
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 10:
                    ...
                    executeShellCommand(_arg06, parcelFileDescriptorCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    grantRuntimePermission(_arg07, _arg14, _arg2);
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    revokeRuntimePermission(_arg08, _arg15, _arg22);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
