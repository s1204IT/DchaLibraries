...
public final class RemoteInput implements Parcelable {
    ...
    RemoteInput(Parcel in, RemoteInput remoteInput) {
        this(in);
    }

    RemoteInput(String resultKey, CharSequence label, CharSequence[] choices, int flags, Bundle extras, RemoteInput remoteInput) {
