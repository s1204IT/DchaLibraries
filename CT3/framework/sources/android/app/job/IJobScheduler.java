...
public interface IJobScheduler extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IJobScheduler {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            JobInfo jobInfoCreateFromParcel2;
            switch (code) {
                case 1:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        jobInfoCreateFromParcel2 = JobInfo.CREATOR.createFromParcel(data);
                    } else {
                        jobInfoCreateFromParcel2 = null;
                    }
                    int _result = schedule(jobInfoCreateFromParcel2);
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        jobInfoCreateFromParcel = JobInfo.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    int _result2 = scheduleAsPackage(jobInfoCreateFromParcel, _arg1, _arg2, _arg3);
                    reply.writeNoException();
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    List<JobInfo> _result3 = getAllPendingJobs();
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    JobInfo _result4 = getPendingJob(_arg02);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
        ...
        private static class Proxy implements IJobScheduler {
            ...
            public JobInfo getPendingJob(int jobId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        jobInfoCreateFromParcel = JobInfo.CREATOR.createFromParcel(_reply);
                    } else {
                        jobInfoCreateFromParcel = null;
                    }
