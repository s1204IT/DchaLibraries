...
public class LocalActivityManager {
    ...
    private void moveToState(LocalActivityRecord r, int desiredState) throws SuperNotCalledException {
    ...
    public Window startActivity(String id, Intent intent) throws SuperNotCalledException {
    ...
    public void dispatchPause(boolean finishing) throws SuperNotCalledException {
        if (finishing) {
