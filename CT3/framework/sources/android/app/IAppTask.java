        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    int _result2 = startActivity(_arg0, _arg1, intentCreateFromParcel, _arg3, bundleCreateFromParcel);
                    reply.writeNoException();
        ...
        private static class Proxy implements IAppTask {
            ...
            public ActivityManager.RecentTaskInfo getTaskInfo() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        recentTaskInfoCreateFromParcel = ActivityManager.RecentTaskInfo.CREATOR.createFromParcel(_reply);
                    } else {
