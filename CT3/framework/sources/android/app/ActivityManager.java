...
public class ActivityManager {
    ...
    public static class StackId {
        ...
        public static boolean isResizeableByDockedStack(int stackId) {
            return (!isStaticStack(stackId) || stackId == 3 || stackId == 4) ? false : true;
        }

        public static boolean isTaskResizeableByDockedStack(int stackId) {
            return (!isStaticStack(stackId) || stackId == 2 || stackId == 3 || stackId == 4) ? false : true;
        }
        ...
        public static boolean useAnimationSpecForAppTransition(int stackId) {
            return stackId == 2 || stackId == 1 || stackId == 3 || stackId == -1;
        }
        ...
        public static boolean normallyFullscreenWindows(int stackId) {
            return (stackId == 4 || stackId == 2 || stackId == 3) ? false : true;
        }

        public static boolean isMultiWindowStack(int stackId) {
            return isStaticStack(stackId) || stackId == 4 || stackId == 2 || stackId == 3;
        }
    ...
    public static boolean isHighEndGfx() {
        return (isLowRamDeviceStatic() || Resources.getSystem().getBoolean(17956882)) ? false : true;
    }
    ...
    public static class TaskDescription implements Parcelable {
        ...
        public static final Parcelable.Creator<TaskDescription> CREATOR = new Parcelable.Creator<TaskDescription>() {
            ...
            public TaskDescription createFromParcel(Parcel source) {
                return new TaskDescription(source, (TaskDescription) null);
            }
        ...
        TaskDescription(Parcel source, TaskDescription taskDescription) {
            this(source);
        }
    ...
    public static class RecentTaskInfo implements Parcelable {
        ...
        RecentTaskInfo(Parcel source, RecentTaskInfo recentTaskInfo) {
            this(source);
        }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeInt(this.isDockable ? 1 : 0);
        ...
        public void readFromParcel(Parcel source) {
            ...
            this.isDockable = source.readInt() == 1;
    ...
    public static class RunningTaskInfo implements Parcelable {
        ...
        RunningTaskInfo(Parcel source, RunningTaskInfo runningTaskInfo) {
            this(source);
        }
        ...
        public void readFromParcel(Parcel source) {
            ...
            this.isDockable = source.readInt() != 0;
            this.resizeMode = source.readInt();
        }
    ...
    public static class TaskThumbnailInfo implements Parcelable {
        ...
        TaskThumbnailInfo(Parcel source, TaskThumbnailInfo taskThumbnailInfo) {
            this(source);
        }
        ...
        public void restoreFromXml(String attrName, String attrValue) {
            if (ATTR_TASK_WIDTH.equals(attrName)) {
                ...
                if (!ATTR_SCREEN_ORIENTATION.equals(attrName)) {
                    return;
                }
    ...
    public static class TaskThumbnail implements Parcelable {
        ...
        TaskThumbnail(Parcel source, TaskThumbnail taskThumbnail) {
            this(source);
        }
    ...
    public static class RunningServiceInfo implements Parcelable {
        ...
        RunningServiceInfo(Parcel source, RunningServiceInfo runningServiceInfo) {
            this(source);
        }
    ...
    public static class MemoryInfo implements Parcelable {
        ...
        MemoryInfo(Parcel source, MemoryInfo memoryInfo) {
            this(source);
        }
    ...
    public static class StackInfo implements Parcelable {
        ...
        StackInfo(Parcel source, StackInfo stackInfo) {
            this(source);
        }
    ...
    public static class ProcessErrorStateInfo implements Parcelable {
        ...
        ProcessErrorStateInfo(Parcel source, ProcessErrorStateInfo processErrorStateInfo) {
            this(source);
        }
    ...
    public static class RunningAppProcessInfo implements Parcelable {
        ...
        RunningAppProcessInfo(Parcel source, RunningAppProcessInfo runningAppProcessInfo) {
            this(source);
        }
    ...
    public int getPackageImportance(String packageName) {
        try {
            int procState = ActivityManagerNative.getDefault().getPackageProcessState(packageName, this.mContext.getOpPackageName());
    ...
    public static void dumpPackageStateStatic(FileDescriptor fd, String packageName) {
        ...
        dumpService(fastPrintWriter, fd, "package", new String[]{packageName});
        fastPrintWriter.println();
        dumpService(fastPrintWriter, fd, Context.ACTIVITY_SERVICE, new String[]{"-a", "package", packageName});
        fastPrintWriter.println();
        dumpService(fastPrintWriter, fd, "meminfo", new String[]{"--local", "--package", packageName});
        fastPrintWriter.println();
        dumpService(fastPrintWriter, fd, "procstats", new String[]{packageName});
        fastPrintWriter.println();
        dumpService(fastPrintWriter, fd, Context.USAGE_STATS_SERVICE, new String[]{"--packages", packageName});
        fastPrintWriter.println();
        dumpService(fastPrintWriter, fd, BatteryStats.SERVICE_NAME, new String[]{packageName});
