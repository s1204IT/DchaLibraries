...
class ActivityManagerProxy implements IActivityManager {
    ...
    public ParceledListSlice<ActivityManager.RecentTaskInfo> getRecentTasks(int maxNum, int flags, int userId) throws RemoteException {
        ...
        reply.readException();
        ParceledListSlice<ActivityManager.RecentTaskInfo> list = ParceledListSlice.CREATOR.createFromParcel(reply);
        data.recycle();
        reply.recycle();
        return list;
    }
    ...
    public Intent getIntentForIntentSender(IIntentSender sender) throws RemoteException {
        ...
        reply.readException();
        Intent intentCreateFromParcel = reply.readInt() != 0 ? Intent.CREATOR.createFromParcel(reply) : null;
        data.recycle();
        reply.recycle();
    ...
    public IActivityContainer createVirtualActivityContainer(IBinder parentActivityToken, IActivityContainerCallback callback) throws RemoteException {
        IActivityContainer iActivityContainerAsInterface;
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        ...
        int result = reply.readInt();
        if (result == 1) {
            iActivityContainerAsInterface = IActivityContainer.Stub.asInterface(reply.readStrongBinder());
        } else {
            iActivityContainerAsInterface = null;
        }
        data.recycle();
        reply.recycle();
        return iActivityContainerAsInterface;
    }
    ...
    public Bitmap getTaskDescriptionIcon(String filename, int userId) throws RemoteException {
        ...
        reply.readException();
        Bitmap bitmapCreateFromParcel = reply.readInt() == 0 ? null : Bitmap.CREATOR.createFromParcel(reply);
        data.recycle();
        reply.recycle();
