...
public class SearchDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((ViewGroup.LayoutParams) lp).width = -1;
        ((ViewGroup.LayoutParams) lp).height = -1;
        lp.gravity = 55;
        lp.softInputMode = 16;
    ...
    private void createContentView() {
        setContentView(17367254);
        this.mSearchView = (SearchView) findViewById(16909300);
        ...
        this.mAppIcon = (ImageView) findViewById(16909299);
        this.mSearchPlate = this.mSearchView.findViewById(16909306);
        this.mWorkingSpinner = getContext().getDrawable(17303134);
        setWorking(false);
