...
public class FieldPacker {
    ...
    public int subI32() {
        ...
        int i2 = this.mPos - 1;
        this.mPos = i2;
        int v2 = v | ((bArr2[i2] & BatteryStats.HistoryItem.CMD_NULL) << 16);
        byte[] bArr3 = this.mData;
        int i3 = this.mPos - 1;
        this.mPos = i3;
        ...
        int i4 = this.mPos - 1;
        this.mPos = i4;
        return v3 | (bArr4[i4] & BatteryStats.HistoryItem.CMD_NULL);
    }
    ...
    public long subI64() {
        ...
        this.mPos = i;
        byte x = bArr[i];
        long v = 0 | ((((long) x) & 255) << 56);
        byte[] bArr2 = this.mData;
        int i2 = this.mPos - 1;
        this.mPos = i2;
        byte x2 = bArr2[i2];
        long v2 = v | ((((long) x2) & 255) << 48);
        byte[] bArr3 = this.mData;
        int i3 = this.mPos - 1;
        this.mPos = i3;
        byte x3 = bArr3[i3];
        long v3 = v2 | ((((long) x3) & 255) << 40);
        byte[] bArr4 = this.mData;
        int i4 = this.mPos - 1;
        this.mPos = i4;
        byte x4 = bArr4[i4];
        long v4 = v3 | ((((long) x4) & 255) << 32);
        byte[] bArr5 = this.mData;
        int i5 = this.mPos - 1;
        this.mPos = i5;
        byte x5 = bArr5[i5];
        long v5 = v4 | ((((long) x5) & 255) << 24);
        byte[] bArr6 = this.mData;
        int i6 = this.mPos - 1;
        this.mPos = i6;
        byte x6 = bArr6[i6];
        long v6 = v5 | ((((long) x6) & 255) << 16);
        byte[] bArr7 = this.mData;
        int i7 = this.mPos - 1;
        this.mPos = i7;
        byte x7 = bArr7[i7];
        long v7 = v6 | ((((long) x7) & 255) << 8);
        byte[] bArr8 = this.mData;
        int i8 = this.mPos - 1;
        this.mPos = i8;
        byte x8 = bArr8[i8];
        return v7 | (((long) x8) & 255);
    }
    ...
    private void add(Object obj) {
        ...
        if (obj instanceof Long) {
            addI64(obj.longValue());
            return;
        }
        if (obj instanceof Float) {
            addF32(obj.floatValue());
            return;
        }
        if (obj instanceof Double) {
            addF64(obj.doubleValue());
            return;
        }
