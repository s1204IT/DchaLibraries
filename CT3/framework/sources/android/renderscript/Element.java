...
public class Element extends BaseObj {
    ...
    private static final int[] f25androidrenderscriptElement$DataKindSwitchesValues = null;

    private static final int[] f26androidrenderscriptElement$DataTypeSwitchesValues = null;
    int[] mArraySizes;
    ...
    private static int[] m1917getandroidrenderscriptElement$DataKindSwitchesValues() {
        if (f25androidrenderscriptElement$DataKindSwitchesValues != null) {
            return f25androidrenderscriptElement$DataKindSwitchesValues;
        }
        int[] iArr = new int[DataKind.valuesCustom().length];
        try {
        ...
        f25androidrenderscriptElement$DataKindSwitchesValues = iArr;
        return iArr;
    }

    private static int[] m1918getandroidrenderscriptElement$DataTypeSwitchesValues() {
        if (f26androidrenderscriptElement$DataTypeSwitchesValues != null) {
            return f26androidrenderscriptElement$DataTypeSwitchesValues;
        }
        ...
        f26androidrenderscriptElement$DataTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    void updateFromNative() {
        ...
        this.mSize = 0;
        for (DataType dt : DataType.valuesCustom()) {
            if (dt.mID == dataBuffer[0]) {
                this.mType = dt;
                this.mSize = this.mType.mSize * this.mVectorSize;
            }
        }
        for (DataKind dk : DataKind.valuesCustom()) {
    ...
    public static Element createVector(RenderScript rs, DataType dt, int size) {
        ...
        switch (m1918getandroidrenderscriptElement$DataTypeSwitchesValues()[dt.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    public static Element createPixel(RenderScript rs, DataType dt, DataKind dk) {
        ...
        int size = 1;
        switch (m1917getandroidrenderscriptElement$DataKindSwitchesValues()[dk.ordinal()]) {
            case 1:
                size = 2;
                break;
            case 2:
    ...
    public boolean isCompatible(Element e) {
        ...
        if (this.mSize == e.mSize && this.mType != DataType.NONE && this.mType == e.mType) {
            return this.mVectorSize == e.mVectorSize;
        }
        return false;
    }
