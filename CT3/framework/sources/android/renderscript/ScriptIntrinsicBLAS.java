...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public void STRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 49, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 57, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void CTRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 65, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0f, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTRMV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        ...
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 73, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void STBMV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        validateTRMV(Element.F32(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 50, TransA, 0, 0, Uplo, Diag, 0, N, K, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTBMV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        validateTRMV(Element.F64(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 58, TransA, 0, 0, Uplo, Diag, 0, N, K, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void CTBMV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        validateTRMV(Element.F32_2(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 66, TransA, 0, 0, Uplo, Diag, 0, N, K, 0.0f, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTBMV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        validateTRMV(Element.F64_2(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 74, TransA, 0, 0, Uplo, Diag, 0, N, K, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void STPMV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 51, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0f, Ap.getID(this.mRS), X.getID(this.mRS), 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTPMV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 59, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, Ap.getID(this.mRS), X.getID(this.mRS), 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void CTPMV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 67, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0f, 0.0f, Ap.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTPMV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 75, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, 0.0d, Ap.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0L, incX, 0, 0, 0);
    }

    public void STRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        validateTRMV(Element.F32(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 52, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0L, incX, 0, 0, 0);
    }

    public void DTRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        validateTRMV(Element.F64(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 60, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0L, incX, 0, 0, 0);
    }

    public void CTRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        validateTRMV(Element.F32_2(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 68, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0f, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0L, incX, 0, 0, 0);
    }

    public void ZTRSV(int Uplo, int TransA, int Diag, Allocation A, Allocation X, int incX) {
        validateTRMV(Element.F64_2(this.mRS), Uplo, TransA, Diag, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 76, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void STBSV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 53, TransA, 0, 0, Uplo, Diag, 0, N, K, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTBSV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 61, TransA, 0, 0, Uplo, Diag, 0, N, K, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void CTBSV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 69, TransA, 0, 0, Uplo, Diag, 0, N, K, 0.0f, 0.0f, A.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTBSV(int Uplo, int TransA, int Diag, int K, Allocation A, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 77, TransA, 0, 0, Uplo, Diag, 0, N, K, 0.0d, 0.0d, A.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0L, incX, 0, 0, 0);
    }

    public void STPSV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        int N = validateTPMV(Element.F32(this.mRS), Uplo, TransA, Diag, Ap, X, incX);
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 54, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0f, Ap.getID(this.mRS), X.getID(this.mRS), 0.0f, 0L, incX, 0, 0, 0);
    }

    public void DTPSV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        int N = validateTPMV(Element.F64(this.mRS), Uplo, TransA, Diag, Ap, X, incX);
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 62, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, Ap.getID(this.mRS), X.getID(this.mRS), 0.0d, 0L, incX, 0, 0, 0);
    }

    public void CTPSV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        int N = validateTPMV(Element.F32_2(this.mRS), Uplo, TransA, Diag, Ap, X, incX);
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 70, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0f, 0.0f, Ap.getID(this.mRS), X.getID(this.mRS), 0.0f, 0.0f, 0L, incX, 0, 0, 0);
    }

    public void ZTPSV(int Uplo, int TransA, int Diag, Allocation Ap, Allocation X, int incX) {
        int N = validateTPMV(Element.F64_2(this.mRS), Uplo, TransA, Diag, Ap, X, incX);
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 78, TransA, 0, 0, Uplo, Diag, 0, N, 0, 0.0d, 0.0d, Ap.getID(this.mRS), X.getID(this.mRS), 0.0d, 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void SSYR(int Uplo, float alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 83, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, X.getID(this.mRS), A.getID(this.mRS), 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void SSPR(int Uplo, float alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 84, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, X.getID(this.mRS), Ap.getID(this.mRS), 0.0f, 0L, incX, 0, 0, 0);
    }
    ...
    public void DSYR(int Uplo, double alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 91, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, X.getID(this.mRS), A.getID(this.mRS), 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void DSPR(int Uplo, double alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 92, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, X.getID(this.mRS), Ap.getID(this.mRS), 0.0d, 0L, incX, 0, 0, 0);
    }
    ...
    public void CHER(int Uplo, float alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 100, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, 0.0f, X.getID(this.mRS), 0L, 0.0f, 0.0f, A.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void CHPR(int Uplo, float alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 101, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, 0.0f, X.getID(this.mRS), 0L, 0.0f, 0.0f, Ap.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void ZHER(int Uplo, double alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 109, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, 0.0d, X.getID(this.mRS), 0L, 0.0d, 0.0d, A.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void ZHPR(int Uplo, double alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 110, 0, 0, 0, Uplo, 0, 0, N, 0, alpha, 0.0d, X.getID(this.mRS), 0L, 0.0d, 0.0d, Ap.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void SSYMM(int Side, int Uplo, float alpha, Allocation A, Allocation B, float beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 114, 0, 0, Side, Uplo, 0, C.getType().getY(), C.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), beta, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void SSYRK(int Uplo, int Trans, float alpha, Allocation A, float beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 115, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha, A.getID(this.mRS), 0L, beta, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void DSYRK(int Uplo, int Trans, double alpha, Allocation A, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 121, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha, A.getID(this.mRS), 0L, beta, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYRK(int Uplo, int Trans, Float2 alpha, Allocation A, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 127, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), 0L, beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYRK(int Uplo, int Trans, Double2 alpha, Allocation A, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 133, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha.x, alpha.y, A.getID(this.mRS), 0L, beta.x, beta.y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void SSYR2K(int Uplo, int Trans, float alpha, Allocation A, Allocation B, float beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 116, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), K, alpha, A.getID(this.mRS), B.getID(this.mRS), beta, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void STRMM(int Side, int Uplo, int TransA, int Diag, float alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 117, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0L, 0, 0, 0, 0);
    }
    ...
    public void DTRMM(int Side, int Uplo, int TransA, int Diag, double alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 123, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0L, 0, 0, 0, 0);
    }
    ...
    public void CTRMM(int Side, int Uplo, int TransA, int Diag, Float2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 129, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0.0f, 0L, 0, 0, 0, 0);
    }
    ...
    public void ZTRMM(int Side, int Uplo, int TransA, int Diag, Double2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 135, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0.0d, 0L, 0, 0, 0, 0);
    }
    ...
    public void STRSM(int Side, int Uplo, int TransA, int Diag, float alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Single(getID(this.mRS), 118, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0L, 0, 0, 0, 0);
    }
    ...
    public void DTRSM(int Side, int Uplo, int TransA, int Diag, double alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 124, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0L, 0, 0, 0, 0);
    }
    ...
    public void CTRSM(int Side, int Uplo, int TransA, int Diag, Float2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 130, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0.0f, 0L, 0, 0, 0, 0);
    }
    ...
    public void ZTRSM(int Side, int Uplo, int TransA, int Diag, Double2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 136, TransA, 0, Side, Uplo, Diag, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0.0d, 0L, 0, 0, 0, 0);
    }
    ...
    static void validateHEMM(Element e, int Side, Allocation A, Allocation B, Allocation C) {
        ...
        if ((Side == 141 && adim != B.getType().getY()) || (Side == 142 && adim != B.getType().getX())) {
    ...
    public void CHERK(int Uplo, int Trans, float alpha, Allocation A, float beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 138, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), k, alpha, 0.0f, A.getID(this.mRS), 0L, beta, 0.0f, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHERK(int Uplo, int Trans, double alpha, Allocation A, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 141, Trans, 0, 0, Uplo, 0, 0, C.getType().getX(), k, alpha, 0.0d, A.getID(this.mRS), 0L, beta, 0.0d, C.getID(this.mRS), 0, 0, 0, 0);
    }
