...
public final class ParcelableCall implements Parcelable {
    ...
    public String toString() {
        return String.format("[%s, parent:%s, children:%s, handlePresentation:%s,videoCallProvider:%s, videoState:%s]", this.mId, this.mParentCallId, this.mChildCallIds, Integer.valueOf(this.mHandlePresentation), this.mVideoCallProvider, Integer.valueOf(this.mVideoState));
    }
}
