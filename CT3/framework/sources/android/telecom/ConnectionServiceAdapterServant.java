...
final class ConnectionServiceAdapterServant {
        ...
        private void internalHandleMessage(Message msg) throws RemoteException {
            ...
            switch (msg.what) {
                ...
                case 1000:
                    args = (SomeArgs) msg.obj;
                    try {
                        ConnectionServiceAdapterServant.this.mDelegate.handleCreateConferenceComplete((String) args.arg1, (ConnectionRequest) args.arg2, (ParcelableConference) args.arg3);
                        return;
                    } finally {
                    }
                default:
    ...
    private final IConnectionServiceAdapter mStub = new IConnectionServiceAdapter.Stub() {
        ...
        public void handleCreateConferenceComplete(String conferenceId, ConnectionRequest request, ParcelableConference conference) {
            SomeArgs args = SomeArgs.obtain();
            args.arg1 = conferenceId;
            args.arg2 = request;
            args.arg3 = conference;
            ConnectionServiceAdapterServant.this.mHandler.obtainMessage(1000, args).sendToTarget();
        }
    };
