...
public final class DisconnectCause implements Parcelable {
    ...
    public static final Parcelable.Creator<DisconnectCause> CREATOR = new Parcelable.Creator<DisconnectCause>() {
        ...
        public DisconnectCause createFromParcel(Parcel source) {
            ...
            CharSequence label = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(source);
            CharSequence description = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(source);
    ...
    public boolean equals(Object o) {
        ...
        if (Objects.equals(Integer.valueOf(this.mDisconnectCode), Integer.valueOf(d.getCode())) && Objects.equals(this.mDisconnectLabel, d.getLabel()) && Objects.equals(this.mDisconnectDescription, d.getDescription()) && Objects.equals(this.mDisconnectReason, d.getReason())) {
            return Objects.equals(Integer.valueOf(this.mToneToPlay), Integer.valueOf(d.getTone()));
        }
        return false;
    }
    ...
    public String toString() {
        ...
        String description = this.mDisconnectDescription == null ? ProxyInfo.LOCAL_EXCL_LIST : this.mDisconnectDescription.toString();
        String reason = this.mDisconnectReason == null ? ProxyInfo.LOCAL_EXCL_LIST : this.mDisconnectReason;
