...
public class InputMethodService extends AbstractInputMethodService {
    ...
    public class InputMethodImpl extends AbstractInputMethodService.AbstractInputMethodImpl {
        ...
        public void showSoftInput(int flags, ResultReceiver resultReceiver) {
            ...
            InputMethodService.this.mImm.setImeWindowStatus(InputMethodService.this.mToken, (showing ? 2 : 0) | 1, InputMethodService.this.mBackDisposition);
            if (resultReceiver == null) {
                return;
            }
            if (wasVis == InputMethodService.this.isInputViewShown()) {
    ...
    void initViews() {
        ...
        this.mRootView = this.mInflater.inflate(17367149, (ViewGroup) null);
        ...
        this.mFullscreenArea = (ViewGroup) this.mRootView.findViewById(16909185);
    ...
    private void resetStateForNewConfiguration() {
        ...
        this.mImm.setImeWindowStatus(this.mToken, (showing ? 2 : 0) | 1, this.mBackDisposition);
    }
    ...
    public void updateFullscreenMode() {
        View v;
        boolean zOnEvaluateFullscreenMode = this.mShowInputRequested ? onEvaluateFullscreenMode() : false;
        boolean changed = this.mLastShowInputRequested != this.mShowInputRequested;
        if (this.mIsFullscreen != zOnEvaluateFullscreenMode || !this.mFullscreenApplied) {
            changed = true;
            this.mIsFullscreen = zOnEvaluateFullscreenMode;
            InputConnection ic = getCurrentInputConnection();
            if (ic != null) {
                ic.reportFullscreenMode(zOnEvaluateFullscreenMode);
            }
            this.mFullscreenApplied = true;
            initialize();
            LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) this.mFullscreenArea.getLayoutParams();
            if (zOnEvaluateFullscreenMode) {
        ...
        onConfigureWindow(this.mWindow.getWindow(), zOnEvaluateFullscreenMode, !this.mShowInputRequested);
    ...
    public void updateInputViewShown() {
        boolean zOnEvaluateInputViewShown = this.mShowInputRequested ? onEvaluateInputViewShown() : false;
        if (this.mIsInputViewShown == zOnEvaluateInputViewShown || !this.mWindowVisible) {
            return;
        }
        this.mIsInputViewShown = zOnEvaluateInputViewShown;
        this.mInputFrame.setVisibility(zOnEvaluateInputViewShown ? 0 : 8);
    ...
    public void setExtractView(View view) {
        ...
        if (view != null) {
            ...
            this.mExtractAction = view.findViewById(16909187);
            if (this.mExtractAction != null) {
                this.mExtractAccessories = (ViewGroup) view.findViewById(16909186);
            }
            startExtractingText(false);
            return;
        }
    ...
    public View onCreateExtractTextView() {
        return this.mInflater.inflate(17367150, (ViewGroup) null);
    }
    ...
    void showWindowInner(boolean showInput) {
        ...
        int nextImeWindowStatus = (isInputViewShown() ? 2 : 0) | 1;
    ...
    public CharSequence getTextForImeAction(int imeOptions) {
        switch (imeOptions & 255) {
            case 1:
                return null;
            case 2:
                return getText(17040466);
            case 3:
                return getText(17040467);
            case 4:
                return getText(17040468);
            case 5:
                return getText(17040469);
            case 6:
                return getText(17040470);
            case 7:
                return getText(17040471);
            default:
                return getText(17040472);
        }
    }
    ...
    void startExtractingText(boolean inputChanged) {
        ...
        InputConnection ic = getCurrentInputConnection();
        this.mExtractedText = ic != null ? ic.getExtractedText(req, 1) : null;
