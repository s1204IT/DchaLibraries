...
public final class SoundTriggerDetector {
    ...
    SoundTriggerDetector(ISoundTriggerService soundTriggerService, UUID soundModelId, Callback callback, Handler handler) {
        RecognitionCallback recognitionCallback = null;
        ...
        this.mRecognitionCallback = new RecognitionCallback(this, recognitionCallback);
    }
    ...
    private class RecognitionCallback extends IRecognitionStatusCallback.Stub {
        RecognitionCallback(SoundTriggerDetector this$0, RecognitionCallback recognitionCallback) {
            this();
        }
