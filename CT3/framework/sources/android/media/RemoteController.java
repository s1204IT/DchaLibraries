...
public final class RemoteController {
    ...
    public RemoteController(Context context, OnClientUpdateListener onClientUpdateListener, Looper looper) throws IllegalArgumentException {
        ...
        this.mSessionListener = new TopTransportSessionListener(this, objArr == true ? 1 : 0);
    ...
    private class MediaControllerCallback extends MediaController.Callback {
        MediaControllerCallback(RemoteController this$0, MediaControllerCallback mediaControllerCallback) {
            this();
        }
    ...
    private class TopTransportSessionListener implements MediaSessionManager.OnActiveSessionsChangedListener {
        TopTransportSessionListener(RemoteController this$0, TopTransportSessionListener topTransportSessionListener) {
            this();
        }
