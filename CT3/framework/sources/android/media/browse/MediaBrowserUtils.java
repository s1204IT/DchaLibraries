...
public class MediaBrowserUtils {
    public static boolean areSameOptions(Bundle options1, Bundle options2) {
        ...
        return options1 == null ? options2.getInt(MediaBrowser.EXTRA_PAGE, -1) == -1 && options2.getInt(MediaBrowser.EXTRA_PAGE_SIZE, -1) == -1 : options2 == null ? options1.getInt(MediaBrowser.EXTRA_PAGE, -1) == -1 && options1.getInt(MediaBrowser.EXTRA_PAGE_SIZE, -1) == -1 : options1.getInt(MediaBrowser.EXTRA_PAGE, -1) == options2.getInt(MediaBrowser.EXTRA_PAGE, -1) && options1.getInt(MediaBrowser.EXTRA_PAGE_SIZE, -1) == options2.getInt(MediaBrowser.EXTRA_PAGE_SIZE, -1);
    }
