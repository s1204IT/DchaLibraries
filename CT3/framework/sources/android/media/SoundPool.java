...
public class SoundPool {
    ...
    SoundPool(int maxStreams, AudioAttributes attributes, SoundPool soundPool) {
    ...
    private boolean isRestricted() {
        ...
        return (!cameraSoundForced || (this.mAttributes.getAllFlags() & 1) == 0) && (this.mAttributes.getAllFlags() & 64) == 0 && !this.mHasAppOpsPlayAudio;
    }
    ...
    public static class Builder {
        ...
        public SoundPool build() {
            ...
            return new SoundPool(this.mMaxStreams, this.mAudioAttributes, soundPool);
        }
    }
}
