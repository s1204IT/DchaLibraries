        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    sendEvent(_arg0, bundleCreateFromParcel2);
                ...
                case 5:
                    ...
                    setMediaButtonReceiver(pendingIntentCreateFromParcel2);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setLaunchPendingIntent(pendingIntentCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        mediaMetadataCreateFromParcel = MediaMetadata.CREATOR.createFromParcel(data);
                    } else {
                        mediaMetadataCreateFromParcel = null;
                    }
                    setMetadata(mediaMetadataCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        playbackStateCreateFromParcel = PlaybackState.CREATOR.createFromParcel(data);
                    } else {
                        playbackStateCreateFromParcel = null;
                    }
                    setPlaybackState(playbackStateCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setQueue(parceledListSliceCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 12:
                    ...
                    setExtras(bundleCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg04 = data.readInt();
                    setRatingType(_arg04);
                    reply.writeNoException();
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setPlaybackToLocal(audioAttributesCreateFromParcel);
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setPlaybackToRemote(_arg05, _arg1);
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg06 = data.readInt();
                    setCurrentVolume(_arg06);
                    reply.writeNoException();
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
