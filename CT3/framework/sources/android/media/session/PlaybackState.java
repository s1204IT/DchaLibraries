...
public final class PlaybackState implements Parcelable {
    ...
    PlaybackState(int state, long position, long updateTime, float speed, long bufferedPosition, long transportControls, List customActions, long activeItemId, CharSequence error, Bundle extras, PlaybackState playbackState) {
        this(state, position, updateTime, speed, bufferedPosition, transportControls, customActions, activeItemId, error, extras);
    }

    PlaybackState(Parcel in, PlaybackState playbackState) {
        this(in);
    }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        CustomAction(Parcel in, CustomAction customAction) {
            this(in);
        }

        CustomAction(String action, CharSequence name, int icon, Bundle extras, CustomAction customAction) {
