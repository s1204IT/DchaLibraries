                ...
                if (pl.profile == profile) {
                    ...
                    if ((!this.mMime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_H263) || pl.level == level.intValue() || pl.level != 16 || level.intValue() <= 1) && (!this.mMime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_MPEG4) || pl.level == level.intValue() || pl.level != 4 || level.intValue() <= 1)) {
                        if (this.mMime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_HEVC)) {
                            ...
                            boolean checkingHighTier = (level.intValue() & 44739242) != 0;
                            if (!checkingHighTier || supportsHighTier) {
                            }
                        } else if (pl.level >= level.intValue()) {
    ...
    public static final class VideoCapabilities {
        ...
        private boolean supports(Integer width, Integer height, Number rate) {
            ...
            if (ok && height != null && width != null) {
                ...
                boolean ok3 = (ok2 && this.mBlockCountRange.contains(Integer.valueOf(blockCount)) && this.mBlockAspectRatioRange.contains(new Rational(widthInBlocks, heightInBlocks))) ? this.mAspectRatioRange.contains(new Rational(width.intValue(), height.intValue())) : false;
                if (ok3 && rate != null) {
        ...
        private Map<Size, Range<Long>> getMeasuredFrameRates(Map<String, Object> map) {
            ...
            for (String key : keys) {
                if (key.startsWith("measured-frame-rate-")) {
                    ...
                    String[] temp = key.split(ContactsContract.Aas.ENCODE_SYMBOL);
                    if (temp.length == 5) {
        ...
        public static int equivalentVP9Level(MediaFormat info) {
            ...
            long SR = blockRates == null ? 0L : ((long) BS) * ((Long) blockRates.getUpper()).longValue();
        ...
        private void parseFromInfo(MediaFormat info) {
            ...
            if (sizeRanges != null) {
                widths = (Range) sizeRanges.first;
                heights = (Range) sizeRanges.second;
            }
            ...
            if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_AVC)) {
                ...
                for (CodecProfileLevel profileLevel : profileLevels) {
                    ...
                    switch (profileLevel.level) {
                        ...
                        case 64:
                            MBPS = 19800;
                            FS = 792;
                            BR2 = AudioFormat.SAMPLE_RATE_HZ_MIN;
                            DPB = 4752;
                            break;
                        case 128:
                            MBPS = 20250;
                        ...
                        case 1:
                            switch (profileLevel2.level) {
                                case 0:
                                    ...
                                    H = 18;
                                    MBPS2 = 11880;
                                    FS2 = MediaFile.FILE_TYPE_RMVB;
                                    BR3 = AudioFormat.SAMPLE_RATE_HZ_MIN;
                                    break;
                                case 1:
                                    FR = 30;
                                    W = 45;
                ...
                for (CodecProfileLevel profileLevel3 : profileLevels) {
                    ...
                    switch (profileLevel3.profile) {
                        case 1:
                            switch (profileLevel3.level) {
                                ...
                                case 64:
                                    ...
                                    MBPS3 = 36000;
                                    FS3 = 1200;
                                    BR4 = AudioFormat.SAMPLE_RATE_HZ_MIN;
                                    break;
                                case 128:
                                    FR2 = 30;
                                    W2 = 45;
                        ...
                        case 8192:
                        case 16384:
                            Log.i(TAG, "Unsupported profile " + profileLevel3.profile + " for " + mime);
                            errors |= 2;
                            supported3 = false;
                            break;
                        case 32768:
                    ...
                    maxBlocks3 = Math.max(FS3, maxBlocks3);
                    maxBps = Math.max(BR4 * 1000, maxBps);
                    if (strict) {
                        ...
                        maxWidth2 = Math.max(maxDim, maxWidth2);
                        maxHeight2 = Math.max(maxDim, maxHeight2);
                        maxRate2 = Math.max(Math.max(FR2, 60), maxRate2);
                    }
                }
                ...
                for (CodecProfileLevel profileLevel4 : profileLevels) {
                    ...
                    switch (profileLevel4.level) {
                        ...
                        case 2:
                            ...
                            H3 = 18;
                            BR5 = 2;
                            MBPS4 = MediaFile.FILE_TYPE_RMVB * 15;
                            break;
                        case 4:
                            strict2 = true;
                            FR3 = 30;
                            ...
                            H3 = 18;
                            BR5 = 6;
                            MBPS4 = MediaFile.FILE_TYPE_RMVB * 30;
                            break;
                        case 8:
                            strict2 = true;
                            FR3 = 30;
                        ...
                        case 32:
                            ...
                            H3 = 18;
                            BR5 = 64;
                            MBPS4 = MediaFile.FILE_TYPE_RMVB * 50;
                            break;
                        case 64:
                            minW = 1;
                            minH = 1;
                        ...
                        case 128:
                            ...
                            break;
                        default:
                            Log.w(TAG, "Unrecognized profile/level " + profileLevel4.profile + "/" + profileLevel4.level + " for " + mime);
                            errors |= 1;
                            break;
                    }
                    ...
                    errors &= -5;
                    maxBlocksPerSecond4 = Math.max(MBPS4, maxBlocksPerSecond4);
                    maxBlocks4 = Math.max(W3 * H3, maxBlocks4);
                    maxBps = Math.max(64000 * BR5, maxBps);
                    maxWidth3 = Math.max(W3, maxWidth3);
                    maxHeight3 = Math.max(H3, maxHeight3);
                    maxRate3 = Math.max(FR3, maxRate3);
                ...
                applyMacroBlockLimits(minWidth, minHeight, maxWidth3, maxHeight3, maxBlocks4, maxBlocksPerSecond4, 16, 16, minAlignment, minAlignment);
                ...
                maxBps = 200000;
                int maxDim2 = 512;
                for (CodecProfileLevel profileLevel6 : profileLevels) {
                    long SR = 0;
                    int FS4 = 0;
                    int BR6 = 0;
                    int D = 0;
                    switch (profileLevel6.level) {
                        ...
                        case 4:
                            SR = 4608000;
                            FS4 = 122880;
                            BR6 = BluetoothClass.Device.WEARABLE_PAGER;
                            D = 960;
                            break;
                        case 8:
                            SR = 9216000;
                        ...
                        case 8192:
                            ...
                            break;
                        default:
                            Log.w(TAG, "Unrecognized level " + profileLevel6.level + " for " + mime);
                            errors |= 1;
                            break;
                    }
                    switch (profileLevel6.profile) {
                        ...
                        case 8192:
                            break;
                        default:
                            Log.w(TAG, "Unrecognized profile " + profileLevel6.profile + " for " + mime);
                            errors |= 1;
                            break;
                    }
                    errors &= -5;
                    maxBlocksPerSecond5 = Math.max(SR, maxBlocksPerSecond5);
                    maxBlocks5 = Math.max(FS4, maxBlocks5);
                    maxBps = Math.max(BR6 * 1000, maxBps);
                    maxDim2 = Math.max(D, maxDim2);
                }
                int maxLengthInBlocks2 = Utils.divUp(maxDim2, 8);
                applyMacroBlockLimits(maxLengthInBlocks2, maxLengthInBlocks2, Utils.divUp(maxBlocks5, 64), Utils.divUp(maxBlocksPerSecond5, 64L), 8, 8, 1, 1);
            } else if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_HEVC)) {
                int maxBlocks6 = 576;
                long maxBlocksPerSecond6 = 8640;
                maxBps = 128000;
                for (CodecProfileLevel profileLevel7 : profileLevels) {
                    double FR4 = 0.0d;
                    int FS5 = 0;
                    int BR7 = 0;
                    switch (profileLevel7.level) {
                        ...
                        case 2048:
                            FR4 = 30.0d;
                            FS5 = 2228224;
                            BR7 = HealthKeys.BASE_PROCESS;
                            break;
                        case 4096:
                            FR4 = 60.0d;
                            FS5 = 2228224;
                            BR7 = HealthKeys.BASE_PID;
                            break;
                        case 8192:
                            FR4 = 60.0d;
                            FS5 = 2228224;
                        ...
                        case 33554432:
                            ...
                            break;
                        default:
                            Log.w(TAG, "Unrecognized level " + profileLevel7.level + " for " + mime);
                            errors |= 1;
                            break;
                    }
                    switch (profileLevel7.profile) {
                        ...
                        case 4096:
                            break;
                        default:
                            Log.w(TAG, "Unrecognized profile " + profileLevel7.profile + " for " + mime);
                            errors |= 1;
                            break;
                    }
                    errors &= -5;
                    maxBlocksPerSecond6 = Math.max((int) (((double) r40) * FR4), maxBlocksPerSecond6);
                    maxBlocks6 = Math.max(FS5 >> 6, maxBlocks6);
                    maxBps = Math.max(BR7 * 1000, maxBps);
                }
                int maxLengthInBlocks3 = (int) Math.sqrt(maxBlocks6 * 8);
