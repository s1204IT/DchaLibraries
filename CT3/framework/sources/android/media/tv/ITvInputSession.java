        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    ...
                    tune(uriCreateFromParcel3, bundleCreateFromParcel2);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    appPrivateCommand(_arg06, bundleCreateFromParcel);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    createOverlayView(_arg07, rectCreateFromParcel2);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    relayoutOverlayView(rectCreateFromParcel);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    removeOverlayView();
                ...
                case 14:
                    ...
                    timeShiftPlay(uriCreateFromParcel2);
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    timeShiftPause();
                ...
                case 18:
                    ...
                    timeShiftSetPlaybackParams(playbackParamsCreateFromParcel);
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg010 = data.readInt() != 0;
                    timeShiftEnablePositionTracking(_arg010);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    startRecording(uriCreateFromParcel);
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    stopRecording();
