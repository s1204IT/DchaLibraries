...
public final class TvContract {
    ...
    public static final boolean isChannelUri(Uri uri) {
        ...
        return isChannelUriForPassthroughInput(uri);
    }

    public static final boolean isChannelUriForTunerInput(Uri uri) {
        if (isTvUri(uri)) {
            return isTwoSegmentUriStartingWith(uri, "channel");
        }
        return false;
    }
    ...
    public static final boolean isChannelUriForPassthroughInput(Uri uri) {
        if (isTvUri(uri)) {
            return isTwoSegmentUriStartingWith(uri, PATH_PASSTHROUGH);
        }
        return false;
    }
    ...
    public static final boolean isProgramUri(Uri uri) {
        if (isTvUri(uri)) {
            return isTwoSegmentUriStartingWith(uri, PATH_PROGRAM);
        }
        return false;
    }
