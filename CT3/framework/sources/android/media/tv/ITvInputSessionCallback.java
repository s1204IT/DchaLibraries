        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    onSessionEvent(_arg02, bundleCreateFromParcel);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onChannelRetuned(uriCreateFromParcel3);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    List<TvTrackInfo> _arg03 = data.createTypedArrayList(TvTrackInfo.CREATOR);
                    onTracksChanged(_arg03);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg04 = data.readInt();
                    String _arg12 = data.readString();
                    onTrackSelected(_arg04, _arg12);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    onVideoAvailable();
                ...
                case 10:
                    ...
                    onLayoutSurface(_arg07, _arg13, _arg2, _arg3);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg08 = data.readInt();
                    onTimeShiftStatusChanged(_arg08);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    long _arg09 = data.readLong();
                    onTimeShiftStartPositionChanged(_arg09);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    long _arg010 = data.readLong();
                    onTimeShiftCurrentPositionChanged(_arg010);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 15:
                    ...
                    onRecordingStopped(uriCreateFromParcel);
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
