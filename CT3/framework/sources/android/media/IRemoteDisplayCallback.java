...
public interface IRemoteDisplayCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRemoteDisplayCallback {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            RemoteDisplayState remoteDisplayStateCreateFromParcel;
            switch (code) {
                case 1:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        remoteDisplayStateCreateFromParcel = RemoteDisplayState.CREATOR.createFromParcel(data);
                    } else {
                        remoteDisplayStateCreateFromParcel = null;
                    }
                    onStateChanged(remoteDisplayStateCreateFromParcel);
                    return true;
