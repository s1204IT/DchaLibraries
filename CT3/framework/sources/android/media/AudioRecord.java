...
public class AudioRecord implements AudioRouting {
    ...
    public AudioRecord(AudioAttributes attributes, AudioFormat format, int bufferSizeInBytes, int sessionId) throws IllegalArgumentException {
        ...
        int initResult = native_setup(new WeakReference(this), this.mAudioAttributes, sampleRate, this.mChannelMask, this.mChannelIndexMask, this.mAudioFormat, this.mNativeBufferSizeInBytes, session, ActivityThread.currentOpPackageName(), 0L);
        if (initResult != 0) {
    ...
    private class NativeRoutingEventHandlerDelegate {
        ...
        NativeRoutingEventHandlerDelegate(final AudioRecord record, final AudioRouting.OnRoutingChangedListener listener, Handler handler) {
            Looper looper;
            if (handler != null) {
