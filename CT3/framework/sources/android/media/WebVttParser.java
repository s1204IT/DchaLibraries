...
class WebVttParser {
    ...
    private final Phase mParseHeader = new Phase() {
        ...
        static final boolean f17assertionsDisabled;

        static {
            f17assertionsDisabled = !AnonymousClass3.class.desiredAssertionStatus();
        }
    ...
    private final Phase mParseCueId = new Phase() {
        ...
        static final boolean f18assertionsDisabled;

        static {
            f18assertionsDisabled = !AnonymousClass4.class.desiredAssertionStatus();
        }
    ...
    private final Phase mParseCueTime = new Phase() {
        ...
        static {
            f19assertionsDisabled = !AnonymousClass5.class.desiredAssertionStatus();
        }
        ...
        public void parse(String line) {
            ...
            String rest2 = spaceAt > 0 ? rest.substring(spaceAt + 1) : ProxyInfo.LOCAL_EXCL_LIST;
            ...
            for (String setting : rest2.split(" +")) {
