...
public class AudioPolicyConfig implements Parcelable {
    ...
    AudioPolicyConfig(Parcel in, AudioPolicyConfig audioPolicyConfig) {
        this(in);
    }
    ...
    protected void setRegistration(String regId) {
        boolean zIsEmpty = this.mRegistrationId != null ? this.mRegistrationId.isEmpty() : true;
        boolean zIsEmpty2 = regId != null ? regId.isEmpty() : true;
        if (!zIsEmpty && !zIsEmpty2 && !this.mRegistrationId.equals(regId)) {
