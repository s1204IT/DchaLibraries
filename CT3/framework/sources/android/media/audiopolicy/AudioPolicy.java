...
public class AudioPolicy {
    ...
    AudioPolicy(AudioPolicyConfig config, Context context, Looper looper, AudioPolicyFocusListener fl, AudioPolicyStatusListener sl, AudioPolicy audioPolicy) {
    ...
    public static class Builder {
        ...
        public AudioPolicy build() {
            ...
            return new AudioPolicy(new AudioPolicyConfig(this.mMixes), this.mContext, this.mLooper, this.mFocusListener, this.mStatusListener, audioPolicy);
        }
    }
    ...
    public AudioRecord createAudioRecordSink(AudioMix mix) throws IllegalArgumentException {
        ...
        AudioRecord ar = new AudioRecord(new AudioAttributes.Builder().setInternalCapturePreset(8).addTag(addressForTag(mix)).build(), mixFormat, AudioRecord.getMinBufferSize(mix.getFormat().getSampleRate(), 12, mix.getFormat().getEncoding()), 0);
        return ar;
    }
