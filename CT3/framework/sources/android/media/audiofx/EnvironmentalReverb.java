...
public class EnvironmentalReverb extends AudioEffect {
    ...
    public EnvironmentalReverb(int priority, int audioSession) throws RuntimeException {
    ...
    public void setRoomLevel(short room) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setRoomHFLevel(short roomHF) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setDecayTime(int decayTime) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setDecayHFRatio(short decayHFRatio) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setReflectionsLevel(short reflectionsLevel) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setReflectionsDelay(int reflectionsDelay) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setReverbLevel(short reverbLevel) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setReverbDelay(int reverbDelay) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setDiffusion(short diffusion) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public void setDensity(short density) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    private class BaseParameterListener implements AudioEffect.OnParameterChangeListener {
        BaseParameterListener(EnvironmentalReverb this$0, BaseParameterListener baseParameterListener) {
            this();
        }
        ...
        public void onParameterChange(AudioEffect effect, int status, byte[] param, byte[] value) {
            ...
            int v = -1;
            if (param.length == 4) {
                p = EnvironmentalReverb.byteArrayToInt(param, 0);
            }
            if (value.length == 2) {
                v = EnvironmentalReverb.byteArrayToShort(value, 0);
            } else if (value.length == 4) {
                v = EnvironmentalReverb.byteArrayToInt(value, 0);
            }
            if (p == -1 || v == -1) {
                return;
            }
