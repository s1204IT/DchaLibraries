...
public class Virtualizer extends AudioEffect {
    ...
    public Virtualizer(int priority, int audioSession) throws RuntimeException {
    ...
    private boolean getAnglesInt(int inputChannelMask, int deviceType, int[] angles) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    public boolean canVirtualize(int inputChannelMask, int virtualizationMode) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
        return getAnglesInt(inputChannelMask, getDeviceForModeQuery(virtualizationMode), null);
    }

    public boolean getSpeakerAngles(int inputChannelMask, int virtualizationMode, int[] angles) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
        if (angles == null) {
    ...
    public boolean forceVirtualizationMode(int virtualizationMode) throws IllegalStateException, UnsupportedOperationException, IllegalArgumentException {
    ...
    private class BaseParameterListener implements AudioEffect.OnParameterChangeListener {
        BaseParameterListener(Virtualizer this$0, BaseParameterListener baseParameterListener) {
            this();
        }
        ...
        public void onParameterChange(AudioEffect effect, int status, byte[] param, byte[] value) {
            ...
            short v = -1;
            if (param.length == 4) {
                p = Virtualizer.byteArrayToInt(param, 0);
            }
            if (value.length == 2) {
                v = Virtualizer.byteArrayToShort(value, 0);
            }
            if (p == -1 || v == -1) {
                return;
            }
