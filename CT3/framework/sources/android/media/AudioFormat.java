...
public final class AudioFormat implements Parcelable {
    ...
    public static final Parcelable.Creator<AudioFormat> CREATOR = new Parcelable.Creator<AudioFormat>() {
        ...
        public AudioFormat createFromParcel(Parcel p) {
            return new AudioFormat(p, (AudioFormat) null);
        }
    ...
    AudioFormat(int ignoredArgument, AudioFormat audioFormat) {
        this(ignoredArgument);
    }

    AudioFormat(Parcel in, AudioFormat audioFormat) {
        this(in);
    }
    ...
    public static class Builder {
        ...
        public AudioFormat build() {
            AudioFormat af = new AudioFormat(1980, (AudioFormat) null);
    ...
    public boolean equals(Object o) {
        ...
        if (((this.mPropertySetMask & 1) == 0 || this.mEncoding == that.mEncoding) && (((this.mPropertySetMask & 2) == 0 || this.mSampleRate == that.mSampleRate) && ((this.mPropertySetMask & 4) == 0 || this.mChannelMask == that.mChannelMask))) {
            return (this.mPropertySetMask & 8) == 0 || this.mChannelIndexMask == that.mChannelIndexMask;
        }
        return false;
    }
