...
public abstract class ChooserTargetService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        IChooserTargetServiceWrapper iChooserTargetServiceWrapper = null;
        if (!SERVICE_INTERFACE.equals(intent.getAction())) {
            return null;
        }
        if (this.mWrapper == null) {
            this.mWrapper = new IChooserTargetServiceWrapper(this, iChooserTargetServiceWrapper);
        }
        return this.mWrapper;
    }

    private class IChooserTargetServiceWrapper extends IChooserTargetService.Stub {
        IChooserTargetServiceWrapper(ChooserTargetService this$0, IChooserTargetServiceWrapper iChooserTargetServiceWrapper) {
            this();
        }
