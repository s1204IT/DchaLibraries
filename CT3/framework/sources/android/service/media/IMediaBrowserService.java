        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    connect(_arg0, bundleCreateFromParcel2, _arg2);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 3:
                    ...
                    IMediaBrowserServiceCallbacks _arg1 = IMediaBrowserServiceCallbacks.Stub.asInterface(data.readStrongBinder());
                    addSubscriptionDeprecated(_arg03, _arg1);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg04 = data.readString();
                    IMediaBrowserServiceCallbacks _arg12 = IMediaBrowserServiceCallbacks.Stub.asInterface(data.readStrongBinder());
                    removeSubscriptionDeprecated(_arg04, _arg12);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    getMediaItem(_arg05, resultReceiverCreateFromParcel, _arg22);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    addSubscription(_arg06, _arg13, bundleCreateFromParcel, _arg3);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    removeSubscription(_arg07, _arg14, _arg23);
                    return true;
