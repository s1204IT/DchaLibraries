...
public class TrustAgentService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        ComponentName component = new ComponentName(this, (Class<?>) getClass());
        try {
    ...
    private final class TrustAgentServiceWrapper extends ITrustAgentService.Stub {
        TrustAgentServiceWrapper(TrustAgentService this$0, TrustAgentServiceWrapper trustAgentServiceWrapper) {
            this();
        }
