...
public class DreamService extends Service implements Window.Callback {
    ...
    private boolean getSystemUiVisibilityFlagValue(int flag, boolean defaultValue) {
        View v = this.mWindow != null ? this.mWindow.getDecorView() : null;
    ...
    protected void dump(final FileDescriptor fd, PrintWriter pw, final String[] args) {
        ...
        }, pw, ProxyInfo.LOCAL_EXCL_LIST, 1000L);
    }
    ...
    private final class DreamServiceWrapper extends IDreamService.Stub {
        DreamServiceWrapper(DreamService this$0, DreamServiceWrapper dreamServiceWrapper) {
            this();
        }
