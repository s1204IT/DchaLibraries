...
public abstract class NotificationListenerService extends Service {
    ...
    public StatusBarNotification[] getActiveNotifications(String[] keys, int trim) {
        ...
        try {
            ...
            List<T> list = parceledList.getList();
    ...
    public static class RankingMap implements Parcelable {
        public static final Parcelable.Creator<RankingMap> CREATOR = new Parcelable.Creator<RankingMap>() {
            ...
            public RankingMap createFromParcel(Parcel source) {
                ...
                return new RankingMap(rankingUpdate, null);
            }
        ...
        RankingMap(NotificationRankingUpdate rankingUpdate, RankingMap rankingMap) {
            this(rankingUpdate);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    args2.recycle();
                    NotificationListenerService.this.onNotificationRemoved(sbn2, rankingMap2);
                    break;
                case 3:
