...
public class AccessibilityServiceInfo implements Parcelable {
    ...
    static {
        sAvailableCapabilityInfos.put(1, new CapabilityInfo(1, 17039699, 17039700));
        sAvailableCapabilityInfos.put(2, new CapabilityInfo(2, 17039701, 17039702));
        sAvailableCapabilityInfos.put(4, new CapabilityInfo(4, 17039703, 17039704));
        sAvailableCapabilityInfos.put(8, new CapabilityInfo(8, 17039705, 17039706));
        sAvailableCapabilityInfos.put(16, new CapabilityInfo(16, 17039707, 17039708));
        sAvailableCapabilityInfos.put(32, new CapabilityInfo(32, 17039709, 17039710));
