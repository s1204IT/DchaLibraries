...
class DialogFilter implements ServerRequestInterface, ServerResponseInterface {
    ...
    public void processRequest(SIPRequest sipRequest, MessageChannel incomingMessageChannel) {
        ...
        if (dialog != null && provider != dialog.getSipProvider() && (contact = dialog.getMyContactHeader()) != null) {
            ...
            if (contactPort == -1) {
                contactPort = (contactTransport.equals(ParameterNames.UDP) || contactTransport.equals(ParameterNames.TCP)) ? 5060 : 5061;
            }
        ...
        if (sipRequest.getHeader("Route") != null && sIPServerTransaction.getDialog() != null) {
            ...
            int port = uri.getHostPort().hasPort() ? uri.getHostPort().getPort() : this.listeningPoint.getTransport().equalsIgnoreCase(ListeningPoint.TLS) ? 5061 : 5060;
        ...
        if (sipRequest.getMethod().equals(Request.REFER) && dialog != null && provider.isDialogErrorsAutomaticallyHandled()) {
            ...
            if (dialog != null && provider.isDialogErrorsAutomaticallyHandled() && lastTransaction2 != null && lastTransaction2.isInviteTransaction() && (lastTransaction2 instanceof ClientTransaction) && lastTransaction2.getLastResponse() != null && lastTransaction2.getLastResponse().getStatusCode() == 200 && !dialog.isAckSent(lastTransaction2.getLastResponse().getCSeq().getSeqNumber())) {
                ...
                sendRequestPendingResponse(sipRequest, sIPServerTransaction);
                return;
            } else if (dialog != null && lastTransaction2 != null && provider.isDialogErrorsAutomaticallyHandled() && lastTransaction2.isInviteTransaction() && (lastTransaction2 instanceof ServerTransaction) && !dialog.isAckSeen()) {
                if (sipStackImpl.isLoggingEnabled()) {
        ...
        if (dialog == null && sipRequest.getMethod().equals("NOTIFY")) {
            ...
            if (pendingSubscribeClientTx != null) {
                ...
                sipEvent = (sIPServerTransaction == null || !sIPServerTransaction.isTransactionMapped()) ? new RequestEvent(provider, null, subscriptionDialog, sipRequest) : new RequestEvent(provider, sIPServerTransaction, subscriptionDialog, sipRequest);
            } else {
                if (sipStackImpl.isLoggingEnabled()) {
            ...
            sipEvent = (sIPServerTransaction == null || !sIPServerTransaction.isTransactionMapped()) ? new RequestEvent(provider, null, dialog, sipRequest) : new RequestEvent(provider, sIPServerTransaction, dialog, sipRequest);
        }
