...
public class ParserFactory {
    ...
    public static HeaderParser createParser(String line) throws ParseException {
        ...
        if (cls != null) {
            try {
                Constructor<? extends HeaderParser> constructor = (Constructor) parserConstructorCache.get(cls);
                if (constructor == null) {
                    constructor = cls.getConstructor(constructorArgs);
                    parserConstructorCache.put(cls, constructor);
                }
                Object[] args = {line};
                HeaderParser retval = constructor.newInstance(args);
                return retval;
            } catch (Exception ex) {
