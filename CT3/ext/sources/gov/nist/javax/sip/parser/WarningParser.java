    ...
    public SIPHeader parse() throws ParseException {
        ...
        try {
            ...
            while (this.lexer.lookAhead(0) != '\n') {
                ...
                try {
                    int code = Integer.parseInt(this.lexer.getNextToken().getTokenValue());
                    ...
                    while (this.lexer.lookAhead(0) == ',') {
                        ...
                        this.lexer.match(4095);
                        try {
                            int code2 = Integer.parseInt(this.lexer.getNextToken().getTokenValue());
                            warning2.setCode(code2);
                            this.lexer.SPorHT();
                            this.lexer.match(4095);
                            ...
                            this.lexer.SPorHT();
                            String text2 = this.lexer.quotedString();
                            warning2.setText(text2);
                            this.lexer.SPorHT();
