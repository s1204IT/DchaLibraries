...
public class UDPMessageChannel extends MessageChannel implements ParseExceptionListener, Runnable, RawMessageChannel {
    ...
    public void processMessage(SIPMessage sIPMessage) {
        if (sIPMessage instanceof SIPRequest) {
            ...
            if (this.sipStack.isLoggingEnabled()) {
                this.sipStack.getStackLogger().logDebug("About to process " + sIPMessage.getFirstLine() + Separators.SLASH + serverRequestInterfaceNewSIPServerRequest);
            }
            try {
                ...
                this.sipStack.getStackLogger().logDebug("Done processing " + sIPMessage.getFirstLine() + Separators.SLASH + serverRequestInterfaceNewSIPServerRequest);
                return;
            } finally {
    ...
    public void sendMessage(SIPMessage sIPMessage) throws IOException {
        if (this.sipStack.isLoggingEnabled() && this.sipStack.isLogStackTraceOnMessageSend()) {
            if ((sIPMessage instanceof SIPRequest) && sIPMessage.getRequestLine() != null) {
