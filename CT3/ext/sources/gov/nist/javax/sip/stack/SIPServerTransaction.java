    ...
    public boolean isMessagePartOfTransaction(SIPMessage messageToTest) {
        ...
        if (messageBranch != null && getBranch() != null) {
            if (!method.equals(Request.CANCEL)) {
                ...
                boolean transactionMatches = topViaHeader.getSentBy().equals(((Via) getOriginalRequest().getViaHeaders().getFirst()).getSentBy());
                return transactionMatches;
            }
            if (!getMethod().equals(Request.CANCEL) || !getBranch().equalsIgnoreCase(messageBranch)) {
                return false;
            }
            boolean transactionMatches2 = topViaHeader.getSentBy().equals(((Via) getOriginalRequest().getViaHeaders().getFirst()).getSentBy());
        ...
        if ((skipTo || (originalToTag != null && originalToTag.equalsIgnoreCase(thisToTag))) && getOriginalRequest().getCallId().getCallId().equalsIgnoreCase(messageToTest.getCallId().getCallId()) && getOriginalRequest().getCSeq().getSeqNumber() == messageToTest.getCSeq().getSeqNumber()) {
            return (!messageToTest.getCSeq().getMethod().equals(Request.CANCEL) || getOriginalRequest().getMethod().equals(messageToTest.getCSeq().getMethod())) && topViaHeader.equals(getOriginalRequest().getViaHeaders().getFirst());
        }
        return false;
    }
