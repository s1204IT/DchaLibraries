...
public class HeaderFactoryImpl implements HeaderFactory, HeaderFactoryExt {
    ...
    @Override
    public CSeqHeader createCSeqHeader(long sequenceNumber, String method) throws InvalidArgumentException, ParseException {
        if (sequenceNumber < 0) {
    ...
    @Override
    public CSeqHeader createCSeqHeader(int sequenceNumber, String method) throws InvalidArgumentException, ParseException {
    ...
    @Override
    public ViaHeader createViaHeader(String host, int port, String transport, String branch) throws InvalidArgumentException, ParseException {
        int zoneStart;
    ...
    @Override
    public javax.sip.header.Header createHeader(java.lang.String r9) throws java.text.ParseException {
    ...
    public List createHeaders(String headers) throws ParseException {
        ...
        ?? sIPHeader = smp.parseSIPHeader(headers);
