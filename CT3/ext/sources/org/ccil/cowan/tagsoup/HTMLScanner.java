...
public class HTMLScanner implements Scanner, Locator {
    ...
    static {
        ...
        statetableIndex = (short[][]) Array.newInstance((Class<?>) Short.TYPE, maxState + 1, maxChar + 3);
    ...
    @Override
    public void scan(Reader r0, ScanHandler h) throws SAXException, IOException {
        PushbackReader r;
        this.theState = 28;
        ...
        while (this.theState != 21) {
            ...
            if (ch >= 32 || ch == 10 || ch == 9 || ch == -1) {
                ...
                short s = statetableIndex[this.theState][adjCh + 2];
                int action = 0;
                if (s != -1) {
                    action = statetable[s + 2];
                ...
                switch (action) {
                    ...
                    case 19:
                        ...
                        this.theState = this.theNextState;
                        break;
                    case WarningHeader.INCOMPATIBLE_BANDWIDTH_UNITS:
                        save(45, h);
                        save(ch, h);
                        this.theState = this.theNextState;
                        break;
    ...
    private void save(int ch, ScanHandler h) throws SAXException, IOException {
