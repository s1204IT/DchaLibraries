    ...
    public static class PhoneNumber implements Serializable {
        ...
        public boolean exactlySameAs(PhoneNumber other) {
            ...
            if (this.countryCode_ == other.countryCode_ && this.nationalNumber_ == other.nationalNumber_ && this.extension_.equals(other.extension_) && this.italianLeadingZero_ == other.italianLeadingZero_ && this.numberOfLeadingZeros_ == other.numberOfLeadingZeros_ && this.rawInput_.equals(other.rawInput_) && this.countryCodeSource_ == other.countryCodeSource_ && this.preferredDomesticCarrierCode_.equals(other.preferredDomesticCarrierCode_)) {
                return hasPreferredDomesticCarrierCode() == other.hasPreferredDomesticCarrierCode();
            }
            return false;
        }
        ...
        public boolean equals(Object that) {
            if (that instanceof PhoneNumber) {
                return exactlySameAs((PhoneNumber) that);
            }
            return false;
        }

        public int hashCode() {
            int hash = getCountryCode() + 2173;
            return (((((((((((((((hash * 53) + Long.valueOf(getNationalNumber()).hashCode()) * 53) + getExtension().hashCode()) * 53) + (isItalianLeadingZero() ? 1231 : 1237)) * 53) + getNumberOfLeadingZeros()) * 53) + getRawInput().hashCode()) * 53) + getCountryCodeSource().hashCode()) * 53) + getPreferredDomesticCarrierCode().hashCode()) * 53) + (hasPreferredDomesticCarrierCode() ? 1231 : 1237);
        }
