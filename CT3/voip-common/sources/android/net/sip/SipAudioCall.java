...
public class SipAudioCall {
    ...
    public SipProfile getPeerProfile() {
        ...
        synchronized (this) {
            peerProfile = this.mSipSession != null ? this.mSipSession.getPeerProfile() : null;
        }
        return peerProfile;
    }
    ...
    public void toggleMute() {
        synchronized (this) {
            this.mMuted = this.mMuted ? DONT_RELEASE_SOCKET : true;
            setAudioGroupMode();
        }
    }
    ...
    public AudioGroup getAudioGroup() {
        synchronized (this) {
            ...
            return this.mAudioStream != null ? this.mAudioStream.getGroup() : null;
        }
    }
