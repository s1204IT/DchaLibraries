...
public class RtpStream {
    ...
    public void associate(InetAddress address, int port) {
        ...
        if (!(address instanceof Inet4Address ? this.mLocalAddress instanceof Inet4Address : false) && (!(address instanceof Inet6Address) || !(this.mLocalAddress instanceof Inet6Address))) {
