...
public final class Telephony {
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static final class Inbox implements BaseColumns, TextBasedSmsColumns {
            ...
            public static Uri addMessage(int subId, ContentResolver resolver, String address, String body, String subject, String sc, Long date, boolean read) {
                return Sms.addMessageToUri(subId, resolver, CONTENT_URI, address, body, subject, sc, date, read, false, -1L);
            }
        }
        ...
        public static final class Sent implements BaseColumns, TextBasedSmsColumns {
            ...
            public static Uri addMessage(int subId, ContentResolver resolver, String address, String body, String subject, String sc, Long date) {
                return Sms.addMessageToUri(subId, resolver, CONTENT_URI, address, body, subject, sc, date, true, false, -1L);
            }
        }
    ...
    public static final class MmsSms implements BaseColumns {
        ...
        public static final class PendingMessages implements BaseColumns {
            public static final Uri CONTENT_URI = Uri.withAppendedPath(MmsSms.CONTENT_URI, ConferenceCallMessageHandler.STATUS_PENDING);
    ...
    public static final class CellBroadcasts implements BaseColumns {
        ...
        public static final String[] QUERY_COLUMNS = {"_id", GEOGRAPHICAL_SCOPE, PLMN, LAC, "cid", SERIAL_NUMBER, SERVICE_CATEGORY, LANGUAGE_CODE, "body", "date", "read", "format", "priority", ETWS_WARNING_TYPE, CMAS_MESSAGE_CLASS, CMAS_CATEGORY, CMAS_RESPONSE_TYPE, CMAS_SEVERITY, CMAS_URGENCY, CMAS_CERTAINTY, "sub_id"};
