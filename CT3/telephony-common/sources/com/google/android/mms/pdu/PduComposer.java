...
public class PduComposer {
    ...
    static {
        f36assertionsDisabled = !PduComposer.class.desiredAssertionStatus();
    ...
    protected void appendTextString(byte[] text) {
        if ((text[0] & PplMessageManager.Type.INVALID) > 127) {
    ...
    private int makeMessageBody(int pduType) {
        ...
        for (int i = 0; i < partNum; i++) {
            ...
            if ((name == null || name.length == 0) && (((name = part2.getFilename()) == null || name.length == 0) && ((name = part2.getContentLocation()) == null || name.length == 0))) {
    ...
    private static class LengthRecordNode {
        ...
        LengthRecordNode(LengthRecordNode lengthRecordNode) {
            this();
        }
    ...
    private class PositionMarker {
        ...
        PositionMarker(PduComposer this$0, PositionMarker positionMarker) {
            this();
        }
    ...
    private class BufferStack {
        ...
        BufferStack(PduComposer this$0, BufferStack bufferStack) {
            this();
        }
        ...
        void newbuf() {
            LengthRecordNode lengthRecordNode = null;
            if (this.toCopy != null) {
                throw new RuntimeException("BUG: Invalid newbuf() before copy()");
            }
            LengthRecordNode temp = new LengthRecordNode(lengthRecordNode);
    ...
    private int makeNotifyInd() {
        ...
        appendOctet(142);
        long size = ((NotificationInd) this.mPdu).getMessageSize();
