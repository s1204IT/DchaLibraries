...
public class RatConfiguration {
    ...
    protected static synchronized int getMaxRat() {
        ...
        synchronized (RatConfiguration.class) {
            if (!max_rat_initialized) {
                String sMaxRat = SystemProperties.get(PROPERTY_BUILD_RAT_CONFIG, UsimPBMemInfo.STRING_NOT_SET);
    ...
    protected static int getRatConfig() {
        ...
        String rat = SystemProperties.get(PROPERTY_RAT_CONFIG, UsimPBMemInfo.STRING_NOT_SET);
        if (rat.length() > 0) {
    ...
    protected static String ratToString(int iRat) {
        String rat = UsimPBMemInfo.STRING_NOT_SET;
        if ((iRat & 32) == 32) {
            rat = UsimPBMemInfo.STRING_NOT_SET + "/C";
        }
        if ((iRat & 16) == 16) {
            rat = rat + "/Lf";
        }
