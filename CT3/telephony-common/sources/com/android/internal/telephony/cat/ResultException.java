...
public class ResultException extends CatException {
    ...
    private static final int[] f20comandroidinternaltelephonycatResultCodeSwitchesValues = null;
    private int mAdditionalInfo;
    private String mExplanation;
    private ResultCode mResult;

    private static int[] m240getcomandroidinternaltelephonycatResultCodeSwitchesValues() {
        if (f20comandroidinternaltelephonycatResultCodeSwitchesValues != null) {
            return f20comandroidinternaltelephonycatResultCodeSwitchesValues;
        }
        ...
        f20comandroidinternaltelephonycatResultCodeSwitchesValues = iArr;
        return iArr;
    }

    public ResultException(ResultCode result) {
        switch (m240getcomandroidinternaltelephonycatResultCodeSwitchesValues()[result.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
