...
public class SsData {
    ...
    public enum TeleserviceType {
        ...
        public static TeleserviceType[] valuesCustom() {
            return values();
        }
    }
    ...
    public ServiceType ServiceTypeFromRILInt(int type) {
        try {
            return ServiceType.valuesCustom()[type];
    ...
    public RequestType RequestTypeFromRILInt(int type) {
        try {
            return RequestType.valuesCustom()[type];
        } catch (IndexOutOfBoundsException e) {
    ...
    public TeleserviceType TeleserviceTypeFromRILInt(int type) {
        try {
            return TeleserviceType.valuesCustom()[type];
        } catch (IndexOutOfBoundsException e) {
