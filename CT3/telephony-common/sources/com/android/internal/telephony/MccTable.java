...
public final class MccTable {
    ...
    private static MccEntry entryForMcc(int mcc) {
        MccEntry m = new MccEntry(mcc, UsimPBMemInfo.STRING_NOT_SET, 0);
    ...
    public static String defaultTimeZoneForMcc(int mcc) {
        ...
        Locale locale = new Locale(UsimPBMemInfo.STRING_NOT_SET, entry.mIso);
    ...
    static {
        ...
        sTable.add(new MccEntry(466, "tw", 2, "zh"));
        ...
        sTable.add(new MccEntry(510, PplMessageManager.PendingMessage.KEY_ID, 2));
        ...
        sTable.add(new MccEntry(630, Telephony.Mms.Part.CONTENT_DISPOSITION, 2));
    ...
    private static Locale getLocaleForLanguageCountry(Context context, String language, String country) {
        ...
        try {
            ...
            bestMatch = chooseBestFallback(target, languageMatches);
        } catch (Exception e) {
