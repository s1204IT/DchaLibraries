...
public interface CommandsInterface {
    ...
    void forceReleaseCall(int i, Message message);
    ...
    void setDataOnToMD(boolean z, Message message);
    ...
    void syncApnTable(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, Message message);

    void syncApnTableToRds(String[] strArr, Message message);

    void syncDataSettingsToMd(boolean z, boolean z2, Message message);
