...
public class TelephonyEventLog extends ConnectivityMetricsLogger {
    ...
    private static final int[] f11comandroidinternaltelephonyCall$StateSwitchesValues = null;

    private static final int[] f12xb32e9020 = null;
    ...
    private static int[] m159getcomandroidinternaltelephonyCall$StateSwitchesValues() {
        if (f11comandroidinternaltelephonyCall$StateSwitchesValues != null) {
            return f11comandroidinternaltelephonyCall$StateSwitchesValues;
        }
        ...
        f11comandroidinternaltelephonyCall$StateSwitchesValues = iArr;
        return iArr;
    }

    private static int[] m160x3549e7c4() {
        if (f12xb32e9020 != null) {
            return f12xb32e9020;
        }
    ...
    public void writeRilCallRing(char[] response) {
        ...
        writeEvent(1003, CharacterSets.UTF_32BE, -1, b);
    }
    ...
    public void writePhoneState(PhoneConstants.State phoneState) {
        int state;
        switch (m160x3549e7c4()[phoneState.ordinal()]) {
            case 1:
                state = 0;
                break;
            case 2:
    ...
    public void writeImsCallState(ImsCallSession session, Call.State callState) {
        int state;
        switch (m159getcomandroidinternaltelephonyCall$StateSwitchesValues()[callState.ordinal()]) {
            case 1:
                state = 1;
                break;
            case 2:
    ...
    public void writeOnImsCallHandover(ImsCallSession session, int srcAccessTech, int targetAccessTech, ImsReasonInfo reasonInfo) {
        ...
        writeEvent(2025, getCallId(session), -1, b);
    }
    ...
    public void writeOnImsCallHandoverFailed(ImsCallSession session, int srcAccessTech, int targetAccessTech, ImsReasonInfo reasonInfo) {
        Bundle b = imsHandoverToBundle(srcAccessTech, targetAccessTech, reasonInfo);
        writeEvent(2026, getCallId(session), -1, b);
    }
