...
public class DataProfile {
    ...
    public DataProfile(ApnSetting apn, boolean isRoaming) {
        this(apn.profileId, apn.apn, isRoaming ? apn.roamingProtocol : apn.protocol, apn.authType, apn.user, apn.password, apn.bearerBitmask != 0 ? ServiceState.bearerBitmapHasCdma(apn.bearerBitmask) ? 2 : 1 : 0, apn.maxConnsTime, apn.maxConns, apn.waitTime, apn.carrierEnabled);
    }
