    ...
    private InetAddress decIpToHex(String ipAddr) {
        ...
        if (ipElements.length == 16) {
            ...
            for (int i = 0; i < ipElements.length; i += 2) {
                ...
                String hex1 = String.format(Locale.US, "%02x", Integer.valueOf(a1));
                int a2 = Integer.parseInt(ipElements[i + 1]);
                String hex2 = String.format(Locale.US, "%02x", Integer.valueOf(a2));
                sb.append(hex1 + hex2);
        ...
        Rlog.d("DataCallResponse", "Process:" + ipAddr);
