...
abstract class ImsPhoneBase extends Phone {
    ...
    protected void startOnHoldTone(Connection cn) {
        Pair<Connection, Boolean> result = new Pair<>(cn, Boolean.TRUE);
        this.mOnHoldRegistrants.notifyRegistrants(new AsyncResult((Object) null, result, (Throwable) null));
    }

    protected void stopOnHoldTone(Connection cn) {
        Pair<Connection, Boolean> result = new Pair<>(cn, Boolean.FALSE);
        this.mOnHoldRegistrants.notifyRegistrants(new AsyncResult((Object) null, result, (Throwable) null));
    }
    ...
    void notifySuppServiceFailed(PhoneInternalInterface.SuppService code) {
