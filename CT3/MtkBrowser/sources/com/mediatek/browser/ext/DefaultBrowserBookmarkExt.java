...
public class DefaultBrowserBookmarkExt implements IBrowserBookmarkExt {
    ...
    @Override
    public void showCustomizedEditFolderNewFolderView(View newFolder, View divider, Bundle bundle) {
    ...
    @Override
    public Boolean saveCustomizedEditFolder(Context context, String title, long currentFolder, Bundle bundle, String errorMessage) {
