...
public class HomeProvider extends ContentProvider {
    ...
    public static WebResourceResponse shouldInterceptRequest(Context context, String url) {
        try {
            if (url.equals("content://com.android.browser.site_navigation/websites") || url.equals("content://com.android.browser.home/")) {
                Uri uri = Uri.parse(url);
                return new WebResourceResponse("text/html", "utf-8", context.getContentResolver().openInputStream(uri));
            }
