...
public class UrlBarAutoShowManager implements View.OnTouchListener, BrowserWebView.OnScrollChangedListener {
    ...
    public void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (t != 0) {
            ...
            this.mUi.showTitleBarForDuration(Math.max(2000 - remaining, SCROLL_TIMEOUT_DURATION));
            return;
        }
            ...
            case 2:
                if (this.mIsTracking && !this.mHasTriggered) {
                    ...
                    if (ady > this.mSlop) {
                        ...
                        if (dy > this.mSlop && angle > V_TRIGGER_ANGLE && !this.mUi.isTitleBarShowing() && (web.getVisibleTitleHeight() == 0 || (!this.mIsScrolling && web.getScrollY() > 0))) {
