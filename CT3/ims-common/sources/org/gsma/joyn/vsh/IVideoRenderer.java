    ...
    public static abstract class Stub extends Binder implements IVideoRenderer {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    IVideoRendererListener _arg0 = IVideoRendererListener.Stub.asInterface(data.readStrongBinder());
                    addEventListener(_arg0);
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    IVideoRendererListener _arg02 = IVideoRendererListener.Stub.asInterface(data.readStrongBinder());
        ...
        private static class Proxy implements IVideoRenderer {
            ...
            @Override
            public void addEventListener(IVideoRendererListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override
            public void removeEventListener(IVideoRendererListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
