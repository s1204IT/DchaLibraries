    ...
    public static abstract class Stub extends Binder implements IIPCallRenderer {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    IIPCallRendererListener _arg0 = IIPCallRendererListener.Stub.asInterface(data.readStrongBinder());
                    addEventListener(_arg0);
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    IIPCallRendererListener _arg02 = IIPCallRendererListener.Stub.asInterface(data.readStrongBinder());
        ...
        private static class Proxy implements IIPCallRenderer {
            ...
            @Override
            public void addEventListener(IIPCallRendererListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override
            public void removeEventListener(IIPCallRendererListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
