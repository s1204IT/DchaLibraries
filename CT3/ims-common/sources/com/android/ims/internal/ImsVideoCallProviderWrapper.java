...
public class ImsVideoCallProviderWrapper extends Connection.VideoProvider {
            ...
            switch (msg.what) {
                ...
                case WfcReasonInfo.CODE_WFC_DEFAULT:
                    ...
                    try {
                        ...
                        ImsVideoCallProviderWrapper.this.changePeerDimensionsWithAngle(width2, height2, rotation);
                        return;
                    } finally {
                    }
                default:
    ...
    private final class ImsVideoCallCallback extends IImsVideoCallCallback.Stub {
        ImsVideoCallCallback(ImsVideoCallProviderWrapper this$0, ImsVideoCallCallback imsVideoCallCallback) {
            this();
        }
        ...
        public void changePeerDimensionsWithAngle(int width, int height, int rotation) {
            ...
            ImsVideoCallProviderWrapper.this.mHandler.obtainMessage(100, args).sendToTarget();
        }
