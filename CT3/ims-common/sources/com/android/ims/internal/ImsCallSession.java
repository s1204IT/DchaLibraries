...
public class ImsCallSession {
        ...
        if (result != null) {
            try {
                if (result.getTarget() != null) {
                    ...
                    this.miSession.sendDtmfbyTarget(c, result, target);
                } else {
    ...
    private class IImsCallSessionListenerProxy extends IImsCallSessionListener.Stub {
        IImsCallSessionListenerProxy(ImsCallSession this$0, IImsCallSessionListenerProxy iImsCallSessionListenerProxy) {
            this();
        }
