...
public class Tracer {
    ...
    private static final int[] f0comandroiduiautomatorcoreTracer$ModeSwitchesValues = null;
    ...
    private static int[] m10getcomandroiduiautomatorcoreTracer$ModeSwitchesValues() {
        if (f0comandroiduiautomatorcoreTracer$ModeSwitchesValues != null) {
            return f0comandroiduiautomatorcoreTracer$ModeSwitchesValues;
        }
        ...
        f0comandroiduiautomatorcoreTracer$ModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    private class LogcatSink implements TracerSink {
        ...
        LogcatSink(Tracer this$0, LogcatSink logcatSink) {
            this();
        }
    ...
    public void setOutputMode(Mode mode) {
        ...
        try {
            switch (m10getcomandroiduiautomatorcoreTracer$ModeSwitchesValues()[mode.ordinal()]) {
                case 1:
