...
public abstract class ASN1Set extends ASN1Primitive implements Iterable<ASN1Encodable> {
    ...
    public static com.android.org.bouncycastle.asn1.ASN1Set getInstance(java.lang.Object r5) throws java.io.IOException {
    ...
    public ASN1SetParser parser() {
        return new ASN1SetParser() {
            ...
            public ASN1Encodable readObject() throws IOException {
                ...
                int i = this.index;
                this.index = i + 1;
                ?? objectAt = aSN1Set.getObjectAt(i);
    ...
    boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        if (!(aSN1Primitive instanceof ASN1Set) || size() != aSN1Primitive.size()) {
            return false;
        }
