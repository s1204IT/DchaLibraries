...
public class SignedData extends ASN1Object {
    ...
    private SignedData(ASN1Sequence seq) {
        ...
        while (e.hasMoreElements()) {
            ?? r1 = (ASN1Primitive) e.nextElement();
            if (r1 instanceof ASN1TaggedObject) {
                switch (r1.getTagNo()) {
                    case 0:
                        this.certsBer = r1 instanceof BERTaggedObject;
                        this.certificates = ASN1Set.getInstance(r1, false);
                        break;
                    case 1:
                        this.crlsBer = r1 instanceof BERTaggedObject;
                        this.crls = ASN1Set.getInstance(r1, false);
                        break;
                    default:
                        throw new IllegalArgumentException("unknown tag value " + r1.getTagNo());
                }
            } else {
                this.signerInfos = (ASN1Set) r1;
            }
        }
    }
