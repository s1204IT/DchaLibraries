...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1TaggedObjectParser {
    ...
    public static com.android.org.bouncycastle.asn1.ASN1TaggedObject getInstance(java.lang.Object r4) {
    ...
    boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        if ((aSN1Primitive instanceof ASN1TaggedObject) && this.tagNo == aSN1Primitive.tagNo && this.empty == aSN1Primitive.empty && this.explicit == aSN1Primitive.explicit) {
            return this.obj == null ? aSN1Primitive.obj == null : this.obj.toASN1Primitive().equals(aSN1Primitive.obj.toASN1Primitive());
        }
        return false;
    }
