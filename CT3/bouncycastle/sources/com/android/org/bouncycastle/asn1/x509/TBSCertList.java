...
public class TBSCertList extends ASN1Object {
    ...
    private class EmptyEnumeration implements Enumeration {
        EmptyEnumeration(TBSCertList this$0, EmptyEnumeration emptyEnumeration) {
            this();
        }
    ...
    public TBSCertList(ASN1Sequence seq) {
        ...
        if (seqPos5 >= seq.size()) {
            seqPos = seqPos5;
        } else if ((seq.getObjectAt(seqPos5) instanceof ASN1UTCTime) || (seq.getObjectAt(seqPos5) instanceof ASN1GeneralizedTime) || (seq.getObjectAt(seqPos5) instanceof Time)) {
            seqPos = seqPos5 + 1;
    ...
    public Enumeration getRevokedCertificateEnumeration() {
        EmptyEnumeration emptyEnumeration = null;
        if (this.revokedCertificates == null) {
            return new EmptyEnumeration(this, emptyEnumeration);
        }
