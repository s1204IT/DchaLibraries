...
public class X509Name extends ASN1Object {
    ...
    public static X509Name getInstance(Object obj) {
        if (obj == 0 || (obj instanceof X509Name)) {
            return (X509Name) obj;
        }
        if (obj instanceof X500Name) {
            return new X509Name(ASN1Sequence.getInstance(obj.toASN1Primitive()));
        }
        if (obj != 0) {
    ...
    public X509Name(ASN1Sequence seq) throws IOException {
        this.converter = null;
        this.ordering = new Vector();
        this.values = new Vector();
        this.added = new Vector();
        ...
        while (e.hasMoreElements()) {
            ...
            while (i < set.size()) {
                ...
                this.added.addElement(Boolean.valueOf(i != 0));
                i++;
            }
        }
    }
    ...
    private String canonicalize(String s) {
        ...
        if (value.length() > 0 && value.charAt(0) == '#') {
            Encodable encodableDecodeObject = decodeObject(value);
