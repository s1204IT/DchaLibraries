...
public class ExtendedPKIXBuilderParameters extends ExtendedPKIXParameters {
    ...
    protected void setParams(PKIXParameters pKIXParameters) {
        ...
        if (pKIXParameters instanceof ExtendedPKIXBuilderParameters) {
            this.maxPathLength = pKIXParameters.maxPathLength;
            this.excludedCerts = new HashSet(pKIXParameters.excludedCerts);
        }
        if (!(pKIXParameters instanceof PKIXBuilderParameters)) {
            return;
        }
        this.maxPathLength = pKIXParameters.getMaxPathLength();
    }
