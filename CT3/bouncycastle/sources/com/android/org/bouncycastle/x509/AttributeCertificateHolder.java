...
public class AttributeCertificateHolder implements CertSelector, Selector {
    ...
    public boolean match(Certificate certificate) {
        ...
        try {
            if (this.holder.getBaseCertificateID() != null) {
                if (this.holder.getBaseCertificateID().getSerial().getValue().equals(certificate.getSerialNumber())) {
                    return matchesDN(PrincipalUtil.getIssuerX509Principal((X509Certificate) certificate), this.holder.getBaseCertificateID().getIssuer());
                }
                return false;
            }
            if (this.holder.getEntityName() != null && matchesDN(PrincipalUtil.getSubjectX509Principal(certificate), this.holder.getEntityName())) {
                return true;
            }
            if (this.holder.getObjectDigestInfo() != null) {
                try {
