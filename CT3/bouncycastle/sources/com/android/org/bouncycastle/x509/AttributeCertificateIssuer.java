...
public class AttributeCertificateIssuer implements CertSelector, Selector {
    ...
    public boolean match(Certificate certificate) {
        ...
        if (this.form instanceof V2Form) {
            ...
            if (issuer.getBaseCertificateID() != null) {
                if (issuer.getBaseCertificateID().getSerial().getValue().equals(certificate.getSerialNumber())) {
                    return matchesDN(certificate.getIssuerX500Principal(), issuer.getBaseCertificateID().getIssuer());
                }
                return false;
            }
            GeneralNames name = issuer.getIssuerName();
            if (matchesDN(certificate.getSubjectX500Principal(), name)) {
                return true;
            }
        } else {
            GeneralNames name2 = (GeneralNames) this.form;
            if (matchesDN(certificate.getSubjectX500Principal(), name2)) {
                return true;
            }
        }
        return false;
    ...
    public boolean equals(Object obj) {
        ...
        return this.form.equals(obj.form);
    }
