...
public final class TwofishEngine implements BlockCipher {
    ...
    @Override
    public void init(boolean encrypting, CipherParameters cipherParameters) {
        if (cipherParameters instanceof KeyParameter) {
            this.encrypting = encrypting;
            this.workingKey = cipherParameters.getKey();
    ...
    private void setKey(byte[] key) {
        ...
        for (int i3 = 0; i3 < MAX_KEY_BITS; i3++) {
            int b3 = i3;
            int b2 = i3;
            int b1 = i3;
            int b0 = i3;
    ...
    private int F32(int x, int[] k32) {
        ...
        switch (this.k64Cnt & 3) {
            case 0:
                ...
                b2 = (P[0][b2] & 255) ^ b2(k2);
                b3 = (P[0][b3] & 255) ^ b3(k2);
                int result = ((this.gMDS0[(P[0][(P[0][b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)] ^ this.gMDS1[(P[0][(P[1][b1] & 255) ^ b1(k1)] & 255) ^ b1(k0)]) ^ this.gMDS2[(P[1][(P[0][b2] & 255) ^ b2(k1)] & 255) ^ b2(k0)]) ^ this.gMDS3[(P[1][(P[1][b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
                return result;
            case 1:
                int result2 = ((this.gMDS0[(P[0][b0] & 255) ^ b0(k0)] ^ this.gMDS1[(P[0][b1] & 255) ^ b1(k0)]) ^ this.gMDS2[(P[1][b2] & 255) ^ b2(k0)]) ^ this.gMDS3[(P[1][b3] & 255) ^ b3(k0)];
                return result2;
            case 2:
                int result3 = ((this.gMDS0[(P[0][(P[0][b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)] ^ this.gMDS1[(P[0][(P[1][b1] & 255) ^ b1(k1)] & 255) ^ b1(k0)]) ^ this.gMDS2[(P[1][(P[0][b2] & 255) ^ b2(k1)] & 255) ^ b2(k0)]) ^ this.gMDS3[(P[1][(P[1][b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
                return result3;
            case 3:
                b0 = (P[1][b0] & 255) ^ b0(k2);
                b1 = (P[1][b1] & 255) ^ b1(k2);
                b2 = (P[0][b2] & 255) ^ b2(k2);
                b3 = (P[0][b3] & 255) ^ b3(k2);
                int result32 = ((this.gMDS0[(P[0][(P[0][b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)] ^ this.gMDS1[(P[0][(P[1][b1] & 255) ^ b1(k1)] & 255) ^ b1(k0)]) ^ this.gMDS2[(P[1][(P[0][b2] & 255) ^ b2(k1)] & 255) ^ b2(k0)]) ^ this.gMDS3[(P[1][(P[1][b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
                return result32;
            default:
                return 0;
        }
    ...
    private int LFSR2(int x) {
        return ((x & 1) != 0 ? GF256_FDBK_4 : 0) ^ (((x & 2) != 0 ? GF256_FDBK_2 : 0) ^ (x >> 2));
    }
