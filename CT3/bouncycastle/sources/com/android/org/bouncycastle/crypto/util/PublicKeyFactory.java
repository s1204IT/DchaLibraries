    ...
    public static AsymmetricKeyParameter createKey(SubjectPublicKeyInfo keyInfo) throws IOException {
        ...
        if (algId.getAlgorithm().equals(X9ObjectIdentifiers.dhpublicnumber)) {
            ...
            if (dhValidationParms != null) {
                ...
                dHValidationParameters = new DHValidationParameters(seed, pgenCounter.intValue());
            }
        ...
        if (algId.getAlgorithm().equals(X9ObjectIdentifiers.id_dsa) || algId.getAlgorithm().equals(OIWObjectIdentifiers.dsaWithSHA1)) {
            ...
            if (de != null) {
                ...
                dSAParameters = new DSAParameters(params2.getP(), params2.getQ(), params2.getG());
            }
            return new DSAPublicKeyParameters(derY2.getValue(), dSAParameters);
        }
