...
public class RSADigestSigner implements Signer {
    ...
    public void init(boolean forSigning, CipherParameters cipherParameters) {
        ...
        AsymmetricKeyParameter k = cipherParameters instanceof ParametersWithRandom ? (AsymmetricKeyParameter) cipherParameters.getParameters() : (AsymmetricKeyParameter) cipherParameters;
