    ...
    public static class Util {
        private static PBEParametersGenerator makePBEGenerator(int type, int hash) {
            ...
            if (type == 2) {
                switch (hash) {
                    case 0:
                        PBEParametersGenerator generator6 = new PKCS12ParametersGenerator(AndroidDigestFactory.getMD5());
                        return generator6;
                    case 1:
                        PBEParametersGenerator generator7 = new PKCS12ParametersGenerator(AndroidDigestFactory.getSHA1());
                        return generator7;
                    case 2:
                    case 3:
                    default:
                    ...
                    case 4:
                        PBEParametersGenerator generator8 = new PKCS12ParametersGenerator(AndroidDigestFactory.getSHA256());
                        return generator8;
                }
            }
            PBEParametersGenerator generator9 = new OpenSSLPBEParametersGenerator();
            return generator9;
        }

        public static CipherParameters makePBEParameters(byte[] pbeKey, int scheme, int digest, int keySize, int ivSize, AlgorithmParameterSpec algorithmParameterSpec, String targetAlgorithm) throws InvalidAlgorithmParameterException {
            CipherParameters param;
            if (algorithmParameterSpec == 0 || !(algorithmParameterSpec instanceof PBEParameterSpec)) {
                throw new InvalidAlgorithmParameterException("Need a PBEParameter spec with a PBE key.");
            }
            PBEParametersGenerator generator = makePBEGenerator(scheme, digest);
            generator.init(pbeKey, algorithmParameterSpec.getSalt(), algorithmParameterSpec.getIterationCount());
            if (ivSize != 0) {
            ...
            if (targetAlgorithm.startsWith("DES")) {
                if (param instanceof ParametersWithIV) {
                    KeyParameter kParam = (KeyParameter) param.getParameters();
            ...
            for (int i = 0; i != pbeKey.length; i++) {
                pbeKey[i] = 0;
            }
            return param;
        }

        public static CipherParameters makePBEParameters(BCPBEKey pbeKey, AlgorithmParameterSpec algorithmParameterSpec, String targetAlgorithm) {
            CipherParameters param;
            if (algorithmParameterSpec == 0 || !(algorithmParameterSpec instanceof PBEParameterSpec)) {
            ...
            generator.init(key, algorithmParameterSpec.getSalt(), algorithmParameterSpec.getIterationCount());
        ...
        public static CipherParameters makePBEMacParameters(BCPBEKey pbeKey, AlgorithmParameterSpec algorithmParameterSpec) {
            if (algorithmParameterSpec == 0 || !(algorithmParameterSpec instanceof PBEParameterSpec)) {
                throw new IllegalArgumentException("Need a PBEParameter spec with a PBE key.");
            }
            PBEParametersGenerator generator = makePBEGenerator(pbeKey.getType(), pbeKey.getDigest());
