...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom random) throws InvalidAlgorithmParameterException {
        ...
        this.param = new DSAKeyGenerationParameters(random, new DSAParameters(algorithmParameterSpec.getP(), algorithmParameterSpec.getQ(), algorithmParameterSpec.getG()));
