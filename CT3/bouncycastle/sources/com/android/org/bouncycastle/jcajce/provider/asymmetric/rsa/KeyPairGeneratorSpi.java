...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom random) throws InvalidAlgorithmParameterException {
        ...
        BigInteger publicExponent = algorithmParameterSpec.getPublicExponent();
        if (random == null) {
            random = new SecureRandom();
        }
        this.param = new RSAKeyGenerationParameters(publicExponent, random, algorithmParameterSpec.getKeysize(), defaultTests);
        this.engine.init(this.param);
    }
