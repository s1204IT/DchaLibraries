    ...
    protected void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof BCPBEKey) {
            if (params instanceof PBEParameterSpec) {
                param = PBE.Util.makePBEParameters(key, params, this.wrapEngine.getAlgorithmName());
            } else if (key.getParam() != null) {
                param = key.getParam();
            } else {
        ...
        CipherParameters param3 = random != null ? new ParametersWithRandom(param2, random) : param2;
        switch (opmode) {
            case 1:
            case 2:
