...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    protected KeySpec engineGetKeySpec(Key key, Class spec) throws InvalidKeySpecException {
        ...
        if (spec.isAssignableFrom(com.android.org.bouncycastle.jce.spec.ECPublicKeySpec.class) && (key instanceof ECPublicKey)) {
            ...
            return new com.android.org.bouncycastle.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k3.getParams(), k3.getW(), false), implicitSpec3);
        }
        if (spec.isAssignableFrom(com.android.org.bouncycastle.jce.spec.ECPrivateKeySpec.class) && (key instanceof ECPrivateKey)) {
            ...
            return new com.android.org.bouncycastle.jce.spec.ECPrivateKeySpec(k4.getS(), implicitSpec4);
        }
