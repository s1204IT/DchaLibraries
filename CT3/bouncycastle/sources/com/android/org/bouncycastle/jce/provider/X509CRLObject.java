...
public class X509CRLObject extends X509CRL {
    ...
    @Override
    public void verify(PublicKey key) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException, CRLException, NoSuchProviderException {
        Signature sig;
        try {
    ...
    @Override
    public void verify(PublicKey key, Provider sigProvider) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CRLException {
        Signature sig;
        if (sigProvider != null) {
            sig = Signature.getInstance(getSigAlgName(), sigProvider);
        } else {
    ...
    private void doVerify(PublicKey key, Signature sig) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException, CRLException {
    ...
    private Set loadCRLEntries() {
        ...
        while (certs.hasMoreElements()) {
            ...
            X509CRLEntryObject crlEntry = new X509CRLEntryObject(entry, this.isIndirect, x500Name);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLObject) {
            if (this.isHashCodeSet) {
                boolean otherIsHashCodeSet = obj.isHashCodeSet;
                if (otherIsHashCodeSet && obj.hashCodeValue != this.hashCodeValue) {
                    return false;
                }
            }
