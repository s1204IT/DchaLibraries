...
public class PKIXNameConstraintValidator {
    ...
    private int hashCollection(Collection coll) {
        ...
        int hash = 0;
        for (?? r2 : coll) {
            hash = r2 instanceof byte[] ? hash + Arrays.hashCode((byte[]) r2) : hash + r2.hashCode();
        }
        return hash;
    }

    public boolean equals(Object obj) {
        if ((obj instanceof PKIXNameConstraintValidator) && collectionsAreEqual(obj.excludedSubtreesDN, this.excludedSubtreesDN) && collectionsAreEqual(obj.excludedSubtreesDNS, this.excludedSubtreesDNS) && collectionsAreEqual(obj.excludedSubtreesEmail, this.excludedSubtreesEmail) && collectionsAreEqual(obj.excludedSubtreesIP, this.excludedSubtreesIP) && collectionsAreEqual(obj.excludedSubtreesURI, this.excludedSubtreesURI) && collectionsAreEqual(obj.permittedSubtreesDN, this.permittedSubtreesDN) && collectionsAreEqual(obj.permittedSubtreesDNS, this.permittedSubtreesDNS) && collectionsAreEqual(obj.permittedSubtreesEmail, this.permittedSubtreesEmail) && collectionsAreEqual(obj.permittedSubtreesIP, this.permittedSubtreesIP)) {
            return collectionsAreEqual(obj.permittedSubtreesURI, this.permittedSubtreesURI);
        }
        return false;
    }
