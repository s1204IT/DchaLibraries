...
public abstract class Nat224 {
    ...
    public static void mul(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 1; i < 7; i++) {
            ...
            long c8 = 0 + (x_i * y_0) + (((long) zz[zzOff + 0]) & M);
            zz[zzOff + 0] = (int) c8;
            long c9 = (c8 >>> 32) + (x_i * y_1) + (((long) zz[zzOff + 1]) & M);
            zz[zzOff + 1] = (int) c9;
            long c10 = (c9 >>> 32) + (x_i * y_2) + (((long) zz[zzOff + 2]) & M);
            zz[zzOff + 2] = (int) c10;
            long c11 = (c10 >>> 32) + (x_i * y_3) + (((long) zz[zzOff + 3]) & M);
            zz[zzOff + 3] = (int) c11;
            long c12 = (c11 >>> 32) + (x_i * y_4) + (((long) zz[zzOff + 4]) & M);
            zz[zzOff + 4] = (int) c12;
            long c13 = (c12 >>> 32) + (x_i * y_5) + (((long) zz[zzOff + 5]) & M);
            zz[zzOff + 5] = (int) c13;
            long c14 = (c13 >>> 32) + (x_i * y_6) + (((long) zz[zzOff + 6]) & M);
            zz[zzOff + 6] = (int) c14;
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            zz[i + 6] = (int) c7;
            long c8 = (c7 >>> 32) + (((long) zz[i + 7]) & M) + zc;
            zz[i + 7] = (int) c8;
            zc = c8 >>> 32;
        }
        return (int) zc;
    ...
    public static int mulAddTo(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            zz[zzOff + 6] = (int) c7;
            long c8 = (c7 >>> 32) + (((long) zz[zzOff + 7]) & M) + zc;
            zz[zzOff + 7] = (int) c8;
            zc = c8 >>> 32;
            zzOff++;
        }
    ...
    public static void square(int[] x, int xOff, int[] zz, int zzOff) {
        ...
        while (true) {
            ...
            if (i2 <= 0) {
                ...
                int c14 = w12 >>> 31;
                zz[zzOff + 13] = ((zz[zzOff + 13] + ((int) (zz_123 >> 32))) << 1) | c14;
                return;
            }
            i = i2;
        }
