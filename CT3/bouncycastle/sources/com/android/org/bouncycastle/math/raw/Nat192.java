...
public abstract class Nat192 {
    ...
    public static void mul(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 1; i < 6; i++) {
            ...
            long c7 = 0 + (x_i * y_0) + (((long) zz[zzOff + 0]) & M);
            zz[zzOff + 0] = (int) c7;
            long c8 = (c7 >>> 32) + (x_i * y_1) + (((long) zz[zzOff + 1]) & M);
            zz[zzOff + 1] = (int) c8;
            long c9 = (c8 >>> 32) + (x_i * y_2) + (((long) zz[zzOff + 2]) & M);
            zz[zzOff + 2] = (int) c9;
            long c10 = (c9 >>> 32) + (x_i * y_3) + (((long) zz[zzOff + 3]) & M);
            zz[zzOff + 3] = (int) c10;
            long c11 = (c10 >>> 32) + (x_i * y_4) + (((long) zz[zzOff + 4]) & M);
            zz[zzOff + 4] = (int) c11;
            long c12 = (c11 >>> 32) + (x_i * y_5) + (((long) zz[zzOff + 5]) & M);
            zz[zzOff + 5] = (int) c12;
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            zz[i + 5] = (int) c6;
            long c7 = (c6 >>> 32) + (((long) zz[i + 6]) & M) + zc;
            zz[i + 6] = (int) c7;
            zc = c7 >>> 32;
        }
        return (int) zc;
    ...
    public static int mulAddTo(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            zz[zzOff + 5] = (int) c6;
            long c7 = (c6 >>> 32) + (((long) zz[zzOff + 6]) & M) + zc;
            zz[zzOff + 6] = (int) c7;
            zc = c7 >>> 32;
            zzOff++;
        }
    ...
    public static int mulWordAddExt(int x, int[] yy, int yyOff, int[] zz, int zzOff) {
        ...
        zz[zzOff + 4] = (int) c5;
        long c6 = (c5 >>> 32) + ((((long) yy[yyOff + 5]) & M) * xVal) + (((long) zz[zzOff + 5]) & M);
        zz[zzOff + 5] = (int) c6;
        return (int) (c6 >>> 32);
    }
