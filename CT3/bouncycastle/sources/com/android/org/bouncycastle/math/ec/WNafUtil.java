...
public abstract class WNafUtil {
    ...
    public static WNafPreCompInfo getWNafPreCompInfo(PreCompInfo preCompInfo) {
        return (preCompInfo == 0 || !(preCompInfo instanceof WNafPreCompInfo)) ? new WNafPreCompInfo() : preCompInfo;
    }
    ...
    public static WNafPreCompInfo precompute(ECPoint p, int width, boolean includeNegated) {
        ...
        if (iniPreCompLen < reqPreCompLen) {
            ...
            if (reqPreCompLen == 1) {
                ...
                int curPreCompLen2 = iniPreCompLen;
                if (iniPreCompLen == 0) {
                    preComp[0] = p;
                    curPreCompLen2 = 1;
                }
                ...
                if (reqPreCompLen == 2) {
                    ...
                    ECPoint last = preComp[curPreCompLen2 - 1];
                    if (twiceP == null) {
                        ...
                        if (curPreCompLen >= reqPreCompLen) {
                            curPreCompLen2 = curPreCompLen + 1;
