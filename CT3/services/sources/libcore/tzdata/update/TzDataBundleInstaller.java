...
public final class TzDataBundleInstaller {
    ...
    public boolean install(byte[] content) throws Throwable {
    ...
    private File unpackBundle(byte[] content, File targetDir) throws Throwable {
    ...
    private boolean verifySystemChecksums(File unpackedContentDir) throws Throwable {
