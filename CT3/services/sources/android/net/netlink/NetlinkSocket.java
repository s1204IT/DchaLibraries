...
public class NetlinkSocket implements Closeable {
    ...
    public void bind(NetlinkSocketAddress localAddr) throws SocketException, ErrnoException {
        Os.bind(this.mDescriptor, localAddr);
    }

    public void connectTo(NetlinkSocketAddress peerAddr) throws SocketException, ErrnoException {
        Os.connect(this.mDescriptor, peerAddr);
    }

    public void connectToKernel() throws SocketException, ErrnoException {
    ...
    public boolean sendMessage(byte[] bytes, int offset, int count) throws ErrnoException, InterruptedIOException {
        return sendMessage(bytes, offset, count, 0L);
    }
