...
public class NetworkStatsRecorder {
    ...
    public NetworkStats.Entry getTotalSinceBootLocked(NetworkTemplate template) {
        return this.mSinceBoot.getSummary(template, Long.MIN_VALUE, JobStatus.NO_LATEST_RUNTIME, 3).getTotal((NetworkStats.Entry) null);
    }
        ...
        for (int i = 0; i < delta.size(); i++) {
            ...
            if (ifaceName != null) {
                ...
                if (ident == null) {
                    ...
                    } else if ((entry.tag == 0) != this.mOnlyTags) {
                        if (this.mPending != null) {
