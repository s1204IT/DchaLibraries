...
public class EventLogTags {
    ...
    public static void writeCpu(int total, int user, int system, int iowait, int irq, int softirq) {
        EventLog.writeEvent(CPU, Integer.valueOf(total), Integer.valueOf(user), Integer.valueOf(system), Integer.valueOf(iowait), Integer.valueOf(irq), Integer.valueOf(softirq));
    }
    ...
    public static void writeAmFinishActivity(int user, int token, int taskId, String componentName, String reason) {
        EventLog.writeEvent(AM_FINISH_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), Integer.valueOf(taskId), componentName, reason);
    }

    public static void writeAmTaskToFront(int user, int task) {
        EventLog.writeEvent(AM_TASK_TO_FRONT, Integer.valueOf(user), Integer.valueOf(task));
    }
    ...
    public static void writeAmNewIntent(int user, int token, int taskId, String componentName, String action, String mimeType, String uri, int flags) {
        EventLog.writeEvent(AM_NEW_INTENT, Integer.valueOf(user), Integer.valueOf(token), Integer.valueOf(taskId), componentName, action, mimeType, uri, Integer.valueOf(flags));
    }

    public static void writeAmCreateTask(int user, int taskId) {
        EventLog.writeEvent(AM_CREATE_TASK, Integer.valueOf(user), Integer.valueOf(taskId));
    }
    ...
    public static void writeAmCreateActivity(int user, int token, int taskId, String componentName, String action, String mimeType, String uri, int flags) {
        EventLog.writeEvent(AM_CREATE_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), Integer.valueOf(taskId), componentName, action, mimeType, uri, Integer.valueOf(flags));
    }

    public static void writeAmRestartActivity(int user, int token, int taskId, String componentName) {
        EventLog.writeEvent(AM_RESTART_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), Integer.valueOf(taskId), componentName);
    }

    public static void writeAmResumeActivity(int user, int token, int taskId, String componentName) {
        EventLog.writeEvent(AM_RESUME_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), Integer.valueOf(taskId), componentName);
    }

    public static void writeAmAnr(int user, int pid, String packageName, int flags, String reason) {
        EventLog.writeEvent(AM_ANR, Integer.valueOf(user), Integer.valueOf(pid), packageName, Integer.valueOf(flags), reason);
    }

    public static void writeAmActivityLaunchTime(int user, int token, String componentName, long time) {
        EventLog.writeEvent(AM_ACTIVITY_LAUNCH_TIME, Integer.valueOf(user), Integer.valueOf(token), componentName, Long.valueOf(time));
    }

    public static void writeAmProcBound(int user, int pid, String processName) {
        EventLog.writeEvent(AM_PROC_BOUND, Integer.valueOf(user), Integer.valueOf(pid), processName);
    }

    public static void writeAmProcDied(int user, int pid, String processName) {
        EventLog.writeEvent(AM_PROC_DIED, Integer.valueOf(user), Integer.valueOf(pid), processName);
    }

    public static void writeAmFailedToPause(int user, int token, String wantingToPause, String currentlyPausing) {
        EventLog.writeEvent(AM_FAILED_TO_PAUSE, Integer.valueOf(user), Integer.valueOf(token), wantingToPause, currentlyPausing);
    }

    public static void writeAmPauseActivity(int user, int token, String componentName) {
        EventLog.writeEvent(AM_PAUSE_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), componentName);
    }

    public static void writeAmProcStart(int user, int pid, int uid, String processName, String type, String component) {
        EventLog.writeEvent(AM_PROC_START, Integer.valueOf(user), Integer.valueOf(pid), Integer.valueOf(uid), processName, type, component);
    }

    public static void writeAmProcBad(int user, int uid, String processName) {
        EventLog.writeEvent(AM_PROC_BAD, Integer.valueOf(user), Integer.valueOf(uid), processName);
    }

    public static void writeAmProcGood(int user, int uid, String processName) {
        EventLog.writeEvent(AM_PROC_GOOD, Integer.valueOf(user), Integer.valueOf(uid), processName);
    }
    ...
    public static void writeAmDestroyActivity(int user, int token, int taskId, String componentName, String reason) {
        EventLog.writeEvent(AM_DESTROY_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), Integer.valueOf(taskId), componentName, reason);
    }

    public static void writeAmRelaunchResumeActivity(int user, int token, int taskId, String componentName) {
        EventLog.writeEvent(AM_RELAUNCH_RESUME_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), Integer.valueOf(taskId), componentName);
    }

    public static void writeAmRelaunchActivity(int user, int token, int taskId, String componentName) {
        EventLog.writeEvent(AM_RELAUNCH_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), Integer.valueOf(taskId), componentName);
    }

    public static void writeAmOnPausedCalled(int user, String componentName, String reason) {
        EventLog.writeEvent(AM_ON_PAUSED_CALLED, Integer.valueOf(user), componentName, reason);
    }

    public static void writeAmOnResumeCalled(int user, String componentName, String reason) {
        EventLog.writeEvent(AM_ON_RESUME_CALLED, Integer.valueOf(user), componentName, reason);
    }

    public static void writeAmKill(int user, int pid, String processName, int oomadj, String reason) {
        EventLog.writeEvent(AM_KILL, Integer.valueOf(user), Integer.valueOf(pid), processName, Integer.valueOf(oomadj), reason);
    }
    ...
    public static void writeAmBroadcastDiscardFilter(int user, int broadcast, String action, int receiverNumber, int broadcastfilter) {
        EventLog.writeEvent(AM_BROADCAST_DISCARD_FILTER, Integer.valueOf(user), Integer.valueOf(broadcast), action, Integer.valueOf(receiverNumber), Integer.valueOf(broadcastfilter));
    }

    public static void writeAmBroadcastDiscardApp(int user, int broadcast, String action, int receiverNumber, String app) {
        EventLog.writeEvent(AM_BROADCAST_DISCARD_APP, Integer.valueOf(user), Integer.valueOf(broadcast), action, Integer.valueOf(receiverNumber), app);
    }

    public static void writeAmCreateService(int user, int serviceRecord, String name, int uid, int pid) {
        EventLog.writeEvent(AM_CREATE_SERVICE, Integer.valueOf(user), Integer.valueOf(serviceRecord), name, Integer.valueOf(uid), Integer.valueOf(pid));
    }

    public static void writeAmDestroyService(int user, int serviceRecord, int pid) {
        EventLog.writeEvent(AM_DESTROY_SERVICE, Integer.valueOf(user), Integer.valueOf(serviceRecord), Integer.valueOf(pid));
    }

    public static void writeAmProcessCrashedTooMuch(int user, String name, int pid) {
        EventLog.writeEvent(AM_PROCESS_CRASHED_TOO_MUCH, Integer.valueOf(user), name, Integer.valueOf(pid));
    }
    ...
    public static void writeAmServiceCrashedTooMuch(int user, int crashCount, String componentName, int pid) {
        EventLog.writeEvent(AM_SERVICE_CRASHED_TOO_MUCH, Integer.valueOf(user), Integer.valueOf(crashCount), componentName, Integer.valueOf(pid));
    }

    public static void writeAmScheduleServiceRestart(int user, String componentName, long time) {
        EventLog.writeEvent(AM_SCHEDULE_SERVICE_RESTART, Integer.valueOf(user), componentName, Long.valueOf(time));
    }

    public static void writeAmProviderLostProcess(int user, String packageName, int uid, String name) {
        EventLog.writeEvent(AM_PROVIDER_LOST_PROCESS, Integer.valueOf(user), packageName, Integer.valueOf(uid), name);
    }

    public static void writeAmProcessStartTimeout(int user, int pid, int uid, String processName) {
        EventLog.writeEvent(AM_PROCESS_START_TIMEOUT, Integer.valueOf(user), Integer.valueOf(pid), Integer.valueOf(uid), processName);
    }
    ...
    public static void writeAmCrash(int user, int pid, String processName, int flags, String exception, String message, String file, int line) {
        EventLog.writeEvent(AM_CRASH, Integer.valueOf(user), Integer.valueOf(pid), processName, Integer.valueOf(flags), exception, message, file, Integer.valueOf(line));
    }

    public static void writeAmWtf(int user, int pid, String processName, int flags, String tag, String message) {
        EventLog.writeEvent(AM_WTF, Integer.valueOf(user), Integer.valueOf(pid), processName, Integer.valueOf(flags), tag, message);
    }
    ...
    public static void writeAmActivityFullyDrawnTime(int user, int token, String componentName, long time) {
        EventLog.writeEvent(AM_ACTIVITY_FULLY_DRAWN_TIME, Integer.valueOf(user), Integer.valueOf(token), componentName, Long.valueOf(time));
    }

    public static void writeAmFocusedActivity(int user, String componentName, String reason) {
        EventLog.writeEvent(AM_FOCUSED_ACTIVITY, Integer.valueOf(user), componentName, reason);
    }

    public static void writeAmFocusedStack(int user, int focusedStackId, int lastFocusedStackId, String reason) {
        EventLog.writeEvent(AM_FOCUSED_STACK, Integer.valueOf(user), Integer.valueOf(focusedStackId), Integer.valueOf(lastFocusedStackId), reason);
    }

    public static void writeAmPreBoot(int user, String package_) {
        EventLog.writeEvent(AM_PRE_BOOT, Integer.valueOf(user), package_);
    }

    public static void writeAmMeminfo(long cached, long free, long zram, long kernel, long native_) {
        EventLog.writeEvent(AM_MEMINFO, Long.valueOf(cached), Long.valueOf(free), Long.valueOf(zram), Long.valueOf(kernel), Long.valueOf(native_));
    }

    public static void writeAmPss(int pid, int uid, String processName, long pss, long uss, long swappss) {
        EventLog.writeEvent(AM_PSS, Integer.valueOf(pid), Integer.valueOf(uid), processName, Long.valueOf(pss), Long.valueOf(uss), Long.valueOf(swappss));
    }

    public static void writeAmStopActivity(int user, int token, String componentName) {
        EventLog.writeEvent(AM_STOP_ACTIVITY, Integer.valueOf(user), Integer.valueOf(token), componentName);
    }

    public static void writeAmOnStopCalled(int user, String componentName, String reason) {
        EventLog.writeEvent(AM_ON_STOP_CALLED, Integer.valueOf(user), componentName, reason);
    }

    public static void writeAmMemFactor(int current, int previous) {
        EventLog.writeEvent(AM_MEM_FACTOR, Integer.valueOf(current), Integer.valueOf(previous));
    }
}
