...
public class HealthStatsBatteryStatsWriter {
    ...
    public void writeProc(HealthStatsWriter procWriter, BatteryStats.Uid.Proc proc) {
        ...
        procWriter.addMeasurement(EventLogTags.AM_NEW_INTENT, proc.getStarts(2));
        procWriter.addMeasurement(EventLogTags.AM_CREATE_TASK, proc.getNumCrashes(2));
        procWriter.addMeasurement(EventLogTags.AM_CREATE_ACTIVITY, proc.getNumAnrs(2));
