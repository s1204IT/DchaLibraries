...
public final class BatteryStatsService extends IBatteryStats.Stub implements PowerManagerInternal.LowPowerModeListener, BatteryStatsImpl.PlatformIdleStateCallback {
    ...
    public void publish(Context context) {
        ...
        this.mStats.setRadioScanningTimeout(((long) this.mContext.getResources().getInteger(R.integer.button_pressed_animation_duration)) * 1000);
    ...
    public byte[] getStatistics() throws Throwable {
    ...
    public ParcelFileDescriptor getStatisticsStream() throws Throwable {
        this.mContext.enforceCallingPermission("android.permission.BATTERY_STATS", null);
        Parcel out = Parcel.obtain();
        updateExternalStatsSync("get-stats", 15);
        synchronized (this.mStats) {
    ...
    public void setBatteryState(final int status, final int health, final int plugType, final int level, final int temp, final int volt, final int chargeUAh) {
        enforceCallingPermission();
            ...
            public void run() throws Throwable {
                synchronized (BatteryStatsService.this.mStats) {
                    ...
                    if (BatteryStatsService.this.mStats.isOnBattery() == onBattery) {
                        BatteryStatsService.this.mStats.setBatteryStateLocked(status, health, plugType, level, temp, volt, chargeUAh);
                        return;
                    }
                        ...
                        if (this.mStats.mCheckinFile.exists()) {
                            try {
                                ...
                                if (raw != null) {
                                    ...
                                    BatteryStatsImpl checkinStats = new BatteryStatsImpl((File) null, this.mStats.mHandler, (BatteryStatsImpl.ExternalStatsSync) null);
    ...
    private static <T extends Parcelable> T awaitControllerInfo(SynchronousResultReceiver synchronousResultReceiver) throws TimeoutException {
    ...
    void updateExternalStatsSync(String reason, int updateFlags) throws Throwable {
        WifiActivityEnergyInfo wifiInfo;
        BluetoothActivityEnergyInfo bluetoothInfo;
        ...
        synchronized (this.mExternalStatsLock) {
            ...
            } else if ((updateFlags & 8) == 0 && (adapter = BluetoothAdapter.getDefaultAdapter()) != null) {
    ...
    public HealthStatsParceler[] takeUidSnapshots(int[] requestUids) {
        ...
        try {
            try {
                ...
                Slog.d(TAG, "Crashed while writing for takeUidSnapshots(" + Arrays.toString(requestUids) + ") i=-1", ex);
                throw ex;
            }
        } finally {
            Binder.restoreCallingIdentity(ident);
