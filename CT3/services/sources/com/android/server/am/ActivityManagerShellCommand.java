...
class ActivityManagerShellCommand extends ShellCommand {
    ...
    public int onCommand(String cmd) {
        ...
        try {
            return cmd.equals("force-stop") ? runForceStop(pw) : cmd.equals("kill") ? runKill(pw) : cmd.equals("kill-all") ? runKillAll(pw) : cmd.equals("write") ? runWrite(pw) : cmd.equals("track-associations") ? runTrackAssociations(pw) : cmd.equals("untrack-associations") ? runUntrackAssociations(pw) : cmd.equals("is-user-stopped") ? runIsUserStopped(pw) : cmd.equals("lenient-background-check") ? runLenientBackgroundCheck(pw) : cmd.equals("get-uid-state") ? getUidState(pw) : handleDefaultCommands(cmd);
