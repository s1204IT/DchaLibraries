...
class ActivityStartInterceptor {
    ...
    private boolean interceptQuietProfileIfNeeded() {
        ...
        IIntentSender target = this.mService.getIntentSenderLocked(2, this.mCallingPackage, this.mCallingUid, this.mUserId, null, null, 0, new Intent[]{this.mIntent}, new String[]{this.mResolvedType}, 1342177280, null);
    ...
    private boolean interceptSuspendPackageIfNeed() {
        ...
        if (this.mAInfo == null || this.mAInfo.applicationInfo == null || (this.mAInfo.applicationInfo.flags & 1073741824) == 0 || (devicePolicyManager = (DevicePolicyManagerInternal) LocalServices.getService(DevicePolicyManagerInternal.class)) == null) {
            return false;
        }
