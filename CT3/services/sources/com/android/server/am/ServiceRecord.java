                ...
                try {
                    if (localForegroundNoti.getSmallIcon() == null) {
                        ...
                        try {
                            ...
                            notiBuilder.setColor(ServiceRecord.this.ams.mContext.getColor(R.color.system_accent3_600));
                            notiBuilder.setContentTitle(ServiceRecord.this.ams.mContext.getString(R.string.done_label, appName));
                            notiBuilder.setContentText(ServiceRecord.this.ams.mContext.getString(R.string.dream_accessibility_action_click, appName));
