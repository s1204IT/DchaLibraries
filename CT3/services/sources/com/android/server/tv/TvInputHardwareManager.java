...
class TvInputHardwareManager implements TvInputHal.Callback {
    ...
    private final IHdmiDeviceEventListener mHdmiDeviceEventListener = new HdmiDeviceEventListener(this, 0 == true ? 1 : 0);
    private final IHdmiSystemAudioModeChangeListener mHdmiSystemAudioModeChangeListener = new HdmiSystemAudioModeChangeListener(this, 0 == true ? 1 : 0);
    ...
    private final Handler mHandler = new ListenerHandler(this, 0 == true ? 1 : 0);
    ...
    private void handleVolumeChange(Context context, Intent intent) {
        ...
        if (!action.equals("android.media.VOLUME_CHANGED_ACTION")) {
            ...
            if (streamType2 != 3 || (index = intent.getIntExtra("android.media.EXTRA_VOLUME_STREAM_VALUE", 0)) == this.mCurrentIndex) {
                return;
            } else {
        ...
        private void updateAudioConfigLocked() {
            ...
            if (this.mAudioSource.gains().length > 0 && volume != this.mCommittedVolume) {
                ...
                while (true) {
                    ...
                    AudioGain gain = audioGainArrGains[i];
                    if ((gain.mode() & 1) == 0) {
                        i++;
                    } else {
                        sourceGain = gain;
            ...
            if (sourceConfig == null || sourceGainConfig != null) {
                ...
                while (true) {
                    ...
                    int inChannelMask = iArrChannelMasks[i2];
    ...
    private class ListenerHandler extends Handler {
        ...
        ListenerHandler(TvInputHardwareManager this$0, ListenerHandler listenerHandler) {
            this();
        }
    ...
    private final class HdmiHotplugEventListener extends IHdmiHotplugEventListener.Stub {
        HdmiHotplugEventListener(TvInputHardwareManager this$0, HdmiHotplugEventListener hdmiHotplugEventListener) {
            this();
        }
    ...
    private final class HdmiDeviceEventListener extends IHdmiDeviceEventListener.Stub {
        HdmiDeviceEventListener(TvInputHardwareManager this$0, HdmiDeviceEventListener hdmiDeviceEventListener) {
            this();
        }
    ...
    private final class HdmiSystemAudioModeChangeListener extends IHdmiSystemAudioModeChangeListener.Stub {
        HdmiSystemAudioModeChangeListener(TvInputHardwareManager this$0, HdmiSystemAudioModeChangeListener hdmiSystemAudioModeChangeListener) {
            this();
        }
