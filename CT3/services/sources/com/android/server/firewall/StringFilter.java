...
abstract class StringFilter implements Filter {
    ...
    StringFilter(ValueProvider valueProvider, StringFilter stringFilter) {
        this(valueProvider);
    }
    ...
    private static class EqualsFilter extends StringFilter {
        ...
        public boolean matchesValue(String value) {
            if (value != null) {
                return value.equals(this.mFilterValue);
            }
            return false;
        }
    }
    ...
    private static class ContainsFilter extends StringFilter {
        ...
        public boolean matchesValue(String value) {
            if (value != null) {
                return value.contains(this.mFilterValue);
            }
            return false;
        }
    }
    ...
    private static class StartsWithFilter extends StringFilter {
        ...
        public boolean matchesValue(String value) {
            if (value != null) {
                return value.startsWith(this.mFilterValue);
            }
            return false;
        }
    }
    ...
    private static class PatternStringFilter extends StringFilter {
        ...
        public boolean matchesValue(String value) {
            if (value != null) {
                return this.mPattern.match(value);
            }
            return false;
        }
    }
