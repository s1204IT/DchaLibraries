...
public final class DreamManagerService extends SystemService {
    ...
    public void onStart() {
        ...
        publishLocalService(DreamManagerInternal.class, new LocalService(this, 0 == true ? 1 : 0));
    }
    ...
    private ComponentName getDozeComponent(int userId) {
        ...
        if (TextUtils.isEmpty(name)) {
            name = this.mContext.getResources().getString(R.string.CwMmi);
        }
        boolean enabled = Settings.Secure.getIntForUser(this.mContext.getContentResolver(), "doze_enabled", 1, userId) != 0;
    ...
    private final class BinderService extends IDreamManager.Stub {
        BinderService(DreamManagerService this$0, BinderService binderService) {
            this();
        }
    ...
    private final class LocalService extends DreamManagerInternal {
        LocalService(DreamManagerService this$0, LocalService localService) {
            this();
        }
