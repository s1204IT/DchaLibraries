...
final class LogicalDisplay {
    ...
    public void updateLocked(List<DisplayDevice> devices) {
        ...
        this.mBaseDisplayInfo.supportedColorTransforms = (Display.ColorTransform[]) Arrays.copyOf(deviceInfo.supportedColorTransforms, deviceInfo.supportedColorTransforms.length);
    ...
    public void configureDisplayInTransactionLocked(DisplayDevice device, boolean isBlanked) {
        ...
        } else if (BenesseExtension.getDchaState() != 0 && physWidth >= displayInfo.logicalWidth && physHeight >= displayInfo.logicalHeight) {
            displayRectWidth = displayInfo.logicalWidth;
            displayRectHeight = displayInfo.logicalHeight;
