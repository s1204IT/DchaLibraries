...
public final class HdmiCecMessageValidator {
    ...
    public HdmiCecMessageValidator(HdmiControlService service) {
        ...
        addValidationInfo(DhcpPacket.MAX_OPTION_LEN, noneValidator, 1);
    ...
    private class PhysicalAddressValidator implements ParameterValidator {
        PhysicalAddressValidator(HdmiCecMessageValidator this$0, PhysicalAddressValidator physicalAddressValidator) {
            this();
        }
    ...
    private class SystemAudioModeRequestValidator extends PhysicalAddressValidator {
        SystemAudioModeRequestValidator(HdmiCecMessageValidator this$0, SystemAudioModeRequestValidator systemAudioModeRequestValidator) {
            this();
        }
    ...
    private class ReportPhysicalAddressValidator implements ParameterValidator {
        ReportPhysicalAddressValidator(HdmiCecMessageValidator this$0, ReportPhysicalAddressValidator reportPhysicalAddressValidator) {
            this();
        }
        ...
        public int isValid(byte[] params) {
            ...
            return HdmiCecMessageValidator.toErrorCode(HdmiCecMessageValidator.this.isValidPhysicalAddress(params, 0) ? HdmiCecMessageValidator.isValidType(params[2]) : false);
        }
    }

    private class RoutingChangeValidator implements ParameterValidator {
        RoutingChangeValidator(HdmiCecMessageValidator this$0, RoutingChangeValidator routingChangeValidator) {
            this();
        }
        ...
        public int isValid(byte[] params) {
            ...
            return HdmiCecMessageValidator.toErrorCode(HdmiCecMessageValidator.this.isValidPhysicalAddress(params, 0) ? HdmiCecMessageValidator.this.isValidPhysicalAddress(params, 2) : false);
        }
    }
}
