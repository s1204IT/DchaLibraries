...
public class FocusRequester {
    ...
    FocusRequester(AudioAttributes aa, int focusRequest, int grantFlags, IAudioFocusDispatcher afl, IBinder source, String id, MediaFocusControl.AudioFocusDeathHandler hdlr, String pn, int uid, MediaFocusControl ctlr) {
        this.mAttributes = aa;
    ...
    boolean hasSameBinder(IBinder ib) {
        if (this.mSourceRef != null) {
            return this.mSourceRef.equals(ib);
        }
        return false;
    }
