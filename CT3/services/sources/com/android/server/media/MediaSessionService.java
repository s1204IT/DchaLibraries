...
public class MediaSessionService extends SystemService implements Watchdog.Monitor {
    ...
    private void pushRemoteVolumeUpdateLocked(int userId) {
        ...
        try {
            ...
            this.mRvc.updateRemoteController(record != null ? record.getControllerBinder() : null);
        } catch (RemoteException e) {
    ...
    final class UserRecord {
        ...
        private void restoreMediaButtonReceiver() {
            ...
            String receiverName = Settings.Secure.getStringForUser(MediaSessionService.this.mContentResolver, "media_button_receiver", -2);
            if (TextUtils.isEmpty(receiverName) || (eventReceiver = ComponentName.unflattenFromString(receiverName)) == null) {
                return;
            }
    ...
    final class SettingsObserver extends ContentObserver {
        ...
        SettingsObserver(MediaSessionService this$0, SettingsObserver settingsObserver) {
            this();
        }
    ...
    class SessionManagerImpl extends ISessionManager.Stub {
        ...
        public void dispatchMediaKeyEvent(KeyEvent keyEvent, boolean needWakeLock) {
            ...
            try {
                ...
                synchronized (MediaSessionService.this.mLock) {
                    ...
                    boolean useNotPlayingSessions = ur != null ? ur.mLastMediaButtonReceiver == null && ur.mRestoredMediaButtonReceiver == null : true;
        ...
        public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
            ...
            synchronized (MediaSessionService.this.mLock) {
                ...
                for (int i2 = 0; i2 < count2; i2++) {
                    UserRecord user = (UserRecord) MediaSessionService.this.mUserRecords.get(MediaSessionService.this.mUserRecords.keyAt(i2));
                    user.dumpLocked(pw, "");
                }
            }
        }
        ...
        private void handleVoiceKeyEventLocked(KeyEvent keyEvent, boolean needWakeLock, MediaSessionRecord session) {
            if (session != null && session.hasFlag(PackageManagerService.DumpState.DUMP_INSTALLS)) {
                dispatchMediaKeyEventLocked(keyEvent, needWakeLock, session);
                return;
            }
        ...
        class KeyEventWakeLockReceiver extends ResultReceiver implements Runnable, PendingIntent.OnFinished {
            ...
            public void aquireWakeLockLocked() {
                ...
                this.mHandler.postDelayed(this, DataShapingUtils.CLOSING_DELAY_BUFFER_FOR_MUSIC);
            }
