...
class OtaDexoptShellCommand extends ShellCommand {
    ...
    public int onCommand(String cmd) {
        ...
        try {
            return cmd.equals("prepare") ? runOtaPrepare() : cmd.equals("cleanup") ? runOtaCleanup() : cmd.equals("done") ? runOtaDone() : cmd.equals("step") ? runOtaStep() : handleDefaultCommands(cmd);
