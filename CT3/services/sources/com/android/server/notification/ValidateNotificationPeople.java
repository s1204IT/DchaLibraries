...
public class ValidateNotificationPeople implements NotificationSignalExtractor {
    ...
    private RankingReconsideration validatePeople(Context context, NotificationRecord record) {
        ...
        float[] affinityOut = new float[1];
        PeopleRankingReconsideration rr = validatePeople(context, key, extras, affinityOut);
        float affinity = affinityOut[0];
        record.setContactAffinity(affinity);
        if (rr == null) {
            this.mUsageStats.registerPeopleAffinity(record, affinity > NONE, affinity == STARRED_CONTACT, true);
        } else {
            rr.setRecord(record);
        }
        return rr;
    ...
    private static class LookupResult {
        ...
        private boolean isInvalid() {
            if (this.mAffinity != ValidateNotificationPeople.NONE) {
                return isExpired();
            }
            return true;
        }
    ...
    private class PeopleRankingReconsideration extends RankingReconsideration {
        ...
        PeopleRankingReconsideration(ValidateNotificationPeople this$0, Context context, String key, LinkedList pendingLookups, PeopleRankingReconsideration peopleRankingReconsideration) {
        ...
        public void work() {
            ...
            if (this.mRecord != null) {
                ValidateNotificationPeople.this.mUsageStats.registerPeopleAffinity(this.mRecord, this.mContactAffinity > ValidateNotificationPeople.NONE, this.mContactAffinity == ValidateNotificationPeople.STARRED_CONTACT, false);
            }
