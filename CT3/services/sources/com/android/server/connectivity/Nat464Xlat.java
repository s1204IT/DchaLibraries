...
public class Nat464Xlat extends BaseNetworkObserver {
    ...
    public static boolean requiresClat(NetworkAgentInfo nai) {
        ...
        boolean zHasIPv4Address = nai.linkProperties != null ? nai.linkProperties.hasIPv4Address() : false;
        if (!connected || zHasIPv4Address) {
            return false;
        }
        return ArrayUtils.contains(NETWORK_TYPES, netType);
    }
