    ...
    public EmulatorDisplayOverlay(Context context, Display display, SurfaceSession session, int zOrder) {
        ...
        try {
            if (WindowManagerDebugConfig.DEBUG_SURFACE_TRACE) {
                ctrl = new WindowSurfaceController.SurfaceTrace(session, "EmulatorDisplayOverlay", this.mScreenSize.x, this.mScreenSize.y, -3, 4);
            } else {
        ...
        this.mOverlay = context.getDrawable(R.drawable.btn_toggle_on_disabled_focused_holo_light);
    }
