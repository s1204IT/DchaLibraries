...
public class WebViewUpdateServiceImpl {
    ...
    void handleNewUser(int userId) {
        WebViewProviderInfo[] webviewProviders;
        WebViewProviderInfo fallbackProvider;
        if (this.mSystemInterface.isFallbackLogicEnabled() && (fallbackProvider = getFallbackProvider((webviewProviders = this.mSystemInterface.getWebViewPackages()))) != null) {
    ...
    boolean isFallbackPackage(String packageName) {
        ...
        if (fallbackProvider != null) {
            return packageName.equals(fallbackProvider.packageName);
        }
        return false;
    }
    ...
    private static class WebViewUpdater {
            ...
            synchronized (this.mLock) {
                ...
                try {
                    ...
                    if (oldPackage == null) {
                        ...
                        providerChanged = !newPackage.packageName.equals(oldPackage.packageName);
                    }
                    if (providerChanged) {
                        onWebViewProviderChanged(newPackage);
                    }
        ...
        private PackageInfo findPreferredWebViewPackage() throws WebViewFactory.MissingWebViewPackageException {
            ...
            for (ProviderAndPackageInfo providerAndPackage3 : providers) {
                if (providerAndPackage3.provider.availableByDefault) {
                    return providerAndPackage3.packageInfo;
                }
            }
        ...
        public boolean isValidProvider(WebViewProviderInfo configInfo, PackageInfo packageInfo) {
            return (versionCodeGE(packageInfo.versionCode, getMinimumVersionCode()) || this.mSystemInterface.systemIsDebuggable()) && WebViewUpdateServiceImpl.providerHasValidSignature(configInfo, packageInfo, this.mSystemInterface) && WebViewFactory.getWebViewLibrary(packageInfo.applicationInfo) != null;
        }
