...
class AccountAuthenticatorCache extends RegisteredServicesCache<AuthenticatorDescription> implements IAccountAuthenticatorCache {
    ...
    public AuthenticatorDescription m823parseServiceAttributes(Resources res, String packageName, AttributeSet attrs) {
    ...
    private static class MySerializer implements XmlSerializerAndParser<AuthenticatorDescription> {
        MySerializer(MySerializer mySerializer) {
            this();
        }
        ...
        public AuthenticatorDescription m824createFromXml(XmlPullParser parser) throws XmlPullParserException, IOException {
            return AuthenticatorDescription.newKey(parser.getAttributeValue(null, DatabaseHelper.SoundModelContract.KEY_TYPE));
        }
    }

    @Override
    public RegisteredServicesCache.ServiceInfo getServiceInfo(AuthenticatorDescription type, int userId) {
