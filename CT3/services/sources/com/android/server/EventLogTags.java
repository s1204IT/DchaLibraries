...
public class EventLogTags {
    ...
    public static void writeBatteryLevel(int level, int voltage, int temperature) {
        EventLog.writeEvent(BATTERY_LEVEL, Integer.valueOf(level), Integer.valueOf(voltage), Integer.valueOf(temperature));
    }

    public static void writeBatteryStatus(int status, int health, int present, int plugged, String technology) {
        EventLog.writeEvent(BATTERY_STATUS, Integer.valueOf(status), Integer.valueOf(health), Integer.valueOf(present), Integer.valueOf(plugged), technology);
    }

    public static void writeBatteryDischarge(long duration, int minlevel, int maxlevel) {
        EventLog.writeEvent(BATTERY_DISCHARGE, Long.valueOf(duration), Integer.valueOf(minlevel), Integer.valueOf(maxlevel));
    }
    ...
    public static void writePowerScreenBroadcastDone(int on, long broadcastduration, int wakelockcount) {
        EventLog.writeEvent(POWER_SCREEN_BROADCAST_DONE, Integer.valueOf(on), Long.valueOf(broadcastduration), Integer.valueOf(wakelockcount));
    }

    public static void writePowerScreenBroadcastStop(int which, int wakelockcount) {
        EventLog.writeEvent(POWER_SCREEN_BROADCAST_STOP, Integer.valueOf(which), Integer.valueOf(wakelockcount));
    }

    public static void writePowerScreenState(int offoron, int becauseofuser, long totaltouchdowntime, int touchcycles) {
        EventLog.writeEvent(POWER_SCREEN_STATE, Integer.valueOf(offoron), Integer.valueOf(becauseofuser), Long.valueOf(totaltouchdowntime), Integer.valueOf(touchcycles));
    }

    public static void writePowerPartialWakeState(int releasedoracquired, String tag) {
        EventLog.writeEvent(POWER_PARTIAL_WAKE_STATE, Integer.valueOf(releasedoracquired), tag);
    }
    ...
    public static void writeFreeStorageLeft(long data, long system, long cache) {
        EventLog.writeEvent(FREE_STORAGE_LEFT, Long.valueOf(data), Long.valueOf(system), Long.valueOf(cache));
    }
    ...
    public static void writeNotificationEnqueue(int uid, int pid, String pkg, int id, String tag, int userid, String notification, int status) {
        EventLog.writeEvent(NOTIFICATION_ENQUEUE, Integer.valueOf(uid), Integer.valueOf(pid), pkg, Integer.valueOf(id), tag, Integer.valueOf(userid), notification, Integer.valueOf(status));
    }
    ...
    public static void writeNotificationCancel(int uid, int pid, String pkg, int id, String tag, int userid, int requiredFlags, int forbiddenFlags, int reason, String listener) {
        EventLog.writeEvent(NOTIFICATION_CANCEL, Integer.valueOf(uid), Integer.valueOf(pid), pkg, Integer.valueOf(id), tag, Integer.valueOf(userid), Integer.valueOf(requiredFlags), Integer.valueOf(forbiddenFlags), Integer.valueOf(reason), listener);
    }
    ...
    public static void writeNotificationCancelAll(int uid, int pid, String pkg, int userid, int requiredFlags, int forbiddenFlags, int reason, String listener) {
        EventLog.writeEvent(NOTIFICATION_CANCEL_ALL, Integer.valueOf(uid), Integer.valueOf(pid), pkg, Integer.valueOf(userid), Integer.valueOf(requiredFlags), Integer.valueOf(forbiddenFlags), Integer.valueOf(reason), listener);
    }
    ...
    public static void writeNotificationVisibilityChanged(String newlyvisiblekeys, String nolongervisiblekeys) {
        EventLog.writeEvent(NOTIFICATION_VISIBILITY_CHANGED, newlyvisiblekeys, nolongervisiblekeys);
    }
    ...
    public static void writeNotificationExpansion(String key, int userAction, int expanded, int lifespan, int freshness, int exposure) {
        EventLog.writeEvent(NOTIFICATION_EXPANSION, key, Integer.valueOf(userAction), Integer.valueOf(expanded), Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure));
    }

    public static void writeNotificationClicked(String key, int lifespan, int freshness, int exposure) {
        EventLog.writeEvent(NOTIFICATION_CLICKED, key, Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure));
    }

    public static void writeNotificationActionClicked(String key, int actionIndex, int lifespan, int freshness, int exposure) {
        EventLog.writeEvent(NOTIFICATION_ACTION_CLICKED, key, Integer.valueOf(actionIndex), Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure));
    }

    public static void writeNotificationCanceled(String key, int reason, int lifespan, int freshness, int exposure) {
        EventLog.writeEvent(NOTIFICATION_CANCELED, key, Integer.valueOf(reason), Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure));
    }

    public static void writeNotificationVisibility(String key, int visibile, int lifespan, int freshness, int exposure, int rank) {
        EventLog.writeEvent(NOTIFICATION_VISIBILITY, key, Integer.valueOf(visibile), Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure), Integer.valueOf(rank));
    }

    public static void writeNotificationAlert(String key, int buzz, int beep, int blink) {
        EventLog.writeEvent(NOTIFICATION_ALERT, key, Integer.valueOf(buzz), Integer.valueOf(beep), Integer.valueOf(blink));
    }
    ...
    public static void writeWatchdogProcPss(String process, int pid, int pss) {
        EventLog.writeEvent(WATCHDOG_PROC_PSS, process, Integer.valueOf(pid), Integer.valueOf(pss));
    }

    public static void writeWatchdogSoftReset(String process, int pid, int maxpss, int pss, String skip) {
        EventLog.writeEvent(WATCHDOG_SOFT_RESET, process, Integer.valueOf(pid), Integer.valueOf(maxpss), Integer.valueOf(pss), skip);
    }

    public static void writeWatchdogHardReset(String process, int pid, int maxpss, int pss) {
        EventLog.writeEvent(WATCHDOG_HARD_RESET, process, Integer.valueOf(pid), Integer.valueOf(maxpss), Integer.valueOf(pss));
    }
    ...
    public static void writeWatchdogProcStats(int deathsinone, int deathsintwo, int deathsinthree, int deathsinfour, int deathsinfive) {
        EventLog.writeEvent(WATCHDOG_PROC_STATS, Integer.valueOf(deathsinone), Integer.valueOf(deathsintwo), Integer.valueOf(deathsinthree), Integer.valueOf(deathsinfour), Integer.valueOf(deathsinfive));
    }

    public static void writeWatchdogScheduledReboot(long now, int interval, int starttime, int window, String skip) {
        EventLog.writeEvent(WATCHDOG_SCHEDULED_REBOOT, Long.valueOf(now), Integer.valueOf(interval), Integer.valueOf(starttime), Integer.valueOf(window), skip);
    }
    ...
    public static void writeWatchdogMeminfo(int memfree, int buffers, int cached, int active, int inactive, int anonpages, int mapped, int slab, int sreclaimable, int sunreclaim, int pagetables) {
        EventLog.writeEvent(WATCHDOG_MEMINFO, Integer.valueOf(memfree), Integer.valueOf(buffers), Integer.valueOf(cached), Integer.valueOf(active), Integer.valueOf(inactive), Integer.valueOf(anonpages), Integer.valueOf(mapped), Integer.valueOf(slab), Integer.valueOf(sreclaimable), Integer.valueOf(sunreclaim), Integer.valueOf(pagetables));
    }
    ...
    public static void writeWatchdogVmstat(long runtime, int pgfree, int pgactivate, int pgdeactivate, int pgfault, int pgmajfault) {
        EventLog.writeEvent(WATCHDOG_VMSTAT, Long.valueOf(runtime), Integer.valueOf(pgfree), Integer.valueOf(pgactivate), Integer.valueOf(pgdeactivate), Integer.valueOf(pgfault), Integer.valueOf(pgmajfault));
    }
    ...
    public static void writeWatchdogRequestedReboot(int nowait, int scheduleinterval, int recheckinterval, int starttime, int window, int minscreenoff, int minnextalarm) {
        EventLog.writeEvent(WATCHDOG_REQUESTED_REBOOT, Integer.valueOf(nowait), Integer.valueOf(scheduleinterval), Integer.valueOf(recheckinterval), Integer.valueOf(starttime), Integer.valueOf(window), Integer.valueOf(minscreenoff), Integer.valueOf(minnextalarm));
    }
    ...
    public static void writeBackupAgentFailure(String package_, String message) {
        EventLog.writeEvent(BACKUP_AGENT_FAILURE, package_, message);
    }

    public static void writeBackupPackage(String package_, int size) {
        EventLog.writeEvent(BACKUP_PACKAGE, package_, Integer.valueOf(size));
    }

    public static void writeBackupSuccess(int packages, int time) {
        EventLog.writeEvent(BACKUP_SUCCESS, Integer.valueOf(packages), Integer.valueOf(time));
    }
    ...
    public static void writeBackupRequested(int total, int keyValue, int full) {
        EventLog.writeEvent(BACKUP_REQUESTED, Integer.valueOf(total), Integer.valueOf(keyValue), Integer.valueOf(full));
    }
    ...
    public static void writeRestoreStart(String transport, long source) {
        EventLog.writeEvent(RESTORE_START, transport, Long.valueOf(source));
    }
    ...
    public static void writeRestoreAgentFailure(String package_, String message) {
        EventLog.writeEvent(RESTORE_AGENT_FAILURE, package_, message);
    }

    public static void writeRestorePackage(String package_, int size) {
        EventLog.writeEvent(RESTORE_PACKAGE, package_, Integer.valueOf(size));
    }

    public static void writeRestoreSuccess(int packages, int time) {
        EventLog.writeEvent(RESTORE_SUCCESS, Integer.valueOf(packages), Integer.valueOf(time));
    }
    ...
    public static void writeFullBackupAgentFailure(String package_, String message) {
        EventLog.writeEvent(FULL_BACKUP_AGENT_FAILURE, package_, message);
    }
    ...
    public static void writeBackupTransportLifecycle(String transport, int bound) {
        EventLog.writeEvent(BACKUP_TRANSPORT_LIFECYCLE, transport, Integer.valueOf(bound));
    }
    ...
    public static void writeWmNoSurfaceMemory(String window, int pid, String operation) {
        EventLog.writeEvent(WM_NO_SURFACE_MEMORY, window, Integer.valueOf(pid), operation);
    }

    public static void writeWmTaskCreated(int taskid, int stackid) {
        EventLog.writeEvent(WM_TASK_CREATED, Integer.valueOf(taskid), Integer.valueOf(stackid));
    }

    public static void writeWmTaskMoved(int taskid, int totop, int index) {
        EventLog.writeEvent(WM_TASK_MOVED, Integer.valueOf(taskid), Integer.valueOf(totop), Integer.valueOf(index));
    }

    public static void writeWmTaskRemoved(int taskid, String reason) {
        EventLog.writeEvent(WM_TASK_REMOVED, Integer.valueOf(taskid), reason);
    }
    ...
    public static void writeImfForceReconnectIme(Object[] ime, long timeSinceConnect, int showing) {
        EventLog.writeEvent(IMF_FORCE_RECONNECT_IME, ime, Long.valueOf(timeSinceConnect), Integer.valueOf(showing));
    }
    ...
    public static void writeDeviceIdle(int state, String reason) {
        EventLog.writeEvent(DEVICE_IDLE, Integer.valueOf(state), reason);
    }
    ...
    public static void writeDeviceIdleWakeFromIdle(int isIdle, String reason) {
        EventLog.writeEvent(DEVICE_IDLE_WAKE_FROM_IDLE, Integer.valueOf(isIdle), reason);
    }
    ...
    public static void writeDeviceIdleLight(int state, String reason) {
        EventLog.writeEvent(DEVICE_IDLE_LIGHT, Integer.valueOf(state), reason);
    }
    ...
    public static void writeAutoBrightnessAdj(float oldAdj, float oldLux, float oldBrightness, float oldGamma, float newAdj, float newLux, float newBrightness, float newGamma) {
        EventLog.writeEvent(AUTO_BRIGHTNESS_ADJ, Float.valueOf(oldAdj), Float.valueOf(oldLux), Float.valueOf(oldBrightness), Float.valueOf(oldGamma), Float.valueOf(newAdj), Float.valueOf(newLux), Float.valueOf(newBrightness), Float.valueOf(newGamma));
    }

    public static void writeConnectivityStateChanged(int type, int subtype, int state) {
        EventLog.writeEvent(CONNECTIVITY_STATE_CHANGED, Integer.valueOf(type), Integer.valueOf(subtype), Integer.valueOf(state));
    }
    ...
    public static void writeNetstatsWifiSample(long devRxBytes, long devTxBytes, long devRxPkts, long devTxPkts, long xtRxBytes, long xtTxBytes, long xtRxPkts, long xtTxPkts, long uidRxBytes, long uidTxBytes, long uidRxPkts, long uidTxPkts, long trustedTime) {
        EventLog.writeEvent(NETSTATS_WIFI_SAMPLE, Long.valueOf(devRxBytes), Long.valueOf(devTxBytes), Long.valueOf(devRxPkts), Long.valueOf(devTxPkts), Long.valueOf(xtRxBytes), Long.valueOf(xtTxBytes), Long.valueOf(xtRxPkts), Long.valueOf(xtTxPkts), Long.valueOf(uidRxBytes), Long.valueOf(uidTxBytes), Long.valueOf(uidRxPkts), Long.valueOf(uidTxPkts), Long.valueOf(trustedTime));
    }
    ...
    public static void writeIfwIntentMatched(int intentType, String componentName, int callerUid, int callerPkgCount, String callerPkgs, String action, String mimeType, String uri, int flags) {
        EventLog.writeEvent(IFW_INTENT_MATCHED, Integer.valueOf(intentType), componentName, Integer.valueOf(callerUid), Integer.valueOf(callerPkgCount), callerPkgs, action, mimeType, uri, Integer.valueOf(flags));
    }

    public static void writeIdleMaintenanceWindowStart(long time, long lastuseractivity, int batterylevel, int batterycharging) {
        EventLog.writeEvent(IDLE_MAINTENANCE_WINDOW_START, Long.valueOf(time), Long.valueOf(lastuseractivity), Integer.valueOf(batterylevel), Integer.valueOf(batterycharging));
    }

    public static void writeIdleMaintenanceWindowFinish(long time, long lastuseractivity, int batterylevel, int batterycharging) {
        EventLog.writeEvent(IDLE_MAINTENANCE_WINDOW_FINISH, Long.valueOf(time), Long.valueOf(lastuseractivity), Integer.valueOf(batterylevel), Integer.valueOf(batterycharging));
    }
    ...
    public static void writeVolumeChanged(int stream, int prevLevel, int level, int maxLevel, String caller) {
        EventLog.writeEvent(VOLUME_CHANGED, Integer.valueOf(stream), Integer.valueOf(prevLevel), Integer.valueOf(level), Integer.valueOf(maxLevel), caller);
    }

    public static void writeStreamDevicesChanged(int stream, int prevDevices, int devices) {
        EventLog.writeEvent(STREAM_DEVICES_CHANGED, Integer.valueOf(stream), Integer.valueOf(prevDevices), Integer.valueOf(devices));
    }

    public static void writeCameraGestureTriggered(long gestureOnTime, long sensor1OnTime, long sensor2OnTime, int eventExtra) {
        EventLog.writeEvent(CAMERA_GESTURE_TRIGGERED, Long.valueOf(gestureOnTime), Long.valueOf(sensor1OnTime), Long.valueOf(sensor2OnTime), Integer.valueOf(eventExtra));
    }
}
