...
public class StatusBarShellCommand extends ShellCommand {
    ...
    public int onCommand(String cmd) {
        ...
        try {
            return cmd.equals("expand-notifications") ? runExpandNotifications() : cmd.equals("expand-settings") ? runExpandSettings() : cmd.equals("collapse") ? runCollapse() : cmd.equals("add-tile") ? runAddTile() : cmd.equals("remove-tile") ? runRemoveTile() : cmd.equals("click-tile") ? runClickTile() : handleDefaultCommands(cmd);
