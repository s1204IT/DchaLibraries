...
public class JobServiceContext extends IJobCallback.Stub implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        this.mWakeLock = pm.newWakeLock(1, runningJob.getTag());
            ...
            switch (message.what) {
                ...
                case 3:
                    if (JobServiceContext.this.mVerb == 4) {
                        ...
                        if (message.arg1 == 2) {
                            JobServiceContext.this.mPreferredUid = JobServiceContext.this.mRunningJob != null ? JobServiceContext.this.mRunningJob.getUid() : -1;
                        }
                        handleCancelH();
                    }
                    break;
    ...
    private void scheduleOpTimeOut() {
        removeOpTimeOut();
        long timeoutMillis = this.mVerb == 2 ? 600000L : OP_TIMEOUT_MILLIS;
        if (DEBUG) {
