...
final class DockObserver extends SystemService {
    ...
    public DockObserver(Context context) {
        ...
        this.mAllowTheaterModeWakeFromDock = context.getResources().getBoolean(R.^attr-private.colorSurfaceHighlight);
        init();
    ...
    private final class BinderService extends Binder {
        BinderService(DockObserver this$0, BinderService binderService) {
            this();
        }
