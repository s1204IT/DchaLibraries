...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean updateKeyphraseSoundModel(SoundTrigger.KeyphraseSoundModel soundModel) {
        synchronized (this) {
            ...
            try {
                return db.insertWithOnConflict(SoundModelContract.TABLE, null, values, 5) != -1;
            } finally {
                db.close();
            }
        }
                            ...
                            if (modelUuid == null) {
                                ...
                                if (users == null) {
                                    ...
                                    if (isAvailableForCurrentUser) {
                                        ...
                                        SoundTrigger.KeyphraseSoundModel model = new SoundTrigger.KeyphraseSoundModel(UUID.fromString(modelUuid), (UUID) null, data, keyphrases);
                                        return model;
                                    }
                                }
                            }
