...
class C2kAgpsInterface {
    ...
    private final NetworkRequest mNetworkRequest = new NetworkRequest.Builder().addCapability(1).build();
    ...
    private void connect() throws IOException {
        ...
        this.mClient.connect(new LocalSocketAddress(SOCKET_ADDRESS, LocalSocketAddress.Namespace.ABSTRACT));
        this.mClient.setSoTimeout(3000);
