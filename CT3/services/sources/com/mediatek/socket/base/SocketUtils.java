...
public class SocketUtils {
    ...
    public static class BaseBuffer {
        ...
        public void putShort(short data) {
            ...
            putByte((byte) ((data >> 8) & DhcpPacket.MAX_OPTION_LEN));
        }
        ...
        public short getShort() {
            short ret = (short) ((getByte() & 255) | 0);
            return (short) ((getByte() << 8) | ret);
        }

        public int getInt() {
            int ret = (getShort() & 65535) | 0;
            return ret | (getShort() << 16);
        }

        public long getLong() {
            long ret = 0 | (((long) getInt()) & 4294967295L);
            return ret | (((long) getInt()) << 32);
        }
