...
public class HealthCheckLogic {
    public void getMacAddress(Context context, WifiInfo wifiInfo, HealthCheckDto healthCheckDto) {
        ...
        try {
            ...
            healthCheckDto.myMacaddress = Settings.System.getString(cr, "bc:mac_address");
        } catch (Exception e) {
    ...
    public void checkSsid(Context context, List<WifiConfiguration> cfgList, HealthCheckDto healthCheckDto) {
        ...
        if (cfgList != null) {
            ...
            Iterator wifiConfiguration$iterator = cfgList.iterator();
            while (true) {
                if (!wifiConfiguration$iterator.hasNext()) {
                    break;
                }
                WifiConfiguration wifiConfiguration = (WifiConfiguration) wifiConfiguration$iterator.next();
