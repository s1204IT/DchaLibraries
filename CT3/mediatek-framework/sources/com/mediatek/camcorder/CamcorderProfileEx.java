...
public class CamcorderProfileEx {
    ...
    private static final int SLOW_MOTION_LIST_END = 2252;
    ...
    public static CamcorderProfile getProfile(int cameraId, int quality) {
        if ((quality < QUALITY_LIST_START || quality > 123) && ((quality < QUALITY_TIME_LAPSE_LIST_START || quality > QUALITY_TIME_LAPSE_LIST_END) && (quality < 2231 || quality > 2252))) {
