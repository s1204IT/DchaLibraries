...
public class MessageDigestAlgorithm {
    ...
    public static String calculateResponse(String algorithm, String hashUserNameRealmPasswd, String nonce_value, String nc_value, String cnonce_value, String method, String digest_uri_value, String entity_body, String qop_value) {
        String A2;
        System.out.println("trying to authenticate using : " + algorithm + ", " + hashUserNameRealmPasswd + ", " + nonce_value + ", " + nc_value + ", " + cnonce_value + ", " + method + ", " + digest_uri_value + ", " + entity_body + ", " + qop_value);
        ...
        if (cnonce_value == null || qop_value == null || nc_value == null || !(qop_value.equalsIgnoreCase("auth") || qop_value.equalsIgnoreCase("auth-int"))) {
            String request_digest = KD(hashUserNameRealmPasswd, nonce_value + ":" + H(A2));
            return request_digest;
        }
        String request_digest2 = KD(hashUserNameRealmPasswd, nonce_value + ":" + nc_value + ":" + cnonce_value + ":" + qop_value + ":" + H(A2));
        return request_digest2;
    }
    ...
    public static String calculateResponse(String algorithm, String username_value, String realm_value, String passwd, String nonce_value, String nc_value, String cnonce_value, String method, String digest_uri_value, String entity_body, String qop_value) {
        String A1;
        String A2;
        System.out.println("trying to authenticate using : " + algorithm + ", " + username_value + ", " + realm_value + ", " + passwd + ", " + nonce_value + ", " + nc_value + ", " + cnonce_value + ", " + method + ", " + digest_uri_value + ", " + entity_body + ", " + qop_value);
        ...
        if (cnonce_value == null || qop_value == null || nc_value == null || !(qop_value.equalsIgnoreCase("auth") || qop_value.equalsIgnoreCase("auth-int"))) {
            String request_digest = KD(H(A1), nonce_value + ":" + H(A2));
            return request_digest;
        }
        String request_digest2 = KD(H(A1), nonce_value + ":" + nc_value + ":" + cnonce_value + ":" + qop_value + ":" + H(A2));
        return request_digest2;
    }
