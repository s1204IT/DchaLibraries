...
public final class HttpConnection {
    ...
    private final class FixedLengthSink implements Sink {
        ...
        FixedLengthSink(HttpConnection this$0, long bytesRemaining, FixedLengthSink fixedLengthSink) {
            this(bytesRemaining);
        }
    ...
    private final class ChunkedSink implements Sink {
        ...
        ChunkedSink(HttpConnection this$0, ChunkedSink chunkedSink) {
            this();
        }
    ...
    private abstract class AbstractSource implements Source {
        ...
        AbstractSource(HttpConnection this$0, AbstractSource abstractSource) {
            this();
        }
    ...
    private class UnknownLengthSource extends AbstractSource {
        ...
        UnknownLengthSource(HttpConnection this$0, UnknownLengthSource unknownLengthSource) {
            this();
        }
