...
public final class CacheControl {
    ...
    CacheControl(Builder builder, CacheControl cacheControl) {
        this(builder);
    }
            ...
            while (pos < value.length()) {
                ...
                if (pos2 == value.length() || value.charAt(pos2) == ',' || value.charAt(pos2) == ';') {
                    ...
                    if (pos3 < value.length() && value.charAt(pos3) == '\"') {
                        ...
                        strTrim = value.substring(pos4, pos5);
                        pos = pos5 + 1;
                    } else {
                        pos = HeaderParser.skipUntil(value, pos3, ",;");
                        strTrim = value.substring(pos3, pos).trim();
                    }
                }
                if ("no-cache".equalsIgnoreCase(directive)) {
                    ...
                    maxAgeSeconds = HeaderParser.parseSeconds(strTrim, -1);
                } else if ("s-maxage".equalsIgnoreCase(directive)) {
                    sMaxAgeSeconds = HeaderParser.parseSeconds(strTrim, -1);
                    ...
                    maxStaleSeconds = HeaderParser.parseSeconds(strTrim, Integer.MAX_VALUE);
                } else if ("min-fresh".equalsIgnoreCase(directive)) {
                    minFreshSeconds = HeaderParser.parseSeconds(strTrim, -1);
