...
final class RealBufferedSink implements BufferedSink {
    ...
    public OutputStream outputStream() {
        return new OutputStream() {
            ...
            @Override
            public void write(byte[] data, int offset, int byteCount) throws Throwable {
                if (RealBufferedSink.this.closed) {
                    throw new IOException("closed");
                }
                if (this.writeStart) {
                ...
                if ("true".equals(System.getProperty("http.digest.support", "false"))) {
                    ...
                    System.setProperty("http.req.body", requestBody.substring(0, byteCount));
                }
    ...
    private boolean isMmsSendPdu(byte[] pdu) {
        ...
        if (len >= 2) {
            ...
            if ((pdu[0] & 255) == 140 && (pdu[1] & 255) == 128) {
                return true;
            }
        }
        return false;
