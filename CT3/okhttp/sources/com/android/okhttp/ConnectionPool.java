...
public final class ConnectionPool {
    ...
    public void evictAll() {
        List<com.squareup.okhttp.Connection> toEvict;
        synchronized (this) {
    ...
    boolean performCleanup() {
        synchronized (this) {
            ...
            List<com.squareup.okhttp.Connection> evictableConnections = new ArrayList<>();
            ...
            if (evictableConnections.isEmpty()) {
                try {
                    ...
                    long remainderNanos = nanosUntilNextEviction - (1000000 * millisUntilNextEviction);
