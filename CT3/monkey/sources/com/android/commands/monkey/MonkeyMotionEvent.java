...
public abstract class MonkeyMotionEvent extends MonkeyEvent {
    ...
    private MotionEvent getEvent() {
        ...
        MotionEvent ev = MotionEvent.obtain(this.mDownTime, this.mEventTime < 0 ? SystemClock.uptimeMillis() : this.mEventTime, this.mAction, pointerCount, pointerIds, pointerCoords, this.mMetaState, this.mXPrecision, this.mYPrecision, this.mDeviceId, this.mEdgeFlags, this.mSource, this.mFlags);
        return ev;
    }
    ...
    public int injectEvent(IWindowManager iwm, IActivityManager iam, int verbose) {
        ...
        try {
            return !InputManager.getInstance().injectInputEvent(me, 1) ? 0 : 1;
        } finally {
            me.recycle();
        }
    }
