...
public class MonkeySourceNetwork implements MonkeyEventSource {
    ...
    private final CommandQueueImpl commandQueue = new CommandQueueImpl(null);
    ...
    static {
        COMMAND_MAP.put("flip", new FlipCommand(null));
        COMMAND_MAP.put("touch", new TouchCommand(0 == true ? 1 : 0));
        COMMAND_MAP.put("trackball", new TrackballCommand(0 == true ? 1 : 0));
        COMMAND_MAP.put("key", new KeyCommand(0 == true ? 1 : 0));
        COMMAND_MAP.put("sleep", new SleepCommand(0 == true ? 1 : 0));
        COMMAND_MAP.put("wake", new WakeCommand(0 == true ? 1 : 0));
        COMMAND_MAP.put("tap", new TapCommand(0 == true ? 1 : 0));
        COMMAND_MAP.put("press", new PressCommand(0 == true ? 1 : 0));
        COMMAND_MAP.put("type", new TypeCommand(0 == true ? 1 : 0));
        ...
        COMMAND_MAP.put("deferreturn", new DeferReturnCommand(0 == true ? 1 : 0));
    }

    private static class FlipCommand implements MonkeyCommand {
        FlipCommand(FlipCommand flipCommand) {
            this();
        }
    ...
    private static class TouchCommand implements MonkeyCommand {
        TouchCommand(TouchCommand touchCommand) {
            this();
        }
    ...
    private static class TrackballCommand implements MonkeyCommand {
        TrackballCommand(TrackballCommand trackballCommand) {
            this();
        }
    ...
    private static class KeyCommand implements MonkeyCommand {
        KeyCommand(KeyCommand keyCommand) {
            this();
        }
    ...
    private static class TypeCommand implements MonkeyCommand {
        TypeCommand(TypeCommand typeCommand) {
            this();
        }
    ...
    private static class WakeCommand implements MonkeyCommand {
        WakeCommand(WakeCommand wakeCommand) {
            this();
        }
    ...
    private static class TapCommand implements MonkeyCommand {
        TapCommand(TapCommand tapCommand) {
            this();
        }
    ...
    private static class PressCommand implements MonkeyCommand {
        PressCommand(PressCommand pressCommand) {
            this();
        }
    ...
    private static class DeferReturnCommand implements MonkeyCommand {
        DeferReturnCommand(DeferReturnCommand deferReturnCommand) {
            this();
        }
    ...
    private static final boolean wake() {
        ...
        try {
            pm.wakeUp(SystemClock.uptimeMillis(), "Monkey", (String) null);
            return true;
    ...
    private static class CommandQueueImpl implements CommandQueue {
        ...
        CommandQueueImpl(CommandQueueImpl commandQueueImpl) {
            this();
        }
