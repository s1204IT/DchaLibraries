...
public final class EncodedValueCodec {
    ...
    public static void writeSignedIntegralValue(ByteOutput out, int type, long value) {
        int requiredBits = 65 - Long.numberOfLeadingZeros((value >> 63) ^ value);
    ...
    public static int readSignedInt(ByteInput in, int zwidth) {
        ...
        for (int i = zwidth; i >= 0; i--) {
            result = (result >>> 8) | ((in.readByte() & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 24);
        }
