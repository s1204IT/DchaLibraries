...
public final class Os {
    ...
    public static FileDescriptor accept(FileDescriptor fd, InetSocketAddress peerAddress) throws SocketException, ErrnoException {
        return Libcore.os.accept(fd, peerAddress);
    }

    public static FileDescriptor accept(FileDescriptor fd, SocketAddress peerAddress) throws SocketException, ErrnoException {
        return Libcore.os.accept(fd, peerAddress);
    }
    ...
    public static void bind(FileDescriptor fd, InetAddress address, int port) throws SocketException, ErrnoException {
        Libcore.os.bind(fd, address, port);
    }

    public static void bind(FileDescriptor fd, SocketAddress address) throws SocketException, ErrnoException {
    ...
    public static void connect(FileDescriptor fd, InetAddress address, int port) throws SocketException, ErrnoException {
        Libcore.os.connect(fd, address, port);
    }

    public static void connect(FileDescriptor fd, SocketAddress address) throws SocketException, ErrnoException {
    ...
    public static int recvfrom(FileDescriptor fd, ByteBuffer buffer, int flags, InetSocketAddress srcAddress) throws SocketException, ErrnoException {
        return Libcore.os.recvfrom(fd, buffer, flags, srcAddress);
    }

    public static int recvfrom(FileDescriptor fd, byte[] bytes, int byteOffset, int byteCount, int flags, InetSocketAddress srcAddress) throws SocketException, ErrnoException {
    ...
    public static int sendto(FileDescriptor fd, ByteBuffer buffer, int flags, InetAddress inetAddress, int port) throws SocketException, ErrnoException {
        return Libcore.os.sendto(fd, buffer, flags, inetAddress, port);
    }

    public static int sendto(FileDescriptor fd, byte[] bytes, int byteOffset, int byteCount, int flags, InetAddress inetAddress, int port) throws SocketException, ErrnoException {
        return Libcore.os.sendto(fd, bytes, byteOffset, byteCount, flags, inetAddress, port);
    }

    public static int sendto(FileDescriptor fd, byte[] bytes, int byteOffset, int byteCount, int flags, SocketAddress address) throws SocketException, ErrnoException {
