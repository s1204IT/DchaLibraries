...
public class GlobalizationPreferences implements Freezable<GlobalizationPreferences> {
    ...
    public GlobalizationPreferences setLocales(String acceptLanguageString) {
        ...
        try {
            ULocale[] acceptLocales = ULocale.parseAcceptLanguage(acceptLanguageString, true);
    ...
    public ResourceBundle getResourceBundle(String str, ClassLoader classLoader) {
        ...
        UResourceBundle bundleInstance = null;
        ?? name = 0;
        ...
        while (true) {
            ...
            if (bundleInstance != null) {
                name = bundleInstance.getULocale().getName();
    ...
    public DateFormat getDateFormat(int dateStyle, int timeStyle) {
        ...
        DateFormat result3 = guessDateFormat(dateStyle, timeStyle);
        return result3;
    }
    ...
    public NumberFormat getNumberFormat(int style) {
        ...
        NumberFormat result2 = guessNumberFormat(style);
        return result2;
    }
    ...
    protected List<ULocale> processLocales(List<ULocale> inputLocales) {
        ...
        while (index < result.size()) {
            ...
            while (true) {
                uloc2 = uloc2.getFallback();
                if (uloc2.getLanguage().length() == 0) {
                    break;
                }
                index++;
    ...
    protected DateFormat guessDateFormat(int dateStyle, int timeStyle) {
        ...
        if (timeStyle == 4) {
            DateFormat result = DateFormat.getDateInstance(getCalendar(), dateStyle, dfLocale);
            return result;
        }
        if (dateStyle == 4) {
            DateFormat result2 = DateFormat.getTimeInstance(getCalendar(), timeStyle, dfLocale);
            return result2;
        }
        DateFormat result3 = DateFormat.getDateTimeInstance(getCalendar(), dateStyle, timeStyle, dfLocale);
        return result3;
    }
    ...
    protected String guessTerritory() {
        ...
        String result2 = null;
        if (script.length() != 0) {
            String result3 = language_territory_hack_map.get(language + BaseLocale.SEP + script);
            result2 = result3;
        }
        if (result2 == null) {
    ...
    protected BreakIterator guessBreakIterator(int type) {
        ...
        switch (type) {
            case 0:
                BreakIterator bitr = BreakIterator.getCharacterInstance(brkLocale);
                return bitr;
            case 1:
                BreakIterator bitr2 = BreakIterator.getWordInstance(brkLocale);
                return bitr2;
            case 2:
                BreakIterator bitr3 = BreakIterator.getLineInstance(brkLocale);
                return bitr3;
            case 3:
                BreakIterator bitr4 = BreakIterator.getSentenceInstance(brkLocale);
                return bitr4;
            case 4:
                BreakIterator bitr5 = BreakIterator.getTitleInstance(brkLocale);
                return bitr5;
            default:
    ...
    static {
        ...
        for (ULocale uLocale2 : brkLocales) {
