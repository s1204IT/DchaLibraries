...
public final class VersionInfo implements Comparable<VersionInfo> {
    ...
    public static final VersionInfo ICU_VERSION = getInstance(56, 1, 0, 0);

    @Deprecated
    public static final VersionInfo ICU_DATA_VERSION = getInstance(56, 1, 0, 0);
    private static final VersionInfo UNICODE_VERSION = UNICODE_8_0;
    ...
    static String getTZDataVersion() {
        if (TZDATA_VERSION == null) {
            synchronized (VersionInfo.class) {
                if (TZDATA_VERSION == null) {
                    UResourceBundle tzbundle = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b", "zoneinfo64");
