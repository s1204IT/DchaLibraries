...
public class SimpleTimeZone extends BasicTimeZone {
    ...
    static final boolean f111assertionsDisabled;
    ...
    static {
        f111assertionsDisabled = !SimpleTimeZone.class.desiredAssertionStatus();
        staticMonthLength = new byte[]{31, 29, 31, UCharacterEnums.ECharacterCategory.CHAR_CATEGORY_COUNT, 31, UCharacterEnums.ECharacterCategory.CHAR_CATEGORY_COUNT, 31, 31, UCharacterEnums.ECharacterCategory.CHAR_CATEGORY_COUNT, 31, UCharacterEnums.ECharacterCategory.CHAR_CATEGORY_COUNT, 31};
    }
    ...
    private int getOffset(int era, int year, int month, int day, int dayOfWeek, int millis, int monthLength, int prevMonthLength) {
        ...
        if (southern != (startCompare >= 0)) {
            if (this.endTimeMode == 0) {
                ...
                i = this.endTimeMode == 2 ? -this.raw : 0;
            }
