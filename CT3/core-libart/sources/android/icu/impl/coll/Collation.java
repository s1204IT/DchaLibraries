...
public final class Collation {
    ...
    static final boolean f31assertionsDisabled;
    ...
    static {
        f31assertionsDisabled = !Collation.class.desiredAssertionStatus();
    }
    ...
    public static long incTwoBytePrimaryByOffset(long basePrimary, boolean isCompressible, int offset) {
        ...
        if (isCompressible) {
            ...
            primary = ((offset3 % 251) + 4) << 16;
            offset2 = offset3 / 251;
        } else {
            int offset4 = offset + ((((int) (basePrimary >> 16)) & 255) - 2);
            primary = ((offset4 % 254) + 2) << 16;
            offset2 = offset4 / 254;
        }
    ...
    static long unassignedPrimaryFromCodePoint(int c) {
        int c2 = c + 1;
        long primary = ((c2 % 18) * 14) + 2;
        int c3 = c2 / 18;
        return 4261412864L | primary | ((long) (((c3 % 254) + 2) << 8)) | ((long) ((((c3 / 254) % 251) + 4) << 16));
    }
