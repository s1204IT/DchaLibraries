...
public final class ContractionsAndExpansions {
    ...
    static final boolean f53assertionsDisabled;
    ...
    static {
        f53assertionsDisabled = !ContractionsAndExpansions.class.desiredAssertionStatus();
    }
    ...
    private void handleCE32(int start, int end, int ce32) {
        while ((ce32 & 255) >= 192) {
            switch (Collation.tagFromCE32(ce32)) {
                ...
                case 7:
                case 13:
                    throw new AssertionError(String.format("Unexpected CE32 tag type %d for ce32=0x%08x", Integer.valueOf(Collation.tagFromCE32(ce32)), Integer.valueOf(ce32)));
                case 4:
                    if (this.sink != null) {
                ...
                case 12:
                    if (this.sink != null) {
                        ...
                        for (int c = start; c <= end; c++) {
                            ...
                            int length2 = iter.fetchCEs();
                            if (!f53assertionsDisabled) {
                                if (!(length2 >= 2 && iter.getCE(length2 + (-1)) == Collation.NO_CE)) {
                                    throw new AssertionError();
                                }
                            }
    ...
    void handleContractions(int start, int end, int ce32) {
        ...
        if ((ce32 & 256) != 0) {
            ...
            int ce322 = this.data.getCE32FromContexts(index);
            if (!f53assertionsDisabled) {
                if (!(Collation.isContractionCE32(ce322) ? false : true)) {
                    throw new AssertionError();
                }
            }
            handleCE32(start, end, ce322);
