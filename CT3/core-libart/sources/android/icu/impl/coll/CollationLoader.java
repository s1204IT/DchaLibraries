...
public final class CollationLoader {
    ...
    private static void loadRootRules() {
        ...
        synchronized (CollationLoader.class) {
            if (rootRules == null) {
                UResourceBundle rootBundle = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b/coll", ULocale.ROOT);
        ...
        static String toLowerCase(String s) {
            ...
            while (i < s.length()) {
                ...
                if ('A' > c || c > 'Z') {
                    ...
                    sb.append((CharSequence) s, 0, i).append((char) (c + ' '));
                    while (true) {
                        i++;
                        if (i < s.length()) {
                            char c2 = s.charAt(i);
    ...
    static String loadRules(ULocale locale, String collationType) {
        UResourceBundle bundle = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b/coll", locale);
    ...
    public static CollationTailoring loadTailoring(ULocale locale, Output<ULocale> outValidLocale) {
        ...
        try {
            UResourceBundle bundle = ICUResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b/coll", locale, ICUResourceBundle.OpenType.LOCALE_ROOT);
            ...
            try {
                ...
                if (data == null && type.length() > 6 && type.startsWith("search")) {
                    type = "search";
                    data = findWithFallback(collations, "search");
                }
                ...
                if (data == null && !type.equals("standard")) {
                    type = "standard";
                    data = findWithFallback(collations, "standard");
                }
                if (data == null) {
                    return root;
                }
                ...
                try {
                    ...
                    if (!actualLocale.equals(validLocale)) {
                        UResourceBundle actualBundle = UResourceBundle.getBundleInstance("android/icu/impl/data/icudt56b/coll", actualLocale);
