...
public abstract class Trie {
    ...
    static final boolean f21assertionsDisabled;
    ...
    static {
        f21assertionsDisabled = !Trie.class.desiredAssertionStatus();
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.m_isLatin1Linear_ == othertrie.m_isLatin1Linear_ && this.m_options_ == othertrie.m_options_ && this.m_dataLength_ == othertrie.m_dataLength_) {
            return Arrays.equals(this.m_index_, othertrie.m_index_);
        }
        return false;
    }
    ...
    protected Trie(ByteBuffer bytes, DataManipulate dataManipulate) {
        DefaultGetFoldingOffset defaultGetFoldingOffset = null;
        ...
        if (dataManipulate != null) {
            ...
            this.m_dataManipulate_ = new DefaultGetFoldingOffset(defaultGetFoldingOffset);
        }
    ...
    private final boolean checkHeader(int signature) {
        return signature == HEADER_SIGNATURE_ && (this.m_options_ & 15) == 5 && ((this.m_options_ >> 4) & 15) == 2;
    }
}
