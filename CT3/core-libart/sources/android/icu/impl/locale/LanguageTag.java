...
public class LanguageTag {
    ...
    static final boolean f60assertionsDisabled;
    ...
    static {
        f60assertionsDisabled = !LanguageTag.class.desiredAssertionStatus();
        UNDETERMINED = "und";
    ...
    public static LanguageTag parse(String languageTag, ParseStatus sts) {
        ...
        if (isGrandfathered) {
            if (!f60assertionsDisabled && !itr.isDone()) {
                throw new AssertionError();
            }
            if (!f60assertionsDisabled) {
                if (!(sts.isError() ? false : true)) {
                    throw new AssertionError();
                }
            }
    ...
    public static boolean isLanguage(String s) {
        ...
        return AsciiUtil.isAlphaString(s);
    }
    ...
    public static boolean isRegion(String s) {
        ...
        if (s.length() == 3) {
            return AsciiUtil.isNumericString(s);
        }
        return false;
    }
    ...
    public static boolean isVariant(String s) {
        ...
        if (len == 4 && AsciiUtil.isNumeric(s.charAt(0)) && AsciiUtil.isAlphaNumeric(s.charAt(1)) && AsciiUtil.isAlphaNumeric(s.charAt(2))) {
            return AsciiUtil.isAlphaNumeric(s.charAt(3));
        }
        return false;
    }
