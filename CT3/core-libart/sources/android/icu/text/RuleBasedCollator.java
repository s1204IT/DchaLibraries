...
public final class RuleBasedCollator extends Collator {
    ...
    static final boolean f88assertionsDisabled;
    ...
    static {
        f88assertionsDisabled = !RuleBasedCollator.class.desiredAssertionStatus();
    }
    ...
    public Collator freeze() {
        ...
        if (!isFrozen()) {
            ...
            if (this.collationBuffer == null) {
                this.collationBuffer = new CollationBuffer(this.data, collationBuffer);
            }
        }
        return this;
    }
    ...
    public RuleBasedCollator cloneAsThawed() {
        try {
            ...
            result.settings = this.settings.m77clone();
    ...
    public void setReorderCodes(int... order) {
        ...
        if (length != 0) {
            if (Arrays.equals(order, ((CollationSettings) this.settings.readOnly()).reorderCodes)) {
                return;
            }
        } else if (((CollationSettings) this.settings.readOnly()).reorderCodes.length == 0) {
            return;
        }
        CollationSettings defaultSettings = getDefaultSettings();
    ...
    public long[] internalGetCEs(CharSequence str) {
        ...
        try {
            CollationBuffer buffer = getCollationBuffer();
            boolean numeric = ((CollationSettings) this.settings.readOnly()).isNumeric();
            if (((CollationSettings) this.settings.readOnly()).dontCheckFCD()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!f88assertionsDisabled) {
            if (!((thisIsRoot && otherIsRoot) ? false : true)) {
                throw new AssertionError();
            }
        }
    ...
    protected int doCompare(CharSequence left, CharSequence right) {
        ...
        try {
            ...
            if (roSettings.dontCheckFCD()) {
                ...
                int iCompareNFDIter = compareNFDIter(nfcImpl, buffer2.leftUTF16NFDIter, buffer2.rightUTF16NFDIter);
            ...
            int iCompareNFDIter2 = compareNFDIter(nfcImpl, buffer2.leftFCDUTF16NFDIter, buffer2.rightFCDUTF16NFDIter);
            releaseCollationBuffer(buffer2);
    ...
    RuleBasedCollator(CollationTailoring t, ULocale vl) {
        this.data = t.data;
        this.settings = t.settings.m77clone();
        this.tailoring = t;
        this.validLocale = vl;
    ...
    private static final class CollationBuffer {
        ...
        CollationBuffer(CollationData data, CollationBuffer collationBuffer) {
            this(data);
        }
    ...
    void setLocale(ULocale valid, ULocale actual) {
        ...
        if (Utility.objectEquals(actual, this.tailoring.actualLocale)) {
            ...
            if (!f88assertionsDisabled && !Utility.objectEquals(actual, valid)) {
                throw new AssertionError();
            }
