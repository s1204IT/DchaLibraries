...
final class BidiLine {
    ...
    static void getRuns(Bidi bidi) {
        ...
        for (int ic = 0; ic < bidi.length; ic++) {
            ...
            if (Bidi.IsBidiControlChar(c)) {
                ...
                BidiRun bidiRun2 = bidi.runs[runIndex3];
                bidiRun2.insertRemove--;
            }
        }
    }
                ...
                while (true) {
                    if (i < bidi.runCount) {
                        ...
                        if (offset >= 0 && offset < length) {
                            visualIndex = runs[i].isEvenRun() ? visualStart + offset : ((visualStart + length) - offset) - 1;
                        } else {
                            visualStart += length;
                            i++;
                        }
    ...
    static int getLogicalIndex(Bidi bidi, int visualIndex) {
        ...
        if (bidi.insertPoints.size > 0) {
            ...
            int i2 = 0;
            while (true) {
                int length2 = runs[i2].limit - visualStart;
                int insertRemove2 = runs[i2].insertRemove;
                ...
                if ((insertRemove2 & 10) > 0) {
                    if (visualIndex == visualStart + length2 + markFound) {
                        return -1;
                    }
                    markFound++;
                }
            ...
            int i3 = 0;
            while (true) {
                length = runs[i3].limit - visualStart2;
                insertRemove = runs[i3].insertRemove;
                if (visualIndex < (runs[i3].limit - controlFound) + insertRemove) {
                    break;
                }
            ...
            if (insertRemove == 0) {
                ...
                int logicalStart = runs[i3].start;
    ...
    static int[] getVisualMap(Bidi bidi) {
        ...
        if (bidi.insertPoints.size > 0) {
            ...
            while (i3 < runCount2) {
                ...
                if (insertRemove3 == 0 && k4 == visualStart3) {
                    k4 += length;
