...
public final class StringSearch extends SearchIterator {
    ...
    private int getCE(int sourcece) {
        ...
        if (this.strength_ >= 3 && sourcece2 == 0) {
            return 65535;
        }
        return sourcece2;
    }
    ...
    private boolean isBreakBoundary(int index) {
        ...
        if (breakiterator != null) {
            return breakiterator.isBoundary(index);
        }
        return false;
    }
    ...
    private boolean search(int startIdx, Match m) {
        ...
        while (true) {
            ...
            if (found || (targetCEI != null && targetCEI.ce_ == -1)) {
                ...
                CEI lastCEI = ceb.get((targetIx + targetIxOffset2) - 1);
                ...
                if (this.search_.elementComparisonType_ == SearchIterator.ElementComparisonType.STANDARD_ELEMENT_COMPARISON) {
                    nextCEI = ceb.get(targetIx + targetIxOffset2);
                ...
                boolean allowMidclusterMatch = (this.breakIterator != null || nextCEI == null || ((nextCEI.ce_ >>> 32) & Collation.MAX_PRIMARY) == 0 || maxLimit < lastCEI.highIndex_ || nextCEI.highIndex_ <= maxLimit) ? false : !this.nfd_.hasBoundaryBefore(codePointAt(this.targetText, maxLimit)) ? this.nfd_.hasBoundaryAfter(codePointBefore(this.targetText, maxLimit)) : true;
                mLimit = maxLimit;
    ...
    private boolean handlePreviousCommonImpl() {
        ...
        if (searchBackwards(textOffset, match2)) {
    ...
    private static class CollationPCE {
        ...
        public long previousProcessed(Range range) {
            RCEBuffer rCEBuffer = null;
            while (this.pceBuffer_.empty()) {
                RCEBuffer rceb = new RCEBuffer(rCEBuffer);
    ...
    private static class CEBuffer {
        ...
        static final boolean f96assertionsDisabled;
        ...
        static {
            f96assertionsDisabled = !CEBuffer.class.desiredAssertionStatus();
        }
