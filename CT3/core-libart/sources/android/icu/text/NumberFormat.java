...
public abstract class NumberFormat extends UFormat {
    ...
    static final boolean f79assertionsDisabled;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.maximumIntegerDigits == other.maximumIntegerDigits && this.minimumIntegerDigits == other.minimumIntegerDigits && this.maximumFractionDigits == other.maximumFractionDigits && this.minimumFractionDigits == other.minimumFractionDigits && this.groupingUsed == other.groupingUsed && this.parseIntegerOnly == other.parseIntegerOnly && this.parseStrict == other.parseStrict) {
            return this.capitalizationSetting == other.capitalizationSetting;
        }
        return false;
    }
    ...
    protected static String getPattern(ULocale forLocale, int choice) {
        ...
        try {
            String result = rb.getStringWithFallback("NumberElements/" + ns.getName() + "/patterns/" + patternKey);
            return result;
        } catch (MissingResourceException e) {
            String result2 = rb.getStringWithFallback("NumberElements/latn/patterns/" + patternKey);
            return result2;
        }
    }
    ...
    static {
        f79assertionsDisabled = !NumberFormat.class.desiredAssertionStatus();
        doubleCurrencySign = new char[]{164, 164};
