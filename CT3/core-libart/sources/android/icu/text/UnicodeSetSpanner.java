...
public class UnicodeSetSpanner {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof UnicodeSetSpanner) {
            return this.unicodeSet.equals(obj.unicodeSet);
        }
        return false;
    }
    ...
    public enum CountMethod {
        ...
        public static CountMethod[] valuesCustom() {
            return values();
        }
    }
    ...
    public enum TrimOption {
        ...
        public static TrimOption[] valuesCustom() {
            return values();
        }
    }
