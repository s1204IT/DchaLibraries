...
public final class Normalizer implements Cloneable {
    ...
    @Deprecated
    public static final Mode NFD = new NFDMode(0 == true ? 1 : 0);

    @Deprecated
    public static final Mode NFKD = new NFKDMode(0 == true ? 1 : 0);

    @Deprecated
    public static final Mode NFC = new NFCMode(0 == true ? 1 : 0);

    @Deprecated
    public static final Mode DEFAULT = NFC;

    @Deprecated
    public static final Mode NFKC = new NFKCMode(0 == true ? 1 : 0);

    @Deprecated
    public static final Mode FCD = new FCDMode(0 == true ? 1 : 0);
    ...
    public static final QuickCheckResult NO = new QuickCheckResult(0, 0 == true ? 1 : 0);
    public static final QuickCheckResult YES = new QuickCheckResult(1, 0 == true ? 1 : 0);
    public static final QuickCheckResult MAYBE = new QuickCheckResult(2, 0 == true ? 1 : 0);

    private static final class ModeImpl {
        private final Normalizer2 normalizer2;

        ModeImpl(Normalizer2 n2, ModeImpl modeImpl) {
            this(n2);
        }
    ...
    public static final class QuickCheckResult {
        QuickCheckResult(int value, QuickCheckResult quickCheckResult) {
            this(value);
        }
    ...
    private static final class CmpEquivLevel {
        ...
        CmpEquivLevel(CmpEquivLevel cmpEquivLevel) {
            this();
        }
    ...
    private static final CmpEquivLevel[] createCmpEquivLevelStack() {
        CmpEquivLevel cmpEquivLevel = null;
        return new CmpEquivLevel[]{new CmpEquivLevel(cmpEquivLevel), new CmpEquivLevel(cmpEquivLevel)};
    }
    ...
    static int cmpEquivFold(CharSequence cs1, CharSequence cs2, int options) {
            ...
            if (c1 == c2) {
                ...
                if (UTF16.isSurrogate((char) c1)) {
                    if (Normalizer2Impl.UTF16Plus.isSurrogateLead(c1)) {
                        if (s1 != limit1) {
                            char c = cs1.charAt(s1);
                            if (Character.isLowSurrogate(c)) {
                                cp1 = Character.toCodePoint((char) c1, c);
                            }
                        }
                    } else if (s1 - 2 >= 0) {
                        char c3 = cs1.charAt(s1 - 2);
                ...
                if (UTF16.isSurrogate((char) c2)) {
                    if (Normalizer2Impl.UTF16Plus.isSurrogateLead(c2)) {
                        if (s2 != limit2) {
                            char c4 = cs2.charAt(s2);
                            if (Character.isLowSurrogate(c4)) {
                                cp2 = Character.toCodePoint((char) c2, c4);
                            }
                        }
                    } else if (s2 - 2 >= 0) {
                        char c5 = cs2.charAt(s2 - 2);
                        if (Character.isHighSurrogate(c5)) {
                            cp2 = Character.toCodePoint(c5, (char) c2);
                        }
                    }
                }
                if (level1 == 0 && (65536 & options) != 0 && (length2 = csp.toFullFolding(cp1, fold1, options)) >= 0) {
                    if (UTF16.isSurrogate((char) c1)) {
                        if (Normalizer2Impl.UTF16Plus.isSurrogateLead(c1)) {
                            s1++;
                        } else {
                    ...
                    limit1 = fold1.length();
                    c1 = -1;
                } else if (level2 == 0 && (65536 & options) != 0 && (length = csp.toFullFolding(cp2, sb, options)) >= 0) {
                    if (UTF16.isSurrogate((char) c2)) {
                        if (Normalizer2Impl.UTF16Plus.isSurrogateLead(c2)) {
                            s2++;
                        } else {
                    ...
                    if (length <= 31) {
                        ...
                        sb.setLength(0);
                        sb.appendCodePoint(length);
                    }
                    cs2 = sb;
                    s2 = 0;
                    limit2 = sb.length();
                    c2 = -1;
                } else if (level1 < 2 && (524288 & options) != 0 && (decomp1 = normalizer2Impl.getDecomposition(cp1)) != null) {
                    if (UTF16.isSurrogate((char) c1)) {
                        if (Normalizer2Impl.UTF16Plus.isSurrogateLead(c1)) {
                            s1++;
                        } else {
                    ...
                    if (level2 >= 2 || (524288 & options) == 0 || (decomp2 = normalizer2Impl.getDecomposition(cp2)) == null) {
                        break;
                    }
                    if (UTF16.isSurrogate((char) c2)) {
                        if (Normalizer2Impl.UTF16Plus.isSurrogateLead(c2)) {
        ...
        if (c1 >= 55296 && c2 >= 55296 && (32768 & options) != 0) {
            if (c1 > 56319 || s1 == limit1 || !Character.isLowSurrogate(cs1.charAt(s1))) {
                if (Character.isLowSurrogate((char) c1) && s1 - 1 != 0) {
                    if (!Character.isHighSurrogate(cs1.charAt(s1 - 2))) {
                    }
                } else {
                    c1 -= 10240;
                }
            ...
            if (c2 > 56319 || s2 == limit2 || !Character.isLowSurrogate(cs2.charAt(s2))) {
                if (Character.isLowSurrogate((char) c2) && s2 - 1 != 0) {
                    if (!Character.isHighSurrogate(cs2.charAt(s2 - 2))) {
                    }
                } else {
                    c2 -= 10240;
                }
