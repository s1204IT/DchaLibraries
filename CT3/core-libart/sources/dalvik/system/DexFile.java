...
public final class DexFile {
    ...
    public static native int getDexOptNeeded(String str, String str2, String str3, boolean z) throws IOException;
    ...
    private static Object openDexFile(String sourceName, String outputName, int flags, ClassLoader loader, DexPathList.Element[] elements) throws IOException {
        return openDexFileNative(new File(sourceName).getAbsolutePath(), outputName != null ? new File(outputName).getAbsolutePath() : null, flags, loader, elements);
    }
