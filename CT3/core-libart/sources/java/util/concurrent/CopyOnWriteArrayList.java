...
public class CopyOnWriteArrayList<E> implements List<E>, RandomAccess, Cloneable, Serializable {
    ...
    public boolean equals(Object other) {
        if (other instanceof CopyOnWriteArrayList) {
            if (this != other) {
                return Arrays.equals(this.elements, ((CopyOnWriteArrayList) other).elements);
            }
            return true;
        }
    ...
    private void replaceInRange(int from, int to, UnaryOperator<E> unaryOperator) {
        ...
        for (int i = from; i < to; i++) {
            newElements[i] = unaryOperator.apply(this.elements[i]);
        }
        this.elements = newElements;
    }
