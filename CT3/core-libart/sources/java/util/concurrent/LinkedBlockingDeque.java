...
public class LinkedBlockingDeque<E> extends AbstractQueue<E> implements BlockingDeque<E>, Serializable {
    ...
    public E peekFirst() {
        ...
        lock.lock();
        try {
            return this.first != null ? this.first.item : null;
        } finally {
            lock.unlock();
        }
    }
    ...
    public E peekLast() {
        ...
        lock.lock();
        try {
            return this.last != null ? this.last.item : null;
        } finally {
            lock.unlock();
        }
    }
    ...
    private abstract class AbstractItr implements Iterator<E> {
        ...
        AbstractItr() {
            ...
            try {
                this.next = firstNode();
                this.nextItem = this.next != null ? this.next.item : null;
            } finally {
                lock.unlock();
            }
        }
    ...
    private class Itr extends LinkedBlockingDeque<E>.AbstractItr {
        Itr(LinkedBlockingDeque this$0, Itr itr) {
            this();
        }
    ...
    private class DescendingItr extends LinkedBlockingDeque<E>.AbstractItr {
        DescendingItr(LinkedBlockingDeque this$0, DescendingItr descendingItr) {
            this();
        }
    ...
    static final class LBDSpliterator<E> implements Spliterator<E> {
        ...
        public Spliterator<E> trySplit() {
            ...
            if (!this.exhausted) {
                ...
                if ((h != null || (h = q.first) != null) && h.next != null) {
