...
public abstract class AtomicLongFieldUpdater<T> {
    ...
    private static final class LockedUpdater<T> extends AtomicLongFieldUpdater<T> {
        ...
        private final RuntimeException accessCheckException(T obj) {
            return this.cclass == this.tclass ? new ClassCastException() : new RuntimeException(new IllegalAccessException("Class " + this.cclass.getName() + " can not access a protected member of class " + this.tclass.getName() + " using an instance of " + obj.getClass().getName()));
        }
