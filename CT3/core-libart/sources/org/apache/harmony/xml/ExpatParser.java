...
class ExpatParser {
    ...
    ExpatParser(String encoding, ExpatReader xmlReader, long pointer, String publicId, String systemId, ExpatParser expatParser) {
    ...
    ExpatParser(String str, ExpatReader expatReader, boolean z, String str2, String str3) {
        ...
        this.attributes = new CurrentAttributes(this, 0 == true ? 1 : 0);
        this.publicId = str2;
        this.systemId = str3;
    ...
    private void parseExternalEntity(ExpatParser entityParser, InputSource inputSource) throws SAXException, IOException {
        ...
        if (systemId == null) {
            throw new ParseException("No input specified.", this.locator, parseException);
        }
        in = openUrl(systemId);
        try {
            entityParser.append("<externalEntity>".getBytes(entityParser.encoding));
    ...
    private static class ClonedAttributes extends ExpatAttributes {
        ...
        ClonedAttributes(long parserPointer, long pointer, int length, ClonedAttributes clonedAttributes) {
    ...
    private class ExpatLocator implements Locator {
        ExpatLocator(ExpatParser this$0, ExpatLocator expatLocator) {
            this();
        }
    ...
    private class CurrentAttributes extends ExpatAttributes {
        CurrentAttributes(ExpatParser this$0, CurrentAttributes currentAttributes) {
            this();
        }
    ...
    private static class ParseException extends SAXParseException {
        ParseException(String message, Locator locator, ParseException parseException) {
    ...
    private static class EntityParser extends ExpatParser {
        ...
        EntityParser(String encoding, ExpatReader xmlReader, long pointer, String publicId, String systemId, EntityParser entityParser) {
            this(encoding, xmlReader, pointer, publicId, systemId);
        }
