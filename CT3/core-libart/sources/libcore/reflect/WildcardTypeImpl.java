...
public final class WildcardTypeImpl implements WildcardType {
    ...
    @Override
    public Type[] getLowerBounds() throws MalformedParameterizedTypeException, TypeNotPresentException {
        return (Type[]) this.superBound.getResolvedTypes().clone();
    }

    @Override
    public Type[] getUpperBounds() throws MalformedParameterizedTypeException, TypeNotPresentException {
