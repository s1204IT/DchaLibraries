...
public interface Os {
    FileDescriptor accept(FileDescriptor fileDescriptor, SocketAddress socketAddress) throws SocketException, ErrnoException;
    ...
    void bind(FileDescriptor fileDescriptor, InetAddress inetAddress, int i) throws SocketException, ErrnoException;

    void bind(FileDescriptor fileDescriptor, SocketAddress socketAddress) throws SocketException, ErrnoException;
    ...
    void connect(FileDescriptor fileDescriptor, InetAddress inetAddress, int i) throws SocketException, ErrnoException;

    void connect(FileDescriptor fileDescriptor, SocketAddress socketAddress) throws SocketException, ErrnoException;
    ...
    int recvfrom(FileDescriptor fileDescriptor, ByteBuffer byteBuffer, int i, InetSocketAddress inetSocketAddress) throws SocketException, ErrnoException;

    int recvfrom(FileDescriptor fileDescriptor, byte[] bArr, int i, int i2, int i3, InetSocketAddress inetSocketAddress) throws SocketException, ErrnoException;
    ...
    int sendto(FileDescriptor fileDescriptor, ByteBuffer byteBuffer, int i, InetAddress inetAddress, int i2) throws SocketException, ErrnoException;

    int sendto(FileDescriptor fileDescriptor, byte[] bArr, int i, int i2, int i3, InetAddress inetAddress, int i4) throws SocketException, ErrnoException;

    int sendto(FileDescriptor fileDescriptor, byte[] bArr, int i, int i2, int i3, SocketAddress socketAddress) throws SocketException, ErrnoException;
