...
public final class Memory {
    ...
    public static int peekInt(byte[] src, int offset, ByteOrder order) {
        if (order == ByteOrder.BIG_ENDIAN) {
            ...
            int i = (src[offset] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 24;
            int offset3 = offset2 + 1;
            return i | ((src[offset2] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 16) | ((src[offset3] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 8) | ((src[offset3 + 1] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 0);
        }
        int offset4 = offset + 1;
        int i2 = (src[offset] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 0;
        int offset5 = offset4 + 1;
        return i2 | ((src[offset4] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 8) | ((src[offset5] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 16) | ((src[offset5 + 1] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 24);
    }
    ...
    public static long peekLong(byte[] src, int offset, ByteOrder order) {
        if (order == ByteOrder.BIG_ENDIAN) {
            ...
            int i = (src[offset] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 24;
            int offset3 = offset2 + 1;
            int i2 = i | ((src[offset2] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 16);
            int offset4 = offset3 + 1;
            int i3 = i2 | ((src[offset3] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 8);
            int offset5 = offset4 + 1;
            int h = i3 | ((src[offset4] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 0);
            int offset6 = offset5 + 1;
            int i4 = (src[offset5] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 24;
            int offset7 = offset6 + 1;
            int l = i4 | ((src[offset6] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 16) | ((src[offset7] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 8) | ((src[offset7 + 1] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 0);
            return (((long) h) << 32) | (((long) l) & 4294967295L);
        }
        int offset8 = offset + 1;
        int i5 = (src[offset] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 0;
        int offset9 = offset8 + 1;
        int i6 = i5 | ((src[offset8] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 8);
        int offset10 = offset9 + 1;
        int i7 = i6 | ((src[offset9] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 16);
        int offset11 = offset10 + 1;
        int l2 = i7 | ((src[offset10] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 24);
        int offset12 = offset11 + 1;
        int i8 = (src[offset11] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 0;
        int offset13 = offset12 + 1;
        int h2 = i8 | ((src[offset12] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 8) | ((src[offset13] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 16) | ((src[offset13 + 1] & UCharacterEnums.ECharacterDirection.DIRECTIONALITY_UNDEFINED) << 24);
