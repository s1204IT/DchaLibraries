...
public class URI implements Serializable {
    ...
    private void initialize(URI p_base, String p_uriSpec) throws MalformedURIException {
        ...
        if (uriSpec.startsWith("//")) {
            ...
            if (index > 2) {
                initializeAuthority(uriSpec.substring(2, index));
            } else {
                this.m_host = "";
            }
        }
        ...
        if (this.m_host == null) {
            ...
            while (true) {
                ...
                if (segIndex2 != -1) {
                    ...
                    if (!tempString.substring(segIndex2).equals(org.apache.xalan.templates.Constants.ATTRVAL_PARENT)) {
    ...
    public boolean equals(Object obj) {
        ...
        return (this.m_fragment == null || obj.m_fragment == null || !this.m_fragment.equals(obj.m_fragment)) ? false : true;
    }
    ...
    public static boolean isWellFormedAddress(String p_address) {
        String address;
        int addrLength;
        if (p_address == null || (addrLength = (address = p_address.trim()).length()) == 0 || addrLength > 255 || address.startsWith(org.apache.xalan.templates.Constants.ATTRVAL_THIS) || address.startsWith("-")) {
            return false;
        }
        int index = address.lastIndexOf(46);
        if (address.endsWith(org.apache.xalan.templates.Constants.ATTRVAL_THIS)) {
