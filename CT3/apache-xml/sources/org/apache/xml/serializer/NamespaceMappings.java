...
public class NamespaceMappings {
    ...
    private void initNamespaces() {
        ...
        stack.push(nn);
        MappingRecord nn2 = new MappingRecord("xml", "http://www.w3.org/XML/1998/namespace", -1);
        Stack stack2 = createPrefixStack("xml");
        stack2.push(nn2);
    }
    ...
    boolean popNamespace(String prefix) {
        Stack stack;
        if (prefix.startsWith("xml") || (stack = getPrefixStack(prefix)) == null) {
            return false;
        }
        stack.pop();
        return true;
