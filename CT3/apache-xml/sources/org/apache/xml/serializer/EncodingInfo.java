...
public final class EncodingInfo {
    ...
    public boolean isInEncoding(char ch) {
        ...
        if (this.m_encoding == null) {
            this.m_encoding = new EncodingImpl(this, encodingImpl);
        }
    ...
    private class EncodingImpl implements InEncoding {
        ...
        EncodingImpl(EncodingInfo this$0, EncodingImpl encodingImpl) {
            this(this$0);
        }
