...
final class DOM3TreeWalker {
    ...
    protected void serializeAttList(Element node) throws SAXException {
        ...
        for (int i = 0; i < nAttrs; i++) {
            ...
            boolean zStartsWith = !attrName.equals("xmlns") ? attrName.startsWith(Constants.ATTRNAME_XMLNS) : true;
            if ((this.fFeatures & 16384) != 0) {
                isAttributeWellFormed(attr);
            }
            if ((this.fFeatures & 256) == 0 || zStartsWith) {
                attrName2 = attrName;
            } else if (attrNS != null) {
                if (attrPrefix == null) {
                    attrPrefix = "";
                ...
                if (!"".equals(attrPrefix) && !"".equals(declAttrPrefix) && attrPrefix.equals(declAttrPrefix)) {
                    ...
                    while (this.fLocalNSBinder.getURI(attrPrefix2) != null) {
                        attrPrefix2 = "NS" + counter;
                        counter++;
                    }
            ...
            if (applyFilter && this.fFilter != null && (this.fFilter.getWhatToShow() & 2) != 0 && !zStartsWith) {
            ...
            if (zStartsWith && (this.fFeatures & 512) != 0) {
    ...
    protected boolean isValidQName(String prefix, String local, boolean xml11Version) {
        ...
        if (!xml11Version) {
            ...
            boolean validNCName = XMLChar.isValidNCName(local);
            return validNCName;
        }
        if (prefix != null && !XML11Char.isXML11ValidNCName(prefix)) {
            return false;
        }
        boolean validNCName2 = XML11Char.isXML11ValidNCName(local);
        return validNCName2;
    }
        ...
        if (this.fIsXMLVersion11) {
            ...
            while (i3 < datalength) {
                ...
                if (XMLChar.isInvalid(dataarray[i3])) {
                    ...
                    Character refInvalidChar2 = new Character(ch3);
                    return refInvalidChar2;
                }
                i3 = i4;
            }
        }
        ...
        while (i3 < datalength) {
            ...
            if (XMLChar.isInvalid(c3)) {
                if (XMLChar.isHighSurrogate(c3) && i4 < datalength) {
                    ...
                    if (!XMLChar.isLowSurrogate(c22)) {
                        i4 = i3;
                    } else if (!XMLChar.isSupplemental(XMLChar.supplemental(c3, c22))) {
                        i4 = i3;
                    }
                }
    ...
    protected void initProperties(Properties properties) {
        ...
        while (keys.hasMoreElements()) {
            ...
            ?? r2 = s_propKeys.get(key);
            if (r2 != 0) {
                if (r2 instanceof Integer) {
                    int BITFLAG = r2.intValue();
