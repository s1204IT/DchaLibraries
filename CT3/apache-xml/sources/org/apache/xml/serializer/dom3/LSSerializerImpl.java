...
public final class LSSerializerImpl implements DOMConfiguration, LSSerializer {
    ...
    public boolean canSetParameter(String name, Object obj) {
        ...
        } else if ((name.equalsIgnoreCase(DOMConstants.DOM_ERROR_HANDLER) && obj == 0) || (obj instanceof DOMErrorHandler)) {
            return true;
        }
        return false;
    }
    ...
    @Override
    public void setParameter(String name, Object obj) throws DOMException {
        if (!(obj instanceof Boolean)) {
            if (name.equalsIgnoreCase(DOMConstants.DOM_ERROR_HANDLER)) {
                if (obj == 0 || (obj instanceof DOMErrorHandler)) {
            ...
            if (name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_LOCATION) || name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_TYPE)) {
                if (obj != 0) {
                    if (obj instanceof String) {
                        String msg2 = Utils.messages.createMessage("FEATURE_NOT_SUPPORTED", new Object[]{name});
                        throw new DOMException((short) 9, msg2);
                    }
                    String msg3 = Utils.messages.createMessage(MsgKey.ER_TYPE_MISMATCH_ERR, new Object[]{name});
            ...
            if (name.equalsIgnoreCase(DOMConstants.DOM_COMMENTS) || name.equalsIgnoreCase(DOMConstants.DOM_CDATA_SECTIONS) || name.equalsIgnoreCase(DOMConstants.DOM_ENTITIES) || name.equalsIgnoreCase(DOMConstants.DOM_NAMESPACES) || name.equalsIgnoreCase(DOMConstants.DOM_NAMESPACE_DECLARATIONS) || name.equalsIgnoreCase(DOMConstants.DOM_SPLIT_CDATA) || name.equalsIgnoreCase(DOMConstants.DOM_WELLFORMED) || name.equalsIgnoreCase(DOMConstants.DOM_DISCARD_DEFAULT_CONTENT) || name.equalsIgnoreCase(DOMConstants.DOM_FORMAT_PRETTY_PRINT) || name.equalsIgnoreCase(DOMConstants.DOM_XMLDECL) || name.equalsIgnoreCase(DOMConstants.DOM_ELEMENT_CONTENT_WHITESPACE) || name.equalsIgnoreCase(DOMConstants.DOM_IGNORE_UNKNOWN_CHARACTER_DENORMALIZATIONS) || name.equalsIgnoreCase(DOMConstants.DOM_CANONICAL_FORM) || name.equalsIgnoreCase(DOMConstants.DOM_VALIDATE_IF_SCHEMA) || name.equalsIgnoreCase(DOMConstants.DOM_VALIDATE) || name.equalsIgnoreCase(DOMConstants.DOM_CHECK_CHAR_NORMALIZATION) || name.equalsIgnoreCase(DOMConstants.DOM_DATATYPE_NORMALIZATION) || name.equalsIgnoreCase(DOMConstants.DOM_INFOSET)) {
                String msg4 = Utils.messages.createMessage(MsgKey.ER_TYPE_MISMATCH_ERR, new Object[]{name});
                throw new DOMException((short) 17, msg4);
            }
            String msg5 = Utils.messages.createMessage("FEATURE_NOT_FOUND", new Object[]{name});
            throw new DOMException((short) 8, msg5);
        }
        boolean state = obj.booleanValue();
        if (name.equalsIgnoreCase(DOMConstants.DOM_COMMENTS)) {
        ...
        if (name.equalsIgnoreCase(DOMConstants.DOM_DISCARD_DEFAULT_CONTENT)) {
            this.fFeatures = state ? this.fFeatures | 32768 : this.fFeatures & (-32769);
            if (state) {
        ...
        if (name.equalsIgnoreCase(DOMConstants.DOM_IGNORE_UNKNOWN_CHARACTER_DENORMALIZATIONS)) {
            if (state) {
                ...
                String msg6 = Utils.messages.createMessage("FEATURE_NOT_SUPPORTED", new Object[]{name});
                throw new DOMException((short) 9, msg6);
            }
        }
        if (name.equalsIgnoreCase(DOMConstants.DOM_CANONICAL_FORM) || name.equalsIgnoreCase(DOMConstants.DOM_VALIDATE_IF_SCHEMA) || name.equalsIgnoreCase(DOMConstants.DOM_VALIDATE) || name.equalsIgnoreCase(DOMConstants.DOM_CHECK_CHAR_NORMALIZATION) || name.equalsIgnoreCase(DOMConstants.DOM_DATATYPE_NORMALIZATION)) {
            if (state) {
                String msg7 = Utils.messages.createMessage("FEATURE_NOT_SUPPORTED", new Object[]{name});
                throw new DOMException((short) 9, msg7);
            }
        ...
        if (!name.equalsIgnoreCase(DOMConstants.DOM_INFOSET)) {
            if (name.equalsIgnoreCase(DOMConstants.DOM_ERROR_HANDLER) || name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_LOCATION) || name.equalsIgnoreCase(DOMConstants.DOM_SCHEMA_TYPE)) {
                String msg8 = Utils.messages.createMessage(MsgKey.ER_TYPE_MISMATCH_ERR, new Object[]{name});
                throw new DOMException((short) 17, msg8);
            }
            String msg9 = Utils.messages.createMessage("FEATURE_NOT_FOUND", new Object[]{name});
            throw new DOMException((short) 8, msg9);
        }
        if (state) {
            this.fFeatures &= -65;
            this.fFeatures &= -3;
    ...
    public boolean write(Node nodeArg, LSOutput destination) throws LSException {
        ...
        if (nodeArg != this.fVisitedNode) {
            ...
            if (this.fEncoding == null) {
                ...
                if (this.fEncoding != null) {
                    xMLEncoding = this.fEncoding;
                } else {
                    xMLEncoding = getXMLEncoding(nodeArg) == null ? "UTF-8" : getXMLEncoding(nodeArg);
                }
            ...
            if (!Encodings.isRecognizedEncoding(this.fEncoding)) {
                ...
                if (this.fDOMErrorHandler != null) {
                    this.fDOMErrorHandler.handleError(new DOMErrorImpl((short) 3, msg2, MsgKey.ER_UNSUPPORTED_ENCODING));
                }
        ...
        try {
            ...
            if (writer == null) {
                ...
                if (outputStream == null) {
                    ...
                    if (uri == null) {
                        ...
                        if (this.fDOMErrorHandler != null) {
                            this.fDOMErrorHandler.handleError(new DOMErrorImpl((short) 3, msg3, MsgKey.ER_NO_OUTPUT_SPECIFIED));
                        }
            ...
            String msg4 = Utils.messages.createMessage(MsgKey.ER_UNSUPPORTED_ENCODING, null);
            if (this.fDOMErrorHandler != null) {
                this.fDOMErrorHandler.handleError(new DOMErrorImpl((short) 3, msg4, MsgKey.ER_UNSUPPORTED_ENCODING, ue));
            }
