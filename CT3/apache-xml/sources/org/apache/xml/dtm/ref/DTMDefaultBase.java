...
public abstract class DTMDefaultBase implements DTM {
    ...
    public DTMDefaultBase(DTMManager dTMManager, Source source, int dtmIdentity, DTMWSFilter whiteSpaceFilter, XMLStringFactory xstringfactory, boolean doIndexing, int blocksize, boolean usePrevsib, boolean newNameTable) {
        int numblocks;
        this.m_size = 0;
    ...
    protected void ensureSizeOfIndex(int namespaceID, int LocalNameID) {
        ...
        if (elemHandles == null) {
            ...
            if (elemHandles.length > elemHandles[0] + 1) {
                return;
            }
