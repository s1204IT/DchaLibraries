...
public abstract class DTMDefaultBaseIterators extends DTMDefaultBaseTraversers {
    ...
    public DTMAxisIterator getTypedAxisIterator(int axis, int type) {
        switch (axis) {
            ...
            case 3:
                DTMAxisIterator iterator = new TypedChildrenIterator(type);
                return iterator;
            case 4:
                DTMAxisIterator iterator2 = new TypedDescendantIterator(type);
                return iterator2;
            case 5:
                DTMAxisIterator iterator3 = new TypedDescendantIterator(type).includeSelf();
                return iterator3;
            case 6:
                DTMAxisIterator iterator4 = new TypedFollowingIterator(type);
                return iterator4;
            case 7:
                DTMAxisIterator iterator5 = new TypedFollowingSiblingIterator(type);
                return iterator5;
            case 8:
            case 14:
            case 15:
            ...
            case 9:
                DTMAxisIterator iterator6 = new TypedNamespaceIterator(type);
                return iterator6;
            case 10:
                return new ParentIterator().setNodeType(type);
            case 11:
                DTMAxisIterator iterator7 = new TypedPrecedingIterator(type);
                return iterator7;
            case 12:
                DTMAxisIterator iterator8 = new TypedPrecedingSiblingIterator(type);
                return iterator8;
            case 13:
                DTMAxisIterator iterator9 = new TypedSingletonIterator(type);
                return iterator9;
            case 19:
                DTMAxisIterator iterator10 = new TypedRootIterator(type);
                return iterator10;
        }
    }
    ...
    public DTMAxisIterator getAxisIterator(int axis) {
        switch (axis) {
            ...
            case 3:
                DTMAxisIterator iterator = new ChildrenIterator();
                return iterator;
            case 4:
                DTMAxisIterator iterator2 = new DescendantIterator();
                return iterator2;
            case 5:
                DTMAxisIterator iterator3 = new DescendantIterator().includeSelf();
                return iterator3;
            case 6:
                DTMAxisIterator iterator4 = new FollowingIterator();
                return iterator4;
            case 7:
                DTMAxisIterator iterator5 = new FollowingSiblingIterator();
                return iterator5;
            case 8:
            case 14:
            case 15:
            ...
            case 9:
                DTMAxisIterator iterator6 = new NamespaceIterator();
                return iterator6;
            case 10:
                return new ParentIterator();
            case 11:
                DTMAxisIterator iterator7 = new PrecedingIterator();
                return iterator7;
            case 12:
                DTMAxisIterator iterator8 = new PrecedingSiblingIterator();
                return iterator8;
            case 13:
                DTMAxisIterator iterator9 = new SingletonIterator(this);
                return iterator9;
            case 19:
                DTMAxisIterator iterator10 = new RootIterator();
                return iterator10;
        }
    }
