...
public class FuncDocument extends Function2Args {
    ...
    public XObject execute(XPathContext xctxt) throws TransformerException {
        ...
        DTMIterator dTMIteratorIter = 4 == arg.getType() ? arg.iter() : null;
        int pos = -1;
        while (true) {
            if (dTMIteratorIter != null) {
                pos = dTMIteratorIter.nextNode();
                if (-1 == pos) {
                    break;
                }
                XMLString ref = dTMIteratorIter != null ? xctxt.getDTM(pos).getStringValue(pos) : arg.xstr();
                ...
                if (ref != null) {
                    ...
                    if (dTMIteratorIter == null || newDoc == -1) {
                        break;
                    }
                }
            }
