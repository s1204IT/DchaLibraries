...
public class XSLTSchema extends XSLTElementDef {
    ...
    void build() {
        ...
        int i4 = i3 + 1;
        templateElements[i3] = xslForEach;
        int i5 = i4 + 1;
        templateElements[i4] = xslValueOf;
        int i6 = i5 + 1;
        templateElements[i5] = xslCopyOf;
        int i7 = i6 + 1;
        templateElements[i6] = xslNumber;
        int i8 = i7 + 1;
        templateElements[i7] = xslChoose;
        int i9 = i8 + 1;
        templateElements[i8] = xslIf;
        int i10 = i9 + 1;
        templateElements[i9] = xslText;
        int i11 = i10 + 1;
        templateElements[i10] = xslCopy;
        int i12 = i11 + 1;
        templateElements[i11] = xslVariable;
        int i13 = i12 + 1;
        templateElements[i12] = xslMessage;
        int i14 = i13 + 1;
        templateElements[i13] = xslFallback;
        int i15 = i14 + 1;
        templateElements[i14] = xslProcessingInstruction;
        int i16 = i15 + 1;
        templateElements[i15] = xslComment;
        int i17 = i16 + 1;
        templateElements[i16] = xslElement;
        int i18 = i17 + 1;
        templateElements[i17] = xslAttribute;
        int i19 = i18 + 1;
        templateElements[i18] = resultElement;
        int i20 = i19 + 1;
        templateElements[i19] = unknownElement;
        int i21 = i20 + 1;
        templateElements[i20] = exsltFunction;
        int i22 = i21 + 1;
        templateElements[i21] = exsltResult;
        System.arraycopy(templateElements, 0, templateElementsAndParams, 0, i22);
        System.arraycopy(templateElements, 0, templateElementsAndSort, 0, i22);
        System.arraycopy(templateElements, 0, exsltFunctionElements, 0, i22);
        templateElementsAndParams[i22] = xslParam;
        templateElementsAndSort[i22] = xslSort;
        exsltFunctionElements[i22] = xslParam;
        charTemplateElements[0] = charData;
        int i23 = 1 + 1;
        charTemplateElements[1] = xslApplyTemplates;
        int i24 = i23 + 1;
        charTemplateElements[i23] = xslCallTemplate;
        int i25 = i24 + 1;
        charTemplateElements[i24] = xslApplyImports;
        int i26 = i25 + 1;
        charTemplateElements[i25] = xslForEach;
        int i27 = i26 + 1;
        charTemplateElements[i26] = xslValueOf;
        int i28 = i27 + 1;
        charTemplateElements[i27] = xslCopyOf;
        int i29 = i28 + 1;
        charTemplateElements[i28] = xslNumber;
        int i30 = i29 + 1;
        charTemplateElements[i29] = xslChoose;
        int i31 = i30 + 1;
        charTemplateElements[i30] = xslIf;
        int i32 = i31 + 1;
        charTemplateElements[i31] = xslText;
        int i33 = i32 + 1;
        charTemplateElements[i32] = xslCopy;
        int i34 = i33 + 1;
        charTemplateElements[i33] = xslVariable;
        int i35 = i34 + 1;
        charTemplateElements[i34] = xslMessage;
        int i36 = i35 + 1;
        charTemplateElements[i35] = xslFallback;
