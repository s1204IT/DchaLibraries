...
public class StylesheetHandler extends DefaultHandler implements TemplatesHandler, PrefixResolver, NodeConsumer {
    ...
    public void processingInstruction(String target, String data) throws SAXException {
        ...
        if (colon >= 0) {
            String prefix = target.substring(0, colon);
    ...
    protected void error(String str, Exception exc) throws SAXException {
        ...
        SAXSourceLocator locator = getLocator();
        ?? errorListener = this.m_stylesheetProcessor.getErrorListener();
        ...
        throw new SAXException((Exception) transformerException);
    }
    ...
    void pushBaseIndentifier(String baseID) {
        int posOfHash;
        if (baseID != null && (posOfHash = baseID.indexOf(35)) > -1) {
