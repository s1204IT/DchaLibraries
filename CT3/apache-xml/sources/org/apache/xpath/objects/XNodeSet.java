...
public class XNodeSet extends NodeSequence {
    ...
    public XNodeSet(DTMIterator dTMIterator) {
        if (dTMIterator instanceof XNodeSet) {
            setIter(dTMIterator.m_iter);
            this.m_dtmMgr = dTMIterator.m_dtmMgr;
            this.m_last = dTMIterator.m_last;
            if (!dTMIterator.hasCache()) {
                dTMIterator.setShouldCacheNodes(true);
            }
            setObject(dTMIterator.getIteratorCache());
            return;
        }
        setIter(dTMIterator);
    }
