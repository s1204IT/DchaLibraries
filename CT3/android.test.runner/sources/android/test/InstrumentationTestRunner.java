...
public class InstrumentationTestRunner extends Instrumentation implements TestSuiteProvider {
    ...
    private class SuiteAssignmentPrinter implements TestListener {
        ...
        public void endTest(Test test) {
            ...
            if (!this.mTimingValid || this.mStartTime < 0) {
                ...
                assignmentSuite = (runTime >= InstrumentationTestRunner.SMALL_SUITE_MAX_RUNTIME || InstrumentationTestCase.class.isAssignableFrom(test.getClass())) ? runTime < InstrumentationTestRunner.MEDIUM_SUITE_MAX_RUNTIME ? InstrumentationTestRunner.MEDIUM_SUITE : InstrumentationTestRunner.LARGE_SUITE : InstrumentationTestRunner.SMALL_SUITE;
            }
            this.mStartTime = -1L;
    ...
    private class WatcherResultPrinter implements TestListener, PerformanceCollector.PerformanceResultsWriter {
        ...
        public void startTest(Test test) {
            ...
            String testName = ((junit.framework.TestCase) test).getName();
        ...
        public void addError(Test test, Throwable t) {
            ...
            this.mTestResult.putString("stream", String.format("\nError in %s:\n%s", ((junit.framework.TestCase) test).getName(), BaseTestRunner.getFilteredTrace(t)));
        }
        ...
        public void addFailure(Test test, junit.framework.AssertionFailedError t) {
            ...
            this.mTestResult.putString("stream", String.format("\nFailure in %s:\n%s", ((junit.framework.TestCase) test).getName(), BaseTestRunner.getFilteredTrace((Throwable) t)));
        }
