...
public class CertificateChainValidator {
    ...
    CertificateChainValidator(CertificateChainValidator certificateChainValidator) {
        this();
    }

    private static class NoPreloadHolder {
        private static final CertificateChainValidator sInstance = new CertificateChainValidator(null);
    ...
    private static SslError verifyServerDomainAndCertificates(X509Certificate[] chain, String domain, String authType) throws IOException {
        ...
        if (domain == null || domain.isEmpty()) {
            ...
            valid = NoPreloadHolder.sVerifier.verify(domain, new DelegatingSSLSession.CertificateWrap(currCertificate));
        }
        if (!valid) {
