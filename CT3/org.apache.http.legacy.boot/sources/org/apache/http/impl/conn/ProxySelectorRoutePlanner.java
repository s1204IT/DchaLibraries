...
public class ProxySelectorRoutePlanner implements HttpRoutePlanner {
    ...
    private static final int[] f0javanetProxy$TypeSwitchesValues = null;
    protected ProxySelector proxySelector;
    protected SchemeRegistry schemeRegistry;

    private static int[] m22getjavanetProxy$TypeSwitchesValues() {
        if (f0javanetProxy$TypeSwitchesValues != null) {
            return f0javanetProxy$TypeSwitchesValues;
        }
        ...
        f0javanetProxy$TypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    protected Proxy chooseProxy(List<Proxy> proxies, HttpHost target, HttpRequest request, HttpContext context) {
        ...
        for (int i = 0; result == null && i < proxies.size(); i++) {
            ...
            switch (m22getjavanetProxy$TypeSwitchesValues()[p.type().ordinal()]) {
                case 1:
                case 2:
                    result = p;
                    break;
