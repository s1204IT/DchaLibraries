...
public class DefaultClientConnection extends SocketHttpClientConnection implements OperatedClientConnection {
    ...
    public void openCompleted(boolean secure, HttpParams params) throws IOException {
        ...
        try {
            ...
            InetAddress remoteAddr = this.socket.getInetAddress();
            this.wireLog.debug("-- \"" + localAddr.getHostAddress() + ":" + this.socket.getLocalPort() + ";" + remoteAddr.getHostAddress() + ":" + this.socket.getPort() + "\"");
        } catch (Exception e) {
