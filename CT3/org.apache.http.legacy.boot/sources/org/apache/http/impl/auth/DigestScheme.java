...
public class DigestScheme extends RFC2617Scheme {
    ...
    private String createDigest(Credentials credentials, HttpRequest request) throws AuthenticationException {
        String a2;
        ...
        if (qoplist != null) {
            ...
            if ((!(request instanceof HttpEntityEnclosingRequest) || !qopset.contains("auth-int")) && qopset.contains("auth")) {
            }
        }
        ...
        if (this.qopVariant == 1) {
            ...
            if (entity == null || entity.isRepeatable()) {
                HttpEntityDigester entityDigester = new HttpEntityDigester(md5Helper);
                if (entity != null) {
                    try {
    ...
    private Header createDigestHeader(Credentials credentials, String digest) throws AuthenticationException {
        ...
        for (int i = 0; i < params.size(); i++) {
            ...
            if ("nc".equals(param.getName()) || "qop".equals(param.getName())) {
                zEquals = true;
            } else {
                zEquals = "algorithm".equals(param.getName());
            }
            BasicHeaderValueFormatter.DEFAULT.formatNameValuePair(buffer, param, !zEquals);
        }
