...
public abstract class AbstractHttpClient implements HttpClient {
    ...
    public final HttpResponse execute(HttpHost target, HttpRequest request, HttpContext context) throws IOException {
        ...
        synchronized (this) {
            ...
            if (context == null) {
                ...
                HttpContext execContext2 = new DefaultedHttpContext(context, defaultContext);
                execContext = execContext2;
            }
    ...
    @Override
    public <T> T execute(HttpHost target, HttpRequest request, ResponseHandler<? extends T> responseHandler, HttpContext context) throws Throwable {
    ...
    private boolean isMmsSendPdu(HttpRequest request) {
        ...
        try {
            ...
            if (contentEncoding == null || !contentEncoding.getValue().equals("gzip")) {
                ...
                InputStream nis2 = new GZIPInputStream(is);
                nis = nis2;
            }
