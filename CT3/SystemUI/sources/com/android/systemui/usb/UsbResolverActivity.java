...
public class UsbResolverActivity extends ResolverActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence title = getResources().getText(R.string.duration_minutes_relative_future);
        super.onCreate(savedInstanceState, target, title, (Intent[]) null, rList, true);
        CheckBox alwaysUse = (CheckBox) findViewById(R.id.flagServiceHandlesDoubleTap);
        if (alwaysUse != null) {
    ...
    protected boolean onTargetSelected(ResolverActivity.TargetInfo target, boolean alwaysCheck) {
        ...
        try {
            ...
            try {
                target.startAsUser(this, (Bundle) null, new UserHandle(userId));
                return true;
