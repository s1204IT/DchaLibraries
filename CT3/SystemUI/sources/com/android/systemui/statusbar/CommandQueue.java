...
public class CommandQueue extends IStatusBar.Stub {
    ...
    public void showRecentApps(boolean triggeredFromAltTab, boolean fromHome) {
        synchronized (this.mLock) {
            ...
            this.mHandler.obtainMessage(851968, triggeredFromAltTab ? 1 : 0, fromHome ? 1 : 0, null).sendToTarget();
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case 786432:
                    ...
                    break;
                case 851968:
                    CommandQueue.this.mCallbacks.showRecentApps(msg.arg1 != 0, msg.arg2 != 0);
                    break;
                case 917504:
                ...
                case 1310720:
                    ...
                    break;
                case 1376256:
                    Pair<Long, Long> data = (Pair) msg.obj;
