                ...
                if (layoutParams.height != -1) {
                    if (layoutParams.height >= 0) {
                        if (layoutParams.height > ownMaxHeight) {
                            childHeightSpec = View.MeasureSpec.makeMeasureSpec(ownMaxHeight, 1073741824);
                        } else {
                            childHeightSpec = View.MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824);
                        }
                    }
