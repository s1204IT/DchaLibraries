...
public final class TouchAnalyticsProto$Session extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.pointers != null && this.pointers.length > 0) {
                for (int i = 0; i < this.pointers.length; i++) {
                    Pointer element = this.pointers[i];
                    if (element != null) {
    ...
    public static final class SensorEvent extends MessageNano {
        ...
        protected int computeSerializedSize() {
            ...
            if (this.values != null && this.values.length > 0) {
                int dataSize = this.values.length * 4;
                size = size + dataSize + (this.values.length * 1);
            }
            if ((this.bitField0_ & 4) != 0) {
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 29:
                        ...
                        int i2 = this.values == null ? 0 : this.values.length;
    ...
    public void writeTo(CodedOutputByteBufferNano output) throws IOException {
        ...
        if (this.touchEvents != null && this.touchEvents.length > 0) {
            for (int i = 0; i < this.touchEvents.length; i++) {
                TouchEvent element = this.touchEvents[i];
                if (element != null) {
        ...
        if (this.sensorEvents != null && this.sensorEvents.length > 0) {
            for (int i2 = 0; i2 < this.sensorEvents.length; i2++) {
                SensorEvent element2 = this.sensorEvents[i2];
                if (element2 != null) {
        ...
        if (this.phoneEvents != null && this.phoneEvents.length > 0) {
            for (int i3 = 0; i3 < this.phoneEvents.length; i3++) {
                PhoneEvent element3 = this.phoneEvents[i3];
                if (element3 != null) {
        ...
        while (true) {
            ...
            switch (tag) {
                ...
                case 50:
                    ...
                    int i2 = this.sensorEvents == null ? 0 : this.sensorEvents.length;
                ...
                case 98:
                    ...
                    int i3 = this.phoneEvents == null ? 0 : this.phoneEvents.length;
