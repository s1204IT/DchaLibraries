...
public class NavigationBarInflaterView extends FrameLayout implements TunerService.Tunable {
    ...
    protected String getDefaultLayout() {
        if (MultiWindowManager.isSupported()) {
            return this.mContext.getString(R.string.config_navBarLayout_float);
        }
    ...
    public static String extractImage(String buttonSpec) {
        ...
        int start = buttonSpec.indexOf(":");
        String subStr = buttonSpec.substring(start + 1, buttonSpec.indexOf(")"));
        return subStr;
    }
    ...
    public static float extractSize(String buttonSpec) {
        ...
        int sizeStart = buttonSpec.indexOf("[");
        String sizeStr = buttonSpec.substring(sizeStart + 1, buttonSpec.indexOf("]"));
