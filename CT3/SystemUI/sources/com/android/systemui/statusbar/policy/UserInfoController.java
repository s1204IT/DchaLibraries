...
public final class UserInfoController {
    ...
    private final BroadcastReceiver mProfileReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                int currentUser = ActivityManagerNative.getDefault().getCurrentUser().id;
        ...
        try {
            ...
            this.mUserInfoTask = new AsyncTask<Void, Void, Pair<String, Drawable>>() {
                ...
                public Pair<String, Drawable> doInBackground(Void... params) {
                    ...
                    if (rawAvatar != null) {
                        avatar = new UserIconDrawable(avatarSize).setIcon(rawAvatar).setBadgeIfManagedUser(UserInfoController.this.mContext, userId).bake();
                    } else {
