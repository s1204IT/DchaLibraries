...
public class KeyguardUserSwitcherScrim extends Drawable implements View.OnLayoutChangeListener {
    ...
    private void updatePaint() {
        ...
        boolean isLtr = getLayoutDirection() == 0;
        this.mRadialGradientPaint.setShader(new RadialGradient(isLtr ? this.mLayoutWidth : 0, 0.0f, radius, new int[]{Color.argb((int) ((Color.alpha(this.mDarkColor) * this.mAlpha) / 255.0f), 0, 0, 0), 0}, new float[]{Math.max(0.0f, (this.mLayoutWidth * 0.75f) / radius), 1.0f}, Shader.TileMode.CLAMP));
    }
}
