...
public class ServiceMonitor {
    ...
    private final class SC implements ServiceConnection, IBinder.DeathRecipient {
        ...
        SC(ServiceMonitor this$0, SC sc) {
            this();
        }
    ...
    public void packageIntent(Intent intent) {
        ...
        boolean serviceEnabled = (!isPackageAvailable() || pm.getApplicationEnabledSetting(this.mServiceName.getPackageName()) == 2 || pm.getComponentEnabledSetting(this.mServiceName) == 2) ? false : true;
    ...
    public void setComponent(ComponentName component) {
        Settings.Secure.putStringForUser(this.mContext.getContentResolver(), this.mSettingKey, component == null ? null : component.flattenToShortString(), -2);
    }
