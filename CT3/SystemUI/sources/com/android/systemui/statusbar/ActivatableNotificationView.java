...
public abstract class ActivatableNotificationView extends ExpandableOutlineView {
    ...
    private void startActivateAnimation(final boolean reverse) {
        ...
        this.mBackgroundNormal.animate().alpha(reverse ? 0.0f : 1.0f).setInterpolator(alphaInterpolator).setUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
    ...
    private void fadeInFromDark(long delay) {
        ...
        background.animate().alpha(1.0f).scaleX(1.0f).scaleY(1.0f).setDuration(170L).setStartDelay(delay).setInterpolator(Interpolators.LINEAR_OUT_SLOW_IN).setListener(new AnimatorListenerAdapter() {
            @Override
    ...
    protected void updateBackground() {
        ...
        if (shouldHideBackground()) {
            ...
            boolean zIsChildInGroup = isGroupExpansionChanging() ? isChildInGroup() : false;
            this.mBackgroundDimmed.setVisibility(zIsChildInGroup ? 4 : 0);
            this.mBackgroundNormal.setVisibility((this.mActivated || zIsChildInGroup) ? 0 : 4);
        } else {
            this.mBackgroundDimmed.setVisibility(4);
            this.mBackgroundNormal.setVisibility(0);
            this.mBackgroundNormal.setAlpha(1.0f);
