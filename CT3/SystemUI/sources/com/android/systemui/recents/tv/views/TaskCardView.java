...
public class TaskCardView extends LinearLayout {
    ...
    private void setAsScreenShotView(Bitmap screenshot, ImageView screenshotView) {
        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) screenshotView.getLayoutParams();
        lp.width = -1;
        lp.height = -1;
        ...
        screenshotView.setOutlineProvider(new ViewOutlineProvider() {
            ...
            public void getOutline(View view, Outline outline) {
                outline.setRoundRect(0, 0, view.getWidth(), view.getHeight(), TaskCardView.this.mCornerRadius);
            }
        });
    ...
    private void setAsIconView(Drawable icon, ImageView iconView) {
        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) iconView.getLayoutParams();
    ...
    public static int getNumberOfVisibleTasks(Context context) {
        ...
        return (int) (Math.ceil(((double) screenWidth) / (((double) cardWidth) + (((double) spacing) * 2.0d))) + 1.0d);
    }
}
