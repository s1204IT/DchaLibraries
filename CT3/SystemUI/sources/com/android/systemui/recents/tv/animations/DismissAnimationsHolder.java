...
public class DismissAnimationsHolder {
    ...
    public DismissAnimationsHolder(TaskCardView taskCardView) {
        ...
        this.mShortDuration = res.getInteger(R.integer.dismiss_short_duration);
        this.mLongDuration = res.getInteger(R.integer.dismiss_long_duration);
    ...
    public void startDismissAnimation(Animator.AnimatorListener listener) {
        ...
        this.mDismissText.animate().setDuration(this.mShortDuration).setInterpolator(Interpolators.FAST_OUT_SLOW_IN).alpha(0.0f);
        this.mInfoField.animate().setDuration(this.mLongDuration).setInterpolator(Interpolators.FAST_OUT_SLOW_IN).translationY(this.mDismissStartYDelta).alpha(0.0f).setListener(listener);
