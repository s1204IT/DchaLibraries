...
public class PipRecentsControlsView extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mFocusLossAnimatorSet.playSequentially(loadAnimator(this.mPipControlsView, R.anim.tv_pip_controls_in_recents_focus_loss_animation), loadAnimator(this.mScrim, R.anim.tv_pip_controls_in_recents_scrim_fade_in_animation));
