...
public class MediatekDigitalClock extends LinearLayout {
    ...
    public void updateTime() {
        ...
        CharSequence newTime2 = DateFormat.format(":mm", this.mCalendar);
        fullTimeStr.append(newTime2);
        this.mTimeDisplayMinutes.setText(newTime2);
        boolean isMorning = this.mCalendar.get(9) == 0;
        this.mAmPm.setIsMorning(isMorning);
