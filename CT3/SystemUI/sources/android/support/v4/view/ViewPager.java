...
public class ViewPager extends ViewGroup {
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        if (this.mAdapter != null) {
            if (this.mObserver == null) {
                this.mObserver = new PagerObserver(this, pagerObserver);
            }
            ...
            case 2:
                ...
                if (activePointerId != -1) {
                    ...
                    if (pointerIndex == -1) {
                        ...
                        if (xDiff < this.mTouchSlopAdjust && yDiff < this.mTouchSlopAdjust && pointInRect(ev, this.mSpecRect)) {
                            if (IS_ENG_BUILD) {
    ...
    private class PagerObserver extends DataSetObserver {
        PagerObserver(ViewPager this$0, PagerObserver pagerObserver) {
            this();
        }
