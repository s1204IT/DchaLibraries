...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    private void startAnimating() {
        ScrollAnimationRunnable scrollAnimationRunnable = null;
        if (this.mRunnable == null) {
            this.mRunnable = new ScrollAnimationRunnable(this, scrollAnimationRunnable);
        }
    ...
    private class ScrollAnimationRunnable implements Runnable {
        ScrollAnimationRunnable(AutoScrollHelper this$0, ScrollAnimationRunnable scrollAnimationRunnable) {
            this();
        }
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long currentTime) {
            ...
            return (1.0f - this.mStopValue) + (this.mStopValue * AutoScrollHelper.constrain(elapsedSinceEnd / this.mEffectiveRampDown, 0.0f, 1.0f));
        }
