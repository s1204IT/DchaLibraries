...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private static class MoveInfo {
        ...
        MoveInfo(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY, MoveInfo moveInfo) {
    ...
    private static class ChangeInfo {
        ...
        ChangeInfo(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder, int fromX, int fromY, int toX, int toY, ChangeInfo changeInfo) {
    ...
    private static class VpaListenerAdapter implements ViewPropertyAnimatorListener {
        VpaListenerAdapter(VpaListenerAdapter vpaListenerAdapter) {
            this();
        }
