...
public class ListPopupWindow implements ShowableListMenu {
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        this.mTouchInterceptor = new PopupTouchInterceptor(this, 0 == true ? 1 : 0);
        this.mScrollListener = new PopupScrollListener(this, 0 == true ? 1 : 0);
        this.mHideSelector = new ListSelectorHider(this, 0 == true ? 1 : 0);
