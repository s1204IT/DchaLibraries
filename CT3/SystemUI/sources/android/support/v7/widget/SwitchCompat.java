...
public class SwitchCompat extends CompoundButton {
    ...
    private void stopDrag(MotionEvent ev) {
        boolean newState;
        this.mTouchMode = 0;
        boolean zIsEnabled = ev.getAction() == 1 ? isEnabled() : false;
    ...
    private void animateThumbToCheckedState(final boolean newCheckedState) {
        ThumbAnimation thumbAnimation = null;
        if (this.mPositionAnimator != null) {
            cancelPositionAnimator();
        }
        this.mPositionAnimator = new ThumbAnimation(this, this.mThumbPosition, newCheckedState ? 1.0f : 0.0f, thumbAnimation);
    ...
    private class ThumbAnimation extends Animation {
        ...
        ThumbAnimation(SwitchCompat this$0, float startPosition, float endPosition, ThumbAnimation thumbAnimation) {
