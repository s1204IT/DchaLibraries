...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (this.mShowingMenus.size() > 0) {
            ...
            viewFindParentViewForSubmenu = findParentViewForSubmenu(parentInfo, menu);
        } else {
            parentInfo = null;
        ...
        if (viewFindParentViewForSubmenu != null) {
            ...
            viewFindParentViewForSubmenu.getLocationInWindow(tempLocation);
            ...
            if ((this.mDropDownGravity & 5) == 5) {
                if (showOnRight) {
                    ...
                    x = parentOffsetLeft - viewFindParentViewForSubmenu.getWidth();
                }
            } else if (showOnRight) {
                x = parentOffsetLeft + viewFindParentViewForSubmenu.getWidth();
            } else {
