...
abstract class StaggeredGrid extends Grid {
    ...
    public final Location getLocation(int index) {
        ...
        return this.mLocations.get(index - this.mFirstIndex);
    }
    ...
    private int calculateOffsetAfterLastItem(int row) {
        ...
        int offset = isReversedFlow() ? (-getLocation(cachedIndex).size) - this.mMargin : getLocation(cachedIndex).size + this.mMargin;
