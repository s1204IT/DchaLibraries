...
class PathParser {
    ...
    public static PathDataNode[] deepCopyNodes(PathDataNode[] source) {
        PathDataNode pathDataNode = null;
        if (source == null) {
            return null;
        }
        PathDataNode[] copy = new PathDataNode[source.length];
        for (int i = 0; i < source.length; i++) {
            copy[i] = new PathDataNode(source[i], pathDataNode);
        }
        return copy;
    }
    ...
    public static class PathDataNode {
        ...
        PathDataNode(char type, float[] params, PathDataNode pathDataNode) {
            this(type, params);
        }

        PathDataNode(PathDataNode n, PathDataNode pathDataNode) {
            this(n);
        }
