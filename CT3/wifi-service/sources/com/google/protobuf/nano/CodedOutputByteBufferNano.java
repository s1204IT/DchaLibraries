...
public final class CodedOutputByteBufferNano {
    ...
    private static void encodeDirect(CharSequence sequence, ByteBuffer byteBuffer) {
        ...
        while (i < utf16Length) {
            ...
            if (c < 128) {
                ...
                byteBuffer.put((byte) ((c >>> '\f') | WifiQualifiedNetworkSelector.LAST_SELECTION_AWARD));
    ...
    private static int encode(CharSequence sequence, byte[] bytes, int offset, int length) {
        ...
        while (i < utf16Length) {
            ...
            if (c2 < 128 && j3 < limit) {
                ...
                int j5 = j3 + 1;
                bytes[j3] = (byte) ((c2 >>> '\f') | WifiQualifiedNetworkSelector.LAST_SELECTION_AWARD);
                int j6 = j5 + 1;
                ...
                if (55296 <= c2 && c2 <= 57343 && (i + 1 == sequence.length() || !Character.isSurrogatePair(c2, sequence.charAt(i + 1)))) {
                    throw new IllegalArgumentException("Unpaired surrogate at index " + i);
                }
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & WifiNetworkScoreCache.INVALID_NETWORK_SCORE) != 0) {
            writeRawByte((value & InformationElementUtil.SupportedRates.MASK) | 128);
            value >>>= 7;
        }
        writeRawByte(value);
    }
    ...
    public void writeRawVarint64(long value) throws IOException {
        while (((-128) & value) != 0) {
            writeRawByte((((int) value) & InformationElementUtil.SupportedRates.MASK) | 128);
            value >>>= 7;
        }
