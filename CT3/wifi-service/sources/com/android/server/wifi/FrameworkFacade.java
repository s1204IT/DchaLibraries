...
public class FrameworkFacade {
    ...
    public WifiScanner makeWifiScanner(Context context, Looper looper) {
        return new WifiScanner(context, IWifiScanner.Stub.asInterface(getService("wifiscanner")), looper);
    }
    ...
    public IpManager makeIpManager(Context context, String iface, IpManager.Callback callback) {
        return new IpManager(context, iface, callback);
    }

    public SoftApManager makeSoftApManager(Context context, Looper looper, WifiNative wifiNative, INetworkManagementService nmService, ConnectivityManager cm, String countryCode, ArrayList<Integer> allowed2GChannels, SoftApManager.Listener listener) {
        return new SoftApManager(context, looper, wifiNative, nmService, cm, countryCode, allowed2GChannels, listener);
    }
