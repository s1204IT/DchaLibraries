...
public class OMAConstants {
    ...
    public static final String[] SupportedMO_URNs = {PPS_URN, DevInfoURN, DevDetailURN, DevDetailXURN};
    ...
    public static void serializeString(String s, OutputStream out) throws IOException {
        ...
        byte[] prefix = String.format("%x:", Integer.valueOf(octets.length)).getBytes(StandardCharsets.UTF_8);
        out.write(prefix);
        out.write(octets);
    }
