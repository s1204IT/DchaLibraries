...
public class UpdateInfo {
    ...
    public enum UpdateRestriction {
        ...
        public static UpdateRestriction[] valuesCustom() {
            return values();
        }
    }
    ...
    public UpdateInfo(OMANode policyUpdate) throws OMAException {
        ...
        if (unp != null) {
            ...
            String pw = PasspointManagementObjectManager.getString(unp.getChild(PasspointManagementObjectManager.TAG_Password));
            this.mPassword = new String(Base64.decode(pw.getBytes(StandardCharsets.US_ASCII), 0), StandardCharsets.UTF_8);
        } else {
            this.mUsername = null;
            this.mPassword = null;
        }
