...
public class IconInfo {
    ...
    public IconInfo(ByteBuffer payload) throws ProtocolException {
        ...
        this.mWidth = payload.getShort() & 65535;
        this.mHeight = payload.getShort() & 65535;
    ...
    public boolean equals(Object thatObject) {
        ...
        if (this.mHeight == that.mHeight && this.mWidth == that.mWidth && this.mFileName.equals(that.mFileName) && this.mIconType.equals(that.mIconType)) {
            return this.mLanguage.equals(that.mLanguage);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((((result * 31) + this.mHeight) * 31) + this.mLanguage.hashCode()) * 31) + this.mIconType.hashCode()) * 31) + this.mFileName.hashCode();
    }
