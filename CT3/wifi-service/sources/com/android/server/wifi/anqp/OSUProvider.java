...
public class OSUProvider {
    ...
    public OSUProvider(ByteBuffer payload) throws ProtocolException {
        ...
        int i = payload.getShort() & 65535;
        int namesLength = payload.getShort() & 65535;
        ...
        while (methodLength > 0) {
            ...
            List<OSUMethod> list = this.mOSUMethods;
            if (methodID < OSUMethod.valuesCustom().length) {
                oSUMethod = OSUMethod.valuesCustom()[methodID];
            } else {
                oSUMethod = null;
            }
            list.add(oSUMethod);
        ...
        int iconsLength = payload.getShort() & 65535;
        ...
        int descriptionsLength = payload.getShort() & 65535;
        ...
        int result = this.mNames.hashCode();
        this.mHashCode = (((((((((result * 31) + this.mOSUServer.hashCode()) * 31) + this.mOSUMethods.hashCode()) * 31) + this.mIcons.hashCode()) * 31) + (this.mOsuNai != null ? this.mOsuNai.hashCode() : 0)) * 31) + this.mServiceDescriptions.hashCode();
    }
