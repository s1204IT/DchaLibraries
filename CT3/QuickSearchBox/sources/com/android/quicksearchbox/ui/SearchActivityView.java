...
public abstract class SearchActivityView extends RelativeLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.mSuggestionsView.setOnFocusChangeListener(new SuggestListFocusListener(this, 0 == true ? 1 : 0));
        this.mSuggestionsAdapter = createSuggestionsAdapter();
        this.mSuggestionsAdapter.setOnFocusChangeListener(new SuggestListFocusListener(this, 0 == true ? 1 : 0));
        ...
        this.mQueryTextView.addTextChangedListener(new SearchTextWatcher(this, 0 == true ? 1 : 0));
        this.mQueryTextView.setOnEditorActionListener(new QueryTextEditorActionListener(this, 0 == true ? 1 : 0));
        this.mQueryTextView.setOnFocusChangeListener(new QueryTextViewFocusListener(this, 0 == true ? 1 : 0));
        this.mQueryTextEmptyBg = this.mQueryTextView.getBackground();
        this.mSearchGoButton.setOnClickListener(new SearchGoButtonClickListener(this, 0 == true ? 1 : 0));
        this.mButtonsKeyListener = new ButtonsKeyListener(this, 0 == true ? 1 : 0);
    ...
    private class SearchTextWatcher implements TextWatcher {
        SearchTextWatcher(SearchActivityView this$0, SearchTextWatcher searchTextWatcher) {
            this();
        }
    ...
    private class InputMethodCloser implements AbsListView.OnScrollListener {
        InputMethodCloser(SearchActivityView this$0, InputMethodCloser inputMethodCloser) {
            this();
        }
    ...
    private class SearchGoButtonClickListener implements View.OnClickListener {
        SearchGoButtonClickListener(SearchActivityView this$0, SearchGoButtonClickListener searchGoButtonClickListener) {
            this();
        }
    ...
    private class QueryTextEditorActionListener implements TextView.OnEditorActionListener {
        QueryTextEditorActionListener(SearchActivityView this$0, QueryTextEditorActionListener queryTextEditorActionListener) {
            this();
        }
    ...
    private class ButtonsKeyListener implements View.OnKeyListener {
        ButtonsKeyListener(SearchActivityView this$0, ButtonsKeyListener buttonsKeyListener) {
            this();
        }
    ...
    private class SuggestListFocusListener implements View.OnFocusChangeListener {
        SuggestListFocusListener(SearchActivityView this$0, SuggestListFocusListener suggestListFocusListener) {
            this();
        }
    ...
    private class QueryTextViewFocusListener implements View.OnFocusChangeListener {
        QueryTextViewFocusListener(SearchActivityView this$0, QueryTextViewFocusListener queryTextViewFocusListener) {
            this();
        }
