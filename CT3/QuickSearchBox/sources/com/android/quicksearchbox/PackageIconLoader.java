...
public class PackageIconLoader implements IconLoader {
    ...
    public NowOrLater<Drawable> getIcon(String drawableId) {
        ...
        try {
            ...
            NowOrLater<Drawable> drawable = new Now<>(icon);
            return drawable;
        } catch (Resources.NotFoundException e) {
            Log.w("QSB.PackageIconLoader", "Icon resource not found: " + drawableId);
            NowOrLater<Drawable> drawable2 = new Now<>(null);
            return drawable2;
        } catch (NumberFormatException e2) {
            Uri uri = Uri.parse(drawableId);
            if ("android.resource".equals(uri.getScheme())) {
                NowOrLater<Drawable> drawable3 = new Now<>(getDrawable(uri));
                return drawable3;
            }
            NowOrLater<Drawable> drawable4 = new IconLaterTask(uri);
            return drawable4;
        }
    }
    ...
    private class OpenResourceIdResult {
        ...
        OpenResourceIdResult(PackageIconLoader this$0, OpenResourceIdResult openResourceIdResult) {
            this();
        }
    ...
    private OpenResourceIdResult getResourceId(Uri uri) throws FileNotFoundException {
        int id;
        OpenResourceIdResult openResourceIdResult = null;
        ...
        try {
            ...
            OpenResourceIdResult res = new OpenResourceIdResult(this, openResourceIdResult);
            res.r = r;
            res.id = id;
            return res;
