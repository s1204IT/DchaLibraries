...
abstract class AbstractIterator<T> implements Iterator<T> {
    ...
    private static int[] m24getcomgooglecommonbaseAbstractIterator$StateSwitchesValues() {
    ...
    public final boolean hasNext() {
        ...
        switch (m24getcomgooglecommonbaseAbstractIterator$StateSwitchesValues()[this.state.ordinal()]) {
            case 1:
                return false;
            case 2:
                return true;
