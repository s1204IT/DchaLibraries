...
public class Content {
            ...
            while (true) {
                ...
                if (argument != null) {
                    if (ARGUMENT_URI.equals(argument)) {
                        ...
                        strArgumentValueRequired = argumentValueRequired(argument);
                    } else {
                        throw new IllegalArgumentException("Unsupported argument: " + argument);
                    }
                } else {
                    ...
                    return new DeleteCommand(uri, userId, strArgumentValueRequired);
                }
            }
        }
        ...
        public QueryCommand parseQueryCommand() {
            ...
            while (true) {
                ...
                if (argument != null) {
                    ...
                    return new QueryCommand(uri, userId, projection, strArgumentValueRequired, sort);
                }
            }
        }
    ...
    private static class QueryCommand extends DeleteCommand {
        ...
        @Override
        public void onExecute(IContentProvider provider) throws Exception {
            Cursor cursor = provider.query(resolveCallingPackage(), this.mUri, this.mProjection, this.mWhere, (String[]) null, this.mSortOrder, (ICancellationSignal) null);
            if (cursor == null) {
