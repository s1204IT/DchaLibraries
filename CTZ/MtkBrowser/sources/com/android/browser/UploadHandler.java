...
public class UploadHandler {
    ...
    public UploadHandler(Controller controller) {
        ...
        if ((r1.totalMem / 1024.0d) / 1024.0d >= 512.0d) {
            this.mIsLowMemory = false;
            return;
        }
    ...
    private void startActivity(Intent intent) {
        try {
            ...
            Toast.makeText(this.mController.getActivity(), 2131492948, 1).show();
        }
    }
    ...
    void openFileChooser(ValueCallback<Uri[]> valueCallback, WebChromeClient.FileChooserParams fileChooserParams) {
        ...
        if (this.mIsLowMemory) {
            ...
            intent2.setType(str);
            intent2.putStringArrayListExtra("user-assigned-authorities", this.mAuthority);
            ...
            intent.putExtra("android.intent.extra.INITIAL_INTENTS", intentArrCreateCaptureIntent);
