...
public class PipControlsView extends LinearLayout {
        ...
        if (!this.mCustomActions.isEmpty()) {
            ...
            while (i < this.mCustomActions.size()) {
                ...
                if (remoteAction.isEnabled()) {
                    pipControlButtonView2.setOnClickListener(new View.OnClickListener() {
                        @Override
    ...
    static void lambda$updateUserActions$0(PipControlButtonView pipControlButtonView, Drawable drawable) {
        drawable.setTint(-1);
        pipControlButtonView.setImageDrawable(drawable);
    }

    static void lambda$updateUserActions$1(RemoteAction remoteAction, View view) {
        try {
