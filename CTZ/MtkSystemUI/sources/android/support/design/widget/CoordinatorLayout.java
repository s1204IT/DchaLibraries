...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
        int anchorHgrav = absAnchorGravity & 7;
        int anchorVgrav = absAnchorGravity & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (anchorHgrav != 1) {
            if (anchorHgrav != 5) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (type != 0 || child.getVisibility() != 8) {
                ...
                if (lp.insetEdge != 0 && !drawRect.isEmpty()) {
                    ...
                    int i2 = absInsetEdge & com.android.systemui.plugins.R.styleable.AppCompatTheme_windowActionBarOverlay;
                    if (i2 == 48) {
