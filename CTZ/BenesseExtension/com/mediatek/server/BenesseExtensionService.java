...
public class BenesseExtensionService extends IBenesseExtensionService.Stub {
    ...
    ServiceConnection mConn = new ServiceConnection(this) {
        final BenesseExtensionService this$0;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        th = th16;
                        th4 = null;
                        $closeResource(th4, bufferedReader2);
                        throw th;
                    }
            ...
            try {
                switch (str.hashCode()) {
                    case -286987330:
                        ...
                        break;
                    case 141985806:
                        b = !str.equals("bc:touchpanel:palmreject:size") ? (byte) -1 : (byte) 7;
                        break;
                    case 367025166:
                    ...
                    case 367025404:
                        ...
                        break;
                    case 562531059:
                        b = !str.equals("bc:pen:battery") ? (byte) -1 : (byte) 6;
                        break;
                    case 1209732899:
                ...
                switch (b) {
                    ...
                    case 1:
                        if ("TAB-A05-BD".equals(Build.PRODUCT)) {
                            ...
                            zExecuteFwUpdate = updateTouchpanelFw(str2);
                        }
                        break;
                    case 2:
                        if (!"TAB-A05-BD".equals(Build.PRODUCT)) {
