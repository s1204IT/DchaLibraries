...
public class KeyStoreAdapter {
    ...
    protected KeyStore loadKeyStore(Context context) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        try {
    ...
    protected String encryptShaString(KeyStore keyStore, String str, String str2) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
    ...
    protected String decryptShaString(KeyStore keyStore, String str, String str2) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        try {
