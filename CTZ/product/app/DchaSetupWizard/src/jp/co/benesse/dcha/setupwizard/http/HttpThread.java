...
public class HttpThread extends Thread {
    ...
    /* JADX WARN: Removed duplicated region for block: B:64:0x014e A[Catch: all -> 0x0199, TryCatch #7 {all -> 0x0199, blocks: (B:23:0x009a, B:25:0x00a0, B:27:0x00a6, B:30:0x00be, B:39:0x00e4, B:41:0x00ec, B:42:0x00f8, B:46:0x011c, B:47:0x011e, B:53:0x0133, B:54:0x0138, B:52:0x0130, B:56:0x013a, B:57:0x013d, B:58:0x013e, B:60:0x0144, B:62:0x0148, B:64:0x014e, B:66:0x0161, B:67:0x0172, B:45:0x0100, B:51:0x0125), top: B:94:0x009a, inners: #2 }] */
    ...
    */
                        ...
                        try {
                            ...
                            try {
                                try {
                                    ...
                                    } else if (next.retryInterval > 0) {
                                        try {
                                            try {
                                                Logger.d(TAG, "run 0010");
                                                this.mRetryWaitLock.lock();
                                                this.mRetryWaitCondition.await(next.retryInterval * i, TimeUnit.MILLISECONDS);
    ...
    protected Response receiveResponse(HttpURLConnection httpURLConnection, Request request) throws IllegalAccessException, InstantiationException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    protected Response newResponseInstance(Class<? extends Response> cls) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
    ...
    protected long getContentLength(Map<String, List<String>> map) throws NumberFormatException {
        long j;
