...
public class HelpUtils {
    ...
    public static boolean prepareHelpMenuItem(Activity activity, Menu menu, String str, String str2) {
        ...
        return prepareHelpMenuItem(activity, menuItemAdd, str, str2);
    }
    ...
    public static boolean prepareHelpMenuItem(final Activity activity, MenuItem menuItem, String str, String str2) throws Resources.NotFoundException, URISyntaxException {
    ...
    public static Intent getHelpIntent(Context context, String str, String str2) throws Resources.NotFoundException, URISyntaxException {
    ...
    public static void addIntentParameters(Context context, Intent intent, String str, boolean z) throws Resources.NotFoundException {
        if (!intent.hasExtra("EXTRA_CONTEXT")) {
            intent.putExtra("EXTRA_CONTEXT", str);
        }
        Resources resources = context.getResources();
        boolean z2 = resources.getBoolean(android.R.^attr-private.legacyLayout);
        if (z && z2) {
            String[] strArr = {resources.getString(android.R.string.anr_activity_process)};
            String[] strArr2 = {resources.getString(android.R.string.anr_application_process)};
            String string = resources.getString(android.R.string.android_upgrading_title);
            String string2 = resources.getString(android.R.string.anr_activity_application);
            String string3 = resources.getString(android.R.string.alternate_eri_file);
            String string4 = resources.getString(android.R.string.alternative_face_setup_notification_content);
