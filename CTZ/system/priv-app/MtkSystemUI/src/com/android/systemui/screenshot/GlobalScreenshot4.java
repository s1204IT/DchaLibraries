...
/* renamed from: com.android.systemui.screenshot.SaveImageInBackgroundTask */
/* loaded from: classes.dex */
class GlobalScreenshot4 extends AsyncTask<Void, Void, Void> {
    ...
    private final GlobalScreenshot3 mParams;
    private final Notification.Builder mPublicNotificationBuilder;
    private final File mScreenshotDir;

    GlobalScreenshot4(Context context, GlobalScreenshot3 globalScreenshot3, NotificationManager notificationManager) {
        Resources resources = context.getResources();
        this.mParams = globalScreenshot3;
        ...
        this.mImageWidth = globalScreenshot3.image.getWidth();
        this.mImageHeight = globalScreenshot3.image.getHeight();
        int i = globalScreenshot3.iconSize;
        int i2 = globalScreenshot3.previewWidth;
        int i3 = globalScreenshot3.previewheight;
        ...
        Bitmap bitmapGenerateAdjustedHwBitmap = generateAdjustedHwBitmap(globalScreenshot3.image, i2, i3, matrix, paint, 1090519039);
        float f = i;
        ...
        Bitmap bitmapGenerateAdjustedHwBitmap2 = generateAdjustedHwBitmap(globalScreenshot3.image, i, i, matrix, paint, 1090519039);
    ...
    protected Void doInBackground(Void... voidArr) throws SecurityException, IOException, IllegalArgumentException {
        if (isCancelled()) {
            return null;
        }
        ...
        try {
            ...
            intent.addFlags(1);
            this.mNotificationBuilder.addAction(new Notification.Action.Builder(R.drawable.ic_screenshot_share, resources.getString(android.R.string.mediasize_japanese_jis_b4), PendingIntent.getBroadcast(context, 0, new Intent(context, (Class<?>) GlobalScreenshot.ScreenshotActionReceiver.class).putExtra("android:screenshot_sharing_intent", intent), 268435456)).build());
            Intent intent2 = new Intent("android.intent.action.EDIT");
            intent2.setType("image/png");
            intent2.setData(uriInsert);
            intent2.addFlags(1);
            intent2.addFlags(2);
            this.mNotificationBuilder.addAction(new Notification.Action.Builder(R.drawable.ic_screenshot_edit, resources.getString(android.R.string.mediasize_iso_a3), PendingIntent.getBroadcast(context, 1, new Intent(context, (Class<?>) GlobalScreenshot.ScreenshotActionReceiver.class).putExtra("android:screenshot_sharing_intent", intent2), 268435456)).build());
            this.mNotificationBuilder.addAction(new Notification.Action.Builder(R.drawable.ic_screenshot_delete, resources.getString(android.R.string.bugreport_screenshot_success_toast), PendingIntent.getBroadcast(context, 0, new Intent(context, (Class<?>) GlobalScreenshot.DeleteScreenshotReceiver.class).putExtra("android:screenshot_uri_id", uriInsert.toString()), 1342177280)).build());
    ...
    @Override // android.os.AsyncTask
    protected void onPostExecute(Void r13) throws Resources.NotFoundException {
