...
public class CustomTile extends QSTileImpl<QSTile.State> implements TileLifecycleManager.TileChangeListener {
    ...
    private CustomTile(QSTileHost qSTileHost, String str) throws PackageManager.NameNotFoundException {
        super(qSTileHost);
    ...
    private void setTileIcon() throws PackageManager.NameNotFoundException {
