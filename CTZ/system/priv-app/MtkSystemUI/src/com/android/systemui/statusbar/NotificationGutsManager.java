...
public class NotificationGutsManager implements Dumpable {
    ...
    public void onDensityOrFontScaleChanged(ExpandableNotificationRow expandableNotificationRow) throws PackageManager.NameNotFoundException {
    ...
    public void bindGuts(ExpandableNotificationRow expandableNotificationRow) throws PackageManager.NameNotFoundException {
        bindGuts(expandableNotificationRow, this.mGutsMenuItem);
    }

    private void bindGuts(final ExpandableNotificationRow expandableNotificationRow, NotificationMenuRowPlugin.MenuItem menuItem) throws PackageManager.NameNotFoundException {
    ...
    private void initializeAppOpsInfo(final ExpandableNotificationRow expandableNotificationRow, AppOpsInfo appOpsInfo) throws PackageManager.NameNotFoundException {
    ...
    void initializeNotificationInfo(final ExpandableNotificationRow expandableNotificationRow, NotificationInfo notificationInfo) throws PackageManager.NameNotFoundException {
        final NotificationGuts guts = expandableNotificationRow.getGuts();
        final StatusBarNotification statusBarNotification = expandableNotificationRow.getStatusBarNotification();
        ...
        try {
            notificationInfo.bindNotification(packageManagerForUser, iNotificationManagerAsInterface, packageName, expandableNotificationRow.getEntry().channel, expandableNotificationRow.getNumUniqueChannels(), statusBarNotification, this.mCheckSaveListener, (!user.equals(UserHandle.ALL) || this.mLockscreenUserManager.getCurrentUserId() == 0) ? new NotificationInfo.OnSettingsClickListener() { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationGutsManager$CuJJD4QSv95ak-chMNjvs4UJcoM
