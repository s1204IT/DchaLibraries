...
public class TaskView extends FixedSizeFrameLayout implements View.OnClickListener, View.OnLongClickListener, Task.TaskCallbacks {
    ...
    /* renamed from: com.android.systemui.recents.views.TaskView$4 */
    ...
    void dismissTask() {
        ...
        dismissTaskViewEvent.addPostAnimationCallback(new Runnable() { // from class: com.android.systemui.recents.views.TaskView.5
            ...
            AnonymousClass5(TaskView this) {
                taskView = this;
            }

            @Override // java.lang.Runnable
            public void run() {
                EventBus.getDefault().send(new TaskViewDismissedEvent(TaskView.this.mTask, taskView, new AnimationProps(200, Interpolators.FAST_OUT_SLOW_IN)));
            }
        });
    ...
    public void hideActionButton(boolean z, int i, boolean z2, Animator.AnimatorListener animatorListener) {
        ...
        this.mActionButtonView.animate().alpha(0.0f).setDuration(i).setInterpolator(Interpolators.ALPHA_OUT).withEndAction(new Runnable() { // from class: com.android.systemui.recents.views.TaskView.6
            final /* synthetic */ Animator.AnimatorListener val$animListener;
    ...
    public void onTaskBound(Task task, boolean z, int i, Rect rect) throws NoSuchMethodException, SecurityException {
    ...
    public boolean onLongClick(View view) throws NoSuchMethodException, SecurityException {
        boolean zContains;
