...
class GlobalScreenshot {
    ...
    public GlobalScreenshot(Context context) throws Resources.NotFoundException {
    ...
    private void saveScreenshotInWorkerThread(Runnable runnable) {
        GlobalScreenshot3 globalScreenshot3 = new GlobalScreenshot3();
        globalScreenshot3.context = this.mContext;
        globalScreenshot3.image = this.mScreenBitmap;
        globalScreenshot3.iconSize = this.mNotificationIconSize;
        globalScreenshot3.finisher = runnable;
        globalScreenshot3.previewWidth = this.mPreviewWidth;
        globalScreenshot3.previewheight = this.mPreviewHeight;
        if (this.mSaveInBgTask != null) {
            this.mSaveInBgTask.cancel(false);
        }
        this.mSaveInBgTask = new GlobalScreenshot4(this.mContext, globalScreenshot3, this.mNotificationManager).execute(new Void[0]);
    }

    private void takeScreenshot(Runnable runnable, boolean z, boolean z2, Rect rect) throws Resources.NotFoundException {
    ...
    void takeScreenshot(Runnable runnable, boolean z, boolean z2) throws Resources.NotFoundException {
        this.mDisplay.getRealMetrics(this.mDisplayMetrics);
    ...
    private ValueAnimator createScreenshotDropInAnimation() {
        ...
        valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.screenshot.GlobalScreenshot.8
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.screenshot.GlobalScreenshot.9
    ...
    private ValueAnimator createScreenshotDropOutAnimation(int i, int i2, boolean z, boolean z2) {
        ...
        valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.screenshot.GlobalScreenshot.10
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
        ...
        if (!z || !z2) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.screenshot.GlobalScreenshot.11
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            ...
            valueAnimatorOfFloat.setDuration(430L);
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.screenshot.GlobalScreenshot.13
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    static void notifyScreenshotError(Context context, NotificationManager notificationManager, int i) throws Resources.NotFoundException {
        Resources resources = context.getResources();
        String string = resources.getString(i);
        Notification.Builder color = new Notification.Builder(context, NotificationChannels.ALERTS).setTicker(resources.getString(R.string.screenshot_failed_title)).setContentTitle(resources.getString(R.string.screenshot_failed_title)).setContentText(string).setSmallIcon(R.drawable.stat_notify_image_error).setWhen(System.currentTimeMillis()).setVisibility(1).setCategory("err").setAutoCancel(true).setColor(context.getColor(android.R.color.car_cyan_400));
    ...
    public static class DeleteScreenshotReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            new GlobalScreenshot2(context).execute(uri);
        }
    }
}
