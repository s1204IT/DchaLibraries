...
public class LauncherAccessibilityDelegate extends View.AccessibilityDelegate implements DragController.DragListener {
    ...
    public boolean performAction(View view, ItemInfo itemInfo, int i) {
        if (i == R.id.action_move) {
            ...
            if (i == R.id.action_add_to_workspace) {
                int[] iArr = new int[2];
                this.mLauncher.getStateManager().goToState(LauncherState.NORMAL, true, (Runnable) new Runnable() { // from class: com.android.launcher3.accessibility.LauncherAccessibilityDelegate.1
                    final /* synthetic */ int[] val$coordinates;
                    final /* synthetic */ ItemInfo val$item;
                    final /* synthetic */ long val$screenId;

                    AnonymousClass1(ItemInfo itemInfo2, long j, int[] iArr2) {
                        itemInfo = itemInfo2;
                        j = j;
                        iArr = iArr2;
                    }
                    ...
                    public void run() {
                        if (itemInfo instanceof AppInfo) {
                            ...
                            LauncherAccessibilityDelegate.this.mLauncher.getModelWriter().addItemToDatabase(shortcutInfoMakeShortcut, -100L, j, iArr[0], iArr[1]);
                            ...
                            LauncherAccessibilityDelegate.this.mLauncher.addPendingItem(pendingAddItemInfo, -100L, j, iArr, pendingAddItemInfo.spanX, pendingAddItemInfo.spanY);
                        }
            ...
            if (i == R.id.action_move_to_workspace) {
                ...
                int[] iArr2 = new int[2];
                this.mLauncher.getModelWriter().moveItemInDatabase(shortcutInfo, -100L, findSpaceOnWorkspace(itemInfo2, iArr2), iArr2[0], iArr2[1]);
                new Handler().post(new Runnable() { // from class: com.android.launcher3.accessibility.LauncherAccessibilityDelegate.2
                    final /* synthetic */ ItemInfo val$item;

                    AnonymousClass2(ItemInfo itemInfo2) {
                        itemInfo = itemInfo2;
                    }
                ...
                if (i == R.id.action_resize) {
                    ...
                    new AlertDialog.Builder(this.mLauncher).setTitle(R.string.action_resize).setItems(charSequenceArr, new DialogInterface.OnClickListener() { // from class: com.android.launcher3.accessibility.LauncherAccessibilityDelegate.3
                        ...
                        AnonymousClass3(ArrayList supportedResizeActions2, View view2, LauncherAppWidgetInfo launcherAppWidgetInfo2) {
                            arrayList = supportedResizeActions2;
                            view = view2;
                        ...
                        public void onClick(DialogInterface dialogInterface, int i3) {
                            LauncherAccessibilityDelegate.this.performResizeAction(((Integer) arrayList.get(i3)).intValue(), view, launcherAppWidgetInfo);
                ...
                if (i == R.id.action_deep_shortcuts) {
                    return PopupContainerWithArrow.showForIcon((BubbleTextView) view2) != null;
                }
                for (ButtonDropTarget buttonDropTarget : this.mLauncher.getDropTargetBar().getDropTargets()) {
                    if (buttonDropTarget.supportsAccessibilityDrop(itemInfo2, view2) && i == buttonDropTarget.getAccessibilityAction()) {
                        buttonDropTarget.onAccessibilityDrop(view2, itemInfo2);
                        return true;
                    }
                }
            }
    ...
    /* renamed from: com.android.launcher3.accessibility.LauncherAccessibilityDelegate$1 */
    ...
    /* renamed from: com.android.launcher3.accessibility.LauncherAccessibilityDelegate$2 */
    ...
    /* renamed from: com.android.launcher3.accessibility.LauncherAccessibilityDelegate$3 */
