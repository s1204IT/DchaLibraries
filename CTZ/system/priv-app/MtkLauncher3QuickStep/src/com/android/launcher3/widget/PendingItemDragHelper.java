...
public class PendingItemDragHelper extends DragPreviewProvider {
    ...
    public void startDrag(Rect rect, int i, int i2, Point point, DragSource dragSource, DragOptions dragOptions) throws Resources.NotFoundException, PackageManager.NameNotFoundException {
        Bitmap bitmap;
        float width;
        Rect rect2;
        Point point2;
