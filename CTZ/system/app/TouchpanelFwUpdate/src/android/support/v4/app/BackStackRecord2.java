...
/* renamed from: android.support.v4.app.BackStackState, reason: use source file name */
/* loaded from: classes.dex */
final class BackStackRecord2 implements Parcelable {
    public static final Parcelable.Creator<BackStackRecord2> CREATOR = new Parcelable.Creator<BackStackRecord2>() { // from class: android.support.v4.app.BackStackState.1
        /* JADX DEBUG: Method merged with bridge method: createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public BackStackRecord2 createFromParcel(Parcel in) {
            return new BackStackRecord2(in);
        }

        /* JADX DEBUG: Method merged with bridge method: newArray(I)[Ljava/lang/Object; */
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public BackStackRecord2[] newArray(int size) {
            return new BackStackRecord2[size];
        }
    };
    ...
    public BackStackRecord2(BackStackRecord bse) {
    ...
    public BackStackRecord2(Parcel in) {
    ...
    public BackStackRecord instantiate(FragmentManager2 fm) {
