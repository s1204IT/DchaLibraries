...
final class FragmentManager2 extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    Runnable mExecCommit = new Runnable() { // from class: android.support.v4.app.FragmentManagerImpl.1
        ...
        public void run() {
            FragmentManager2.this.execPendingActions();
        }
    };
    ...
    private boolean popBackStackImmediate(String name, int id, int flags) throws Resources.NotFoundException {
    ...
    AnimationOrAnimator loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) throws Resources.NotFoundException {
        int styleIndex;
    ...
    public void performPendingDeferredStart(Fragment f) throws Resources.NotFoundException {
        if (f.mDeferStart) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:389:0x034c  */
    /* JADX WARN: Removed duplicated region for block: B:394:0x036b  */
    /* JADX WARN: Removed duplicated region for block: B:424:0x03fa  */
    /* JADX WARN: Removed duplicated region for block: B:426:0x0400  */
    /* JADX WARN: Removed duplicated region for block: B:455:0x0478  */
    /* JADX WARN: Removed duplicated region for block: B:459:? A[RETURN, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    void moveToState(Fragment f, int newState, int transit, int transitionStyle, boolean keepActive) throws Resources.NotFoundException {
        int newState2;
        String resName;
    ...
    private void animateRemoveFragment(Fragment fragment, AnimationOrAnimator anim, int newState) {
        ...
        if (anim.animation != null) {
            ...
            animation.setAnimationListener(new AnimationListenerWrapper(listener) { // from class: android.support.v4.app.FragmentManagerImpl.2
                ...
                AnonymousClass2(Animation.AnimationListener listener2, ViewGroup container2, Fragment fragment2) {
                    super(listener2);
                    viewGroup = container2;
                    fragment = fragment2;
                }

                @Override // android.support.v4.app.FragmentManager2.AnimationListenerWrapper, android.view.animation.Animation.AnimationListener
                    ...
                    viewGroup.post(new Runnable() { // from class: android.support.v4.app.FragmentManagerImpl.2.1
                        ...
                        public void run() throws Resources.NotFoundException {
                            if (fragment.getAnimatingAway() != null) {
                                ...
                                FragmentManager2.this.moveToState(fragment, fragment.getStateAfterAnimating(), 0, 0, false);
                            }
                        }
                    });
                }
        ...
        animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.v4.app.FragmentManagerImpl.3
            ...
            AnonymousClass3(ViewGroup container2, View viewToAnimate2, Fragment fragment2) {
                viewGroup = container2;
                view = viewToAnimate2;
                fragment = fragment2;
            }
            ...
            public void onAnimationEnd(Animator anim2) throws Resources.NotFoundException {
    ...
    void moveToState(Fragment f) throws Resources.NotFoundException {
        moveToState(f, this.mCurState, 0, 0, false);
    }
    ...
    void completeShowHideFragment(Fragment fragment) throws Resources.NotFoundException {
        if (fragment.mView != null) {
            ...
            if (anim != null && anim.animator != null) {
                ...
                if (fragment.mHidden) {
                    if (fragment.isHideReplaced()) {
                        ...
                        anim.animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.v4.app.FragmentManagerImpl.4
                            ...
                            AnonymousClass4(ViewGroup container2, View animatingView2, Fragment fragment2) {
                                viewGroup = container2;
                                view = animatingView2;
                                fragment = fragment2;
                            }
                ...
                int visibility = (!fragment2.mHidden || fragment2.isHideReplaced()) ? 0 : 8;
                fragment2.mView.setVisibility(visibility);
    ...
    private void removeRedundantOperationsAndExecute(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop) throws Resources.NotFoundException {
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) throws Resources.NotFoundException {
    ...
    private int postponePostponableTransactions(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex, ArraySet<Fragment> added) throws Resources.NotFoundException {
        int postponeIndex = endIndex;
    ...
    private void addAddedFragments(ArraySet<Fragment> added) throws Resources.NotFoundException {
        if (this.mCurState < 1) {
            return;
        }
    ...
    Parcelable saveAllState() throws Resources.NotFoundException {
        ...
        int[] added = null;
        BackStackRecord2[] backStack = null;
        ...
        if (this.mBackStack != null && (N = this.mBackStack.size()) > 0) {
            backStack = new BackStackRecord2[N];
            for (int i3 = 0; i3 < N; i3++) {
                backStack[i3] = new BackStackRecord2(this.mBackStack.get(i3));
                if (DEBUG) {
                    Log.v("FragmentManager", "saveAllState: adding back stack #" + i3 + ": " + this.mBackStack.get(i3));
                }
            }
        }
        FragmentManager3 fms = new FragmentManager3();
        fms.mActive = active;
        fms.mAdded = added;
    ...
    void restoreAllState(Parcelable state, FragmentManagerNonConfig nonConfig) {
        ...
        FragmentManager3 fms = (FragmentManager3) state;
        if (fms.mActive == null) {
            return;
        }
    ...
    void dispatchOnFragmentPreAttached(Fragment f, Context context, boolean onlyRecursive) {
        if (this.mParent != null) {
            ...
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentPreAttached(f, context, true);
            }
        }
    ...
    void dispatchOnFragmentAttached(Fragment f, Context context, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentAttached(f, context, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentPreCreated(Fragment f, Bundle savedInstanceState, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentPreCreated(f, savedInstanceState, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentCreated(Fragment f, Bundle savedInstanceState, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentCreated(f, savedInstanceState, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentActivityCreated(Fragment f, Bundle savedInstanceState, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentActivityCreated(f, savedInstanceState, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentViewCreated(Fragment f, View v, Bundle savedInstanceState, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentViewCreated(f, v, savedInstanceState, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentStarted(Fragment f, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentStarted(f, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentResumed(Fragment f, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentResumed(f, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentPaused(Fragment f, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentPaused(f, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentStopped(Fragment f, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentStopped(f, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentSaveInstanceState(Fragment f, Bundle outState, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentSaveInstanceState(f, outState, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentViewDestroyed(Fragment f, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentViewDestroyed(f, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentDestroyed(Fragment f, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentDestroyed(f, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    void dispatchOnFragmentDetached(Fragment f, boolean onlyRecursive) {
        if (this.mParent != null) {
            FragmentManager parentManager = this.mParent.getFragmentManager();
            if (parentManager instanceof FragmentManager2) {
                ((FragmentManager2) parentManager).dispatchOnFragmentDetached(f, true);
            }
        }
        Iterator<FragmentLifecycleCallbacksHolder> it = this.mLifecycleCallbacks.iterator();
        while (it.hasNext()) {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) throws Resources.NotFoundException {
        Fragment fragment;
        Fragment fragment2;
    ...
    static class StartEnterTransitionListener implements Fragment.OnStartEnterTransitionListener {
        ...
        public void completeTransaction() {
            ...
            FragmentManager2 manager = this.mRecord.mManager;
    ...
    private static class AnimationOrAnimator {
        ...
        /* synthetic */ AnimationOrAnimator(Animator x0, AnonymousClass1 x1) {
            this(x0);
        }

        /* synthetic */ AnimationOrAnimator(Animation x0, AnonymousClass1 x1) {
            this(x0);
        }
    ...
    private static class AnimationListenerWrapper implements Animation.AnimationListener {
        ...
        /* synthetic */ AnimationListenerWrapper(Animation.AnimationListener x0, AnonymousClass1 x1) {
            this(x0);
        }
